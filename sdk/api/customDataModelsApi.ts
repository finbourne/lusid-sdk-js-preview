...
import { BatchAmendCustomDataModelMembershipResponse } from '../model/batchAmendCustomDataModelMembershipResponse';
...
import { MembershipAmendmentRequest } from '../model/membershipAmendmentRequest';
...
export enum CustomDataModelsApiApiKeys {
}

export class CustomDataModelsApi {
    ...
    public setApiKey(key: CustomDataModelsApiApiKeys, value: string) {
        (this.authentications as any)[CustomDataModelsApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EXPERIMENTAL] BatchAmend: Batch amend entities Custom Data Model membership.
     * @param successMode Whether the batch request should fail Atomically or in a Partial fashion - Allowed Values: Atomic, Partial.
     * @param requestBody The payload describing the amendments to make for the given Custom Data Model.
     */
    public async batchAmend (successMode: string, requestBody: { [key: string]: MembershipAmendmentRequest; }, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BatchAmendCustomDataModelMembershipResponse;  }> {
        const localVarPath = this.basePath + '/api/datamodel/$batchamend';
        ...
        if (successMode === null || successMode === undefined) {
            throw new Error('Required parameter successMode was null or undefined when calling batchAmend.');
        }

        // verify required parameter 'requestBody' is not null or undefined
        if (requestBody === null || requestBody === undefined) {
            throw new Error('Required parameter requestBody was null or undefined when calling batchAmend.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(requestBody, "{ [key: string]: MembershipAmendmentRequest; }")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: BatchAmendCustomDataModelMembershipResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "BatchAmendCustomDataModelMembershipResponse");
     ...
     * @summary [EXPERIMENTAL] CreateCustomDataModel: Create a Custom Data Model
     * @param entityType The entity type of the Data Model.
     * @param createCustomDataModelRequest The request containing the details of the Data Model.
     */
    public async createCustomDataModel (entityType: string, createCustomDataModelRequest?: CreateCustomDataModelRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CustomDataModel;  }> {
        const localVarPath = this.basePath + '/api/datamodel/{entityType}'
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(createCustomDataModelRequest, "CreateCustomDataModelRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: CustomDataModel;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "CustomDataModel");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param entityType The entity type of the Data Model.
     * @param scope The scope of the specified Data Model.
     * @param code The code of the specified Data Model.
     */
    public async deleteCustomDataModel (entityType: string, scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/datamodel/{entityType}/{scope}/{code}'
            .replace('{' + 'entityType' + '}', encodeURIComponent(String(entityType)))
     ...
     * @param scope The scope of the specified Data Model.
     * @param code The code of the specified Data Model.
     * @param asAt The asAt datetime at which to retrieve the Data Model. Defaults to return              the latest version of the Data Model if not specified.
     */
    public async getCustomDataModel (entityType: string, scope: string, code: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CustomDataModel;  }> {
        const localVarPath = this.basePath + '/api/datamodel/{entityType}/{scope}/{code}'
            .replace('{' + 'entityType' + '}', encodeURIComponent(String(entityType)))
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
     ...
     * @summary [EXPERIMENTAL] ListDataModelHierarchies: List Custom Data Model hierarchies.
     * @param asAt The asAt datetime at which to retrieve the Data Model. Defaults to return              the latest version of the Data Model if not specified.
     ...
     */
    public async listDataModelHierarchies (asAt?: Date, filter?: string, sortBy?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfDataModelSummary;  }> {
        const localVarPath = this.basePath + '/api/datamodel/hierarchies';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ResourceListOfDataModelSummary;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ResourceListOfDataModelSummary");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] ListSupportedEntityTypes: List the currently supported entity types for use in Custom Data Models.
     */
    public async listSupportedEntityTypes (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfString;  }> {
        const localVarPath = this.basePath + '/api/datamodel/entitytype';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
     ...
     * @param scope The scope of the specified Data Model.
     * @param code The code of the specified Data Model.
     * @param updateCustomDataModelRequest The request containing the details of the Data Model.
     */
    public async updateCustomDataModel (entityType: string, scope: string, code: string, updateCustomDataModelRequest?: UpdateCustomDataModelRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CustomDataModel;  }> {
        const localVarPath = this.basePath + '/api/datamodel/{entityType}/{scope}/{code}'
            .replace('{' + 'entityType' + '}', encodeURIComponent(String(entityType)))
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(updateCustomDataModelRequest, "UpdateCustomDataModelRequest")
        };
