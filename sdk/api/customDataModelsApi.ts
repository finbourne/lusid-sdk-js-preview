...
export class CustomDataModelsApi {
     ...
     */
    public async listDataModelHierarchies (asAt?: Date, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfDataModelSummary;  }> {
