...
import { UpsertCustomDataModelRequest } from '../model/upsertCustomDataModelRequest';
...
export class CustomDataModelsApi {
     ...
     * @param upsertCustomDataModelRequest The request containing the details of the Data Model.
     */
    public async createCustomDataModel (scope: string, code: string, entityType: string, upsertCustomDataModelRequest?: UpsertCustomDataModelRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CustomDataModel;  }> {
        ...
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling createCustomDataModel.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling createCustomDataModel.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(upsertCustomDataModelRequest, "UpsertCustomDataModelRequest")
        };
     ...
     * @param code The code of the specified Data Model.
     */
    public async deleteCustomDataModel (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/datamodel/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     */
    public async getCustomDataModel (scope: string, code: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CustomDataModel;  }> {
        const localVarPath = this.basePath + '/api/datamodel/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
     ...
     * @param upsertCustomDataModelRequest The request containing the details of the Data Model.
     */
    public async updateCustomDataModel (scope: string, code: string, entityType: string, upsertCustomDataModelRequest?: UpsertCustomDataModelRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CustomDataModel;  }> {
        const localVarPath = this.basePath + '/api/datamodel/{entityType}/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'entityType' + '}', encodeURIComponent(String(entityType)));
