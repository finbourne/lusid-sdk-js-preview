...
import { AnalyticStore } from '../model/analyticStore';
import { CreateAnalyticStoreRequest } from '../model/createAnalyticStoreRequest';
import { DeletedEntityResponse } from '../model/deletedEntityResponse';
import { InstrumentAnalytic } from '../model/instrumentAnalytic';
...
import { ResourceListOfAnalyticStoreKey } from '../model/resourceListOfAnalyticStoreKey';
...
export enum AnalyticsStoresApiApiKeys {
}

export class AnalyticsStoresApi {
    ...
    public setApiKey(key: AnalyticsStoresApiApiKeys, value: string) {
        (this.authentications as any)[AnalyticsStoresApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async createAnalyticStore (request?: CreateAnalyticStoreRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AnalyticStore;  }> {
        const localVarPath = this.basePath + '/api/analytics';
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(request, "CreateAnalyticStoreRequest")
        };
        ...
        return new Promise<{ response: http.IncomingMessage; body: AnalyticStore;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
                    body = ObjectSerializer.deserialize(body, "AnalyticStore");
     ...
     */
    public async deleteAnalyticStore (scope: string, year: number, month: number, day: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/analytics/{scope}/{year}/{month}/{day}'
     ...
     */
    public async getAnalyticStore (scope: string, year: number, month: number, day: number, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AnalyticStore;  }> {
        const localVarPath = this.basePath + '/api/analytics/{scope}/{year}/{month}/{day}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'year' + '}', encodeURIComponent(String(year)))
            .replace('{' + 'month' + '}', encodeURIComponent(String(month)))
     ...
     */
    public async listAnalyticStores (asAt?: Date, sortBy?: Array<string>, start?: number, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfAnalyticStoreKey;  }> {
        const localVarPath = this.basePath + '/api/analytics';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
        ...
        return new Promise<{ response: http.IncomingMessage; body: ResourceListOfAnalyticStoreKey;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
                    body = ObjectSerializer.deserialize(body, "ResourceListOfAnalyticStoreKey");
                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                        resolve({ response: response, body: body });
                    } else {
                        reject({ response: response, body: body });
     ...
     */
    public async setAnalytics (scope: string, year: number, month: number, day: number, data?: Array<InstrumentAnalytic>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AnalyticStore;  }> {
        const localVarPath = this.basePath + '/api/analytics/{scope}/{year}/{month}/{day}/prices'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'year' + '}', encodeURIComponent(String(year)))
            .replace('{' + 'month' + '}', encodeURIComponent(String(month)))
            .replace('{' + 'day' + '}', encodeURIComponent(String(day)));
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(data, "Array<InstrumentAnalytic>")
        };
