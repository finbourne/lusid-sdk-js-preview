...
export class SearchApi {
     ...
     * @summary [EXPERIMENTAL] InstrumentsSearch: Instruments search
     ...
     */
    public async instrumentsSearch (instrumentSearchProperty: Array<InstrumentSearchProperty>, masteredEffectiveAt?: string, masteredOnly?: boolean, scope?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<InstrumentMatch>;  }> {
     ...
     * @summary [EARLY ACCESS] SearchPortfolioGroups: Search Portfolio Groups
     ...
     * @summary [EARLY ACCESS] SearchPortfolios: Search Portfolios
     ...
     * @summary [EARLY ACCESS] SearchProperties: Search Property Definitions
