...
export class ParticipationsApi {
     ...
     * @summary [EXPERIMENTAL] DeleteParticipation: Delete participation
     ...
     * @summary [EXPERIMENTAL] GetParticipation: Get Participation
     ...
     * @summary [EXPERIMENTAL] ListParticipations: List Participations
     * @param asAt The asAt datetime at which to retrieve the participation. Defaults to return the latest version of the participation if not specified.
     ...
     * @summary [EXPERIMENTAL] UpsertParticipations: Upsert Participation
