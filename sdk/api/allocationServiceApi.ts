...
import { AllocationServiceRunResult } from '../model/allocationServiceRunResult';
...
export enum AllocationServiceApiApiKeys {
}

export class AllocationServiceApi {
    ...
    public setApiKey(key: AllocationServiceApiApiKeys, value: string) {
        (this.authentications as any)[AllocationServiceApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async runAllocationService (resourceId: Array<ResourceId>, allocationAlgorithm?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AllocationServiceRunResult;  }> {
        const localVarPath = this.basePath + '/api/allocationservice/allocate';
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: AllocationServiceRunResult;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "AllocationServiceRunResult");
