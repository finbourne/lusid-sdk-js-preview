...
import { PagedResourceListOfOrderBreachHistory } from '../model/pagedResourceListOfOrderBreachHistory';
...
export class ComplianceApi {
     ...
     * @summary [EXPERIMENTAL] ListOrderBreachHistory: List Historical Order Breaches.
     * @param asAt Optional. The time at which to get results from. Default : latest
     ...
     * @param sortBy Optional. A list of field names to sort by, each suffixed by \&quot;ASC\&quot; or \&quot;DESC\&quot;
     */
    public async listOrderBreachHistory (asAt?: Date, page?: string, limit?: number, filter?: string, sortBy?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfOrderBreachHistory;  }> {
        const localVarPath = this.basePath + '/api/compliance/runs/breaches';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfOrderBreachHistory;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfOrderBreachHistory");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
