...
export class ComplianceApi {
     ...
     */
    public async getComplianceRunResults (runId: string, page?: string, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfComplianceRuleResult;  }> {
     ...
     */
    public async listComplianceRules (effectiveAt?: string, asAt?: Date, page?: string, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfComplianceRule;  }> {
     ...
     * @param filter Expression to filter the result set. Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid.
     */
    public async listComplianceRunInfo (asAt?: Date, page?: string, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfComplianceRunInfo;  }> {
     ...
     */
    public async runCompliance (isPreTrade: boolean, recipeIdScope: string, recipeIdCode?: string, byTaxlots?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ComplianceRunInfo;  }> {
        const localVarPath = this.basePath + '/api/compliance/runs';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
