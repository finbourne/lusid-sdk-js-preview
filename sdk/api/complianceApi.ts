...
export class ComplianceApi {
     ...
     * @summary [EXPERIMENTAL] GetBreachedOrdersInfo: Get the Ids of Breached orders in a given compliance run and the corresponding list of rules that could have caused it.
     ...
     */
    public async getBreachedOrdersInfo (runId: string, orderScope?: string, orderCode?: string, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfComplianceBreachedOrderInfo;  }> {
        const localVarPath = this.basePath + '/api/compliance/runs/breached/{runId}'
        ...
        if (runId === null || runId === undefined) {
            throw new Error('Required parameter runId was null or undefined when calling getBreachedOrdersInfo.');
        }
    ...
    public async getComplianceRunResults (runId: string, page?: string, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfComplianceRuleResult;  }> {
        const localVarPath = this.basePath + '/api/compliance/runs/{runId}'
            .replace('{' + 'runId' + '}', encodeURIComponent(String(runId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
     ...
     * @summary [EXPERIMENTAL] ListComplianceRunInfo: List historical compliance run ids.
     ...
     */
    public async listComplianceRunInfo (asAt?: Date, page?: string, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfComplianceRun;  }> {
    ...
    /**
     * Use this endpoint to fetch a list of all historical compliance runs.
     * @summary [EXPERIMENTAL] ListComplianceRuns: List historical compliance runs. -- DEPRECATING IN FAVOUR OF NEW ENDPOINT
     * @param page The pagination token to use to continue listing compliance runs from a previous call to list compliance runs.              This value is returned from the previous call. If a pagination token is provided the sortBy, filter, and asAt fields              must not have changed since the original request. Also, if set, a start value cannot be provided.
     * @param limit When paginating, limit the number of returned results to this many.
     * @param filter Expression to filter the result set. Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid.
     */
     ...
     * @summary [EXPERIMENTAL] RunCompliance: Kick off the compliance check process
     ...
     */
    public async runCompliance (isPreTrade: boolean, recipeIdScope: string, recipeIdCode?: string, byTaxlots?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ComplianceRun;  }> {
        const localVarPath = this.basePath + '/api/compliance/runs';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
