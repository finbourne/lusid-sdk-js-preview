...
export class SystemConfigurationApi {
     ...
     * @summary [EXPERIMENTAL] CreateSideDefinition: Create side definition
     ...
     * @summary [EXPERIMENTAL] DeleteTransactionConfigurationSource: Delete all transaction configurations for a source
     * @param source The source to delete transaction configurations for
     */
    public async deleteTransactionConfigurationSource (source: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/systemconfiguration/transactions/type/{source}'
     ...
     * @summary [EXPERIMENTAL] GetTransactionConfigurationSource: Get all transaction configurations for a source
     ...
     */
    public async getTransactionConfigurationSource (source: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TransactionSetConfigurationData;  }> {
        const localVarPath = this.basePath + '/api/systemconfiguration/transactions/type/{source}'
            .replace('{' + 'source' + '}', encodeURIComponent(String(source)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @summary [EXPERIMENTAL] SetConfigurationTransactionTypes: Set transaction types
     ...
     * @summary [EXPERIMENTAL] SetTransactionConfigurationSource: Set transaction types for a source
     ...
     */
    public async setTransactionConfigurationSource (source: string, setTransactionConfigurationSourceRequest: Array<SetTransactionConfigurationSourceRequest>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TransactionSetConfigurationData;  }> {
        const localVarPath = this.basePath + '/api/systemconfiguration/transactions/type/{source}'
            .replace('{' + 'source' + '}', encodeURIComponent(String(source)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'setTransactionConfigurationSourceRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(setTransactionConfigurationSourceRequest, "Array<SetTransactionConfigurationSourceRequest>")
        };
