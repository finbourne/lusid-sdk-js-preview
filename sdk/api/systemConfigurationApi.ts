...
import { ResourceListOfTransactionConfigurationData } from '../model/resourceListOfTransactionConfigurationData';
...
export class SystemConfigurationApi {
     ...
     */
    public async createConfigurationTransactionType (type?: TransactionConfigurationDataRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfTransactionConfigurationData;  }> {
        const localVarPath = this.basePath + '/api/systemconfiguration/transactiontypes';
        ...
        return new Promise<{ response: http.IncomingMessage; body: ResourceListOfTransactionConfigurationData;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
                    body = ObjectSerializer.deserialize(body, "ResourceListOfTransactionConfigurationData");
     ...
     */
    public async listConfigurationTransactionTypes (options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfTransactionConfigurationData;  }> {
        const localVarPath = this.basePath + '/api/systemconfiguration/transactiontypes';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
     ...
     */
    public async setConfigurationTransactionTypes (types?: Array<TransactionConfigurationDataRequest>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfTransactionConfigurationData;  }> {
        const localVarPath = this.basePath + '/api/systemconfiguration/transactiontypes';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(types, "Array<TransactionConfigurationDataRequest>")
        };
