...
export class SystemConfigurationApi {
     ...
     * @param side The definition of the side to be created.
     */
    public async createSideDefinition (side?: SideConfigurationDataRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TransactionSetConfigurationData;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(side, "SideConfigurationDataRequest")
        };
     ...
     */
    public async setConfigurationTransactionTypes (types?: TransactionSetConfigurationDataRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TransactionSetConfigurationData;  }> {
        const localVarPath = this.basePath + '/api/systemconfiguration/transactions';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(types, "TransactionSetConfigurationDataRequest")
        };
