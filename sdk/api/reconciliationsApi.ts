...
export class ReconciliationsApi {
     ...
     */
    public async reconcileInline (sortBy?: Array<string>, start?: number, limit?: number, filter?: string, inlineValuationsReconciliationRequest?: InlineValuationsReconciliationRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ListAggregationReconciliation;  }> {
     ...
     */
    public async reconcileValuation (sortBy?: Array<string>, start?: number, limit?: number, filter?: string, valuationsReconciliationRequest?: ValuationsReconciliationRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ListAggregationReconciliation;  }> {
