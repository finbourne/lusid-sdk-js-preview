...
export class ReconciliationsApi {
     ...
     * @param request The specifications of the inputs to the reconciliation. This request can take tolerance for units and cost.
     */
    public async reconcileHoldingsPreview (sortBy?: Array<string>, start?: number, limit?: number, filter?: string, request?: PortfoliosReconciliationRequestPreview, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfReconciliationBreak;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(request, "PortfoliosReconciliationRequestPreview")
        };
     ...
     * @param request The specifications of the inputs to the reconciliation
     */
    public async reconcileInline (sortBy?: Array<string>, start?: number, limit?: number, filter?: string, request?: InlineValuationsReconciliationRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfReconciliationBreak;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(request, "InlineValuationsReconciliationRequest")
        };
