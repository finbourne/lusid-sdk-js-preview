...
import { PortfoliosReconciliationRequestPreview } from '../model/portfoliosReconciliationRequestPreview';
...
export class ReconciliationsApi {
     ...
     * @summary [EXPERIMENTAL] ReconcileGeneric: Reconcile either holdings or valuations performed on one or two sets of holdings using one or two configuration recipes.                The output is configurable for various types of comparisons, to allow tolerances on numerical and date-time data or case-insensitivity on strings,  and elision of resulting differences where they are \'empty\' or null or zero.
    ...
    /**
     * Reconcile the holdings of two portfolios.
     * @summary [EXPERIMENTAL] ReconcileHoldingsPreview: Reconcile portfolio holdings with given tolerance
     * @param sortBy Optional. Order the results by these fields. Use use the \&#39;-\&#39; sign to denote descending order e.g. -MyFieldName
     * @param start Optional. When paginating, skip this number of results
     * @param limit Optional. When paginating, limit the number of returned results to this many.
     * @param filter Optional. Expression to filter the result set
     * @param portfoliosReconciliationRequestPreview The specifications of the inputs to the reconciliation. This request can take tolerance for units and cost.
     */
    public async reconcileHoldingsPreview (sortBy?: Array<string>, start?: number, limit?: number, filter?: string, portfoliosReconciliationRequestPreview?: PortfoliosReconciliationRequestPreview, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfReconciliationBreak;  }> {
        const localVarPath = this.basePath + '/api/portfolios/preview/$reconcileholdings';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(portfoliosReconciliationRequestPreview, "PortfoliosReconciliationRequestPreview")
        };
     ...
     * @summary [BETA] ReconcileInline: Reconcile valuations performed on one or two sets of inline instruments using one or two configuration recipes.
     ...
     * @summary [BETA] ReconcileValuation: Reconcile valuations performed on one or two sets of holdings using one or two configuration recipes.
