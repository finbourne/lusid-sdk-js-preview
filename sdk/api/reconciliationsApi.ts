...
export class ReconciliationsApi {
     ...
     * @summary [EXPERIMENTAL] DeleteReconciliationMapping: Delete a mapping
     * @param scope The scope of the mapping.
     * @param code The code fof the mapping.
     */
    public async deleteReconciliationMapping (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: boolean;  }> {
     ...
     * @summary [EXPERIMENTAL] GetReconciliationMapping: Get a mapping
     * @param scope The scope of the mapping.
     * @param code The code fof the mapping.
     */
     ...
     * @summary [EXPERIMENTAL] ListReconciliationMappings: List the reconciliation mappings
     * @param reconciliationType Optional parameter to specify which type of mappings should be returned.              Currently only supports Transaction types
     */
     ...
     * @summary [EXPERIMENTAL] ReconcileTransactions: Perform a Transactions Reconciliation.
     ...
     * @summary [EXPERIMENTAL] UpsertReconciliationMapping: Create or update a mapping
