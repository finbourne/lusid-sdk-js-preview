...
export class ReconciliationsApi {
    ...
    public async createScheduledReconciliation (scope: string, createReconciliationRequest?: CreateReconciliationRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Reconciliation;  }> {
        const localVarPath = this.basePath + '/api/portfolios/$scheduledReconciliation/{scope}'
    ...
    public async deleteReconciliation (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/portfolios/$scheduledReconciliation/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
    ...
    public async deleteReconciliationRun (scope: string, code: string, runDate: Date, version: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/portfolios/$scheduledReconciliation/run/{scope}/{code}/{runDate}/{version}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
    ...
    public async listReconciliationRuns (scope: string, code: string, effectiveAt?: string, asAt?: Date, page?: string, start?: number, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfReconciliationRun;  }> {
        const localVarPath = this.basePath + '/api/portfolios/$scheduledReconciliation/run/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
    ...
    public async listReconciliations (effectiveAt?: string, asAt?: Date, page?: string, start?: number, limit?: number, filter?: string, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfReconciliation;  }> {
        const localVarPath = this.basePath + '/api/portfolios/$scheduledReconciliation';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
