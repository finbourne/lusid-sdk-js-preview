...
export enum RelationalDatasetDefinitionApiApiKeys {
}

export class RelationalDatasetDefinitionApi {
    ...
    public setApiKey(key: RelationalDatasetDefinitionApiApiKeys, value: string) {
        (this.authentications as any)[RelationalDatasetDefinitionApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EARLY ACCESS] CreateRelationalDatasetDefinition: Create a Relational Dataset Definition
     * @param createRelationalDatasetDefinitionRequest The relational dataset definition to create.
     */
    public async createRelationalDatasetDefinition (createRelationalDatasetDefinitionRequest: CreateRelationalDatasetDefinitionRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: RelationalDatasetDefinition;  }> {
        const localVarPath = this.basePath + '/api/relationaldatasetdefinitions';
        ...
        // verify required parameter 'createRelationalDatasetDefinitionRequest' is not null or undefined
        if (createRelationalDatasetDefinitionRequest === null || createRelationalDatasetDefinitionRequest === undefined) {
            throw new Error('Required parameter createRelationalDatasetDefinitionRequest was null or undefined when calling createRelationalDatasetDefinition.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(createRelationalDatasetDefinitionRequest, "CreateRelationalDatasetDefinitionRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: RelationalDatasetDefinition;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "RelationalDatasetDefinition");
     ...
     * @summary [EARLY ACCESS] DeleteRelationalDatasetDefinition: Delete a Relational Dataset Definition
     * @param scope The scope of the relational dataset definition.
     * @param code The code of the relational dataset definition.
     */
    public async deleteRelationalDatasetDefinition (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/relationaldatasetdefinitions/{scope}/{code}'
        ...
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling deleteRelationalDatasetDefinition.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling deleteRelationalDatasetDefinition.');
        }
     ...
     * @summary [EARLY ACCESS] GetRelationalDatasetDefinition: Get a Relational Dataset Definition
     * @param scope The scope of the relational dataset definition.
     * @param code The code of the relational dataset definition.
     * @param asAt The asAt datetime at which to retrieve the relational dataset definition. Defaults to return the latest version if not specified.
     */
    public async getRelationalDatasetDefinition (scope: string, code: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: RelationalDatasetDefinition;  }> {
        const localVarPath = this.basePath + '/api/relationaldatasetdefinitions/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling getRelationalDatasetDefinition.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling getRelationalDatasetDefinition.');
        }
     ...
     * @summary [EARLY ACCESS] ListRelationalDatasetDefinitions: List Relational Dataset Definitions
     * @param asAt The asAt datetime at which to list the relational dataset definitions. Defaults to return the latest version if not specified.
     ...
     */
    public async listRelationalDatasetDefinitions (asAt?: Date, page?: string, sortBy?: Array<string>, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfRelationalDatasetDefinition;  }> {
        const localVarPath = this.basePath + '/api/relationaldatasetdefinitions';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfRelationalDatasetDefinition;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfRelationalDatasetDefinition");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] UpdateRelationalDatasetDefinition: Update a Relational Dataset Definition
     * @param scope The scope of the relational dataset definition.
     * @param code The code of the relational dataset definition.
     * @param updateRelationalDatasetDefinitionRequest The updated relational dataset definition.
     */
    public async updateRelationalDatasetDefinition (scope: string, code: string, updateRelationalDatasetDefinitionRequest?: UpdateRelationalDatasetDefinitionRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: RelationalDatasetDefinition;  }> {
        const localVarPath = this.basePath + '/api/relationaldatasetdefinitions/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling updateRelationalDatasetDefinition.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling updateRelationalDatasetDefinition.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(updateRelationalDatasetDefinitionRequest, "UpdateRelationalDatasetDefinitionRequest")
        };
