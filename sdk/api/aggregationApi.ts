...
export class AggregationApi {
     ...
     */
    public async getAggregationByResultSet (scope: string, resultsKey: string, sortBy?: Array<string>, limit?: number, aggregationRequest?: AggregationRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ListAggregationResponse;  }> {
