...
export class AggregationApi {
     ...
     * @summary [EXPERIMENTAL] Aggregate data in a portfolio or portfolio group  Deprecated: Please use the GetValuation endpoint. It is aimed at a simpler set of requirements now deemed stable.  Aggregation will shortly be modified to include experimental features such as Simulation and XVA
     ...
     * @summary [EXPERIMENTAL] Aggregate data in a portfolio or portfolio group, as nested                Deprecated: Endpoint is being retired. The nested functionality is supported on the valuation endpoint through use of an \'include subtotals\' flag.
     * @param scope The scope of the portfolio or portfolio group
     * @param code The code of the portfolio or portfolio group
     * @param aggregationRequest The request specifying the parameters of the aggregation
     */
    ...
    public async getValuationOfWeightedInstruments (inlineValuationRequest?: InlineValuationRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ListAggregationResponse;  }> {
        const localVarPath = this.basePath + '/api/aggregation/$valuationinlined';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(inlineValuationRequest, "InlineValuationRequest")
        };
