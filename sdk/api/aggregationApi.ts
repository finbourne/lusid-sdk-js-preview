...
export class AggregationApi {
     ...
     * @summary [EXPERIMENTAL] Aggregate data in a portfolio or portfolio group
     * @param scope The scope of the portfolio or portfolio group
     * @param code The code of the portfolio or portfolio group
     ...
     * @param aggregationRequest The request specifying the parameters of the aggregation
     */
    public async getAggregation (scope: string, code: string, sortBy?: Array<string>, start?: number, limit?: number, aggregationRequest?: AggregationRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ListAggregationResponse;  }> {
        const localVarPath = this.basePath + '/api/aggregation/{scope}/{code}/$aggregate'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling getAggregation.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling getAggregation.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(aggregationRequest, "AggregationRequest")
        };
     ...
     * @param aggregationRequest The request specifying the parameters of the aggregation
     */
    public async getAggregationByGroup (scope: string, code: string, sortBy?: Array<string>, start?: number, limit?: number, aggregationRequest?: AggregationRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ListAggregationResponse;  }> {
     ...
     * @param aggregationRequest The request specifying the parameters of the aggregation
     */
    public async getAggregationByPortfolio (scope: string, code: string, sortBy?: Array<string>, start?: number, limit?: number, aggregationRequest?: AggregationRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ListAggregationResponse;  }> {
     ...
     * @param aggregationRequest The request specifying the parameters of the aggregation
     */
    public async getAggregationByResultSet (scope: string, resultsKey: string, sortBy?: Array<string>, start?: number, limit?: number, aggregationRequest?: AggregationRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ListAggregationResponse;  }> {
     ...
     * @param start Optional. When paginating, skip this number of results
     * @param limit Optional. When paginating, limit the number of returned results to this many.
     * @param inlineAggregationRequest The request specifying the parameters of the aggregation and the inlined set of instruments to aggregate over.
     */
    public async getAggregationOfWeightedInstruments (scope: string, sortBy?: Array<string>, start?: number, limit?: number, inlineAggregationRequest?: InlineAggregationRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ListAggregationResponse;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(inlineAggregationRequest, "InlineAggregationRequest")
        };
     ...
     * @summary [EXPERIMENTAL] Aggregate data in a portfolio or portfolio group, as nested
     * @param scope The scope of the portfolio or portfolio group
     * @param code The code of the portfolio or portfolio group
     * @param aggregationRequest The request specifying the parameters of the aggregation
     */
    public async getNestedAggregation (scope: string, code: string, aggregationRequest?: AggregationRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: NestedAggregationResponse;  }> {
        const localVarPath = this.basePath + '/api/aggregation/{scope}/{code}/$aggregatenested'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling getNestedAggregation.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling getNestedAggregation.');
        }
     ...
     * @param aggregationRequest The request specifying the parameters of the aggregation
     */
    public async getNestedAggregationByGroup (scope: string, code: string, aggregationRequest?: AggregationRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: NestedAggregationResponse;  }> {
     ...
     * @param aggregationRequest The request specifying the parameters of the aggregation
     */
    public async getNestedAggregationByPortfolio (scope: string, code: string, aggregationRequest?: AggregationRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: NestedAggregationResponse;  }> {
     ...
     */
    public async getQueryableKeys (page?: string, start?: number, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfAggregationQuery;  }> {
        ...
        return new Promise<{ response: http.IncomingMessage; body: ResourceListOfAggregationQuery;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
                    body = ObjectSerializer.deserialize(body, "ResourceListOfAggregationQuery");
                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                        resolve({ response: response, body: body });
                    } else {
                        reject({ response: response, body: body });
