...
export class AggregationApi {
     ...
     * @summary [BETA] GetValuation: Perform valuation for a list of portfolios and/or portfolio groups
     ...
     * @summary [BETA] GetValuationOfWeightedInstruments: Perform valuation for an inlined portfolio
