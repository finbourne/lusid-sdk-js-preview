...
export class AggregationApi {
     ...
     * @param request The request specifying the parameters to generating the recipe
     */
    public async generateConfigurationRecipe (scope: string, code: string, request?: CreateRecipeRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ConfigurationRecipe;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(request, "CreateRecipeRequest")
        };
