...
export enum AmortisationRuleSetsApiApiKeys {
}

export class AmortisationRuleSetsApi {
    ...
    public setApiKey(key: AmortisationRuleSetsApiApiKeys, value: string) {
        (this.authentications as any)[AmortisationRuleSetsApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EXPERIMENTAL] CreateAmortisationRuleSet: Create an amortisation rule set.
     * @param scope The scope of the rule set.
     * @param createAmortisationRuleSetRequest The contents of the rule set.
     */
    public async createAmortisationRuleSet (scope: string, createAmortisationRuleSetRequest: CreateAmortisationRuleSetRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AmortisationRuleSet;  }> {
        const localVarPath = this.basePath + '/api/amortisation/rulesets/{scope}'
        ...
        // verify required parameter 'createAmortisationRuleSetRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(createAmortisationRuleSetRequest, "CreateAmortisationRuleSetRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: AmortisationRuleSet;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "AmortisationRuleSet");
     ...
     * @summary [EXPERIMENTAL] DeleteAmortisationRuleset: Delete an amortisation rule set.
     * @param scope The rule set scope.
     * @param code The rule set code.
     */
    public async deleteAmortisationRuleset (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/amortisation/rulesets/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
     ...
     * @summary [EXPERIMENTAL] GetAmortisationRuleSet: Retrieve the definition of a single amortisation rule set
     * @param scope The rule set scope.
     * @param code The rule set code.
     ...
     */
    public async getAmortisationRuleSet (scope: string, code: string, effectiveAt?: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AmortisationRuleSet;  }> {
        const localVarPath = this.basePath + '/api/amortisation/rulesets/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
     ...
     * @summary [EXPERIMENTAL] ListAmortisationRuleSets: List amortisation rule sets.
     ...
     */
    public async listAmortisationRuleSets (effectiveAt?: string, asAt?: Date, page?: string, limit?: number, filter?: string, sortBy?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfAmortisationRuleSet;  }> {
        const localVarPath = this.basePath + '/api/amortisation/rulesets';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfAmortisationRuleSet;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfAmortisationRuleSet");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] SetAmortisationRules: Set Amortisation Rules on an existing Amortisation Rule Set.
     * @param scope The rule set scope.
     * @param code The rule set code.
     * @param setAmortisationRulesRequest The contents of the rules.
     */
    public async setAmortisationRules (scope: string, code: string, setAmortisationRulesRequest: SetAmortisationRulesRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AmortisationRuleSet;  }> {
        const localVarPath = this.basePath + '/api/amortisation/rulesets/{scope}/{code}/rules'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'setAmortisationRulesRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(setAmortisationRulesRequest, "SetAmortisationRulesRequest")
        };
     ...
     * @summary [EXPERIMENTAL] UpdateAmortisationRuleSetDetails: Update an amortisation rule set.
     * @param scope The rule set scope.
     * @param code The rule set code.
     * @param updateAmortisationRuleSetDetailsRequest The contents of the rule set.
     */
    public async updateAmortisationRuleSetDetails (scope: string, code: string, updateAmortisationRuleSetDetailsRequest: UpdateAmortisationRuleSetDetailsRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AmortisationRuleSet;  }> {
        const localVarPath = this.basePath + '/api/amortisation/rulesets/{scope}/{code}/details'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'updateAmortisationRuleSetDetailsRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(updateAmortisationRuleSetDetailsRequest, "UpdateAmortisationRuleSetDetailsRequest")
        };
