...
import { GetAddressKeyAliasResponse } from '../model/getAddressKeyAliasResponse';
...
import { PagedResourceListOfGetAddressKeyAliasResponse } from '../model/pagedResourceListOfGetAddressKeyAliasResponse';
import { UpsertAddressKeyAliasRequest } from '../model/upsertAddressKeyAliasRequest';
...
export enum AddressKeyAliasApiApiKeys {
}

export class AddressKeyAliasApi {
    ...
    public setApiKey(key: AddressKeyAliasApiApiKeys, value: string) {
        (this.authentications as any)[AddressKeyAliasApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EXPERIMENTAL] DeleteAddressKeyAlias: Delete an Address Key Alias, assuming that it is present.
     * @param scope The scope of the Address Key Alias to delete.
     * @param code The Address Key Alias to delete.
     */
    public async deleteAddressKeyAlias (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AnnulSingleStructuredDataResponse;  }> {
        const localVarPath = this.basePath + '/api/addresskeyaliases/{scope}/{code}'
        ...
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling deleteAddressKeyAlias.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling deleteAddressKeyAlias.');
        }
     ...
     * @summary [EXPERIMENTAL] GetAddressKeyAlias: Get Address Key Alias
     * @param scope The scope of the Address Key Alias to retrieve.
     * @param code The code of the alias to retrieve.
     * @param asAt The asAt datetime at which to retrieve the alias. Defaults to return the latest version if not specified.
     */
    public async getAddressKeyAlias (scope: string, code: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GetAddressKeyAliasResponse;  }> {
        const localVarPath = this.basePath + '/api/addresskeyaliases/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling getAddressKeyAlias.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling getAddressKeyAlias.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: GetAddressKeyAliasResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GetAddressKeyAliasResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] ListAddressKeyAliases: List the set of Address Key Aliases
     * @param scope The scope to list aliases for.
     * @param asAt The asAt datetime at which to list the aliases. Defaults to latest if not specified.
     ...
     */
    public async listAddressKeyAliases (scope: string, asAt?: Date, filter?: string, limit?: number, page?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfGetAddressKeyAliasResponse;  }> {
        const localVarPath = this.basePath + '/api/addresskeyaliases/{scope}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling listAddressKeyAliases.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfGetAddressKeyAliasResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfGetAddressKeyAliasResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] UpsertAddressKeyAlias: Upsert an Address Key Alias. This creates or updates the alias in LUSID.
     * @param upsertAddressKeyAliasRequest The Address Key Alias to update or insert
     */
    public async upsertAddressKeyAlias (upsertAddressKeyAliasRequest: UpsertAddressKeyAliasRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UpsertSingleStructuredDataResponse;  }> {
        const localVarPath = this.basePath + '/api/addresskeyaliases';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'upsertAddressKeyAliasRequest' is not null or undefined
        if (upsertAddressKeyAliasRequest === null || upsertAddressKeyAliasRequest === undefined) {
            throw new Error('Required parameter upsertAddressKeyAliasRequest was null or undefined when calling upsertAddressKeyAlias.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(upsertAddressKeyAliasRequest, "UpsertAddressKeyAliasRequest")
        };
