...
export enum AborConfigurationApiApiKeys {
}

export class AborConfigurationApi {
    ...
    public setApiKey(key: AborConfigurationApiApiKeys, value: string) {
        (this.authentications as any)[AborConfigurationApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EXPERIMENTAL] CreateAborConfiguration: Create an AborConfiguration.
     * @param scope The scope of the AborConfiguration.
     * @param aborConfigurationRequest The definition of the AborConfiguration.
     */
    public async createAborConfiguration (scope: string, aborConfigurationRequest: AborConfigurationRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AborConfiguration;  }> {
        const localVarPath = this.basePath + '/api/aborconfiguration/{scope}'
        ...
        // verify required parameter 'aborConfigurationRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(aborConfigurationRequest, "AborConfigurationRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: AborConfiguration;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "AborConfiguration");
     ...
     * @summary [EXPERIMENTAL] DeleteAborConfiguration: Delete an AborConfiguration.
     ...
     */
    public async deleteAborConfiguration (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/aborconfiguration/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
     ...
     * @summary [EXPERIMENTAL] GetAborConfiguration: Get AborConfiguration.
     * @param scope The scope of the AborConfiguration.
     ...
     */
    public async getAborConfiguration (scope: string, code: string, effectiveAt?: string, asAt?: Date, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AborConfiguration;  }> {
        const localVarPath = this.basePath + '/api/aborconfiguration/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
     ...
     * @summary [EXPERIMENTAL] GetAborConfigurationProperties: Get Abor Configuration properties
     * @param scope The scope of the Abor Configuration to list the properties for.
     * @param code The code of the Abor Configuration to list the properties for. Together with the scope this uniquely identifies the Abor Configuration.
     * @param effectiveAt The effective datetime or cut label at which to list the Abor Configuration\&#39;s properties. Defaults to the current LUSID system datetime if not specified.
     * @param asAt The asAt datetime at which to list the Abor Configuration\&#39;s properties. Defaults to return the latest version of each property if not specified.
     */
    public async getAborConfigurationProperties (scope: string, code: string, effectiveAt?: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AborConfigurationProperties;  }> {
        const localVarPath = this.basePath + '/api/aborconfiguration/{scope}/{code}/properties'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: AborConfigurationProperties;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "AborConfigurationProperties");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] ListAborConfigurations: List AborConfiguration.
     ...
     * @param asAt The asAt datetime at which to list the AborConfiguration. Defaults to returning the latest version of each AborConfiguration if not specified.
     ...
     */
    public async listAborConfigurations (effectiveAt?: string, asAt?: Date, page?: string, limit?: number, filter?: string, sortBy?: Array<string>, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfAborConfiguration;  }> {
        const localVarPath = this.basePath + '/api/aborconfiguration';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfAborConfiguration;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfAborConfiguration");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] PatchAborConfiguration: Patch Abor Configuration.
     * @param scope The scope of the AborConfiguration.
     * @param code The code of the AborConfiguration.              Together with the scope this uniquely identifies the AborConfiguration.
     * @param operation The json patch document. For more information see: https://datatracker.ietf.org/doc/html/rfc6902.
     */
    public async patchAborConfiguration (scope: string, code: string, operation: Array<Operation>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AborConfiguration;  }> {
        const localVarPath = this.basePath + '/api/aborconfiguration/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling patchAborConfiguration.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling patchAborConfiguration.');
        }

        // verify required parameter 'operation' is not null or undefined
        if (operation === null || operation === undefined) {
            throw new Error('Required parameter operation was null or undefined when calling patchAborConfiguration.');
        }
     ...
     * @summary [EXPERIMENTAL] UpsertAborConfigurationProperties: Upsert AborConfiguration properties
     ...
     */
    public async upsertAborConfigurationProperties (scope: string, code: string, requestBody?: { [key: string]: Property; }, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AborConfigurationProperties;  }> {
        const localVarPath = this.basePath + '/api/aborconfiguration/{scope}/{code}/properties/$upsert'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
