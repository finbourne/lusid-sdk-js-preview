...
export class FundsApi {
     ...
     * @summary [EXPERIMENTAL] AddAllocationGroups: Add Allocation Groups to a Fund.
     * @param scope The scope of the Fund.
     * @param code The code of the Fund. Together with the scope this uniquely identifies the Fund.
     ...
     * @summary [EXPERIMENTAL] AddSeries: Add Series to a Fund.
     * @param scope The scope of the Fund.
     * @param code The code of the Fund. Together with the scope this uniquely identifies the Fund.
     ...
     * @summary [EXPERIMENTAL] DeactivateNavTypes: Deactivate NAV types on a Fund.
     * @param scope The scope of the Fund.
     * @param code The code of the Fund. Together with the scope this uniquely identifies the Fund.
     ...
     * @summary [EXPERIMENTAL] GetA2BDataForFund: Get A2B data for a Fund.
     * @param scope The scope of the Fund.
     * @param code The code of the Fund. Together with the scope this uniquely identifies the Fund.
     ...
     * @summary [EXPERIMENTAL] GetA2BMovementsForFund: Get A2B movements for transaction portfolios in a Fund.
     * @param scope The scope of the Fund.
     * @param code The code of the Fund. Together with the scope this uniquely identifies the Fund.
     ...
     * @summary [EXPERIMENTAL] GetValuationPointUnsettledTransactions: Get Unsettled Transactions for the given Fund.
     * @param scope The scope of the Fund.
     * @param code The code of the Fund. Together with the scope this uniquely identifies the Fund.
     * @param valuationPointDataQueryParameters The arguments to use for querying the unsettled transactions.
     ...
     * @param navTypeCode When provided, runs against the specified NAV Type, otherwise the Primary NAV Type will be used.
     */
    public async getValuationPointUnsettledTransactions (scope: string, code: string, valuationPointDataQueryParameters: ValuationPointDataQueryParameters, asAt?: Date, limit?: number, page?: string, propertyKeys?: Array<string>, navTypeCode?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ValuationPointResourceListOfUnsettledTransaction;  }> {
        ...
        // verify required parameter 'valuationPointDataQueryParameters' is not null or undefined
        if (valuationPointDataQueryParameters === null || valuationPointDataQueryParameters === undefined) {
            throw new Error('Required parameter valuationPointDataQueryParameters was null or undefined when calling getValuationPointUnsettledTransactions.');
        }
    ...
    /**
     * List all the Calendar Entries associated with the Fund.
     * @summary [EXPERIMENTAL] ListFundCalendarEntries: List Fund Calendar Entries.
     * @param scope The scope of the Fund.
     * @param code The code of the Fund. Together with the scope this uniquely identifies the Fund.
     * @param asAt The asAt datetime at which to list the Calendar. Defaults to returning the latest version of each Calendar Entry if not specified.
     * @param page The pagination token to use to continue listing Calendar Entries; this              value is returned from the previous call. If a pagination token is provided, the filter, effectiveAt              and asAt fields must not have changed since the original request.
     ...
     * @summary [EXPERIMENTAL] ListValuationPointInstruments: List Instruments inside a valuation point
     * @param scope The scope of the Fund.
     * @param code The code of the Fund. Together with the scope is the unique identifier for the given Fund.
     ...
     * @summary [EXPERIMENTAL] QueryCashStatement: [EXPERIMENTAL] QueryCashStatement: Query cash statement for a Fund valuation point.
     * @param scope The scope of the Fund.
     * @param code The code of the Fund. Together with the scope this uniquely identifies the Fund.
     ...
     * @summary [EXPERIMENTAL] UpdateValuationPoint: Update a Valuation Point.
     * @param scope The scope of the Fund.
     * @param code The code of the Fund. Together with the scope this uniquely identifies the Fund.
     ...
     */
    public async updateValuationPoint (scope: string, code: string, updateValuationPointRequest: UpdateValuationPointRequest, navTypeCode?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DiaryEntry;  }> {
