...
export class FundsApi {
     ...
     * @param limit When paginating, limit the results to this number. Defaults to 100 if not specified.
     */
    public async listNavActivityAdjustments (scope: string, code: string, valuationPointCode: string, navTypeCode: string, asAt?: Date, page?: string, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfNavActivityAdjustment;  }> {
