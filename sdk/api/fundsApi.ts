...
export class FundsApi {
     ...
     */
    public async deleteNavActivityAdjustments (scope: string, code: string, valuationPointCode: string, navActivityAdjustment: Array<NavActivityAdjustment>, navTypeCode?: string, valuationPointCodeVariant?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
