...
export class FundsApi {
     ...
     */
    public async getValuationPointTransactions (scope: string, code: string, valuationPointDataQueryParameters: ValuationPointDataQueryParameters, asAt?: Date, filter?: string, limit?: number, page?: string, propertyKeys?: Array<string>, navTypeCode?: string, dataModelScope?: string, dataModelCode?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ValuationPointResourceListOfAccountedTransaction;  }> {
