...
export class FundsApi {
     ...
     * @summary [EXPERIMENTAL] CreateValuationPoint: Create a Valuation Point.
     * @param scope The scope of the Fund.
     * @param code The code of the Fund. Together with the scope this uniquely identifies the Fund.
     ...
     * @summary [EXPERIMENTAL] GetValuationPointQuotes: Get the Quotes for the given Fund and Valuation Point.
     * @param scope The scope of the Fund.
     * @param code The code of the Fund. Together with the scope this uniquely identifies the Fund.
     ...
     * @summary [EXPERIMENTAL] ListValuationPointComplexMarketData: List the Complex Market Data for the given Fund and Valuation Point.
     * @param scope The scope of the Fund.
     * @param code The code of the Fund. Together with the scope this uniquely identifies the Fund.
     ...
     * @summary [EXPERIMENTAL] QueryCashStatementLocalCurrency: [EXPERIMENTAL] QueryCashStatementLocalCurrency: Query the local-currency cash statement for a Fund valuation point.
     * @param scope The scope of the Fund.
     * @param code The code of the Fund. Together with the scope this uniquely identifies the Fund.
     * @param queryFundCashStatementParameters The query parameters specifying the diary entry period and display mode.
     * @param asAt The asAt datetime at which to retrieve the cash statement. Defaults to the latest version if not specified.
