...
import { ValuationPointResourceListOfJournalEntryLine } from '../model/valuationPointResourceListOfJournalEntryLine';
...
export class FundsApi {
     ...
     */
    public async acceptEstimateValuationPoint (scope: string, code: string, valuationPointDataRequest: ValuationPointDataRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AcceptEstimateValuationPointResponse;  }> {
     ...
     */
    public async createFee (scope: string, code: string, feeRequest: FeeRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Fee;  }> {
     ...
     */
    public async deleteValuationPoint (scope: string, code: string, diaryEntryCode: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
     ...
     * @summary [EXPERIMENTAL] FinaliseCandidateValuationPoint: Finalise Candidate.
     * @param scope The scope of the Fund.
     * @param code The code of the Fund. Together with the scope this uniquely identifies the Fund.
     * @param valuationPointDataRequest The valuationPointDataRequest which contains the diary entry code to mark as final.
     */
    public async finaliseCandidateValuationPoint (scope: string, code: string, valuationPointDataRequest: ValuationPointDataRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ValuationPointDataResponse;  }> {
     ...
     * @param asAt The asAt datetime at which to retrieve the Fund definition. Defaults to returning the latest version of the Fund definition if not specified.
     */
    public async getValuationPointData (scope: string, code: string, valuationPointDataQueryParameters: ValuationPointDataQueryParameters, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ValuationPointDataResponse;  }> {
     ...
     * @param scope The scope of the Fund.
     * @param code The code of the Fund. Together with the scope is creating the unique identifier for the given Fund.
     ...
     */
    public async getValuationPointJournalEntryLines (scope: string, code: string, valuationPointDataQueryParameters: ValuationPointDataQueryParameters, generalLedgerProfileCode?: string, asAt?: Date, filter?: string, limit?: number, page?: string, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ValuationPointResourceListOfJournalEntryLine;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ValuationPointResourceListOfJournalEntryLine;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ValuationPointResourceListOfJournalEntryLine");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param valuationPointDataQueryParameters The query parameters used in running the generation of the PnL summary
     * @param generalLedgerProfileCode The optional code of a general ledger profile used to decorate journal entry lines with levels.
     ...
     * @param scope The scope of the Fund.
     * @param code The code of the Fund. Together with the scope this uniquely identifies the Fund.
     * @param valuationPointDataQueryParameters The query parameters used in running the generation of the Trial Balance.
     * @param generalLedgerProfileCode The optional code of a general ledger profile used to decorate journal entry lines with levels.
     ...
     */
    public async listValuationPointOverview (scope: string, code: string, effectiveAt?: string, asAt?: Date, page?: string, limit?: number, filter?: string, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfValuationPointOverview;  }> {
     ...
     * @summary [EXPERIMENTAL] UpsertDiaryEntryTypeValuationPoint: Upsert Valuation Point.
     * @param scope The scope of the Fund.
     * @param code The code of the Fund. Together with the scope this uniquely identifies the Fund.
     * @param upsertValuationPointRequest The Valuation Point Estimate definition to Upsert
     */
    public async upsertDiaryEntryTypeValuationPoint (scope: string, code: string, upsertValuationPointRequest: UpsertValuationPointRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DiaryEntry;  }> {
