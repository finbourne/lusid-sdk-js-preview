...
export class FundsApi {
     ...
     * @param navTypeCode When provided Accepts the Valuation Point of the specified NAV Type. When not provided the Primary NAV Type will be Accepted.
     */
     ...
     * @param scope The scope of the Fund for the Bookmark to be deleted.
     * @param code The code of the Fund containing the Bookmark to be deleted. Together with the scope this uniquely identifies the Fund.
     * @param bookmarkCode The bookmark code for the bookmark to be deleted
     * @param navTypeCode When provided, Deletes the Bookmark against the specified NAV Type. When not provided the Primary NAV Type will be Deleted.
     */
     ...
     * @param navTypeCode When provided, Deletes the Valuation Point against the specified NAV Type. When not provided the Primary NAV Type will be Deleted.
     */
     ...
     * @param navTypeCode When provided Finalises the Valuation Point of the specified NAV Type. When not provided the Primary NAV Type will be Finalised.
     */
     ...
     * @param scope The scope of the Fund.
     * @param code The code of the Fund. Together with the scope this uniquely identifies the Fund.
     * @param singleValuationPointQueryParameters The query parameters used for diary entry or effective date of Holdings
     * @param navTypeCode When provided runs against the specified NAV Type, otherwise the Primary NAV Type will be used.
     ...
     * @param navTypeCode May be provided to view a specific NAV type. When not provided, Primary NAV will be used.
     */
     ...
     * @param scope The Scope for the Fund.
     * @param code The Code for the Fund.
     ...
     * @param sortBy A list of field names or properties to sort by, each suffixed by \&quot; ASC\&quot; or \&quot; DESC\&quot;
     */
    public async listFundCalendar (scope: string, code: string, asAt?: Date, page?: string, limit?: number, filter?: string, sortBy?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfFundCalendarEntry;  }> {
     ...
     * @param navTypeCode When provided, Upserts the Valuation Point against the specified NAV Type. When not provided, the Primary NAV Type will be used.
     */
