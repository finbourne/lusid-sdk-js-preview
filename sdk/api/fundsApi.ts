...
export class FundsApi {
     ...
     * @summary [EXPERIMENTAL] AcceptEstimatePoint: Accepts an Estimate Valuation Point.
     ...
     * @param valuationPointDataRequest The valuationPointDataRequest which contains the Diary Entry code for the Estimate Valuation Point to move to Final state.
     */
    public async acceptEstimatePoint (scope: string, code: string, valuationPointDataRequest: ValuationPointDataRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ValuationPointDataResponse;  }> {
        ...
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling acceptEstimatePoint.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling acceptEstimatePoint.');
        }
        ...
        if (valuationPointDataRequest === null || valuationPointDataRequest === undefined) {
            throw new Error('Required parameter valuationPointDataRequest was null or undefined when calling acceptEstimatePoint.');
        }
     ...
     * @summary [EXPERIMENTAL] FinaliseCandidateValuation: Finalise Candidate.
     * @param scope The scope of the Fund.
     * @param code The code of the Fund. Together with the scope this uniquely identifies the Fund.
     * @param valuationPointDataRequest The valuationPointDataRequest which contains the diary entry code to mark as final.
     */
    public async finaliseCandidateValuation (scope: string, code: string, valuationPointDataRequest: ValuationPointDataRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ValuationPointDataResponse;  }> {
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling finaliseCandidateValuation.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling finaliseCandidateValuation.');
        }

        // verify required parameter 'valuationPointDataRequest' is not null or undefined
        if (valuationPointDataRequest === null || valuationPointDataRequest === undefined) {
            throw new Error('Required parameter valuationPointDataRequest was null or undefined when calling finaliseCandidateValuation.');
        }
     ...
     * @summary [EXPERIMENTAL] UpsertValuationPoint: Upsert Valuation Point.
     * @param scope The scope of the Fund.
     * @param code The code of the Fund. Together with the scope this uniquely identifies the Fund.
     * @param upsertValuationPointRequest The Valuation Point Estimate definition to Upsert
     */
    public async upsertValuationPoint (scope: string, code: string, upsertValuationPointRequest: UpsertValuationPointRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DiaryEntry;  }> {
        const localVarPath = this.basePath + '/api/funds/{scope}/{code}/valuationpoints/$upsert'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling upsertValuationPoint.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling upsertValuationPoint.');
        }
        ...
        if (upsertValuationPointRequest === null || upsertValuationPointRequest === undefined) {
            throw new Error('Required parameter upsertValuationPointRequest was null or undefined when calling upsertValuationPoint.');
        }
