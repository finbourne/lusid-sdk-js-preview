...
import { ResourceListOfNavActivityAdjustment } from '../model/resourceListOfNavActivityAdjustment';
...
export class FundsApi {
     ...
     * @summary [EXPERIMENTAL] DeleteNavActivityAdjustments: Delete Nav activity adjustments.
     * @param scope The scope of the Fund.
     ...
     * @param navTypeCode The Nav Type Code to delete the adjustment from
     * @param navActivityAdjustment The request describing the Nav activity adjustments to delete from a specific valuation point and nav type
     */
    public async deleteNavActivityAdjustments (scope: string, code: string, valuationPointCode: string, navTypeCode: string, navActivityAdjustment: Array<NavActivityAdjustment>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        ...
        // verify required parameter 'navTypeCode' is not null or undefined
        if (navTypeCode === null || navTypeCode === undefined) {
            throw new Error('Required parameter navTypeCode was null or undefined when calling deleteNavActivityAdjustments.');
        }
        ...
        if (navActivityAdjustment === null || navActivityAdjustment === undefined) {
            throw new Error('Required parameter navActivityAdjustment was null or undefined when calling deleteNavActivityAdjustments.');
        }
     ...
     * @summary [EXPERIMENTAL] ListNavActivityAdjustments: List NAV adjustment activities applied to a valuation point
     * @param scope The scope of the Fund.
     * @param code The code of the Fund. Together with the scope is the unique identifier for the given Fund.
     * @param valuationPointCode Fetch all NAV adjustment activities for this valuation point.
     * @param navTypeCode Fetch all NAV adjustment activities for this Nav type.
     ...
     * @param filter Expression to filter the result set. Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid.
     */
    public async listNavActivityAdjustments (scope: string, code: string, valuationPointCode: string, navTypeCode: string, asAt?: Date, page?: string, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfNavActivityAdjustment;  }> {
        ...
        // verify required parameter 'navTypeCode' is not null or undefined
        if (navTypeCode === null || navTypeCode === undefined) {
            throw new Error('Required parameter navTypeCode was null or undefined when calling listNavActivityAdjustments.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ResourceListOfNavActivityAdjustment;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ResourceListOfNavActivityAdjustment");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] RevertValuationPointToEstimate: Reverts a Final Valuation Point to Estimate.
     * @param scope The scope of the Fund.
     * @param code The code of the Fund. Together with the scope this uniquely identifies the Fund.
     * @param valuationPointDataRequest The valuationPointDataRequest which contains the Diary Entry code for the Final Valuation Point to move to Estimate status.
     ...
     */
    public async revertValuationPointToEstimate (scope: string, code: string, valuationPointDataRequest: ValuationPointDataRequest, navTypeCode?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ValuationPointDataResponse;  }> {
        ...
        // verify required parameter 'valuationPointDataRequest' is not null or undefined
        if (valuationPointDataRequest === null || valuationPointDataRequest === undefined) {
            throw new Error('Required parameter valuationPointDataRequest was null or undefined when calling revertValuationPointToEstimate.');
        }
     ...
     * @summary [EXPERIMENTAL] UpsertNavActivityAdjustments: Upsert NAV adjustment activities to a valuation point
     * @param scope The scope of the Fund.
     * @param code The code of the Fund. Together with the scope is the unique identifier for the given Fund.
     * @param valuationPointCode The valuation point Code to apply the adjustment to
     * @param navTypeCode The Nav Type Code to apply the adjustment to
     ...
     */
    public async upsertNavActivityAdjustments (scope: string, code: string, valuationPointCode: string, navTypeCode: string, navActivityAdjustment: Array<NavActivityAdjustment>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Date;  }> {
        const localVarPath = this.basePath + '/api/funds/{scope}/{code}/navAdjustment'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'navTypeCode' is not null or undefined
        if (navTypeCode === null || navTypeCode === undefined) {
            throw new Error('Required parameter navTypeCode was null or undefined when calling upsertNavActivityAdjustments.');
        }
