...
export class FundsApi {
     ...
     */
    public async acceptEstimateValuationPoint (scope: string, code: string, valuationPointDataRequest: ValuationPointDataRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ValuationPointDataResponse;  }> {
