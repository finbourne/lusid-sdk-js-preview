...
export enum FundConfigurationEntitiesApiApiKeys {
}

export class FundConfigurationEntitiesApi {
    ...
    public setApiKey(key: FundConfigurationEntitiesApiApiKeys, value: string) {
        (this.authentications as any)[FundConfigurationEntitiesApiApiKeys[key]].apiKey = value;
    }
