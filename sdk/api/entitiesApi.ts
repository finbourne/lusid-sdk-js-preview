...
export class EntitiesApi {
     ...
     * @summary [EXPERIMENTAL] GetCustomEntityByEntityUniqueId: Get a Custom Entity instance by its EntityUniqueId
     ...
     */
    public async getCustomEntityByEntityUniqueId (entityUniqueId: string, effectiveAt?: string, asAt?: Date, previews?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CustomEntityEntity;  }> {
        const localVarPath = this.basePath + '/api/entities/customentities/{entityUniqueId}'
            .replace('{' + 'entityUniqueId' + '}', encodeURIComponent(String(entityUniqueId)));
        ...
        // verify required parameter 'entityUniqueId' is not null or undefined
        ...
        if (previews !== undefined) {
            localVarQueryParameters['previews'] = ObjectSerializer.serialize(previews, "Array<string>");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: CustomEntityEntity;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "CustomEntityEntity");
     ...
     * @summary [EXPERIMENTAL] GetDataTypeByEntityUniqueId: Get DataType by EntityUniqueId
     ...
     * @param previews The ids of the staged modifications to be previewed in the response.
     */
    public async getDataTypeByEntityUniqueId (entityUniqueId: string, asAt?: Date, previews?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DataTypeEntity;  }> {
        const localVarPath = this.basePath + '/api/entities/datatypes/{entityUniqueId}'
            .replace('{' + 'entityUniqueId' + '}', encodeURIComponent(String(entityUniqueId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: DataTypeEntity;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "DataTypeEntity");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] GetEntityHistory: List an entity\'s history information
     ...
     */
    public async getEntityHistory (entityType: string, entityUniqueId: string, asAt?: Date, page?: string, limit?: number, filter?: string, sortBy?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfChangeInterval;  }> {
        const localVarPath = this.basePath + '/api/entities/{entityType}/{entityUniqueId}/history'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ResourceListOfChangeInterval;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ResourceListOfChangeInterval");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] GetInstrumentByEntityUniqueId: Get instrument by EntityUniqueId
     ...
     * @param previews The ids of the staged modifications to be previewed in the response.
     */
    public async getInstrumentByEntityUniqueId (entityUniqueId: string, effectiveAt?: string, asAt?: Date, previews?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InstrumentEntity;  }> {
        const localVarPath = this.basePath + '/api/entities/instruments/{entityUniqueId}'
            .replace('{' + 'entityUniqueId' + '}', encodeURIComponent(String(entityUniqueId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: InstrumentEntity;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "InstrumentEntity");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] GetPortfolioByEntityUniqueId: Get portfolio by EntityUniqueId
     ...
     * @param previews The ids of the staged modifications to be previewed in the response.
     */
    public async getPortfolioByEntityUniqueId (entityUniqueId: string, effectiveAt?: string, asAt?: Date, previews?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PortfolioEntity;  }> {
        const localVarPath = this.basePath + '/api/entities/portfolios/{entityUniqueId}'
            .replace('{' + 'entityUniqueId' + '}', encodeURIComponent(String(entityUniqueId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PortfolioEntity;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PortfolioEntity");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary GetPortfolioChanges: Get the next change to each portfolio in a scope.
     ...
     * @summary [EXPERIMENTAL] GetPropertyDefinitionByEntityUniqueId: Get property definition by EntityUniqueId
     ...
     * @param previews The ids of the staged modifications to be previewed in the response.
     */
    public async getPropertyDefinitionByEntityUniqueId (entityUniqueId: string, effectiveAt?: string, asAt?: Date, previews?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PropertyDefinitionEntity;  }> {
        const localVarPath = this.basePath + '/api/entities/propertydefinitions/{entityUniqueId}'
            .replace('{' + 'entityUniqueId' + '}', encodeURIComponent(String(entityUniqueId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PropertyDefinitionEntity;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PropertyDefinitionEntity");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
