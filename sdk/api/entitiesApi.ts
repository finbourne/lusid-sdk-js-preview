...
export class EntitiesApi {
     ...
     */
    public async getPortfolioByEntityUniqueId (entityUniqueId: string, effectiveAt?: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PortfolioEntity;  }> {
