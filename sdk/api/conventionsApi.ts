...
import { GetConventionsResponse } from '../model/getConventionsResponse';
...
import { ResourceListOfGetConventionsResponse } from '../model/resourceListOfGetConventionsResponse';
import { UpsertConventionsRequest } from '../model/upsertConventionsRequest';
...
export class ConventionsApi {
     ...
     */
    public async getCdsFlowConventions (scope: string, code: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GetConventionsResponse;  }> {
        const localVarPath = this.basePath + '/api/conventions/credit/conventions/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        return new Promise<{ response: http.IncomingMessage; body: GetConventionsResponse;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
                    body = ObjectSerializer.deserialize(body, "GetConventionsResponse");
                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                        resolve({ response: response, body: body });
                    } else {
                        reject({ response: response, body: body });
     ...
     */
    public async getFlowConventions (scope: string, code: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GetConventionsResponse;  }> {
        const localVarPath = this.basePath + '/api/conventions/rates/flowconventions/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
     ...
     */
    public async getIndexConvention (scope: string, code: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GetConventionsResponse;  }> {
        const localVarPath = this.basePath + '/api/conventions/rates/indexconventions/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
     ...
     * @summary [EXPERIMENTAL] List the set of conventions
     * @param asAt The asAt datetime at which to list the conventions. Defaults to latest if not specified.
     */
    public async listConventions (asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfGetConventionsResponse;  }> {
        const localVarPath = this.basePath + '/api/conventions';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
        ...
        return new Promise<{ response: http.IncomingMessage; body: ResourceListOfGetConventionsResponse;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
                    body = ObjectSerializer.deserialize(body, "ResourceListOfGetConventionsResponse");
                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                        resolve({ response: response, body: body });
                    } else {
                        reject({ response: response, body: body });
     ...
     * @param upsertConventionsRequest The CDS Flow Conventions to update or insert
     */
    public async upsertCdsFlowConventions (upsertConventionsRequest: UpsertConventionsRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UpsertSingleStructuredDataResponse;  }> {
        const localVarPath = this.basePath + '/api/conventions/credit/conventions';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};

        // verify required parameter 'upsertConventionsRequest' is not null or undefined
        if (upsertConventionsRequest === null || upsertConventionsRequest === undefined) {
            throw new Error('Required parameter upsertConventionsRequest was null or undefined when calling upsertCdsFlowConventions.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(upsertConventionsRequest, "UpsertConventionsRequest")
        };
     ...
     * @summary [EXPERIMENTAL] Upsert a set of Flow Conventions. This creates or updates the data in Lusid.
     * @param upsertConventionsRequest The Flow Conventions to update or insert
     */
    public async upsertFlowConventions (upsertConventionsRequest: UpsertConventionsRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UpsertSingleStructuredDataResponse;  }> {
        ...
        // verify required parameter 'upsertConventionsRequest' is not null or undefined
        if (upsertConventionsRequest === null || upsertConventionsRequest === undefined) {
            throw new Error('Required parameter upsertConventionsRequest was null or undefined when calling upsertFlowConventions.');
        }
     ...
     * @param upsertConventionsRequest The Index Conventions to update or insert
     */
    public async upsertIndexConvention (upsertConventionsRequest: UpsertConventionsRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UpsertSingleStructuredDataResponse;  }> {
        ...
        // verify required parameter 'upsertConventionsRequest' is not null or undefined
        if (upsertConventionsRequest === null || upsertConventionsRequest === undefined) {
            throw new Error('Required parameter upsertConventionsRequest was null or undefined when calling upsertIndexConvention.');
        }
