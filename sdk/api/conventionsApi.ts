...
export class ConventionsApi {
     ...
     * @summary [EXPERIMENTAL] Delete the conventions of given scope and code, assuming that it is present.
     * @param scope The scope of the conventions to delete.
     * @param code The conventions to delete.
     */
    public async deleteConventions (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AnnulSingleStructuredDataResponse;  }> {
        const localVarPath = this.basePath + '/api/conventions/{scope}/{code}'
        ...
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling deleteConventions.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling deleteConventions.');
        }
