...
export class AborApi {
     ...
     * @summary [EXPERIMENTAL] AddDiaryEntry: Add a diary entry to the specified Abor. This would be type \'Other\'.
     * @param scope The scope of the Abor.
     * @param code The code of the Abor.
     * @param diaryEntryRequest The diary entry to add.
     */
    public async addDiaryEntry (scope: string, code: string, diaryEntryRequest: DiaryEntryRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DiaryEntry;  }> {
     ...
     * @summary [EXPERIMENTAL] ClosePeriod: Closes or locks the current period for the given Abor.
     * @param scope The scope of the Abor.
     * @param code The code of the Abor.
     * @param closePeriodDiaryEntryRequest The request body, containing details to apply to the closing/locking period.
     */
    public async closePeriod (scope: string, code: string, closePeriodDiaryEntryRequest: ClosePeriodDiaryEntryRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DiaryEntry;  }> {
        const localVarPath = this.basePath + '/api/abor/{scope}/{code}/accountingdiary/$closeperiod'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'closePeriodDiaryEntryRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(closePeriodDiaryEntryRequest, "ClosePeriodDiaryEntryRequest")
        };
     ...
     * @summary [EXPERIMENTAL] DeleteDiaryEntry: Delete a diary entry type \'Other\' from the specified Abor.
     * @param scope The scope of the Abor.
     * @param code The code of the Abor.
     * @param diaryEntryCode The diary entry code to be deleted.
     */
    public async deleteDiaryEntry (scope: string, code: string, diaryEntryCode: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling deleteDiaryEntry.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling deleteDiaryEntry.');
        }

        // verify required parameter 'diaryEntryCode' is not null or undefined
        if (diaryEntryCode === null || diaryEntryCode === undefined) {
            throw new Error('Required parameter diaryEntryCode was null or undefined when calling deleteDiaryEntry.');
        }
     ...
     * @summary [EXPERIMENTAL] GetAborProperties: Get Abor properties
     * @param scope The scope of the Abor to list the properties for.
     * @param code The code of the Abor to list the properties for. Together with the scope this uniquely identifies the Abor.
     * @param effectiveAt The effective datetime or cut label at which to list the Abor\&#39;s properties. Defaults to the current LUSID system datetime if not specified.
     * @param asAt The asAt datetime at which to list the Abor\&#39;s properties. Defaults to return the latest version of each property if not specified.
     */
    public async getAborProperties (scope: string, code: string, effectiveAt?: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AborProperties;  }> {
        const localVarPath = this.basePath + '/api/abor/{scope}/{code}/properties'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     */
    public async listAbors (effectiveAt?: string, asAt?: Date, page?: string, limit?: number, filter?: string, sortBy?: Array<string>, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfAbor;  }> {
     ...
     */
    public async listDiaryEntries (scope: string, code: string, effectiveAt?: string, asAt?: Date, page?: string, limit?: number, filter?: string, sortBy?: Array<string>, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfDiaryEntry;  }> {
        const localVarPath = this.basePath + '/api/abor/{scope}/{code}/accountingdiary'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
     ...
     * @summary [EXPERIMENTAL] LockPeriod: Locks the last Closed or given Closed Period.
     * @param scope The scope of the Abor.
     * @param code The code of the Abor.
     * @param lockPeriodDiaryEntryRequest The request body, detailing lock details
     */
    public async lockPeriod (scope: string, code: string, lockPeriodDiaryEntryRequest?: LockPeriodDiaryEntryRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DiaryEntry;  }> {
        const localVarPath = this.basePath + '/api/abor/{scope}/{code}/accountingdiary/$lockperiod'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(lockPeriodDiaryEntryRequest, "LockPeriodDiaryEntryRequest")
        };
     ...
     * @summary [EXPERIMENTAL] PatchAbor: Patch Abor.
     * @param scope The scope of the Abor.
     * @param code The code of the Abor. Together with the              scope this uniquely identifies the Abor.
     * @param operation The json patch document. For more information see: https://datatracker.ietf.org/doc/html/rfc6902.
     */
    public async patchAbor (scope: string, code: string, operation: Array<Operation>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Abor;  }> {
        const localVarPath = this.basePath + '/api/abor/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
     ...
     * @summary [EXPERIMENTAL] ReOpenPeriods: Reopen periods from a seed Diary Entry Code or when not specified, the last Closed Period for the given Abor.
     * @param scope The scope of the Abor.
     * @param code The code of the Abor. Together with the scope this uniquely identifies the Abor.
     * @param reOpenPeriodDiaryEntryRequest The request body, containing details about the period to be re-opened.
     */
    public async reOpenPeriods (scope: string, code: string, reOpenPeriodDiaryEntryRequest?: ReOpenPeriodDiaryEntryRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PeriodDiaryEntriesReopenedResponse;  }> {
        const localVarPath = this.basePath + '/api/abor/{scope}/{code}/accountingdiary/$reopenperiods'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(reOpenPeriodDiaryEntryRequest, "ReOpenPeriodDiaryEntryRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PeriodDiaryEntriesReopenedResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PeriodDiaryEntriesReopenedResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
