...
export class OrdersApi {
     ...
     * @param upsertOrderPropertiesRequest A collection of order property upsert requests.
     */
    public async upsertOrderProperties (scope: string, upsertOrderPropertiesRequest?: Array<UpsertOrderPropertiesRequest>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UpsertOrderPropertiesResponse;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(upsertOrderPropertiesRequest, "Array<UpsertOrderPropertiesRequest>")
        };
