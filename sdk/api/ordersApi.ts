...
export class OrdersApi {
     ...
     * @summary [EXPERIMENTAL] Delete Orders.
     * @param resourceId The IDs of the orders to delete.
     */
    public async deleteOrders (resourceId: Array<ResourceId>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedOrdersEntitiesResponse;  }> {
        const localVarPath = this.basePath + '/api/orders/$delete';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
        ...
        if (resourceId === null || resourceId === undefined) {
            throw new Error('Required parameter resourceId was null or undefined when calling deleteOrders.');
        }
