...
export class RelationsApi {
     ...
     * @param scope Scope of the relation to create.
     * @param code Code of the relation to create.
     ...
     * @param scope Scope of the relation to delete.
     * @param code Code of the relation to delete.
