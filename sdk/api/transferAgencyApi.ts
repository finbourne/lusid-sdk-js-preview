...
import { CalculateOrderDatesRequest } from '../model/calculateOrderDatesRequest';
import { CalculateOrderDatesResponse } from '../model/calculateOrderDatesResponse';
import { DeleteTransferAgencyOrderRequest } from '../model/deleteTransferAgencyOrderRequest';
import { DeleteTransferAgencyOrdersResponse } from '../model/deleteTransferAgencyOrdersResponse';
import { EstimateTransferAgencyOrderRequest } from '../model/estimateTransferAgencyOrderRequest';
import { EstimateTransferAgencyOrdersResponse } from '../model/estimateTransferAgencyOrdersResponse';
...
import { TransferAgencyOrdersResponse } from '../model/transferAgencyOrdersResponse';
import { UpsertTransferAgencyOrderRequest } from '../model/upsertTransferAgencyOrderRequest';
...
export enum TransferAgencyApiApiKeys {
}

export class TransferAgencyApi {
    ...
    public setApiKey(key: TransferAgencyApiApiKeys, value: string) {
        (this.authentications as any)[TransferAgencyApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EXPERIMENTAL] CalculateOrderDates: Calculate the key dates associated with transfer agency orders
     * @param requestBody The request containing the dates used for calculation
     */
    public async calculateOrderDates (requestBody: { [key: string]: CalculateOrderDatesRequest; }, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CalculateOrderDatesResponse;  }> {
        const localVarPath = this.basePath + '/api/transferagency/orderdates';
        ...
        if (requestBody === null || requestBody === undefined) {
            throw new Error('Required parameter requestBody was null or undefined when calling calculateOrderDates.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(requestBody, "{ [key: string]: CalculateOrderDatesRequest; }")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: CalculateOrderDatesResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "CalculateOrderDatesResponse");
     ...
     * @summary [EXPERIMENTAL] DeleteTransferAgencyOrders: Delete transfer agency orders
     * @param requestBody The transfer agency orders to delete, keyed by a unique request identifier.
     */
    public async deleteTransferAgencyOrders (requestBody: { [key: string]: DeleteTransferAgencyOrderRequest; }, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeleteTransferAgencyOrdersResponse;  }> {
        const localVarPath = this.basePath + '/api/transferagency/orders/$delete';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'requestBody' is not null or undefined
        if (requestBody === null || requestBody === undefined) {
            throw new Error('Required parameter requestBody was null or undefined when calling deleteTransferAgencyOrders.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(requestBody, "{ [key: string]: DeleteTransferAgencyOrderRequest; }")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: DeleteTransferAgencyOrdersResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "DeleteTransferAgencyOrdersResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] EstimateTransferAgencyOrders: Estimate the values of transfer agency orders
     * @param requestBody The transfer agency orders to estimate, keyed by a unique request identifier.
     */
    public async estimateTransferAgencyOrders (requestBody: { [key: string]: EstimateTransferAgencyOrderRequest; }, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: EstimateTransferAgencyOrdersResponse;  }> {
        const localVarPath = this.basePath + '/api/transferagency/orders/$estimate';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'requestBody' is not null or undefined
        if (requestBody === null || requestBody === undefined) {
            throw new Error('Required parameter requestBody was null or undefined when calling estimateTransferAgencyOrders.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(requestBody, "{ [key: string]: EstimateTransferAgencyOrderRequest; }")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: EstimateTransferAgencyOrdersResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "EstimateTransferAgencyOrdersResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] UpsertTransferAgencyOrders: Upsert transfer agency orders
     * @param requestBody The transfer agency orders to upsert, keyed by a unique request identifier.
     */
    public async upsertTransferAgencyOrders (requestBody: { [key: string]: UpsertTransferAgencyOrderRequest; }, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TransferAgencyOrdersResponse;  }> {
        const localVarPath = this.basePath + '/api/transferagency/orders';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'requestBody' is not null or undefined
        if (requestBody === null || requestBody === undefined) {
            throw new Error('Required parameter requestBody was null or undefined when calling upsertTransferAgencyOrders.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(requestBody, "{ [key: string]: UpsertTransferAgencyOrderRequest; }")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: TransferAgencyOrdersResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "TransferAgencyOrdersResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
