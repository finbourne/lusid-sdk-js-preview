...
export class TransactionPortfoliosApi {
     ...
     */
    public async batchUpsertTransactions (scope: string, code: string, successMode: string, requestBody: { [key: string]: TransactionRequest; }, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BatchUpsertPortfolioTransactionsResponse;  }> {
     ...
     * @summary [EXPERIMENTAL] CreateTradeTicket: Create Trade Ticket
     * @param scope The scope of the transaction portfolio.
     * @param code The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio.
     ...
     * @summary [EXPERIMENTAL] DeleteCustodianAccounts: Soft or hard delete multiple custodian accounts
     ...
     * @summary [EXPERIMENTAL] GetBucketedCashFlows: Get bucketed cash flows from a list of portfolios
     * @param scope The scope of the transaction portfolio.
     ...
     * @summary [EXPERIMENTAL] GetHoldingContributors: Get Holdings Contributors
     * @param scope The scope of the transaction portfolio.
     * @param code The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio.
    ...
    public async getHoldingContributors (scope: string, code: string, holdingId: number, effectiveDate?: Date, fromTradeDate?: Date, toTradeDate?: Date, includeHistoric?: boolean, taxLotId?: string, limit?: number, asAt?: Date, page?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: VersionedResourceListOfHoldingContributor;  }> {
        ...
        if (effectiveDate !== undefined) {
            localVarQueryParameters['effectiveDate'] = ObjectSerializer.serialize(effectiveDate, "Date");
        }

        if (fromTradeDate !== undefined) {
            localVarQueryParameters['fromTradeDate'] = ObjectSerializer.serialize(fromTradeDate, "Date");
        }

        if (toTradeDate !== undefined) {
            localVarQueryParameters['toTradeDate'] = ObjectSerializer.serialize(toTradeDate, "Date");
        }
     ...
     * @param recipeIdCode The code of the given recipeId
     */
    public async getHoldingsWithOrders (scope: string, code: string, effectiveAt?: string, asAt?: Date, filter?: string, propertyKeys?: Array<string>, byTaxlots?: boolean, recipeIdScope?: string, recipeIdCode?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: VersionedResourceListWithWarningsOfPortfolioHolding;  }> {
     ...
     * @summary [BETA] GetPortfolioCashFlows: Get portfolio cash flows
     * @param scope The scope of the transaction portfolio.
     * @param code The code of the transaction portfolio. Together with the scope this               uniquely identifies the portfolio.
     ...
     */
    public async getTransactions (scope: string, code: string, fromTransactionDate?: string, toTransactionDate?: string, asAt?: Date, filter?: string, propertyKeys?: Array<string>, page?: string, limit?: number, showCancelledTransactions?: boolean, sortBy?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: VersionedResourceListOfTransaction;  }> {
        const localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/transactions'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
     ...
     * @summary [BETA] GetUpsertablePortfolioCashFlows: Get upsertable portfolio cash flows.
     * @param scope The scope of the transaction portfolio.
     * @param code The code of the transaction portfolio. Together with the scope this               uniquely identifies the portfolio.
     * @param effectiveAt The valuation (pricing) effective datetime or cut label (inclusive) at which to evaluate the cashflows.  This determines whether cashflows are evaluated in a historic or forward looking context and will, for certain models, affect where data is looked up.  For example, on a swap if the effectiveAt is in the middle of the window, cashflows before it will be historic and resets assumed to exist where if the effectiveAt  is before the start of the range they are forward looking and will be expectations assuming the model supports that.  There is evidently a presumption here about availability of data and that the effectiveAt is realistically on or before the real-world today.
     ...
     */
    public async listCustodianAccounts (scope: string, code: string, effectiveAt?: string, asAt?: Date, page?: string, start?: number, limit?: number, filter?: string, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfCustodianAccount;  }> {
     ...
     * @summary [EXPERIMENTAL] LookThroughHoldings: Get LookThrough Holdings
     * @param scope The scope of the transaction portfolio.
     * @param code The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio.
     * @param effectiveAt The effective datetime or cut label at which to retrieve the holdings of the transaction              portfolio. Defaults to the current LUSID system datetime if not specified.
     * @param asAt The asAt datetime at which to retrieve the holdings of the transaction portfolio. Defaults              to return the latest version if not specified.
     * @param filter Expression to filter the result set.              For example, to filter on the Holding Type, use \&quot;holdingType eq \&#39;p\&#39;\&quot;.              For more information about filtering LUSID results, see https://support.lusid.com/knowledgebase/article/KA-01914.
     * @param propertyKeys A list of property keys from the \&quot;Instrument\&quot;, \&quot;Holding\&quot; or \&quot;Portfolio\&quot; domain to decorate onto              holdings. These must have the format {domain}/{scope}/{code}, for example \&quot;Instrument/system/Name\&quot; or \&quot;Holding/system/Cost\&quot;.
     * @param quotesScope The scope containing the quotes with the FX rates used for currency conversion.
     * @param slice When running LookThrough, define this slice as the root slice in the portfolio to look through from.
     * @param shareClass When running LookThrough, use this along with the slice parameter to specify              the root share class in the slice in the portfolio to look through from. The slice parameter is a prerequisite              for this parameter to be valid.
     */
    public async lookThroughHoldings (scope: string, code: string, effectiveAt?: string, asAt?: Date, filter?: string, propertyKeys?: Array<string>, quotesScope?: string, slice?: string, shareClass?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: VersionedResourceListOfPortfolioHolding;  }> {
        const localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/holdings/$lookthrough'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling lookThroughHoldings.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling lookThroughHoldings.');
        }
        ...
        if (quotesScope !== undefined) {
            localVarQueryParameters['quotesScope'] = ObjectSerializer.serialize(quotesScope, "string");
        }

        if (slice !== undefined) {
            localVarQueryParameters['slice'] = ObjectSerializer.serialize(slice, "string");
        }

        if (shareClass !== undefined) {
            localVarQueryParameters['shareClass'] = ObjectSerializer.serialize(shareClass, "string");
        }
     ...
     * @summary [EXPERIMENTAL] LookThroughTransactions: Look through transactions
     * @param scope The scope of the transaction portfolio.
     * @param code The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio.
     * @param fromTransactionDate The lower bound effective datetime or cut label (inclusive) from which to retrieve transactions.              There is no lower bound if this is not specified.
     * @param toTransactionDate The upper bound effective datetime or cut label (inclusive) from which to retrieve transactions.              There is no upper bound if this is not specified.
     ...
     * @param slice When running LookThrough, define this slice as the root slice in the portfolio to look through from.
     * @param shareClass When running LookThrough, use this along with the slice parameter to specify              the root share class in the slice in the portfolio to look through from. The slice parameter is a prerequisite              for this parameter to be valid.
     * @param useAlternateScalingLogic When running LookThrough, set this flag to use the same scaling logic as for LT Holdings
     * @param alternateEffectiveAt This effectiveAt field is required when using alternate scaling logic to determine which fund and currency data is used for scaling
     */
    public async lookThroughTransactions (scope: string, code: string, fromTransactionDate?: string, toTransactionDate?: string, asAt?: Date, filter?: string, propertyKeys?: Array<string>, page?: string, limit?: number, quotesScope?: string, slice?: string, shareClass?: string, useAlternateScalingLogic?: boolean, alternateEffectiveAt?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: VersionedResourceListOfTransaction;  }> {
        const localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/transactions/$lookthrough'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling lookThroughTransactions.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling lookThroughTransactions.');
        }
        ...
        if (useAlternateScalingLogic !== undefined) {
            localVarQueryParameters['useAlternateScalingLogic'] = ObjectSerializer.serialize(useAlternateScalingLogic, "boolean");
        }

        if (alternateEffectiveAt !== undefined) {
            localVarQueryParameters['alternateEffectiveAt'] = ObjectSerializer.serialize(alternateEffectiveAt, "string");
        }
     ...
     * @summary [EXPERIMENTAL] UpsertCustodianAccountsProperties: Upsert custodian accounts properties
