 ...
 *
 * The version of the OpenAPI document: 0.11.2516
...
let defaultBasePath = 'http://local-unit-test-server.lusid.com:34358';
...
export class TransactionPortfoliosApi {
    ...
    /**
     * Get cashflow for the given portfolio.
     * @summary [EXPERIMENTAL] Get cashflow for the given portfolio.
     ...
     */
    public async getPortfolioCashFlows (scope: string, code: string, fromEffectiveAt: string, toEffectiveAt: string, asAt?: Date, filter?: string, recipeIdScope?: string, recipeIdCode?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfPortfolioCashFlow;  }> {
