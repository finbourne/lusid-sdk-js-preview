 ...
 *
 * The version of the OpenAPI document: 2.0.1656
...
export class TransactionPortfoliosApi {
     ...
     * @summary [EARLY ACCESS] BatchAmendSettlementInstructions: Batch Amend Settlement Instructions.
     * @param scope The scope of the portfolio.
     * @param code The code of the portfolio.
     * @param requestBody The amendments to make to the settlement instructions.
     * @param successMode Whether the batch request should fail Atomically or in a Partial fashion - Allowed Values: Atomic, Partial
     */
    public async batchAmendSettlementInstructions (scope: string, code: string, requestBody: { [key: string]: SettlementInstructionAmendRequest; }, successMode?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BatchAmendTransactionSettlementInstructionResponse;  }> {
        const localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/settlementinstructions/$batchAmend'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling batchAmendSettlementInstructions.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling batchAmendSettlementInstructions.');
        }

        // verify required parameter 'requestBody' is not null or undefined
        if (requestBody === null || requestBody === undefined) {
            throw new Error('Required parameter requestBody was null or undefined when calling batchAmendSettlementInstructions.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(requestBody, "{ [key: string]: SettlementInstructionAmendRequest; }")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: BatchAmendTransactionSettlementInstructionResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "BatchAmendTransactionSettlementInstructionResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param successMode Whether the batch request should fail Atomically or in a Partial fashion - Allowed Values: Atomic, Partial
     * @param requestBody The selected set of holdings to adjust to the provided targets for the               transaction portfolio.
     * @param reconciliationMethods Optional parameter for specifying a reconciliation method: e.g. FxForward. Available values: FxForward.
     */
     ...
     * @param successMode Whether the batch request should fail Atomically or in a Partial fashion - Allowed Values: Atomic, Partial
     */
    public async batchUpsertSettlementInstructions (scope: string, code: string, requestBody: { [key: string]: SettlementInstructionRequest; }, successMode?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BatchUpsertTransactionSettlementInstructionResponse;  }> {
     ...
     */
    public async batchUpsertTransactions (scope: string, code: string, successMode: string, requestBody: { [key: string]: TransactionRequest; }, preserveProperties?: boolean, dataModelScope?: string, dataModelCode?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BatchUpsertPortfolioTransactionsResponse;  }> {
     ...
     * @param filter Expression to filter the result set.              For example, to return only transactions with a transaction type of \&#39;Buy\&#39;, specify \&quot;type eq \&#39;Buy\&#39;\&quot;.              For more information about filtering LUSID results, see https://support.lusid.com/docs/filtering-information-retrieved-from-lusid.
     ...
     */
    public async buildTransactions (scope: string, code: string, transactionQueryParameters: TransactionQueryParameters, asAt?: Date, filter?: string, propertyKeys?: Array<string>, limit?: number, page?: string, dataModelScope?: string, dataModelCode?: string, membershipType?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: VersionedResourceListOfOutputTransaction;  }> {
     ...
     * @summary [EARLY ACCESS] DeleteVirtualTransactionOverride: [EARLY ACCESS] Delete a virtual transaction override
     * @param scope The scope of the transaction portfolio.
     * @param code The code of the transaction portfolio. Together with the scope this uniquely identifies the transaction portfolio.
     * @param instrumentEventId The ID of the instrument event whose override should be reverted.
     ...
     */
    public async deleteVirtualTransactionOverride (scope: string, code: string, instrumentEventId: string, portfolioEffectiveAt?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/overridevirtualtransactions'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling deleteVirtualTransactionOverride.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling deleteVirtualTransactionOverride.');
        }

        // verify required parameter 'instrumentEventId' is not null or undefined
        if (instrumentEventId === null || instrumentEventId === undefined) {
            throw new Error('Required parameter instrumentEventId was null or undefined when calling deleteVirtualTransactionOverride.');
        }

        if (instrumentEventId !== undefined) {
            localVarQueryParameters['instrumentEventId'] = ObjectSerializer.serialize(instrumentEventId, "string");
        }
     ...
     * @summary [EXPERIMENTAL] GetA2BMovementsTradingVsHolding: Get an A2B report at the movement level for the given portfolio, with P&L split between holding and trading returns.
     * @param scope The scope of the portfolio to retrieve the A2B movement report for.
     * @param code The code of the portfolio to retrieve the A2B movement report for. Together with the scope this              uniquely identifies the portfolio.
     * @param fromEffectiveAt The lower bound effective datetime or cut label (inclusive) from which to retrieve the data.              There is no lower bound if this is not specified.
     * @param toEffectiveAt The upper bound effective datetime or cut label (inclusive) from which to retrieve the data.              There is no upper bound if this is not specified.
     ...
     * @param propertyKeys A list of property keys from the \&quot;Instrument\&quot; domain to decorate onto              the results. These take the format {domain}/{scope}/{code} e.g. \&quot;Instrument/system/Name\&quot;.
     * @param filter Expression to filter the result set.              Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid.
     * @param timelineScope The scope of the timeline to use for loading data per closed period.
     * @param timelineCode The code of the timeline to use for loading data per closed period.
     ...
     */
    public async getA2BMovementsTradingVsHolding (scope: string, code: string, fromEffectiveAt: string, toEffectiveAt: string, asAt?: Date, recipeIdScope?: string, recipeIdCode?: string, propertyKeys?: Array<string>, filter?: string, timelineScope?: string, timelineCode?: string, closedPeriodId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: VersionedResourceListOfA2BMovementRecord;  }> {
        const localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/a2bmovements/tradingvsholding'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling getA2BMovementsTradingVsHolding.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling getA2BMovementsTradingVsHolding.');
        }

        // verify required parameter 'fromEffectiveAt' is not null or undefined
        if (fromEffectiveAt === null || fromEffectiveAt === undefined) {
            throw new Error('Required parameter fromEffectiveAt was null or undefined when calling getA2BMovementsTradingVsHolding.');
        }

        // verify required parameter 'toEffectiveAt' is not null or undefined
        if (toEffectiveAt === null || toEffectiveAt === undefined) {
            throw new Error('Required parameter toEffectiveAt was null or undefined when calling getA2BMovementsTradingVsHolding.');
        }
     ...
     * @param timelineScope The scope of the timeline used for evaluation. If provided, you must also provide a timelineCode.
     * @param timelineCode The code of the Timeline. This can optionally include a colon, followed by the Closed Period Id to use at the head of the timeline, for a timeline with unconfirmed periods.
     */
    public async getHoldingContributors (scope: string, code: string, holdingId: number, effectiveDate?: string, fromTradeDate?: string, toTradeDate?: string, includeHistoric?: boolean, taxLotId?: string, includeUnsettledMovements?: boolean, limit?: number, asAt?: Date, page?: string, timelineScope?: string, timelineCode?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: VersionedResourceListOfHoldingContributor;  }> {
     ...
     * @param filter Expression to filter the result set.              For example, to filter on the Holding Type, use \&quot;holdingType eq \&#39;p\&#39;\&quot;.              For more information about filtering LUSID results, see https://support.lusid.com/docs/filtering-information-retrieved-from-lusid.
     ...
     * @param aggregateCashCommitments When true, collapses cash-commitment rows that share a sub-holding key              into a single aggregated row per portfolio with summed units/cost and the per-leg breakdown retained on the              settlement schedule. Ignored when byTaxlots is true. Defaults to False.
     */
    public async getHoldings (scope: string, code: string, effectiveAt?: string, asAt?: Date, filter?: string, propertyKeys?: Array<string>, byTaxlots?: boolean, includeSettlementEventsAfterDays?: number, timelineScope?: string, timelineCode?: string, closedPeriodId?: string, aggregateCashCommitments?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: VersionedResourceListWithWarningsOfPortfolioHolding;  }> {
        const localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/holdings'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        if (aggregateCashCommitments !== undefined) {
            localVarQueryParameters['aggregateCashCommitments'] = ObjectSerializer.serialize(aggregateCashCommitments, "boolean");
        }
     ...
     */
    public async getHoldingsAdjustment (scope: string, code: string, effectiveAt: string, asAt?: Date, propertyKeys?: Array<string>, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: HoldingsAdjustment;  }> {
     ...
     */
    public async getPortfolioCashFlows (scope: string, code: string, effectiveAt?: string, windowStart?: string, windowEnd?: string, asAt?: Date, filter?: string, recipeIdScope?: string, recipeIdCode?: string, excludeUnsettledTrades?: boolean, cashFlowCalculationVersion?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfInstrumentCashFlow;  }> {
        ...
        if (cashFlowCalculationVersion !== undefined) {
            localVarQueryParameters['cashFlowCalculationVersion'] = ObjectSerializer.serialize(cashFlowCalculationVersion, "string");
        }
     ...
     */
    public async getPortfolioCashLadder (scope: string, code: string, fromEffectiveAt: string, toEffectiveAt: string, effectiveAt: string, asAt?: Date, filter?: string, recipeIdScope?: string, recipeIdCode?: string, excludeUnsettledTrades?: boolean, cashFlowCalculationVersion?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfPortfolioCashLadder;  }> {
     ...
     * @summary [EARLY ACCESS] GetTransactionSettlementStatus: Get transaction settlement status
     * @param scope The scope of the transaction portfolio.
     * @param code The code of the transaction portfolio. This together with the scope uniquely identifies the transaction portfolio.
     * @param transactionId The ID of the transaction.
     * @param effectiveAt The effective date and time or cut label to get the transaction settlement status.              This defaults to the current LUSID system time if not specified.
     * @param asAt The asAt date and time to get the transaction settlement status.               This defaults to return the latest status if not specified.
     * @param propertyKeys A list of property keys from the \&#39;SettlementInstruction\&#39;, \&#39;Instrument\&#39; or \&#39;Portfolio\&#39; domains to decorate onto              settlement instructions. These must have the format {domain}/{scope}/{code}, for example \&#39;Instrument/system/Name\&#39; or \&#39;SettlementInstruction/strategy/quantsignal\&#39;.
     */
    public async getTransactionSettlementStatus (scope: string, code: string, transactionId: string, effectiveAt?: string, asAt?: Date, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TransactionSettlementStatus;  }> {
     ...
     * @param filter Expression with which to filter the result set.               For example, to return only transactions with a transaction type of \&#39;Buy\&#39;, specify \&quot;type eq \&#39;Buy\&#39;\&quot;               For more information about filtering LUSID results, see https://support.lusid.com/docs/filtering-information-retrieved-from-lusid.
     ...
     * @param membershipType The membership types of the specified Custom Data Model to return. Default value: Member. Available values: All, Member, Candidate.
     */
    public async getTransactions (scope: string, code: string, fromTransactionDate?: string, toTransactionDate?: string, asAt?: Date, filter?: string, propertyKeys?: Array<string>, page?: string, limit?: number, showCancelledTransactions?: boolean, sortBy?: Array<string>, dataModelScope?: string, dataModelCode?: string, membershipType?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: VersionedResourceListOfTransaction;  }> {
        const localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/transactions'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
     ...
     * @param cashFlowCalculationVersion The version of the cash flow calculation logic to use. Defaults to \&#39;1\&#39; if not specified; valid values are \&#39;1\&#39; (the current production behaviour)               and \&#39;2\&#39; (cash flows resolved via a deterministic source waterfall, with factual cash flows classified by transaction trade date and corporate action date filtering applied).               Under \&#39;2\&#39; the waterfall governs resolution only: this endpoint returns the de-duplicated instrument and structured result store stream, so a cash flow booked as a transaction               is removed rather than re-listed. Transaction-sourced cash flows are returned by the bucket cash flow drill-down endpoint and by requests using the PortfolioCashFlow or               TransactionCashFlow representation.
     */
    public async getUpsertablePortfolioCashFlows (scope: string, code: string, effectiveAt?: string, windowStart?: string, windowEnd?: string, asAt?: Date, filter?: string, recipeIdScope?: string, recipeIdCode?: string, excludeUnsettledTrades?: boolean, cashFlowCalculationVersion?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfTransaction;  }> {
     ...
     * @summary [EARLY ACCESS] GetVirtualTransactionOverride: [EARLY ACCESS] Get virtual transaction overrides and suppressions for an instrument event
     * @param scope The scope of the transaction portfolio.
     * @param code The code of the transaction portfolio. Together with the scope this uniquely identifies the transaction portfolio.
     * @param instrumentEventId The ID of the instrument event whose overrides and suppressions should be returned.
     * @param portfolioEffectiveAt The effective datetime used to resolve the portfolio. Defaults to the current LUSID system datetime if not specified.
     * @param asAt The asAt datetime at which to retrieve the overrides and suppressions. Defaults to returning the latest version if not specified.
     */
    public async getVirtualTransactionOverride (scope: string, code: string, instrumentEventId: string, portfolioEffectiveAt?: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: VirtualTransactionOverridesResponse;  }> {
        const localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/overridevirtualtransactions'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: VirtualTransactionOverridesResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "VirtualTransactionOverridesResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param filter Expression to filter the results.              For example, to filter on the Custodian Account type, specify \&quot;code eq \&#39;001\&#39;\&quot;. For more information about filtering              results, see https://support.lusid.com/docs/filtering-information-retrieved-from-lusid.
     ...
     * @param filter Expression to filter the holding adjustments result set.              Supported fields: InstrumentUid, InstrumentScope, Currency, Properties[Holding/{scope}/{code}], SubHoldingKeys[Transaction/{scope}/{code}].              For example, to filter on a specific instrument, specify \&quot;InstrumentUid eq \&#39;LUID_00003D4X\&#39;\&quot;.              For more information about filtering LUSID results, see https://support.lusid.com/docs/filtering-information-retrieved-from-lusid.
     */
    public async listHoldingsAdjustments (scope: string, code: string, fromEffectiveAt?: string, toEffectiveAt?: string, asAt?: Date, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfHoldingsAdjustmentHeader;  }> {
     ...
     * @param closedPeriodId The closed period ID. If this is specified, both timelineScope and timelineCode must be specified. Either closedPeriodId or effectiveAt can be used with a Timeline.
     */
    public async listSettlementInstructions (scope: string, code: string, fromDate?: string, toDate?: string, page?: string, limit?: number, filter?: string, asAt?: Date, propertyKeys?: Array<string>, timelineScope?: string, timelineCode?: string, closedPeriodId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: VersionedResourceListOfTransactionSettlementInstruction;  }> {
        const localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/settlementinstructions'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: VersionedResourceListOfTransactionSettlementInstruction;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "VersionedResourceListOfTransactionSettlementInstruction");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] ListVirtualTransactionOverrides: [EARLY ACCESS] List virtual transaction overrides and suppressions
     * @param scope The scope of the transaction portfolio.
     * @param code The code of the transaction portfolio. Together with the scope this uniquely identifies the transaction portfolio.
     * @param portfolioEffectiveAt The effective datetime used to resolve the portfolio. Defaults to the current LUSID system datetime if not specified.
     * @param asAt The asAt datetime at which to retrieve the overrides and suppressions. Defaults to returning the latest version if not specified.
     * @param overrideMatchStatus Restrict the records returned to those with one of these match statuses. May be specified more than once. Available values: Matched, Orphaned.
     * @param overrideApplicationStatus Restrict the records returned to those with one of these application statuses. May be specified more than once. Available values: Full, Partial, Orphaned.
     */
    public async listVirtualTransactionOverrides (scope: string, code: string, portfolioEffectiveAt?: string, asAt?: Date, overrideMatchStatus?: Array<string>, overrideApplicationStatus?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfVirtualTransactionOverrideRecord;  }> {
        const localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/overridevirtualtransactions/$list'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        if (overrideMatchStatus !== undefined) {
            localVarQueryParameters['overrideMatchStatus'] = ObjectSerializer.serialize(overrideMatchStatus, "Array<string>");
        }

        if (overrideApplicationStatus !== undefined) {
            localVarQueryParameters['overrideApplicationStatus'] = ObjectSerializer.serialize(overrideApplicationStatus, "Array<string>");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ResourceListOfVirtualTransactionOverrideRecord;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ResourceListOfVirtualTransactionOverrideRecord");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] UpsertVirtualTransactionOverride: [EARLY ACCESS] Upsert virtual transaction overrides and suppressions
     * @param scope The scope of the transaction portfolio.
     * @param code The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio.
     * @param instrumentEventId The ID of the instrument event whose virtual transactions should be overridden or suppressed.
     * @param overrideVirtualTransactionsRequest The overrides and suppressions to upsert, keyed by the virtual transaction id being overridden or suppressed.
     * @param portfolioEffectiveAt The effective datetime used to resolve the portfolio. Defaults to the current LUSID system datetime if not specified.
     * @param preserveProperties If set to false, the entire property set of an updated override entry will be overwritten by the provided properties. If not specified or set to true, only the properties provided will be updated.
     */
    public async upsertVirtualTransactionOverride (scope: string, code: string, instrumentEventId: string, overrideVirtualTransactionsRequest: OverrideVirtualTransactionsRequest, portfolioEffectiveAt?: string, preserveProperties?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UpsertVirtualTransactionOverrideResponse;  }> {
        const localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/overridevirtualtransactions'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling upsertVirtualTransactionOverride.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling upsertVirtualTransactionOverride.');
        }
        ...
        // verify required parameter 'overrideVirtualTransactionsRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(overrideVirtualTransactionsRequest, "OverrideVirtualTransactionsRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: UpsertVirtualTransactionOverrideResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "UpsertVirtualTransactionOverrideResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
