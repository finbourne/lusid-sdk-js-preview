...
export class TransactionPortfoliosApi {
     ...
     * @summary [EARLY ACCESS] OverrideVirtualTransactions: [EARLY ACCESS] Override virtual transactions
     * @param scope The scope of the transaction portfolio.
     * @param code The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio.
     ...
     * @param dataModelCode The optional code of a Custom Data Model to use
     */
    public async overrideVirtualTransactions (scope: string, code: string, instrumentEventId: string, transactionRequest: Array<TransactionRequest>, portfolioEffectiveAt?: string, preserveProperties?: boolean, dataModelScope?: string, dataModelCode?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: OverrideVirtualTransactionsResponse;  }> {
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling overrideVirtualTransactions.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling overrideVirtualTransactions.');
        }
        ...
        if (instrumentEventId === null || instrumentEventId === undefined) {
            throw new Error('Required parameter instrumentEventId was null or undefined when calling overrideVirtualTransactions.');
        }
        ...
        if (transactionRequest === null || transactionRequest === undefined) {
            throw new Error('Required parameter transactionRequest was null or undefined when calling overrideVirtualTransactions.');
        }
