...
export class TransactionPortfoliosApi {
     ...
     * @param recipeIdCode The code of the given recipeID
     */
    public async getPortfolioCashStatements (scope: string, code: string, fromEffectiveAt: string, toEffectiveAt: string, asAt?: Date, filter?: string, recipeIdScope?: string, recipeIdCode?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfInstrumentCashFlow;  }> {
