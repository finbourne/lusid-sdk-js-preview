...
export class TransactionPortfoliosApi {
     ...
     * @param preserveProperties If set to true, only the properties provided will be updated, if not specified or set to false, the entire property set will be overwritten by the provided properties.
     */
     ...
     * @param preserveProperties If set to true, only the properties provided will be updated, if not specified or set to false, the entire property set will be overwritten by the provided properties.
     */
    public async upsertTransactions (scope: string, code: string, transactionRequest: Array<TransactionRequest>, preserveProperties?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UpsertPortfolioTransactionsResponse;  }> {
        const localVarPath = this.basePath + '/api/transactionportfolios/{scope}/{code}/transactions'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
