 ...
 *
 * The version of the OpenAPI document: 2.0.1598
...
export class TransactionPortfoliosApi {
     ...
     * @param returnExcludedTransactions Whether to include transactions that the portfolio\&#39;s transaction exclusion filter marks as excluded. Defaults to false.
     */
    public async buildTransactions (scope: string, code: string, transactionQueryParameters: TransactionQueryParameters, asAt?: Date, filter?: string, propertyKeys?: Array<string>, limit?: number, page?: string, dataModelScope?: string, dataModelCode?: string, membershipType?: string, returnExcludedTransactions?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: VersionedResourceListOfOutputTransaction;  }> {
        ...
        if (returnExcludedTransactions !== undefined) {
            localVarQueryParameters['returnExcludedTransactions'] = ObjectSerializer.serialize(returnExcludedTransactions, "boolean");
        }
