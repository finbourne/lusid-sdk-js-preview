 ...
 *
 * The version of the OpenAPI document: 0.11.5093
...
export class TransactionPortfoliosApi {
     ...
     */
    public async getBucketedCashFlows (scope: string, code: string, excludeUnsettledTrades?: boolean, bucketedCashFlowRequest?: BucketedCashFlowRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BucketedCashFlowResponse;  }> {
