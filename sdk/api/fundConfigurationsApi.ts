...
export enum FundConfigurationsApiApiKeys {
}

export class FundConfigurationsApi {
    ...
    public setApiKey(key: FundConfigurationsApiApiKeys, value: string) {
        (this.authentications as any)[FundConfigurationsApiApiKeys[key]].apiKey = value;
    }
