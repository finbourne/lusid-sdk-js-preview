...
export enum StagingRuleSetApiApiKeys {
}

export class StagingRuleSetApi {
    ...
    public setApiKey(key: StagingRuleSetApiApiKeys, value: string) {
        (this.authentications as any)[StagingRuleSetApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async createStagingRuleSet (entityType: string, createStagingRuleSetRequest: CreateStagingRuleSetRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: StagingRuleSet;  }> {
        const localVarPath = this.basePath + '/api/stagingrulesets/{entityType}'
        ...
        // verify required parameter 'createStagingRuleSetRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(createStagingRuleSetRequest, "CreateStagingRuleSetRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: StagingRuleSet;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "StagingRuleSet");
     ...
     */
    public async deleteStagingRuleSet (entityType: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/stagingrulesets/{entityType}'
            .replace('{' + 'entityType' + '}', encodeURIComponent(String(entityType)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     */
    public async getStagingRuleSet (entityType: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: StagingRuleSet;  }> {
        const localVarPath = this.basePath + '/api/stagingrulesets/{entityType}'
            .replace('{' + 'entityType' + '}', encodeURIComponent(String(entityType)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     */
    public async listStagingRuleSets (asAt?: Date, page?: string, sortBy?: Array<string>, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfStagingRuleSet;  }> {
        const localVarPath = this.basePath + '/api/stagingrulesets';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfStagingRuleSet;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfStagingRuleSet");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     */
    public async updateStagingRuleSet (entityType: string, updateStagingRuleSetRequest: UpdateStagingRuleSetRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: StagingRuleSet;  }> {
        const localVarPath = this.basePath + '/api/stagingrulesets/{entityType}'
            .replace('{' + 'entityType' + '}', encodeURIComponent(String(entityType)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'updateStagingRuleSetRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(updateStagingRuleSetRequest, "UpdateStagingRuleSetRequest")
        };
