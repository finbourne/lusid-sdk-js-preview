...
export enum TaxRuleSetsApiApiKeys {
}

export class TaxRuleSetsApi {
    ...
    public setApiKey(key: TaxRuleSetsApiApiKeys, value: string) {
        (this.authentications as any)[TaxRuleSetsApiApiKeys[key]].apiKey = value;
    }
    ...
    public async createTaxRuleSet (createTaxRuleSetRequest: CreateTaxRuleSetRequest, effectiveAt?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TaxRuleSet;  }> {
        const localVarPath = this.basePath + '/api/tax/rulesets';
     ...
     * @summary [EXPERIMENTAL] DeleteTaxRuleSet: Delete a tax rule set.
    ...
    public async deleteTaxRuleSet (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/tax/rulesets/{scope}/{code}'
     ...
     * @summary [EXPERIMENTAL] ListTaxRuleSets: List tax rule sets.
