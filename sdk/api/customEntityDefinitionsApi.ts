...
export class CustomEntityDefinitionsApi {
     ...
     * @summary [EXPERIMENTAL] CreateCustomEntityDefinition: Define a new Custom Entity type.
     ...
     * @summary [EXPERIMENTAL] GetDefinition: Get a Custom Entity type definition.
     ...
     * @summary [EXPERIMENTAL] ListCustomEntityDefinitions: List the Custom Entity type definitions
     ...
     * @summary [EXPERIMENTAL] UpdateCustomEntityDefinition: Modify an existing Custom Entity type.
     * @param entityType The identifier for the Custom Entity type, derived from the \&quot;entityTypeName\&quot; provided on creation.
