...
export class CustomEntityDefinitionsApi {
    ...
    public async createCustomEntityDefinition (customEntityDefinitionRequest: CustomEntityDefinitionRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CustomEntityDefinition;  }> {
        const localVarPath = this.basePath + '/api/customentities/entitytypes';
        ...
        // verify required parameter 'customEntityDefinitionRequest' is not null or undefined
     ...
     */
    public async getDefinition (entityType: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CustomEntityDefinition;  }> {
        const localVarPath = this.basePath + '/api/customentities/entitytypes/{entityType}'
     ...
     */
    public async listCustomEntityDefinitions (asAt?: Date, limit?: number, filter?: string, page?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfCustomEntityDefinition;  }> {
        const localVarPath = this.basePath + '/api/customentities/entitytypes';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfCustomEntityDefinition;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfCustomEntityDefinition");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     */
    public async updateCustomEntityDefinition (entityType: string, updateCustomEntityDefinitionRequest: UpdateCustomEntityDefinitionRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CustomEntityDefinition;  }> {
        const localVarPath = this.basePath + '/api/customentities/entitytypes/{entityType}'
            .replace('{' + 'entityType' + '}', encodeURIComponent(String(entityType)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'updateCustomEntityDefinitionRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(updateCustomEntityDefinitionRequest, "UpdateCustomEntityDefinitionRequest")
        };
