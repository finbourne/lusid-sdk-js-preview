...
export enum OrderGraphApiApiKeys {
}

export class OrderGraphApi {
    ...
    public setApiKey(key: OrderGraphApiApiKeys, value: string) {
        (this.authentications as any)[OrderGraphApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EXPERIMENTAL] ListOrderGraphBlocks: Lists blocks that pass the filter provided, and builds a summary picture of the state of their associated order entities.
     ...
     */
    public async listOrderGraphBlocks (asAt?: Date, paginationToken?: string, sortBy?: Array<string>, limit?: number, filter?: string, propertyKeys?: Array<string>, useComplianceV2?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfOrderGraphBlock;  }> {
        const localVarPath = this.basePath + '/api/ordergraph/blocks';
        ...
        if (paginationToken !== undefined) {
            localVarQueryParameters['paginationToken'] = ObjectSerializer.serialize(paginationToken, "string");
        }
        ...
        if (useComplianceV2 !== undefined) {
            localVarQueryParameters['useComplianceV2'] = ObjectSerializer.serialize(useComplianceV2, "boolean");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfOrderGraphBlock;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfOrderGraphBlock");
     ...
     * @summary [EXPERIMENTAL] ListOrderGraphPlacementChildren: Lists all placements for the parent placement specified by the scope and code, and builds a summary picture of the state of their associated order entities.
     ...
     */
    public async listOrderGraphPlacementChildren (scope: string, code: string, asAt?: Date, paginationToken?: string, sortBy?: Array<string>, limit?: number, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfOrderGraphPlacement;  }> {
        const localVarPath = this.basePath + '/api/ordergraph/placementchildren/{scope}/{code}'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfOrderGraphPlacement;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfOrderGraphPlacement");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] ListOrderGraphPlacements: Lists placements that pass the filter provided, and builds a summary picture of the state of their associated order entities.
     * @param asAt See https://support.lusid.com/knowledgebase/article/KA-01832/
     * @param paginationToken See https://support.lusid.com/knowledgebase/article/KA-01915/
     * @param sortBy Order the results by these fields. Use use the \&#39;-\&#39; sign to denote descending order e.g. -MyFieldName.
     * @param limit See https://support.lusid.com/knowledgebase/article/KA-01915/
     ...
     * @param propertyKeys Must be placement properties. See https://support.lusid.com/knowledgebase/article/KA-01855/
     */
    public async listOrderGraphPlacements (asAt?: Date, paginationToken?: string, sortBy?: Array<string>, limit?: number, filter?: string, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfOrderGraphPlacement;  }> {
        const localVarPath = this.basePath + '/api/ordergraph/placements';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
