...
export enum InstrumentEventsApiApiKeys {
}

export class InstrumentEventsApi {
    ...
    public setApiKey(key: InstrumentEventsApiApiKeys, value: string) {
        (this.authentications as any)[InstrumentEventsApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EXPERIMENTAL] QueryApplicableInstrumentEvents: Returns a list of applicable instrument events based on the holdings of the portfolios and date range specified in the query.
     ...
     */
    public async queryApplicableInstrumentEvents (asAt?: Date, limit?: number, page?: string, queryApplicableInstrumentEventsRequest?: QueryApplicableInstrumentEventsRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfApplicableInstrumentEvent;  }> {
        const localVarPath = this.basePath + '/api/instrumentevents/$queryApplicableInstrumentEvents';
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(queryApplicableInstrumentEventsRequest, "QueryApplicableInstrumentEventsRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ResourceListOfApplicableInstrumentEvent;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ResourceListOfApplicableInstrumentEvent");
     ...
     * @summary [EXPERIMENTAL] QueryBucketedCashFlows: Returns bucketed cashflows based on the holdings of the portfolios and date range specified in the query.
     * @param queryBucketedCashFlowsRequest The Query Information.
     */
    public async queryBucketedCashFlows (queryBucketedCashFlowsRequest?: QueryBucketedCashFlowsRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BucketedCashFlowResponse;  }> {
        const localVarPath = this.basePath + '/api/instrumentevents/$queryBucketedCashFlows';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(queryBucketedCashFlowsRequest, "QueryBucketedCashFlowsRequest")
        };
     ...
     * @summary [EXPERIMENTAL] QueryCashFlows: Returns a list of cashflows based on the holdings of the portfolios and date range specified in the query.
     ...
     */
    public async queryCashFlows (limit?: number, page?: string, queryCashFlowsRequest?: QueryCashFlowsRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfInstrumentCashFlow;  }> {
        const localVarPath = this.basePath + '/api/instrumentevents/$queryCashFlows';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(queryCashFlowsRequest, "QueryCashFlowsRequest")
        };
     ...
     * @summary [EXPERIMENTAL] QueryInstrumentEvents: Returns a list of instrument events based on the holdings of the portfolios and date range specified in the query.
     * @param limit Optional. When paginating, limit the number of returned results to this many. If not specified, a default  of 1000 is used.
     * @param page Optional. The pagination token to use to continue listing items from a previous call. Page values are  return from list calls, and must be supplied exactly as returned. Additionally, when specifying this  value, queryBody, and limit must not  be modified.
     * @param queryInstrumentEventsRequest The filter parameters used to retrieve instrument events.
     */
    public async queryInstrumentEvents (limit?: number, page?: string, queryInstrumentEventsRequest?: QueryInstrumentEventsRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfInstrumentEventHolder;  }> {
        const localVarPath = this.basePath + '/api/instrumentevents/$query';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(queryInstrumentEventsRequest, "QueryInstrumentEventsRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ResourceListOfInstrumentEventHolder;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ResourceListOfInstrumentEventHolder");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] QueryTradeTickets: Returns a list of trade tickets based on the holdings of the portfolios and date range specified in the query.
     * @param limit Optional. When paginating, limit the number of returned results to this many. If not specified, a default  of 1000 is used.
     * @param page Optional. The pagination token to use to continue listing items from a previous call. Page values are  return from list calls, and must be supplied exactly as returned. Additionally, when specifying this  value, queryBody, and limit must not  be modified.
     * @param queryTradeTicketsRequest The filter parameters used to retrieve instrument events.
     */
    public async queryTradeTickets (limit?: number, page?: string, queryTradeTicketsRequest?: QueryTradeTicketsRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfPortfolioTradeTicket;  }> {
        const localVarPath = this.basePath + '/api/instrumentevents/$queryTradeTickets';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(queryTradeTicketsRequest, "QueryTradeTicketsRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ResourceListOfPortfolioTradeTicket;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ResourceListOfPortfolioTradeTicket");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
