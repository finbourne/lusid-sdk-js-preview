...
export class InvestorRecordsApi {
     ...
     * @param idTypeScope The scope of the investor record identifier type.
     * @param idTypeCode The code of the investor record identifier type.
     * @param code Code of the investor record under specified identifier type\&#39;s scope and code. This together with defined              identifier type uniquely identifies the investor record to delete.
     */
    public async deleteInvestorRecord (idTypeScope: string, idTypeCode: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/investorrecords/{idTypeScope}/{idTypeCode}/{code}'
     ...
     * @param idTypeScope Scope of the investor record identifier type.
     * @param idTypeCode Code of the investor record identifier type.
     * @param code Code of the investor record under specified identifier type\&#39;s scope and code. This together with stated identifier type uniquely              identifies the investor record.
     ...
     */
    public async getInvestorRecord (idTypeScope: string, idTypeCode: string, code: string, propertyKeys?: Array<string>, effectiveAt?: string, asAt?: Date, relationshipDefinitionIds?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InvestorRecord;  }> {
        const localVarPath = this.basePath + '/api/investorrecords/{idTypeScope}/{idTypeCode}/{code}'
            .replace('{' + 'idTypeScope' + '}', encodeURIComponent(String(idTypeScope)))
            .replace('{' + 'idTypeCode' + '}', encodeURIComponent(String(idTypeCode)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
     ...
     * @summary [EARLY ACCESS] UpsertInvestorRecords: Pluralised upsert of Investor Records
