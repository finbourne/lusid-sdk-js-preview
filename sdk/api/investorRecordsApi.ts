...
export enum InvestorRecordsApiApiKeys {
}

export class InvestorRecordsApi {
    ...
    public setApiKey(key: InvestorRecordsApiApiKeys, value: string) {
        (this.authentications as any)[InvestorRecordsApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EARLY ACCESS] DeleteInvestorRecord: Delete Investor Record
     * @param identifierType Code of the investor record identifier type.
     * @param identifierValue Code of the investor record under specified identifier type\&#39;s scope and code.
     * @param scope The scope of the investor record entity.
     * @param identifierScope Scope of the investor record identifier type.
     */
    public async deleteInvestorRecord (identifierType: string, identifierValue: string, scope: string, identifierScope: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/investorrecords/{identifierType}/{identifierValue}'
        ...
        if (identifierType === null || identifierType === undefined) {
            throw new Error('Required parameter identifierType was null or undefined when calling deleteInvestorRecord.');
        }

        // verify required parameter 'identifierValue' is not null or undefined
        if (identifierValue === null || identifierValue === undefined) {
            throw new Error('Required parameter identifierValue was null or undefined when calling deleteInvestorRecord.');
        }

        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling deleteInvestorRecord.');
        }

        // verify required parameter 'identifierScope' is not null or undefined
        if (identifierScope === null || identifierScope === undefined) {
            throw new Error('Required parameter identifierScope was null or undefined when calling deleteInvestorRecord.');
        }
     ...
     * @summary [EARLY ACCESS] GetInvestorRecord: Get Investor Record
     * @param identifierType Code of the investor record identifier type.
     * @param identifierValue Code of the investor record under specified identifier type\&#39;s scope and code.
     * @param scope The scope of the investor record entity.
     * @param identifierScope Scope of the investor record identifier type.
     ...
     * @param effectiveAt The effective datetime or cut label at which to retrieve the investor record. Defaults to the current LUSID system datetime if not specified.
     * @param asAt The asAt datetime at which to retrieve the investor record. Defaults to return the latest version of the investor record if not specified.
     * @param relationshipDefinitionIds A list of relationship definitions that are used to decorate related entities              onto the investor record in the response. These must take the form {relationshipDefinitionScope}/{relationshipDefinitionCode}.
     */
    public async getInvestorRecord (identifierType: string, identifierValue: string, scope: string, identifierScope: string, propertyKeys?: Array<string>, effectiveAt?: string, asAt?: Date, relationshipDefinitionIds?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InvestorRecord;  }> {
        const localVarPath = this.basePath + '/api/investorrecords/{identifierType}/{identifierValue}'
            .replace('{' + 'identifierType' + '}', encodeURIComponent(String(identifierType)))
            .replace('{' + 'identifierValue' + '}', encodeURIComponent(String(identifierValue)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'identifierType' is not null or undefined
        if (identifierType === null || identifierType === undefined) {
            throw new Error('Required parameter identifierType was null or undefined when calling getInvestorRecord.');
        }

        // verify required parameter 'identifierValue' is not null or undefined
        if (identifierValue === null || identifierValue === undefined) {
            throw new Error('Required parameter identifierValue was null or undefined when calling getInvestorRecord.');
        }

        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling getInvestorRecord.');
        }

        // verify required parameter 'identifierScope' is not null or undefined
        if (identifierScope === null || identifierScope === undefined) {
            throw new Error('Required parameter identifierScope was null or undefined when calling getInvestorRecord.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: InvestorRecord;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "InvestorRecord");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] ListAllInvestorRecords: List Investor Records
     * @param effectiveAt The effective datetime or cut label at which to list the investor records. Defaults to the current LUSID              system datetime if not specified.
     * @param asAt The asAt datetime at which to list the investor records. Defaults to return the latest version              of each investor records if not specified.
     ...
     */
    public async listAllInvestorRecords (effectiveAt?: string, asAt?: Date, page?: string, limit?: number, filter?: string, sortBy?: Array<string>, propertyKeys?: Array<string>, relationshipDefinitionIds?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfInvestorRecord;  }> {
        const localVarPath = this.basePath + '/api/investorrecords';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ResourceListOfInvestorRecord;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ResourceListOfInvestorRecord");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] UpsertInvestorRecords: Upsert investor records
     * @param successMode Whether the batch request should fail Atomically or in a Partial fashion - Allowed Values: Atomic, Partial
     * @param requestBody A collection of requests to create or update Investor Records.
     */
    public async upsertInvestorRecords (successMode: string, requestBody: { [key: string]: UpsertInvestorRecordRequest; }, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UpsertInvestorRecordsResponse;  }> {
        const localVarPath = this.basePath + '/api/investorrecords/$batchUpsert';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(requestBody, "{ [key: string]: UpsertInvestorRecordRequest; }")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: UpsertInvestorRecordsResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "UpsertInvestorRecordsResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
