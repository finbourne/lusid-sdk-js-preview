...
export class ConfigurationRecipeApi {
     ...
     * @summary [EXPERIMENTAL] DeleteConfigurationRecipe: Delete a Configuration Recipe, assuming that it is present.
     ...
     * @summary [EXPERIMENTAL] GetConfigurationRecipe: Get Configuration Recipe
     ...
     * @summary [EXPERIMENTAL] ListConfigurationRecipes: List the set of Configuration Recipes
     ...
     * @summary [EXPERIMENTAL] UpsertConfigurationRecipe: Upsert a Configuration Recipe. This creates or updates the data in Lusid.
