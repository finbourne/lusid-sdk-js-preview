...
export class TransactionConfigurationApi {
     ...
     * @summary [EXPERIMENTAL] DeleteSideDefinition: Delete the given side definition
     ...
     * @summary [EXPERIMENTAL] DeleteTransactionType: Delete a transaction type
     ...
     * @summary [EXPERIMENTAL] DeleteTransactionTypeSource: Delete all transaction types for the given source and scope
     ...
     * @summary [EXPERIMENTAL] GetSideDefinition: Get the side definition for a given side name( or label)
     * @param side The label to uniquely identify the side.
     * @param scope The scope in which the side exists. When not supplied the scope is \&#39;default\&#39;.
     ...
     * @summary [EXPERIMENTAL] GetTransactionType: Get a single transaction configuration type
     * @param source The source that the type is in
     * @param type One of the type\&#39;s aliases
     ...
     * @summary [EXPERIMENTAL] ListSideDefinitions: List the side definitions
     * @param asAt The asAt datetime at which to retrieve the transaction types. Defaults to returning the latest versions if not specified.
     * @param scope The scope in which the side exists. When not supplied the scope is \&#39;default\&#39;.
     */
     ...
     * @summary [EXPERIMENTAL] ListTransactionTypes: List transaction types
     * @param asAt The asAt datetime at which to retrieve the transaction types. Defaults              to returning the latest versions if not specified.
     * @param scope The scope in which the side exists. When not supplied the scope is \&#39;default\&#39;.
     */
     ...
     * @summary [EXPERIMENTAL] SetSideDefinition: Set a side definition
     * @param side The label to uniquely identify the side.
    ...
    /**
     * Set a new side definition for use in a transaction type. For more information, see https://support.lusid.com/knowledgebase/article/KA-01875.
     * @summary [EXPERIMENTAL] SetSideDefinitions: Set the given side definitions
     ...
     * @summary [EXPERIMENTAL] SetTransactionType: Set a specific transaction type
     * @param source The source to set the transaction configuration for
     * @param type One of the transaction configuration alias types to uniquely identify the configuration
     ...
     * @summary [EXPERIMENTAL] SetTransactionTypeSource: Set the transaction types for the given source and scope
     * @param source The source to set the transaction types for.
