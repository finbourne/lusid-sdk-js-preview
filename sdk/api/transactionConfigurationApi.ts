...
export class TransactionConfigurationApi {
     ...
     */
    public async deleteTransactionType (source: string, type: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
     ...
     */
    public async getTransactionType (source: string, type: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TransactionType;  }> {
        const localVarPath = this.basePath + '/api/transactionconfiguration/types/{source}/{type}'
            .replace('{' + 'source' + '}', encodeURIComponent(String(source)))
            .replace('{' + 'type' + '}', encodeURIComponent(String(type)));
        let localVarQueryParameters: any = {};
     ...
     */
    public async listTransactionTypes (asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: { [key: string]: Array<TransactionType>; };  }> {
     ...
     */
    public async setSideDefinition (side: string, sideDefinitionRequest: SideDefinitionRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SideDefinition;  }> {
     ...
     */
    public async setTransactionType (source: string, type: string, transactionTypeRequest: TransactionTypeRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TransactionType;  }> {
        const localVarPath = this.basePath + '/api/transactionconfiguration/types/{source}/{type}'
            .replace('{' + 'source' + '}', encodeURIComponent(String(source)))
            .replace('{' + 'type' + '}', encodeURIComponent(String(type)));
        let localVarQueryParameters: any = {};
