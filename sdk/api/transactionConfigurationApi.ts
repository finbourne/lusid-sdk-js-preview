...
export enum TransactionConfigurationApiApiKeys {
}

export class TransactionConfigurationApi {
    ...
    public setApiKey(key: TransactionConfigurationApiApiKeys, value: string) {
        (this.authentications as any)[TransactionConfigurationApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary DeleteSideDefinition: Delete the given side definition
     ...
     */
    public async deleteSideDefinition (side: string, scope?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/transactionconfiguration/sides/{side}/$delete'
     ...
     * @summary DeleteTransactionType: Delete a transaction type
     ...
     */
    public async deleteTransactionType (source: string, type: string, scope?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/transactionconfiguration/types/{source}/{type}'
     ...
     * @summary DeleteTransactionTypeSource: Delete all transaction types for the given source and scope
     * @param source The source to set the transaction types for.
     * @param scope The scope in which the transaction types exists. When not supplied the scope is \&#39;default\&#39;.
     */
    public async deleteTransactionTypeSource (source: string, scope?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/transactionconfiguration/types/{source}/$delete'
            .replace('{' + 'source' + '}', encodeURIComponent(String(source)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
     ...
     * @summary GetSideDefinition: Get the side definition for a given side name( or label)
     * @param side The label to uniquely identify the side.
     * @param scope The scope in which the side exists. When not supplied the scope is \&#39;default\&#39;.
     ...
     */
    public async getSideDefinition (side: string, scope?: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SideDefinition;  }> {
        const localVarPath = this.basePath + '/api/transactionconfiguration/sides/{side}'
            .replace('{' + 'side' + '}', encodeURIComponent(String(side)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: SideDefinition;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "SideDefinition");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary GetTransactionType: Get a single transaction configuration type
     * @param source The source that the type is in
     * @param type One of the type\&#39;s aliases
     ...
     * @param scope The scope in which the transaction types exists. When not supplied the scope is \&#39;default\&#39;.
     */
    public async getTransactionType (source: string, type: string, asAt?: Date, scope?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TransactionType;  }> {
        const localVarPath = this.basePath + '/api/transactionconfiguration/types/{source}/{type}'
            .replace('{' + 'source' + '}', encodeURIComponent(String(source)))
            .replace('{' + 'type' + '}', encodeURIComponent(String(type)));
        let localVarQueryParameters: any = {};
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: TransactionType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "TransactionType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary ListSideDefinitions: List the side definitions
     * @param asAt The asAt datetime at which to retrieve the transaction types. Defaults to returning the latest versions if not specified.
     * @param scope The scope in which the side exists. When not supplied the scope is \&#39;default\&#39;.
     */
    public async listSideDefinitions (asAt?: Date, scope?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfSideDefinition;  }> {
        const localVarPath = this.basePath + '/api/transactionconfiguration/sides';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ResourceListOfSideDefinition;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ResourceListOfSideDefinition");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary ListTransactionTypes: List transaction types
     * @param asAt The asAt datetime at which to retrieve the transaction types. Defaults              to returning the latest versions if not specified.
     * @param scope The scope in which the side exists. When not supplied the scope is \&#39;default\&#39;.
     */
    public async listTransactionTypes (asAt?: Date, scope?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: { [key: string]: Array<TransactionType>; };  }> {
        const localVarPath = this.basePath + '/api/transactionconfiguration/types';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: { [key: string]: Array<TransactionType>; };  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "{ [key: string]: Array<TransactionType>; }");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary SetSideDefinition: Set a side definition
     * @param side The label to uniquely identify the side.
     * @param sideDefinitionRequest The side definition to create or replace.
     * @param scope The scope in which the side exists. When not supplied the scope is \&#39;default\&#39;.
     */
    public async setSideDefinition (side: string, sideDefinitionRequest: SideDefinitionRequest, scope?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SideDefinition;  }> {
        const localVarPath = this.basePath + '/api/transactionconfiguration/sides/{side}'
            .replace('{' + 'side' + '}', encodeURIComponent(String(side)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'sideDefinitionRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(sideDefinitionRequest, "SideDefinitionRequest")
        };
    ...
    /**
     * Set a new side definition for use in a transaction type. For more information, see https://support.lusid.com/knowledgebase/article/KA-01875.
     * @summary SetSideDefinitions: Set the given side definitions
     * @param sidesDefinitionRequest The list of side definitions to create, or replace.
     * @param scope The scope in which the side exists. When not supplied the scope is \&#39;default\&#39;.
     */
    public async setSideDefinitions (sidesDefinitionRequest: Array<SidesDefinitionRequest>, scope?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfSideDefinition;  }> {
        const localVarPath = this.basePath + '/api/transactionconfiguration/sides';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        // verify required parameter 'sidesDefinitionRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(sidesDefinitionRequest, "Array<SidesDefinitionRequest>")
        };
     ...
     * @summary SetTransactionType: Set a specific transaction type
     ...
     * @param scope The scope in which the transaction types exists. When not supplied the scope is \&#39;default\&#39;.
     */
    public async setTransactionType (source: string, type: string, transactionTypeRequest: TransactionTypeRequest, scope?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TransactionType;  }> {
        const localVarPath = this.basePath + '/api/transactionconfiguration/types/{source}/{type}'
            .replace('{' + 'source' + '}', encodeURIComponent(String(source)))
            .replace('{' + 'type' + '}', encodeURIComponent(String(type)));
        let localVarQueryParameters: any = {};
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(transactionTypeRequest, "TransactionTypeRequest")
        };
     ...
     * @summary SetTransactionTypeSource: Set the transaction types for the given source and scope
     * @param source The source to set the transaction types for.
     * @param transactionTypeRequest The set of transaction types.
     * @param scope The scope in which the transaction types exists. When not supplied the scope is \&#39;default\&#39;.
     */
    public async setTransactionTypeSource (source: string, transactionTypeRequest: Array<TransactionTypeRequest>, scope?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfTransactionType;  }> {
        const localVarPath = this.basePath + '/api/transactionconfiguration/types/{source}'
            .replace('{' + 'source' + '}', encodeURIComponent(String(source)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(transactionTypeRequest, "Array<TransactionTypeRequest>")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ResourceListOfTransactionType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ResourceListOfTransactionType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
