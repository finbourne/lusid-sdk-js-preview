...
export enum TransactionTaxRulesApiApiKeys {
}

export class TransactionTaxRulesApi {
    ...
    public setApiKey(key: TransactionTaxRulesApiApiKeys, value: string) {
        (this.authentications as any)[TransactionTaxRulesApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EXPERIMENTAL] CreateTaxRuleSet: Create a tax rule set.
     ...
     */
    public async createTaxRuleSet (createTaxRuleSetRequest: CreateTaxRuleSetRequest, effectiveAt?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TaxRuleSet;  }> {
        const localVarPath = this.basePath + '/api/transactions/taxrules';
        ...
        // verify required parameter 'createTaxRuleSetRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(createTaxRuleSetRequest, "CreateTaxRuleSetRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: TaxRuleSet;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "TaxRuleSet");
     ...
     * @summary [EXPERIMENTAL] DeleteTaxRuleSet: Deletes a tax rule.
     * @param scope The rule set scope.
     * @param code The rule set code.
     */
    public async deleteTaxRuleSet (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/transactions/taxrules/{scope}/{code}'
     ...
     * @summary [EXPERIMENTAL] GetTaxRuleSet: Retrieve the definition of single tax rule set.
     * @param scope The rule set scope.
     * @param code The rule set code.
     ...
     */
    public async getTaxRuleSet (scope: string, code: string, effectiveAt?: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TaxRuleSet;  }> {
        const localVarPath = this.basePath + '/api/transactions/taxrules/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
     ...
     * @summary [EXPERIMENTAL] ListTaxRuleSets: List tax rules.
     ...
     */
    public async listTaxRuleSets (effectiveAt?: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfTaxRuleSet;  }> {
        const localVarPath = this.basePath + '/api/transactions/taxrules';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ResourceListOfTaxRuleSet;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ResourceListOfTaxRuleSet");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
    ...
    public async updateTaxRuleSet (scope: string, code: string, updateTaxRuleSetRequest: UpdateTaxRuleSetRequest, effectiveAt?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TaxRuleSet;  }> {
        ...
        // verify required parameter 'updateTaxRuleSetRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(updateTaxRuleSetRequest, "UpdateTaxRuleSetRequest")
        };
