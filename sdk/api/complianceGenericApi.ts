...
export enum ComplianceGenericApiApiKeys {
}

export class ComplianceGenericApi {
    ...
    public setApiKey(key: ComplianceGenericApiApiKeys, value: string) {
        (this.authentications as any)[ComplianceGenericApiApiKeys[key]].apiKey = value;
    }
     ...
     */
    public async deleteComplianceRule2 (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/compliance/generic/rules/{scope}/{code}'
        ...
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling deleteComplianceRule2.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling deleteComplianceRule2.');
        }
     ...
     */
    public async getComplianceRule2 (scope: string, code: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ComplianceRuleResponse;  }> {
        const localVarPath = this.basePath + '/api/compliance/generic/rules/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling getComplianceRule2.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling getComplianceRule2.');
        }
     ...
     * @param start Optional. Entry at which to start.
     * @param limit Optional. Entries per page.
     * @param filter Optional. Filter.
     */
    public async listComplianceRules2 (asAt?: Date, page?: string, start?: number, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfComplianceRuleResponse;  }> {
        const localVarPath = this.basePath + '/api/compliance/generic/rules';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
