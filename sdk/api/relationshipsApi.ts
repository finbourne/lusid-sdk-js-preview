...
export enum RelationshipsApiApiKeys {
}
...
export class RelationshipsApi {
    ...
    public setApiKey(key: RelationshipsApiApiKeys, value: string) {
        (this.authentications as any)[RelationshipsApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param effectiveAt The effective datetime or cut label at which the relationship should be effective from. Defaults to the current LUSID system datetime if not specified.
     */
    public async createRelationship (scope: string, code: string, createRelationshipRequest: CreateRelationshipRequest, effectiveAt?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CompleteRelationship;  }> {
        const localVarPath = this.basePath + '/api/relationshipdefinitions/{scope}/{code}/relationships'
        ...
        // verify required parameter 'createRelationshipRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(createRelationshipRequest, "CreateRelationshipRequest")
        };
        ...
        return new Promise<{ response: http.IncomingMessage; body: CompleteRelationship;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
                    body = ObjectSerializer.deserialize(body, "CompleteRelationship");
     ...
     * @param effectiveAt The effective datetime or cut label at which the relationship should the deletion be effective from. Defaults to the current LUSID system datetime if not specified.
     */
    public async deleteRelationship (scope: string, code: string, deleteRelationshipRequest: DeleteRelationshipRequest, effectiveAt?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/relationshipdefinitions/{scope}/{code}/relationships/$delete'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        ...
        // verify required parameter 'deleteRelationshipRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(deleteRelationshipRequest, "DeleteRelationshipRequest")
        };
