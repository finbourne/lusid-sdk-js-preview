...
export class RelationshipsApi {
     ...
     * @summary [EXPERIMENTAL] CreateRelationship: Create Relationship
     ...
     */
    public async createRelationship (scope: string, code: string, createRelationshipRequest: CreateRelationshipRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CompleteRelationship;  }> {
     ...
     * @summary [EXPERIMENTAL] DeleteRelationship: Delete Relationship
     * @param scope The scope of the relationship
     * @param code The code of the relationship
     * @param deleteRelationshipRequest The details of the relationship to delete.
     */
    public async deleteRelationship (scope: string, code: string, deleteRelationshipRequest: DeleteRelationshipRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
