...
export class PackagesApi {
     ...
     * @summary [EXPERIMENTAL] DeletePackage: Delete package
     ...
     * @summary [EXPERIMENTAL] GetPackage: Get Package
     ...
     * @summary [EXPERIMENTAL] ListPackages: List Packages
     * @param asAt The asAt datetime at which to retrieve the package. Defaults to return the latest version of the package if not specified.
     ...
     * @param propertyKeys A list of property keys from the \&quot;Package\&quot; domain to decorate onto each package.                  These take the format {domain}/{scope}/{code} e.g. \&quot;Package/system/Name\&quot;.                  All properties, except derived properties, are returned by default, without specifying here.
     */
     ...
     * @summary [EXPERIMENTAL] UpsertPackages: Upsert Package
