...
export enum TransactionFeeTypesApiApiKeys {
}

export class TransactionFeeTypesApi {
    ...
    public setApiKey(key: TransactionFeeTypesApiApiKeys, value: string) {
        (this.authentications as any)[TransactionFeeTypesApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EXPERIMENTAL] CreateTransactionFeeType: Create a transaction fee type
     * @param scope The scope of the transaction fee type.
     * @param code The code of the transaction fee type.              Together with the scope this uniquely identifies the transaction fee type.
     * @param createTransactionFeeTypeRequest The contents of the transaction fee type.
     */
    public async createTransactionFeeType (scope: string, code: string, createTransactionFeeTypeRequest: CreateTransactionFeeTypeRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TransactionFeeType;  }> {
        const localVarPath = this.basePath + '/api/transactions/transactionfeetypes/{scope}/{code}'
        ...
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling createTransactionFeeType.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling createTransactionFeeType.');
        }

        // verify required parameter 'createTransactionFeeTypeRequest' is not null or undefined
        if (createTransactionFeeTypeRequest === null || createTransactionFeeTypeRequest === undefined) {
            throw new Error('Required parameter createTransactionFeeTypeRequest was null or undefined when calling createTransactionFeeType.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(createTransactionFeeTypeRequest, "CreateTransactionFeeTypeRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: TransactionFeeType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "TransactionFeeType");
     ...
     * @summary [EXPERIMENTAL] DeleteTransactionFeeType: Delete a transaction fee type
     * @param scope The scope of the transaction fee type.
     * @param code The code of the specified transaction fee type.              Together with the scope this uniquely identifies the transaction fee type.
     */
    public async deleteTransactionFeeType (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/transactions/transactionfeetypes/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling deleteTransactionFeeType.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling deleteTransactionFeeType.');
        }
     ...
     * @summary [EXPERIMENTAL] GetTransactionFeeType: Get a transaction fee type
     * @param scope The scope of the transaction fee type.
     * @param code The code of the transaction fee type.              Together with the scope this uniquely identifies the transaction fee type.
     * @param effectiveAt The effective datetime at which to retrieve the transaction fee type properties.              Defaults to the current LUSID system datetime if not specified.
     * @param asAt The asAt datetime at which to retrieve the transaction fee types.              Defaults to latest if not specified.
     * @param propertyKeys The collection of &#x60;PropertyKey&#x60;s that we want to decorate on the transaction fee type.
     */
    public async getTransactionFeeType (scope: string, code: string, effectiveAt?: string, asAt?: Date, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TransactionFeeType;  }> {
        const localVarPath = this.basePath + '/api/transactions/transactionfeetypes/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling getTransactionFeeType.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling getTransactionFeeType.');
        }
     ...
     * @summary [EXPERIMENTAL] ListTransactionFeeTypes: List transaction fee types
     * @param effectiveAt The effective datetime at which to retrieve transaction fee type properties.              Defaults to the current LUSID system datetime if not specified.
     * @param asAt The asAt datetime at which to retrieve the transaction fee types.              Defaults to latest if not specified.
     ...
     */
    public async listTransactionFeeTypes (effectiveAt?: string, asAt?: Date, page?: string, limit?: number, filter?: string, sortBy?: Array<string>, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfTransactionFeeType;  }> {
        const localVarPath = this.basePath + '/api/transactions/transactionfeetypes';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ResourceListOfTransactionFeeType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ResourceListOfTransactionFeeType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] UpdateTransactionFeeType: Update a transaction fee type
     * @param scope The scope of the transaction fee type.
     * @param code The code of the specified transaction fee type.              Together with the scope this uniquely identifies the transaction fee type.
     * @param updateTransactionFeeTypeRequest The updated contents of the transaction fee type.
     */
    public async updateTransactionFeeType (scope: string, code: string, updateTransactionFeeTypeRequest: UpdateTransactionFeeTypeRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TransactionFeeType;  }> {
        const localVarPath = this.basePath + '/api/transactions/transactionfeetypes/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling updateTransactionFeeType.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling updateTransactionFeeType.');
        }

        // verify required parameter 'updateTransactionFeeTypeRequest' is not null or undefined
        if (updateTransactionFeeTypeRequest === null || updateTransactionFeeTypeRequest === undefined) {
            throw new Error('Required parameter updateTransactionFeeTypeRequest was null or undefined when calling updateTransactionFeeType.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(updateTransactionFeeTypeRequest, "UpdateTransactionFeeTypeRequest")
        };
