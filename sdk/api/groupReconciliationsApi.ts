...
export class GroupReconciliationsApi {
     ...
     */
    public async runReconciliation (scope: string, code: string, groupReconciliationRunRequest?: GroupReconciliationRunRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GroupReconciliationRunResponse;  }> {
