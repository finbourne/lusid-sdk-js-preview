...
export enum GroupReconciliationsApiApiKeys {
}

export class GroupReconciliationsApi {
    ...
    public setApiKey(key: GroupReconciliationsApiApiKeys, value: string) {
        (this.authentications as any)[GroupReconciliationsApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EXPERIMENTAL] BatchUpdateComparisonResults: Add User Review entries for a range of comparison results related to a specific GroupReconciliationDefinition.
     ...
     */
    public async batchUpdateComparisonResults (scope: string, code: string, batchUpdateUserReviewForComparisonResultRequest: Array<BatchUpdateUserReviewForComparisonResultRequest>, successMode?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BatchUpdateUserReviewForComparisonResultResponse;  }> {
        const localVarPath = this.basePath + '/api/reconciliations/groupreconciliationdefinitions/{scope}/{code}/comparisonresults/$batchReview'
        ...
        // verify required parameter 'batchUpdateUserReviewForComparisonResultRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(batchUpdateUserReviewForComparisonResultRequest, "Array<BatchUpdateUserReviewForComparisonResultRequest>")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: BatchUpdateUserReviewForComparisonResultResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "BatchUpdateUserReviewForComparisonResultResponse");
     ...
     * @summary [EXPERIMENTAL] CreateComparisonRuleset: Create a Group Reconciliation Comparison Ruleset
     * @param createGroupReconciliationComparisonRulesetRequest The request containing the details of the ruleset
     */
    public async createComparisonRuleset (createGroupReconciliationComparisonRulesetRequest?: CreateGroupReconciliationComparisonRulesetRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GroupReconciliationComparisonRuleset;  }> {
        const localVarPath = this.basePath + '/api/reconciliations/comparisonrulesets';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(createGroupReconciliationComparisonRulesetRequest, "CreateGroupReconciliationComparisonRulesetRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: GroupReconciliationComparisonRuleset;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GroupReconciliationComparisonRuleset");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] CreateGroupReconciliationDefinition: Create Group Reconciliation Definition
     * @param createGroupReconciliationDefinitionRequest The definition Group Reconciliation Definition details
     */
    public async createGroupReconciliationDefinition (createGroupReconciliationDefinitionRequest?: CreateGroupReconciliationDefinitionRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GroupReconciliationDefinition;  }> {
        const localVarPath = this.basePath + '/api/reconciliations/groupreconciliationdefinitions';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(createGroupReconciliationDefinitionRequest, "CreateGroupReconciliationDefinitionRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: GroupReconciliationDefinition;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GroupReconciliationDefinition");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] DeleteComparisonRuleset: Deletes a particular Group Reconciliation Comparison Ruleset
     ...
     */
    public async deleteComparisonRuleset (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/reconciliations/comparisonrulesets/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @summary [EXPERIMENTAL] DeleteGroupReconciliationDefinition: Delete Group Reconciliation Definition
     ...
     */
    public async deleteGroupReconciliationDefinition (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/reconciliations/groupreconciliationdefinitions/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @summary [EXPERIMENTAL] GetComparisonResult: Get a single Group Reconciliation Comparison Result by scope and code.
     ...
     */
    public async getComparisonResult (scope: string, code: string, resultId: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GroupReconciliationComparisonResult;  }> {
        const localVarPath = this.basePath + '/api/reconciliations/groupreconciliationdefinitions/{scope}/{code}/{resultId}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: GroupReconciliationComparisonResult;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GroupReconciliationComparisonResult");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] GetComparisonRuleset: Get a single Group Reconciliation Comparison Ruleset by scope and code.
     * @param scope The scope of the specified comparison ruleset.
     * @param code The code of the specified comparison ruleset. Together with the domain and scope this uniquely              identifies the reconciliation comparison ruleset.
     ...
     */
    public async getComparisonRuleset (scope: string, code: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GroupReconciliationComparisonRuleset;  }> {
        const localVarPath = this.basePath + '/api/reconciliations/comparisonrulesets/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
     ...
     * @summary [EXPERIMENTAL] GetGroupReconciliationDefinition: Get group reconciliation definition
     ...
     */
    public async getGroupReconciliationDefinition (scope: string, code: string, effectiveAt?: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GroupReconciliationDefinition;  }> {
        const localVarPath = this.basePath + '/api/reconciliations/groupreconciliationdefinitions/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
     ...
     * @summary [EXPERIMENTAL] ListComparisonResults: Get a set of Group Reconciliation Comparison Results.
     ...
     */
    public async listComparisonResults (asAt?: Date, page?: string, sortBy?: Array<string>, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfGroupReconciliationComparisonResult;  }> {
        const localVarPath = this.basePath + '/api/reconciliations/comparisonresults';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfGroupReconciliationComparisonResult;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfGroupReconciliationComparisonResult");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] ListComparisonRulesets: Get a set of Group Reconciliation Comparison Rulesets
     ...
     * @param filter Expression to filter the result set. Read more about filtering results from LUSID here:              https://support.lusid.com/filtering-results-from-lusid.
     */
    public async listComparisonRulesets (asAt?: Date, page?: string, sortBy?: Array<string>, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfGroupReconciliationComparisonRuleset;  }> {
        const localVarPath = this.basePath + '/api/reconciliations/comparisonrulesets';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfGroupReconciliationComparisonRuleset;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfGroupReconciliationComparisonRuleset");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] ListGroupReconciliationDefinitions: List group reconciliation definitions
     ...
     * @param sortBy A list of field names to sort by, each suffixed by \&quot; ASC\&quot; or \&quot; DESC\&quot;
     */
    public async listGroupReconciliationDefinitions (effectiveAt?: string, asAt?: Date, page?: string, limit?: number, filter?: string, sortBy?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfGroupReconciliationDefinition;  }> {
        const localVarPath = this.basePath + '/api/reconciliations/groupreconciliationdefinitions';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfGroupReconciliationDefinition;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfGroupReconciliationDefinition");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] RunReconciliation: Runs a Group Reconciliation
     ...
     * @param instanceRunType The run type of the group reconciliation run instance. Default value: Manual. Available values: Manual, WorkflowServiceTaskId.
     */
    public async runReconciliation (scope: string, code: string, groupReconciliationRunRequest: GroupReconciliationRunRequest, instanceRunType?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GroupReconciliationRunResponse;  }> {
        const localVarPath = this.basePath + '/api/reconciliations/groupreconciliationdefinitions/{scope}/{code}/$run'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'groupReconciliationRunRequest' is not null or undefined
        if (groupReconciliationRunRequest === null || groupReconciliationRunRequest === undefined) {
            throw new Error('Required parameter groupReconciliationRunRequest was null or undefined when calling runReconciliation.');
        }

        if (instanceRunType !== undefined) {
            localVarQueryParameters['instanceRunType'] = ObjectSerializer.serialize(instanceRunType, "string");
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(groupReconciliationRunRequest, "GroupReconciliationRunRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: GroupReconciliationRunResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GroupReconciliationRunResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] UpdateComparisonRuleset: Update Group Reconciliation Comparison Ruleset defined by scope and code
     * @param scope The scope of the specified comparison ruleset.
     * @param code The code of the specified comparison ruleset. Together with the domain and scope this uniquely                  identifies the reconciliation comparison ruleset.
     * @param updateGroupReconciliationComparisonRulesetRequest The request containing the updated details of the ruleset
     */
    public async updateComparisonRuleset (scope: string, code: string, updateGroupReconciliationComparisonRulesetRequest?: UpdateGroupReconciliationComparisonRulesetRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GroupReconciliationComparisonRuleset;  }> {
        const localVarPath = this.basePath + '/api/reconciliations/comparisonrulesets/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(updateGroupReconciliationComparisonRulesetRequest, "UpdateGroupReconciliationComparisonRulesetRequest")
        };
     ...
     * @summary [EXPERIMENTAL] UpdateGroupReconciliationDefinition: Update group reconciliation definition
     ...
     */
    public async updateGroupReconciliationDefinition (scope: string, code: string, updateGroupReconciliationDefinitionRequest?: UpdateGroupReconciliationDefinitionRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GroupReconciliationDefinition;  }> {
        const localVarPath = this.basePath + '/api/reconciliations/groupreconciliationdefinitions/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(updateGroupReconciliationDefinitionRequest, "UpdateGroupReconciliationDefinitionRequest")
        };
