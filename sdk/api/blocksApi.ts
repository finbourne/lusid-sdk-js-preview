...
export class BlocksApi {
     ...
     * @summary [EXPERIMENTAL] DeleteBlock: Delete block
     ...
     * @summary [EXPERIMENTAL] GetBlock: Get Block
     ...
     * @summary [EXPERIMENTAL] ListBlocks: List Blocks
     * @param asAt The asAt datetime at which to retrieve the block. Defaults to return the latest version of the block if not specified.
     ...
     * @summary [EXPERIMENTAL] UpsertBlocks: Upsert Block
