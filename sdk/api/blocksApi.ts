...
export class BlocksApi {
     ...
     * @param body The collection of block requests.
     */
    public async upsertBlocks (body?: object, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfBlock;  }> {
        const localVarPath = this.basePath + '/api/blocks';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
