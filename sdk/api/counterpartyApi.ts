...
import { GetCounterpartyResponse } from '../model/getCounterpartyResponse';
...
import { ResourceListOfGetCounterpartyResponse } from '../model/resourceListOfGetCounterpartyResponse';
import { ResourceListOfGetCreditSupportAnnexResponse } from '../model/resourceListOfGetCreditSupportAnnexResponse';
import { UpsertCounterpartyRequest } from '../model/upsertCounterpartyRequest';
...
let defaultBasePath = 'http://local-unit-test-server.lusid.com:32036';

// ===============================================
// This file is autogenerated - Please do not edit
// ===============================================

export enum CounterpartyApiApiKeys {
}

export class CounterpartyApi {
    ...
    public setApiKey(key: CounterpartyApiApiKeys, value: string) {
        (this.authentications as any)[CounterpartyApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param scope The scope of the Counterparty to delete.
     * @param code The Counterparty to delete.
     */
    public async deleteCounterparty (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AnnulSingleStructuredDataResponse;  }> {
        const localVarPath = this.basePath + '/api/counterparties/counterparties/counterparty/{scope}/{code}'
        ...
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling deleteCounterparty.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling deleteCounterparty.');
        }
     ...
     * @param scope The scope of the CSA to delete.
     * @param code The CSA to delete.
     */
    public async deleteCreditSupportAnnex (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AnnulSingleStructuredDataResponse;  }> {
        const localVarPath = this.basePath + '/api/counterparties/counterparties/csa/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
     ...
     * @param scope The scope of the Counterparty to retrieve.
     * @param code The name of the Counterparty to retrieve the data for.
     * @param asAt The asAt datetime at which to retrieve the counterparty. Defaults to return the latest version if not specified.
     */
    public async getCounterparty (scope: string, code: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GetCounterpartyResponse;  }> {
        const localVarPath = this.basePath + '/api/counterparties/counterparties/counterparty/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling getCounterparty.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling getCounterparty.');
        }
        ...
        return new Promise<{ response: http.IncomingMessage; body: GetCounterpartyResponse;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
                    body = ObjectSerializer.deserialize(body, "GetCounterpartyResponse");
                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                        resolve({ response: response, body: body });
                    } else {
                        reject({ response: response, body: body });
     ...
     * @param scope The scope of the CSA to retrieve.
     * @param code The name of the CSA to retrieve the data for.
     * @param asAt The asAt datetime at which to retrieve the CSA. Defaults to return the latest version if not specified.
     */
     ...
     * @param asAt The asAt datetime at which to list the counterparty. Defaults to latest if not specified.
     */
    public async listCounterparties (asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfGetCounterpartyResponse;  }> {
        const localVarPath = this.basePath + '/api/counterparties/counterparties/counterparty';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
        ...
        return new Promise<{ response: http.IncomingMessage; body: ResourceListOfGetCounterpartyResponse;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
                    body = ObjectSerializer.deserialize(body, "ResourceListOfGetCounterpartyResponse");
                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                        resolve({ response: response, body: body });
                    } else {
                        reject({ response: response, body: body });
     ...
     * @param asAt The asAt datetime at which to list the CSAs. Defaults to latest if not specified.
     */
    public async listCreditSupportAnnexes (asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfGetCreditSupportAnnexResponse;  }> {
        const localVarPath = this.basePath + '/api/counterparties/counterparties/csa';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
     ...
     * @param upsertCounterpartyRequest The Counterparty to update or insert
     */
    public async upsertCounterparty (upsertCounterpartyRequest: UpsertCounterpartyRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UpsertSingleStructuredDataResponse;  }> {
        const localVarPath = this.basePath + '/api/counterparties/counterparties/counterparty';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};

        // verify required parameter 'upsertCounterpartyRequest' is not null or undefined
        if (upsertCounterpartyRequest === null || upsertCounterpartyRequest === undefined) {
            throw new Error('Required parameter upsertCounterpartyRequest was null or undefined when calling upsertCounterparty.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(upsertCounterpartyRequest, "UpsertCounterpartyRequest")
        };
     ...
     * @param upsertCreditSupportAnnexRequest The CSA to update or insert
     */
