...
export class SequencesApi {
     ...
     * @param scope Scope of the sequence definition.
     * @param createSequenceRequest Request to create sequence definition.
     */
     ...
     * @summary [EXPERIMENTAL] Return the definition of a sequence
     * @param scope Scope of the sequence definition.
     * @param code Code of the sequence definition. This together with stated scope uniquely              identifies the sequence definition.
     */
    public async getSequenceDefinition (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SequenceDefinition;  }> {
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling getSequenceDefinition.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling getSequenceDefinition.');
        }
     ...
     * @summary [EXPERIMENTAL] Get the next set of values from the sequence
     * @param scope Scope of the sequence definition.
     * @param code Code of the sequence definition. This together with stated scope uniquely              identifies the sequence definition.
