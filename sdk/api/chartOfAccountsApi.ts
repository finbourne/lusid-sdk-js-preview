...
export class ChartOfAccountsApi {
     ...
     * @summary [EXPERIMENTAL] UpsertAccountsProperties: Upsert accounts properties
     ...
     */
    public async upsertAccountsProperties (scope: string, code: string, accountCode: string, requestBody?: { [key: string]: Property; }, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AccountProperties;  }> {
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling upsertAccountsProperties.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling upsertAccountsProperties.');
        }

        // verify required parameter 'accountCode' is not null or undefined
        if (accountCode === null || accountCode === undefined) {
            throw new Error('Required parameter accountCode was null or undefined when calling upsertAccountsProperties.');
        }
