...
export enum ChartOfAccountsApiApiKeys {
}
...
export class ChartOfAccountsApi {
    ...
    public setApiKey(key: ChartOfAccountsApiApiKeys, value: string) {
        (this.authentications as any)[ChartOfAccountsApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EXPERIMENTAL] CreateChartOfAccounts: Create a Chart of Accounts
     * @param scope The scope of the Chart of Accounts.
     * @param chartOfAccountsRequest The definition of the Chart of Accounts.
     */
    public async createChartOfAccounts (scope: string, chartOfAccountsRequest: ChartOfAccountsRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ChartOfAccounts;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}'
        ...
        // verify required parameter 'chartOfAccountsRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(chartOfAccountsRequest, "ChartOfAccountsRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ChartOfAccounts;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ChartOfAccounts");
     ...
     * @summary [EXPERIMENTAL] CreateCleardownModule: Create a Cleardown Module
     * @param scope The scope of the Chart of Accounts.
     ...
     */
    public async createCleardownModule (scope: string, code: string, cleardownModuleRequest: CleardownModuleRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CleardownModuleResponse;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/cleardownmodules'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
        ...
        // verify required parameter 'cleardownModuleRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(cleardownModuleRequest, "CleardownModuleRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: CleardownModuleResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "CleardownModuleResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] CreateGeneralLedgerProfile: Create a General Ledger Profile.
     * @param scope The scope of the Chart of Accounts.
     ...
     */
    public async createGeneralLedgerProfile (scope: string, code: string, generalLedgerProfileRequest: GeneralLedgerProfileRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GeneralLedgerProfileResponse;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/generalledgerprofile'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'generalLedgerProfileRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(generalLedgerProfileRequest, "GeneralLedgerProfileRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: GeneralLedgerProfileResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GeneralLedgerProfileResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] CreatePostingModule: Create a Posting Module
     * @param scope The scope of the Chart of Accounts.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts.
     * @param postingModuleRequest The definition of the Posting Module.
     */
    public async createPostingModule (scope: string, code: string, postingModuleRequest: PostingModuleRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PostingModuleResponse;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/postingmodules'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'postingModuleRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(postingModuleRequest, "PostingModuleRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PostingModuleResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PostingModuleResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] DeleteAccounts: Soft or hard delete multiple accounts
     * @param scope The scope of the Chart of Accounts.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies              the Chart of Accounts.
     * @param requestBody The codes of the accounts to delete.
     * @param deleteMode The delete mode to use (defaults to \&#39;Soft\&#39;).
     */
    public async deleteAccounts (scope: string, code: string, requestBody: Array<string>, deleteMode?: 'Soft' | 'Hard', options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeleteAccountsResponse;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/accounts/$delete'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: DeleteAccountsResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "DeleteAccountsResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] DeleteChartOfAccounts: Delete a Chart of Accounts
     ...
     */
    public async deleteChartOfAccounts (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @summary [EXPERIMENTAL] DeleteCleardownModule: Delete a Cleardown Module.
     * @param scope The scope of the Chart of Accounts.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts.
     * @param cleardownModuleCode The code of the Cleardown Module to be deleted.
     */
    public async deleteCleardownModule (scope: string, code: string, cleardownModuleCode: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/cleardownmodules/{cleardownModuleCode}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'cleardownModuleCode' + '}', encodeURIComponent(String(cleardownModuleCode)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'cleardownModuleCode' is not null or undefined
     ...
     * @summary [EXPERIMENTAL] DeleteGeneralLedgerProfile: Delete a General Ledger Profile.
     ...
     */
    public async deleteGeneralLedgerProfile (scope: string, code: string, generalLedgerProfileCode: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/generalledgerprofile/{generalLedgerProfileCode}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'generalLedgerProfileCode' + '}', encodeURIComponent(String(generalLedgerProfileCode)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'generalLedgerProfileCode' is not null or undefined
     ...
     * @summary [EXPERIMENTAL] DeletePostingModule: Delete a Posting Module.
     * @param scope The scope of the Chart of Accounts.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts.
     * @param postingModuleCode The code of the Posting Module to be deleted.
     */
    public async deletePostingModule (scope: string, code: string, postingModuleCode: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/postingmodules/{postingModuleCode}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'postingModuleCode' + '}', encodeURIComponent(String(postingModuleCode)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'postingModuleCode' is not null or undefined
     ...
     * @summary [EXPERIMENTAL] GetAccount: Get Account
     * @param scope The scope of the Chart of Accounts.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts.
     ...
     * @param propertyKeys A list of property keys from the \&#39;Account\&#39; domain to decorate onto the Account.              These must take the format {domain}/{scope}/{code}, for example \&#39;Account/Manager/Id\&#39;. If no properties are specified, then no properties will be returned.
     */
    public async getAccount (scope: string, code: string, accountCode: string, effectiveAt?: string, asAt?: Date, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Account;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/accounts/{accountCode}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
     ...
     * @summary [EXPERIMENTAL] GetAccountProperties: Get Account properties
     ...
     * @param accountCode The unique ID of the account to get properties for.
     * @param effectiveAt The effective datetime or cut label at which to list the Account\&#39;s properties. Defaults to the current LUSID system datetime if not specified.
     * @param asAt The asAt datetime at which to list the Account\&#39;s properties. Defaults to return the latest version of each property if not specified.
     */
    public async getAccountProperties (scope: string, code: string, accountCode: string, effectiveAt?: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AccountProperties;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/accounts/{accountCode}/properties'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'accountCode' + '}', encodeURIComponent(String(accountCode)));
        let localVarQueryParameters: any = {};
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: AccountProperties;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "AccountProperties");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] GetChartOfAccounts: Get ChartOfAccounts
     * @param scope The scope of the Chart of Accounts.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts.
     ...
     */
    public async getChartOfAccounts (scope: string, code: string, effectiveAt?: string, asAt?: Date, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ChartOfAccounts;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
     ...
     * @summary [EXPERIMENTAL] GetChartOfAccountsProperties: Get chart of accounts properties
     * @param scope The scope of the chart of accounts to list the properties for.
     * @param code The code of the chart of accounts to list the properties for. Together with the scope this uniquely identifies the chart of accounts.
     * @param effectiveAt The effective datetime or cut label at which to list the chart of accounts\&#39; properties. Defaults to the current LUSID system datetime if not specified.
     * @param asAt The asAt datetime at which to list the chart of accounts\&#39; properties. Defaults to return the latest version of each property if not specified.
     */
    public async getChartOfAccountsProperties (scope: string, code: string, effectiveAt?: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ChartOfAccountsProperties;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/properties'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ChartOfAccountsProperties;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ChartOfAccountsProperties");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] GetCleardownModule: Get a Cleardown Module
     * @param scope The scope of the Chart of Accounts.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts.
     ...
     */
    public async getCleardownModule (scope: string, code: string, cleardownModuleCode: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CleardownModuleResponse;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/cleardownmodules/{cleardownModuleCode}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'cleardownModuleCode' + '}', encodeURIComponent(String(cleardownModuleCode)));
     ...
     * @summary [EXPERIMENTAL] GetGeneralLedgerProfile: Get a General Ledger Profile.
     * @param scope The scope of the Chart of Accounts for the General Ledger Profile.
     * @param code The code of the Chart of Accounts for the General Ledger Profile.
     ...
     */
    public async getGeneralLedgerProfile (scope: string, code: string, generalLedgerProfileCode: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GeneralLedgerProfileResponse;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/generalledgerprofile/{generalLedgerProfileCode}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'generalLedgerProfileCode' + '}', encodeURIComponent(String(generalLedgerProfileCode)));
     ...
     * @summary [EXPERIMENTAL] GetPostingModule: Get a Posting Module
     * @param scope The scope of the Chart of Accounts.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts.
     ...
     */
    public async getPostingModule (scope: string, code: string, postingModuleCode: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PostingModuleResponse;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/postingmodules/{postingModuleCode}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'postingModuleCode' + '}', encodeURIComponent(String(postingModuleCode)));
     ...
     * @summary [EXPERIMENTAL] ListAccounts: List Accounts
     * @param scope The scope of the Chart of Accounts.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies              the Chart of Accounts.
     ...
     */
    public async listAccounts (scope: string, code: string, effectiveAt?: string, asAt?: Date, page?: string, limit?: number, filter?: string, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfAccount;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/accounts'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfAccount;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfAccount");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] ListChartsOfAccounts: List Charts of Accounts
     ...
     */
    public async listChartsOfAccounts (effectiveAt?: string, asAt?: Date, page?: string, limit?: number, filter?: string, sortBy?: Array<string>, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfChartOfAccounts;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfChartOfAccounts;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfChartOfAccounts");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] ListCleardownModuleRules: List Cleardown Module Rules
     * @param scope The scope of the Chart of Accounts.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts.
     * @param cleardownModuleCode The code of the cleardown module.
     ...
     */
    public async listCleardownModuleRules (scope: string, code: string, cleardownModuleCode: string, asAt?: Date, page?: string, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfCleardownModuleRule;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/cleardownmodules/{cleardownModuleCode}/cleardownrules'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'cleardownModuleCode' + '}', encodeURIComponent(String(cleardownModuleCode)));
        let localVarQueryParameters: any = {};
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfCleardownModuleRule;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfCleardownModuleRule");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] ListCleardownModules: List Cleardown Modules
     * @param scope The scope of the Chart of Accounts.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts.
     ...
     * @param sortBy A list of field names or properties to sort by, each suffixed by \&quot; ASC\&quot; or \&quot; DESC\&quot;.
     */
    public async listCleardownModules (scope: string, code: string, asAt?: Date, page?: string, limit?: number, filter?: string, sortBy?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfCleardownModuleResponse;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/cleardownmodules'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfCleardownModuleResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfCleardownModuleResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] ListGeneralLedgerProfiles: List General Ledger Profiles.
     * @param scope The scope of the Chart of Accounts
     * @param code The code of the Chart of Accounts
     ...
     * @param sortBy A list of field names or properties to sort by, each suffixed by \&quot; ASC\&quot; or \&quot; DESC\&quot;.
     */
    public async listGeneralLedgerProfiles (scope: string, code: string, asAt?: Date, page?: string, limit?: number, filter?: string, sortBy?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfGeneralLedgerProfileResponse;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/generalledgerprofile'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfGeneralLedgerProfileResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfGeneralLedgerProfileResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] ListPostingModuleRules: List Posting Module Rules
     * @param scope The scope of the Chart of Accounts.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts.
     * @param postingModuleCode The code of the posting module.
     * @param asAt The asAt datetime at which to retrieve the instrument. Defaults to              returning the latest version if not specified.
     ...
     * @param filter Expression to filter the results.              For example, to filter on the rule id, specify \&quot;ruleId eq \&#39;rule 1\&#39;\&quot;. For more information about filtering              results, see https://support.lusid.com/knowledgebase/article/KA-01914.
     */
    public async listPostingModuleRules (scope: string, code: string, postingModuleCode: string, asAt?: Date, page?: string, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfPostingModuleRule;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/postingmodules/{postingModuleCode}/postingrules'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'postingModuleCode' + '}', encodeURIComponent(String(postingModuleCode)));
        let localVarQueryParameters: any = {};
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfPostingModuleRule;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfPostingModuleRule");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] ListPostingModules: List Posting Modules
     * @param scope The scope of the Chart of Accounts.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts.
     ...
     * @param sortBy A list of field names or properties to sort by, each suffixed by \&quot; ASC\&quot; or \&quot; DESC\&quot;.
     */
    public async listPostingModules (scope: string, code: string, asAt?: Date, page?: string, limit?: number, filter?: string, sortBy?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfPostingModuleResponse;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/postingmodules'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfPostingModuleResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfPostingModuleResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] PatchChartOfAccounts: Patch a Chart of Accounts.
     * @param scope The scope of the Chart of Accounts.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts.
     * @param operation The json patch document. For more information see: https://datatracker.ietf.org/doc/html/rfc6902.
     */
    public async patchChartOfAccounts (scope: string, code: string, operation: Array<Operation>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ChartOfAccounts;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
     ...
     * @summary [EXPERIMENTAL] PatchCleardownModule: Patch a Cleardown Module
     * @param scope The scope of the Chart of Accounts.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts.
     * @param cleardownModuleCode The code of the Cleardown Module to be updated.
     * @param operation The json patch document. For more information see: https://datatracker.ietf.org/doc/html/rfc6902.
     */
    public async patchCleardownModule (scope: string, code: string, cleardownModuleCode: string, operation: Array<Operation>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CleardownModuleResponse;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/cleardownmodules/{cleardownModuleCode}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'cleardownModuleCode' + '}', encodeURIComponent(String(cleardownModuleCode)));
     ...
     * @summary [EXPERIMENTAL] PatchPostingModule: Patch a Posting Module
     * @param scope The scope of the Chart of Accounts.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts.
     * @param postingModuleCode The code of the Posting Module to be updated.
     * @param operation The json patch document. For more information see: https://datatracker.ietf.org/doc/html/rfc6902.
     */
    public async patchPostingModule (scope: string, code: string, postingModuleCode: string, operation: Array<Operation>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PostingModuleResponse;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/postingmodules/{postingModuleCode}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'postingModuleCode' + '}', encodeURIComponent(String(postingModuleCode)));
     ...
     * @summary [EXPERIMENTAL] SetCleardownModuleDetails: Set the details of a Cleardown Module
     * @param scope The scope of the Chart of Accounts.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts.
     * @param cleardownModuleCode The code of the Cleardown Module to be updated.
     * @param cleardownModuleDetails The new details for the Cleardown Module.
     */
    public async setCleardownModuleDetails (scope: string, code: string, cleardownModuleCode: string, cleardownModuleDetails: CleardownModuleDetails, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CleardownModuleResponse;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/cleardownmodules/{cleardownModuleCode}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'cleardownModuleCode' + '}', encodeURIComponent(String(cleardownModuleCode)));
        ...
        // verify required parameter 'cleardownModuleDetails' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(cleardownModuleDetails, "CleardownModuleDetails")
        };
     ...
     * @summary [EXPERIMENTAL] SetCleardownModuleRules: Set the rules of a Cleardown Module
     * @param scope The scope of the Chart of Accounts.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts.
     * @param cleardownModuleCode The code of the Cleardown Module to be updated.
     * @param cleardownModuleRule The new rule set for the Cleardown Module.
     */
    public async setCleardownModuleRules (scope: string, code: string, cleardownModuleCode: string, cleardownModuleRule: Array<CleardownModuleRule>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CleardownModuleRulesUpdatedResponse;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/cleardownmodules/{cleardownModuleCode}/cleardownrules'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'cleardownModuleCode' + '}', encodeURIComponent(String(cleardownModuleCode)));
        ...
        // verify required parameter 'cleardownModuleRule' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(cleardownModuleRule, "Array<CleardownModuleRule>")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: CleardownModuleRulesUpdatedResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "CleardownModuleRulesUpdatedResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] SetGeneralLedgerProfileMappings: Sets the General Ledger Profile Mappings.
     * @param scope The scope of the Chart of Accounts.
     * @param code The code of the Chart of Accounts.
     * @param generalLedgerProfileCode The code of the General Ledger Profile
     ...
     */
    public async setGeneralLedgerProfileMappings (scope: string, code: string, generalLedgerProfileCode: string, generalLedgerProfileMapping: Array<GeneralLedgerProfileMapping>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GeneralLedgerProfileResponse;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/generalledgerprofile/{generalLedgerProfileCode}/mappings'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'generalLedgerProfileCode' + '}', encodeURIComponent(String(generalLedgerProfileCode)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'generalLedgerProfileMapping' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(generalLedgerProfileMapping, "Array<GeneralLedgerProfileMapping>")
        };
     ...
     * @summary [EXPERIMENTAL] SetPostingModuleDetails: Set the details of a Posting Module
     * @param scope The scope of the Chart of Accounts.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts.
     * @param postingModuleCode The code of the Posting Module to be updated.
     * @param postingModuleDetails The new details for the Posting Module.
     */
    public async setPostingModuleDetails (scope: string, code: string, postingModuleCode: string, postingModuleDetails: PostingModuleDetails, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PostingModuleResponse;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/postingmodules/{postingModuleCode}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'postingModuleCode' + '}', encodeURIComponent(String(postingModuleCode)));
        ...
        // verify required parameter 'postingModuleDetails' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(postingModuleDetails, "PostingModuleDetails")
        };
     ...
     * @summary [EXPERIMENTAL] SetPostingModuleRules: Set the rules of a Posting Module
     * @param scope The scope of the Chart of Accounts.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies the Chart of Accounts.
     * @param postingModuleCode The code of the Posting Module to be updated.
     * @param postingModuleRule The new rule set for the Posting Module.
     */
    public async setPostingModuleRules (scope: string, code: string, postingModuleCode: string, postingModuleRule: Array<PostingModuleRule>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PostingModuleRulesUpdatedResponse;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/postingmodules/{postingModuleCode}/postingrules'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'postingModuleCode' + '}', encodeURIComponent(String(postingModuleCode)));
        ...
        // verify required parameter 'postingModuleRule' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(postingModuleRule, "Array<PostingModuleRule>")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PostingModuleRulesUpdatedResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PostingModuleRulesUpdatedResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] UpsertAccountProperties: Upsert account properties
     * @param scope The scope of the Chart of Accounts to update or insert the properties onto.
     * @param code The code of the Chart of Accounts to update or insert the properties onto. Together with the scope this uniquely identifies the Chart of Accounts.
     ...
     */
    public async upsertAccountProperties (scope: string, code: string, accountCode: string, requestBody?: { [key: string]: Property; }, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AccountProperties;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/accounts/{accountCode}/properties/$upsert'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'accountCode' + '}', encodeURIComponent(String(accountCode)));
        let localVarQueryParameters: any = {};
     ...
     * @summary [EXPERIMENTAL] UpsertAccounts: Upsert Accounts
     * @param scope The scope of the Chart of Accounts.
     * @param code The code of the Chart of Accounts. Together with the scope this uniquely identifies              the Chart of Accounts.
     * @param account A list of accounts to be created or updated.
     */
    public async upsertAccounts (scope: string, code: string, account: Array<Account>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AccountsUpsertResponse;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/accounts'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(account, "Array<Account>")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: AccountsUpsertResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "AccountsUpsertResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] UpsertChartOfAccountsProperties: Upsert Chart of Accounts properties
     * @param scope The scope of the Chart of Accounts to update or insert the properties onto.
     * @param code The code of the Chart of Accounts to update or insert the properties onto. Together with the scope this uniquely identifies the Chart of Accounts.
     ...
     */
    public async upsertChartOfAccountsProperties (scope: string, code: string, requestBody?: { [key: string]: Property; }, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ChartOfAccountsProperties;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/properties/$upsert'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
