...
export class ChartOfAccountsApi {
     ...
     */
    public async getCleardownModule (scope: string, code: string, cleardownModuleCode: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CleardownModuleResponse;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/cleardownmodules/{cleardownModuleCode}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'cleardownModuleCode' + '}', encodeURIComponent(String(cleardownModuleCode)));
     ...
     */
    public async getGeneralLedgerProfile (scope: string, code: string, generalLedgerProfileCode: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GeneralLedgerProfileResponse;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/generalledgerprofile/{generalLedgerProfileCode}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'generalLedgerProfileCode' + '}', encodeURIComponent(String(generalLedgerProfileCode)));
     ...
     */
    public async getPostingModule (scope: string, code: string, postingModuleCode: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PostingModuleResponse;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/postingmodules/{postingModuleCode}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'postingModuleCode' + '}', encodeURIComponent(String(postingModuleCode)));
     ...
     */
    public async listAccounts (scope: string, code: string, effectiveAt?: string, asAt?: Date, page?: string, start?: number, limit?: number, filter?: string, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfAccount;  }> {
     ...
     */
    public async listChartsOfAccounts (effectiveAt?: string, asAt?: Date, page?: string, start?: number, limit?: number, filter?: string, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfChartOfAccounts;  }> {
     ...
     */
    public async listCleardownModuleRules (scope: string, code: string, cleardownModuleCode: string, asAt?: Date, page?: string, start?: number, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfCleardownModuleRule;  }> {
     ...
     */
    public async listCleardownModules (scope: string, code: string, asAt?: Date, page?: string, start?: number, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfCleardownModuleResponse;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/cleardownmodules'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
     ...
     */
    public async listGeneralLedgerProfiles (scope: string, code: string, asAt?: Date, start?: number, page?: string, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfGeneralLedgerProfileResponse;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/generalledgerprofile'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
     ...
     * @param filter Expression to filter the results.              For example, to filter on the rule id, specify \&quot;ruleId eq \&#39;rule 1\&#39;\&quot;. For more information about filtering              results, see https://support.lusid.com/knowledgebase/article/KA-01914.
     */
    public async listPostingModuleRules (scope: string, code: string, postingModuleCode: string, asAt?: Date, page?: string, start?: number, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfPostingModuleRule;  }> {
     ...
     */
    public async listPostingModules (scope: string, code: string, asAt?: Date, page?: string, start?: number, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfPostingModuleResponse;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/postingmodules'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
