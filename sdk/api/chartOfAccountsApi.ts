...
export class ChartOfAccountsApi {
     ...
     */
    public async listChartsOfAccounts (effectiveAt?: string, asAt?: Date, page?: string, limit?: number, filter?: string, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfChartOfAccounts;  }> {
     ...
     */
    public async listCleardownModules (scope: string, code: string, asAt?: Date, page?: string, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfCleardownModuleResponse;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/cleardownmodules'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
     ...
     */
    public async listGeneralLedgerProfiles (scope: string, code: string, asAt?: Date, page?: string, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfGeneralLedgerProfileResponse;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/generalledgerprofile'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
     ...
     */
    public async listPostingModules (scope: string, code: string, asAt?: Date, page?: string, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfPostingModuleResponse;  }> {
        const localVarPath = this.basePath + '/api/chartofaccounts/{scope}/{code}/postingmodules'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
