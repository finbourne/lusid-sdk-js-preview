...
import { FundStructureRequest } from '../model/fundStructureRequest';
...
import { PagedResourceListOfFundStructure } from '../model/pagedResourceListOfFundStructure';
...
export enum FundStructuresApiApiKeys {
}

export class FundStructuresApi {
    ...
    public setApiKey(key: FundStructuresApiApiKeys, value: string) {
        (this.authentications as any)[FundStructuresApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EXPERIMENTAL] CreateFundStructure: Create a Fund Structure.
     * @param scope The scope of the Fund Structure.
     * @param fundStructureRequest The definition of the Fund Structure.
     */
    public async createFundStructure (scope: string, fundStructureRequest: FundStructureRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FundStructure;  }> {
        const localVarPath = this.basePath + '/api/fundstructures/{scope}'
        ...
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling createFundStructure.');
        }

        // verify required parameter 'fundStructureRequest' is not null or undefined
        if (fundStructureRequest === null || fundStructureRequest === undefined) {
            throw new Error('Required parameter fundStructureRequest was null or undefined when calling createFundStructure.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(fundStructureRequest, "FundStructureRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: FundStructure;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "FundStructure");
     ...
     * @summary [EXPERIMENTAL] GetFundStructure: Get a Fund Structure.
     * @param scope The scope of the Fund Structure.
     * @param code The code of the Fund Structure. Together with the scope this uniquely identifies the Fund Structure.
     * @param asAt The asAt datetime at which to retrieve the Fund Structure. Defaults to returning the latest version if not specified.
     * @param propertyKeys A list of property keys from the \&#39;FundStructure\&#39; domain to decorate onto the Fund Structure.              These must take the format {domain}/{scope}/{code}, for example \&#39;FundStructure/Manager/Id\&#39;. If no properties are specified, then no properties will be returned.
     */
    public async getFundStructure (scope: string, code: string, asAt?: Date, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FundStructure;  }> {
        const localVarPath = this.basePath + '/api/fundstructures/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling getFundStructure.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling getFundStructure.');
        }
     ...
     * @summary [EXPERIMENTAL] ListFundStructures: List Fund Structures.
     * @param asAt The asAt datetime at which to list Fund Structures. Defaults to returning the latest version of each Fund Structure if not specified.
     ...
     * @param propertyKeys A list of property keys from the \&#39;FundStructure\&#39; domain to decorate onto each Fund Structure.              These must take the format {domain}/{scope}/{code}, for example \&#39;FundStructure/Manager/Id\&#39;.
     */
    public async listFundStructures (asAt?: Date, page?: string, limit?: number, filter?: string, sortBy?: Array<string>, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfFundStructure;  }> {
        const localVarPath = this.basePath + '/api/fundstructures';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfFundStructure;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfFundStructure");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
