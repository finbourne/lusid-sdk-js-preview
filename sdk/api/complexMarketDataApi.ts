...
export class ComplexMarketDataApi {
     ...
     * @summary [EXPERIMENTAL] DeleteComplexMarketData: Delete one or more items of complex market data, assuming they are present.
     ...
     * @summary [EXPERIMENTAL] GetComplexMarketData: Get complex market data
     ...
     * @summary [EXPERIMENTAL] UpsertComplexMarketData: Upsert a set of complex market data items. This creates or updates the data in Lusid.
