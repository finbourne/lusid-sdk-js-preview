...
export class StructuredMarketDataApi {
     ...
     * @summary [EXPERIMENTAL] DeleteStructuredMarketData: Delete one or more items of structured market data, assuming they are present.
     ...
     * @summary [EXPERIMENTAL] GetStructuredMarketData: Get structured market data
     ...
     * @summary [EXPERIMENTAL] UpsertStructuredMarketData: Upsert a set of structured market data items. This creates or updates the data in Lusid.
