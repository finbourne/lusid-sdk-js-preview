...
export class PortfolioGroupsApi {
     ...
     * @summary [EXPERIMENTAL] GetA2BDataForPortfolioGroup: Get A2B data for a Portfolio Group
     ...
     * @summary [EXPERIMENTAL] GetPortfolioGroupRelationships: Get Relationships for Portfolio Group
     * @param scope The scope of the portfolio group.
     * @param code The code of the portfolio group. Together with the scope this uniquely identifies              the portfolio group.
     ...
     */
    public async getTransactionsForPortfolioGroup (scope: string, code: string, fromTransactionDate?: string, toTransactionDate?: string, asAt?: Date, filter?: string, propertyKeys?: Array<string>, limit?: number, page?: string, showCancelledTransactions?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: VersionedResourceListOfTransaction;  }> {
     ...
     * @summary [EXPERIMENTAL] PatchPortfolioGroupAccessMetadata: Patch Access Metadata rules for a Portfolio Group.
     * @param scope The scope of the Portfolio Group
     * @param code The Portfolio Group code
     * @param operation The Json patch document
     ...
     */
    public async patchPortfolioGroupAccessMetadata (scope: string, code: string, operation: Array<Operation>, effectiveAt?: string, effectiveUntil?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: { [key: string]: Array<AccessMetadataValue>; };  }> {
        const localVarPath = this.basePath + '/api/portfoliogroups/{scope}/{code}/metadata'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        if (operation === null || operation === undefined) {
            throw new Error('Required parameter operation was null or undefined when calling patchPortfolioGroupAccessMetadata.');
        }
