...
export class PortfolioGroupsApi {
     ...
     * @summary [EXPERIMENTAL] DeleteKeyFromPortfolioGroupAccessMetadata: Delete a Portfolio Group Access Metadata entry
     * @param scope The scope of the Portfolio Group
     ...
     * @summary [EXPERIMENTAL] GetPortfolioGroupAccessMetadataByKey: Get an entry identified by a metadataKey in the Access Metadata of a Portfolio Group
     * @param scope The scope of the Portfolio Group
     * @param code The Portfolio Group code
     ...
     * @summary [EXPERIMENTAL] GetPortfolioGroupMetadata: Get Access Metadata rules for Portfolio Group
     * @param scope The scope of the Portfolio Group
     * @param code The Portfolio Group code
     * @param effectiveAt The effectiveAt datetime at which to retrieve the Access Metadata
     * @param asAt The asAt datetime at which to retrieve the Access Metadata
     ...
     * @summary [EXPERIMENTAL] UpsertPortfolioGroupAccessMetadata: Upsert a Portfolio Group Access Metadata entry associated with a specific metadataKey. This creates or updates the data in LUSID.
     * @param scope The scope of the Portfolio Group
     * @param code The Portfolio Group code
