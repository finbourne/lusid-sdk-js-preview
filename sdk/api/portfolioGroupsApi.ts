...
export class PortfolioGroupsApi {
     ...
     * @param returnExcludedTransactions Whether to include transactions that a portfolio\&#39;s transaction exclusion filter marks as excluded. Defaults to false.
     */
     ...
     * @param propertyKeys A list of property keys from the \&#39;PortfolioGroup\&#39; domain to decorate onto the portfolio group. These must take the format {domain}/{scope}/{code}, e.g. \&#39;PortfolioGroup/Manager/Id\&#39;.
     */
    public async getPortfolioGroup (scope: string, code: string, effectiveAt?: string, asAt?: Date, relatedEntityPropertyKeys?: Array<string>, relationshipDefinitionIds?: Array<string>, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PortfolioGroup;  }> {
        const localVarPath = this.basePath + '/api/portfoliogroups/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
     ...
     * @summary [EXPERIMENTAL] GetPortfolioGroupRelations: Get Relations for Portfolio Group
     * @param scope The scope of the portfolio group.
     * @param code The code of the portfolio group. Together with the scope this uniquely identifies              the portfolio group.
     ...
     * @param membershipType The membership types of the specified Custom Data Model to return. Default value: Member. Available values: All, Member, Candidate.
     */
    public async getTransactionsForPortfolioGroup (scope: string, code: string, fromTransactionDate?: string, toTransactionDate?: string, asAt?: Date, filter?: string, propertyKeys?: Array<string>, limit?: number, page?: string, showCancelledTransactions?: boolean, sortBy?: Array<string>, dataModelScope?: string, dataModelCode?: string, membershipType?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: VersionedResourceListOfTransaction;  }> {
     ...
     * @summary ListAllPortfolioGroups: List all portfolio groups
     ...
     * @param propertyKeys A list of property keys from the \&#39;PortfolioGroup\&#39; domain to decorate onto the portfolio groups. These must take the format {domain}/{scope}/{code}, e.g. \&#39;PortfolioGroup/Manager/Id\&#39;.
     */
    public async listAllPortfolioGroups (effectiveAt?: string, asAt?: Date, page?: string, limit?: number, filter?: string, sortBy?: Array<string>, relatedEntityPropertyKeys?: Array<string>, relationshipDefinitionIds?: Array<string>, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfPortfolioGroup;  }> {
        const localVarPath = this.basePath + '/api/portfoliogroups';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
