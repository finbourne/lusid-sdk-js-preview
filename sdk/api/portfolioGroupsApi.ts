...
export class PortfolioGroupsApi {
     ...
     * @summary [EXPERIMENTAL] Build transactions for transaction portfolios in a portfolio group
     ...
     */
    public async buildTransactionsForPortfolioGroup (scope: string, code: string, _queryParameters: TransactionQueryParameters, asAt?: Date, filter?: string, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: VersionedResourceListOfOutputTransaction;  }> {
        ...
        if (_queryParameters === null || _queryParameters === undefined) {
            throw new Error('Required parameter _queryParameters was null or undefined when calling buildTransactionsForPortfolioGroup.');
        }
     ...
     * @summary [EXPERIMENTAL] Get holdings for transaction portfolios in portfolio group
     * @param scope The scope of the portfolio group.
     * @param code The code of the portfolio group. Together with the scope this uniquely identifies              the portfolio group.
     ...
     * @summary [EXPERIMENTAL] Get transactions for transaction portfolios in a portfolio group
     * @param scope The scope of the portfolio group.
     * @param code The code of the portfolio group. Together with the scope this uniquely identifies              the portfolio group.
     ...
     * @param propertyKeys A list of property keys from the \&quot;Instrument\&quot; or \&quot;Transaction\&quot; domain to decorate onto              the transactions. These take the format {domain}/{scope}/{code} e.g. \&quot;Instrument/system/Name\&quot; or              \&quot;Transaction/strategy/quantsignal\&quot;.
     */
    public async getTransactionsForPortfolioGroup (scope: string, code: string, fromTransactionDate?: string, toTransactionDate?: string, asAt?: Date, filter?: string, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: VersionedResourceListOfTransaction;  }> {
     ...
     */
    public async upsertPortfolioGroupAccessMetadata (scope: string, code: string, metadataKey: string, request: UpsertPortfolioGroupAccessMetadataRequest, effectiveAt?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfAccessMetadataValueOf;  }> {
        const localVarPath = this.basePath + '/api/portfoliogroups/{scope}/{code}/metadata/{metadataKey}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'metadataKey' + '}', encodeURIComponent(String(metadataKey)));
