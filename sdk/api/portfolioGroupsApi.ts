...
export class PortfolioGroupsApi {
     ...
     * @param key Key of the Access Metadata entry to delete
     * @param effectiveAt The effective date to delete at, if this is not supplied, it will delete all data found
     */
    public async deleteKeyFromPortfolioGroupAccessMetadata (scope: string, code: string, key: string, effectiveAt?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/portfoliogroups/{scope}/{code}/metadata/{key}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
        ...
        if (key === null || key === undefined) {
            throw new Error('Required parameter key was null or undefined when calling deleteKeyFromPortfolioGroupAccessMetadata.');
        }
     ...
     * @summary [EXPERIMENTAL] Get an entry identified by a key in the Access Metadata of a Portfolio Group
     * @param scope The scope of the Portfolio Group
     * @param code The Portfolio Group code
     * @param key Key of the metadata entry to retrieve
     ...
     */
    public async getPortfolioGroupAccessMetadataByKey (scope: string, code: string, key: string, effectiveAt?: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<AccessMetadataValue>;  }> {
        const localVarPath = this.basePath + '/api/portfoliogroups/{scope}/{code}/metadata/{key}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'key' + '}', encodeURIComponent(String(key)));
        ...
        // verify required parameter 'key' is not null or undefined
        if (key === null || key === undefined) {
            throw new Error('Required parameter key was null or undefined when calling getPortfolioGroupAccessMetadataByKey.');
        }
     ...
     * @summary [EXPERIMENTAL] Upsert a Portfolio Group Access Metadata entry associated with a specific key. This creates or updates the data in LUSID.
     * @param scope The scope of the Portfolio Group
     * @param code The Portfolio Group code
     * @param key Key of the access metadata entry to upsert
     * @param request The Portfolio Group Access Metadata rule to upsert
     * @param effectiveAt The date this rule will be effective from
     */
    public async upsertPortfolioGroupAccessMetadata (scope: string, code: string, key: string, request: UpsertPortfolioGroupAccessMetadataRequest, effectiveAt?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfAccessMetadataValueOf;  }> {
        const localVarPath = this.basePath + '/api/portfoliogroups/{scope}/{code}/metadata/{key}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'key' + '}', encodeURIComponent(String(key)));
        ...
        // verify required parameter 'key' is not null or undefined
        if (key === null || key === undefined) {
            throw new Error('Required parameter key was null or undefined when calling upsertPortfolioGroupAccessMetadata.');
        }

        // verify required parameter 'request' is not null or undefined
        if (request === null || request === undefined) {
            throw new Error('Required parameter request was null or undefined when calling upsertPortfolioGroupAccessMetadata.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(request, "UpsertPortfolioGroupAccessMetadataRequest")
        };
