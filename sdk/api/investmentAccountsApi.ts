...
export class InvestmentAccountsApi {
     ...
     * @param idTypeScope Scope of the investment account identifier type.
     * @param idTypeCode Code of the investment account identifier type.
     * @param code Code of the investment account under specified identifier type\&#39;s scope and code. This together with stated identifier type uniquely              identifies the investment account.
     ...
     */
    public async getInvestmentAccount (idTypeScope: string, idTypeCode: string, code: string, propertyKeys?: Array<string>, effectiveAt?: string, asAt?: Date, relationshipDefinitionIds?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InvestmentAccount;  }> {
        const localVarPath = this.basePath + '/api/investmentaccounts/{idTypeScope}/{idTypeCode}/{code}'
        ...
        if (idTypeScope === null || idTypeScope === undefined) {
            throw new Error('Required parameter idTypeScope was null or undefined when calling getInvestmentAccount.');
        }

        // verify required parameter 'idTypeCode' is not null or undefined
        if (idTypeCode === null || idTypeCode === undefined) {
            throw new Error('Required parameter idTypeCode was null or undefined when calling getInvestmentAccount.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling getInvestmentAccount.');
        }
