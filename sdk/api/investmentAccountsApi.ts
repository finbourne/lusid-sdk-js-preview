...
export enum InvestmentAccountsApiApiKeys {
}

export class InvestmentAccountsApi {
    ...
    public setApiKey(key: InvestmentAccountsApiApiKeys, value: string) {
        (this.authentications as any)[InvestmentAccountsApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EXPERIMENTAL] DeleteInvestmentAccount: Delete Investment Account
     * @param identifierType Code of the investment account identifier type.
     * @param identifierValue Code of the investment account under specified identifier type\&#39;s scope and code.
     * @param scope The scope of the investment account entity.
     * @param identifierScope Scope of the investment account identifier type.
     */
    public async deleteInvestmentAccount (identifierType: string, identifierValue: string, scope: string, identifierScope: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/investmentaccounts/{identifierType}/{identifierValue}'
        ...
        if (identifierType === null || identifierType === undefined) {
            throw new Error('Required parameter identifierType was null or undefined when calling deleteInvestmentAccount.');
        }

        // verify required parameter 'identifierValue' is not null or undefined
        if (identifierValue === null || identifierValue === undefined) {
            throw new Error('Required parameter identifierValue was null or undefined when calling deleteInvestmentAccount.');
        }

        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling deleteInvestmentAccount.');
        }

        // verify required parameter 'identifierScope' is not null or undefined
        if (identifierScope === null || identifierScope === undefined) {
            throw new Error('Required parameter identifierScope was null or undefined when calling deleteInvestmentAccount.');
        }
     ...
     * @summary [EXPERIMENTAL] DeleteInvestmentAccountAccessMetadata: Delete an Investment Account Access Metadata entry.
     * @param identifierType Code of the investment account identifier type.
     * @param identifierValue Code of the investment account under specified identifier type\&#39;s scope and code.
     ...
     */
    public async deleteInvestmentAccountAccessMetadata (identifierType: string, identifierValue: string, metadataKey: string, scope: string, identifierScope: string, effectiveAt?: string, effectiveUntil?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/investmentaccounts/{identifierType}/{identifierValue}/metadata/{metadataKey}'
            .replace('{' + 'identifierType' + '}', encodeURIComponent(String(identifierType)))
            .replace('{' + 'identifierValue' + '}', encodeURIComponent(String(identifierValue)))
        ...
        // verify required parameter 'identifierType' is not null or undefined
        if (identifierType === null || identifierType === undefined) {
            throw new Error('Required parameter identifierType was null or undefined when calling deleteInvestmentAccountAccessMetadata.');
        }

        // verify required parameter 'identifierValue' is not null or undefined
        if (identifierValue === null || identifierValue === undefined) {
            throw new Error('Required parameter identifierValue was null or undefined when calling deleteInvestmentAccountAccessMetadata.');
        }

        // verify required parameter 'metadataKey' is not null or undefined
        if (metadataKey === null || metadataKey === undefined) {
            throw new Error('Required parameter metadataKey was null or undefined when calling deleteInvestmentAccountAccessMetadata.');
        }

        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling deleteInvestmentAccountAccessMetadata.');
        }

        // verify required parameter 'identifierScope' is not null or undefined
        if (identifierScope === null || identifierScope === undefined) {
            throw new Error('Required parameter identifierScope was null or undefined when calling deleteInvestmentAccountAccessMetadata.');
        }
     ...
     * @summary [EXPERIMENTAL] GetAllInvestmentAccountAccessMetadata: Get Access Metadata rules for an Investment Account.
     * @param identifierType Code of the investment account identifier type.
     * @param identifierValue Code of the investment account under specified identifier type\&#39;s scope and code.
     * @param scope The scope of the investment account entity.
     * @param identifierScope Scope of the investment account identifier type.
     ...
     */
    public async getAllInvestmentAccountAccessMetadata (identifierType: string, identifierValue: string, scope: string, identifierScope: string, effectiveAt?: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: { [key: string]: Array<AccessMetadataValue>; };  }> {
        const localVarPath = this.basePath + '/api/investmentaccounts/{identifierType}/{identifierValue}/metadata'
            .replace('{' + 'identifierType' + '}', encodeURIComponent(String(identifierType)))
            .replace('{' + 'identifierValue' + '}', encodeURIComponent(String(identifierValue)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'identifierType' is not null or undefined
        if (identifierType === null || identifierType === undefined) {
            throw new Error('Required parameter identifierType was null or undefined when calling getAllInvestmentAccountAccessMetadata.');
        }

        // verify required parameter 'identifierValue' is not null or undefined
        if (identifierValue === null || identifierValue === undefined) {
            throw new Error('Required parameter identifierValue was null or undefined when calling getAllInvestmentAccountAccessMetadata.');
        }

        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling getAllInvestmentAccountAccessMetadata.');
        }

        // verify required parameter 'identifierScope' is not null or undefined
        if (identifierScope === null || identifierScope === undefined) {
            throw new Error('Required parameter identifierScope was null or undefined when calling getAllInvestmentAccountAccessMetadata.');
        }
     ...
     * @summary [EXPERIMENTAL] GetInvestmentAccount: Get Investment Account
     * @param identifierType Code of the investment account identifier type.
     * @param identifierValue Code of the investment account under specified identifier type\&#39;s scope and code.
     * @param scope The scope of the investment account entity.
     * @param identifierScope Scope of the investment account identifier type.
     ...
     * @param effectiveAt The effective datetime or cut label at which to retrieve the investment account. Defaults to the current LUSID system datetime if not specified.
     * @param asAt The asAt datetime at which to retrieve the investment account. Defaults to return the latest version of the investment account if not specified.
     * @param relationshipDefinitionIds A list of relationship definitions that are used to decorate related entities              onto the investment account in the response. These must take the form {relationshipDefinitionScope}/{relationshipDefinitionCode}.
     */
    public async getInvestmentAccount (identifierType: string, identifierValue: string, scope: string, identifierScope: string, propertyKeys?: Array<string>, effectiveAt?: string, asAt?: Date, relationshipDefinitionIds?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InvestmentAccount;  }> {
        const localVarPath = this.basePath + '/api/investmentaccounts/{identifierType}/{identifierValue}'
            .replace('{' + 'identifierType' + '}', encodeURIComponent(String(identifierType)))
            .replace('{' + 'identifierValue' + '}', encodeURIComponent(String(identifierValue)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'identifierType' is not null or undefined
        if (identifierType === null || identifierType === undefined) {
            throw new Error('Required parameter identifierType was null or undefined when calling getInvestmentAccount.');
        }

        // verify required parameter 'identifierValue' is not null or undefined
        if (identifierValue === null || identifierValue === undefined) {
            throw new Error('Required parameter identifierValue was null or undefined when calling getInvestmentAccount.');
        }

        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling getInvestmentAccount.');
        }

        // verify required parameter 'identifierScope' is not null or undefined
        if (identifierScope === null || identifierScope === undefined) {
            throw new Error('Required parameter identifierScope was null or undefined when calling getInvestmentAccount.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: InvestmentAccount;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "InvestmentAccount");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] GetInvestmentAccountRelationships: Get Investment Account relationships
     * @param identifierType Code of the investment account identifier type.
     * @param identifierValue Code of the investment account under specified identifier type\&#39;s scope and code.
     * @param scope The scope of the investment account entity.
     * @param identifierScope Scope of the investment account identifier type.
     ...
     */
    public async getInvestmentAccountRelationships (identifierType: string, identifierValue: string, scope: string, identifierScope: string, effectiveAt?: string, asAt?: Date, filter?: string, identifierTypes?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfRelationship;  }> {
        const localVarPath = this.basePath + '/api/investmentaccounts/{identifierType}/{identifierValue}/relationships'
            .replace('{' + 'identifierType' + '}', encodeURIComponent(String(identifierType)))
            .replace('{' + 'identifierValue' + '}', encodeURIComponent(String(identifierValue)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'identifierType' is not null or undefined
        if (identifierType === null || identifierType === undefined) {
            throw new Error('Required parameter identifierType was null or undefined when calling getInvestmentAccountRelationships.');
        }

        // verify required parameter 'identifierValue' is not null or undefined
        if (identifierValue === null || identifierValue === undefined) {
            throw new Error('Required parameter identifierValue was null or undefined when calling getInvestmentAccountRelationships.');
        }

        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling getInvestmentAccountRelationships.');
        }

        // verify required parameter 'identifierScope' is not null or undefined
        if (identifierScope === null || identifierScope === undefined) {
            throw new Error('Required parameter identifierScope was null or undefined when calling getInvestmentAccountRelationships.');
        }
     ...
     * @summary [EXPERIMENTAL] ListAllInvestmentAccounts: List Investment Accounts
     * @param effectiveAt The effective datetime or cut label at which to list the investment accounts. Defaults to the current LUSID              system datetime if not specified.
     * @param asAt The asAt datetime at which to list the investment accounts. Defaults to return the latest version              of each investment accounts if not specified.
     ...
     * @param relationshipDefinitionIds A list of relationship definitions that are used to decorate related entities              onto each investment account in the response. These must take the form {relationshipDefinitionScope}/{relationshipDefinitionCode}.
     */
    public async listAllInvestmentAccounts (effectiveAt?: string, asAt?: Date, page?: string, limit?: number, filter?: string, sortBy?: Array<string>, propertyKeys?: Array<string>, relationshipDefinitionIds?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfInvestmentAccount;  }> {
        const localVarPath = this.basePath + '/api/investmentaccounts';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ResourceListOfInvestmentAccount;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ResourceListOfInvestmentAccount");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] PatchInvestmentAccountAccessMetadata: Patch Access Metadata rules for an Investment Account.
     * @param identifierType Code of the investment account identifier type.
     * @param identifierValue Code of the investment account under specified identifier type\&#39;s scope and code.
     * @param scope The scope of the investment account entity.
     * @param identifierScope Scope of the investment account identifier type.
    ...
    public async patchInvestmentAccountAccessMetadata (identifierType: string, identifierValue: string, scope: string, identifierScope: string, accessMetadataOperation: Array<AccessMetadataOperation>, effectiveAt?: string, effectiveUntil?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: { [key: string]: Array<AccessMetadataValue>; };  }> {
        ...
        // verify required parameter 'identifierType' is not null or undefined
        if (identifierType === null || identifierType === undefined) {
            throw new Error('Required parameter identifierType was null or undefined when calling patchInvestmentAccountAccessMetadata.');
        }

        // verify required parameter 'identifierValue' is not null or undefined
        if (identifierValue === null || identifierValue === undefined) {
            throw new Error('Required parameter identifierValue was null or undefined when calling patchInvestmentAccountAccessMetadata.');
        }

        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling patchInvestmentAccountAccessMetadata.');
        }

        // verify required parameter 'identifierScope' is not null or undefined
        if (identifierScope === null || identifierScope === undefined) {
            throw new Error('Required parameter identifierScope was null or undefined when calling patchInvestmentAccountAccessMetadata.');
        }
        ...
        if (accessMetadataOperation === null || accessMetadataOperation === undefined) {
            throw new Error('Required parameter accessMetadataOperation was null or undefined when calling patchInvestmentAccountAccessMetadata.');
        }
     ...
     * @summary [EXPERIMENTAL] UpsertInvestmentAccounts: Upsert Investment Accounts
     * @param successMode Whether the batch request should fail Atomically or in a Partial fashion - Allowed Values: Atomic, Partial
     * @param requestBody A collection of requests to create or update Investment Accounts.
     */
    public async upsertInvestmentAccounts (successMode: string, requestBody: { [key: string]: UpsertInvestmentAccountRequest; }, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UpsertInvestmentAccountsResponse;  }> {
        const localVarPath = this.basePath + '/api/investmentaccounts/$batchUpsert';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        if (successMode === null || successMode === undefined) {
            throw new Error('Required parameter successMode was null or undefined when calling upsertInvestmentAccounts.');
        }

        // verify required parameter 'requestBody' is not null or undefined
        if (requestBody === null || requestBody === undefined) {
            throw new Error('Required parameter requestBody was null or undefined when calling upsertInvestmentAccounts.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(requestBody, "{ [key: string]: UpsertInvestmentAccountRequest; }")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: UpsertInvestmentAccountsResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "UpsertInvestmentAccountsResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
