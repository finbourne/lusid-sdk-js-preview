...
export enum RecipeComposerApiApiKeys {
}

export class RecipeComposerApi {
    ...
    public setApiKey(key: RecipeComposerApiApiKeys, value: string) {
        (this.authentications as any)[RecipeComposerApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EXPERIMENTAL] DeleteRecipeComposer: Delete a Recipe Composer, assuming that it is present.
    ...
    public async deleteRecipeComposer (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AnnulSingleStructuredDataResponse;  }> {
        const localVarPath = this.basePath + '/api/recipecomposers/{scope}/{code}'
     ...
     * @summary [EXPERIMENTAL] GetRecipeComposer: Get Recipe Composer
     ...
     * @summary [EXPERIMENTAL] GetRecipeComposerResolvedInline: Given a Recipe Composer, this endpoint shows what configuration recipe it would resolve to, able to access the already upserted configuration recipes as well as plain inline string inputs.
     * @param upsertRecipeComposerRequest Recipe composer used to resolve into the Configuration Recipe.
     */
    public async getRecipeComposerResolvedInline (upsertRecipeComposerRequest: UpsertRecipeComposerRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GetRecipeResponse;  }> {
        const localVarPath = this.basePath + '/api/recipecomposers/inline';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
     ...
     * @summary [EXPERIMENTAL] ListRecipeComposers: List the set of Recipe Composers
    ...
    public async listRecipeComposers (asAt?: Date, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfGetRecipeComposerResponse;  }> {
        const localVarPath = this.basePath + '/api/recipecomposers';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
     ...
     * @summary [EXPERIMENTAL] UpsertRecipeComposer: Upsert a Recipe Composer. This creates or updates the data in Lusid.
