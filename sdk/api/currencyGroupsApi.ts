...
import { CurrencyGroupResponse } from '../model/currencyGroupResponse';
...
import { PagedResourceListOfCurrencyGroupResponse } from '../model/pagedResourceListOfCurrencyGroupResponse';
import { UpsertCurrencyGroupRequest } from '../model/upsertCurrencyGroupRequest';
...
export enum CurrencyGroupsApiApiKeys {
}

export class CurrencyGroupsApi {
    ...
    public setApiKey(key: CurrencyGroupsApiApiKeys, value: string) {
        (this.authentications as any)[CurrencyGroupsApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EXPERIMENTAL] DeleteCurrencyGroup: Delete a currency group.
     * @param code The code of the currency group to delete.
     */
    public async deleteCurrencyGroup (code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/currencies/groups/{code}'
        ...
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling deleteCurrencyGroup.');
        }
     ...
     * @summary [EXPERIMENTAL] GetCurrencyGroup: Get a currency group.
     * @param code The code of the currency group.
     * @param asAt The asAt datetime at which to retrieve the currency group. Defaults to returning              the latest version if not specified.
     */
    public async getCurrencyGroup (code: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CurrencyGroupResponse;  }> {
        const localVarPath = this.basePath + '/api/currencies/groups/{code}'
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling getCurrencyGroup.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: CurrencyGroupResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "CurrencyGroupResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] ListCurrencyGroups: List currency groups.
     * @param asAt The asAt datetime at which to list the currency groups. Defaults to returning              the latest version of each currency group if not specified.
     ...
     * @param sortBy A list of field names to sort by, each prefixed with \&quot;+\&quot; for ascending or              \&quot;-\&quot; for descending. Sortable fields are the group\&#39;s code, displayName and majorUnitCurrency.
     */
    public async listCurrencyGroups (asAt?: Date, page?: string, limit?: number, filter?: string, sortBy?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfCurrencyGroupResponse;  }> {
        const localVarPath = this.basePath + '/api/currencies/groups';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfCurrencyGroupResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfCurrencyGroupResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] UpsertCurrencyGroup: Upsert a currency group.
     * @param upsertCurrencyGroupRequest The currency group to upsert.
     */
    public async upsertCurrencyGroup (upsertCurrencyGroupRequest: UpsertCurrencyGroupRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CurrencyGroupResponse;  }> {
        const localVarPath = this.basePath + '/api/currencies/groups';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        // verify required parameter 'upsertCurrencyGroupRequest' is not null or undefined
        if (upsertCurrencyGroupRequest === null || upsertCurrencyGroupRequest === undefined) {
            throw new Error('Required parameter upsertCurrencyGroupRequest was null or undefined when calling upsertCurrencyGroup.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(upsertCurrencyGroupRequest, "UpsertCurrencyGroupRequest")
        };
