...
export class QuotesApi {
     ...
     * @summary [EXPERIMENTAL] DeleteQuoteAccessMetadataRule: Delete a Quote Access Metadata Rule
     ...
     */
    public async deleteQuoteAccessMetadataRule (scope: string, provider?: string, priceSource?: string, instrumentIdType?: string, instrumentId?: string, quoteType?: string, field?: string, effectiveAt?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: QuoteAccessMetadataRule;  }> {
     ...
     * @summary [EXPERIMENTAL] GetQuotesAccessMetadataRule: Get a quote access metadata rule
     * @param scope The scope of the Quote Access Metadata Rule to retrieve.
     * @param provider The Provider of the rule
     * @param priceSource The PriceSource of the rule
     * @param instrumentIdType The InstrumentIdType of the rule
     ...
     */
    public async listQuotes (scope: string, asAt?: Date, page?: string, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfQuote;  }> {
     ...
     * @summary [EXPERIMENTAL] ListQuotesAccessMetadataRules: List all quote access metadata rules in a scope
     * @param scope The scope of the Quote Access Metadata Rule to retrieve.
     * @param asAt The asAt datetime at which to retrieve the access metadata rule. Defaults to return the latest version if not specified.
     */
     ...
     * @param filter Expression to filter the result set.              Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid.
     */
    public async listQuotesForScope (scope: string, asAt?: Date, page?: string, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfQuote;  }> {
     ...
     * @summary [EXPERIMENTAL] UpsertQuoteAccessMetadataRule: Upsert a Quote Access Metadata Rule. This creates or updates the data in LUSID.
     ...
     */
    public async upsertQuoteAccessMetadataRule (scope: string, upsertQuoteAccessMetadataRuleRequest: UpsertQuoteAccessMetadataRuleRequest, effectiveAt?: string, effectiveUntil?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: QuoteAccessMetadataRule;  }> {
        const localVarPath = this.basePath + '/api/metadata/quotes/rules/{scope}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'upsertQuoteAccessMetadataRuleRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(upsertQuoteAccessMetadataRuleRequest, "UpsertQuoteAccessMetadataRuleRequest")
        };
