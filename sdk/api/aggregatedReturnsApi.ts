...
import { AggregatedReturnsEntityRequest } from '../model/aggregatedReturnsEntityRequest';
...
export enum AggregatedReturnsApiApiKeys {
}

export class AggregatedReturnsApi {
    ...
    public setApiKey(key: AggregatedReturnsApiApiKeys, value: string) {
        (this.authentications as any)[AggregatedReturnsApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EXPERIMENTAL] DeleteReturnsEntity: Delete returns entity.
     * @param scope Returns entity scope.
     * @param code Returns entity code.
     */
    public async deleteReturnsEntity (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/returns/{scope}/{code}'
     ...
     * @summary [EXPERIMENTAL] GetAggregatedReturns: Calculate aggregated returns for an entity.
     * @param aggregatedReturnsEntityRequest The entity to calculate returns for, the Returns entity that configures the              calculation, the effective window and the metrics to calculate.
     */
    public async getAggregatedReturns (aggregatedReturnsEntityRequest: AggregatedReturnsEntityRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AggregatedReturnsResponse;  }> {
        const localVarPath = this.basePath + '/api/returns/$aggregated';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'aggregatedReturnsEntityRequest' is not null or undefined
        if (aggregatedReturnsEntityRequest === null || aggregatedReturnsEntityRequest === undefined) {
            throw new Error('Required parameter aggregatedReturnsEntityRequest was null or undefined when calling getAggregatedReturns.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(aggregatedReturnsEntityRequest, "AggregatedReturnsEntityRequest")
        };
    ...
    /**
     * Get returns entity.
     * @summary [EXPERIMENTAL] GetReturnsEntity: Get returns entity.
     * @param scope Returns entity scope.
     * @param code Returns entity code.
     * @param asAt The asAt datetime at which to retrieve the returns entity. Defaults to return              the latest version of the definition if not specified.
     */
    public async getReturnsEntity (scope: string, code: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ReturnsEntity;  }> {
        const localVarPath = this.basePath + '/api/returns/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ReturnsEntity;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ReturnsEntity");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] ListReturnsEntities: List returns entities.
     * @param asAt The asAt datetime at which to retrieve the relation definitions. Defaults to return              the latest version of each definition if not specified.
     */
    public async listReturnsEntities (asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfReturnsEntity;  }> {
        const localVarPath = this.basePath + '/api/returns';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ResourceListOfReturnsEntity;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ResourceListOfReturnsEntity");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] UpsertReturnsEntity: Upsert returns entity.
     * @param returnsEntity Definition of the returns entity.
     */
    public async upsertReturnsEntity (returnsEntity: ReturnsEntity, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ReturnsEntity;  }> {
        const localVarPath = this.basePath + '/api/returns';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        // verify required parameter 'returnsEntity' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(returnsEntity, "ReturnsEntity")
        };
