...
export class CustomEntitiesApi {
     ...
     * @summary [EXPERIMENTAL] GetCustomEntity: Get CustomEntity
     * @param entityType The type of entity to retrieve. An entityType can be created using the \&quot;CreateCustomEntityDefinition\&quot; endpoint for CustomEntityDefinitions.
     ...
     * @param effectiveAt The effective datetime or cut label at which to get the CustomEntity. Defaults to the current LUSID system datetime if not specified.
     */
     ...
     * @summary [EXPERIMENTAL] ListCustomEntities: List Custom Entities
     ...
     * @summary [EXPERIMENTAL] UpsertCustomEntity: Upsert a new CustomEntity
     * @param entityType The type of the CustomEntity to be created. An entityType can be created using the \&quot;CreateCustomEntityDefinition\&quot; endpoint for CustomEntityDefinitions.
