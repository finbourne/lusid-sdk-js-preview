...
export class CustomEntitiesApi {
     ...
     * @summary DeleteCustomEntity: Delete a Custom Entity instance.
     ...
     */
    public async deleteCustomEntity (entityType: string, identifierType: string, identifierValue: string, identifierScope: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
     ...
     */
    public async deleteCustomEntityAccessMetadata (entityType: string, identifierType: string, identifierValue: string, metadataKey: string, identifierScope: string, effectiveAt?: string, effectiveUntil?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/customentities/{entityType}/{identifierType}/{identifierValue}/metadata/{metadataKey}'
            .replace('{' + 'entityType' + '}', encodeURIComponent(String(entityType)))
            .replace('{' + 'identifierType' + '}', encodeURIComponent(String(identifierType)))
            .replace('{' + 'identifierValue' + '}', encodeURIComponent(String(identifierValue)))
     ...
     */
    public async getAllCustomEntityAccessMetadata (entityType: string, identifierType: string, identifierValue: string, identifierScope: string, effectiveAt?: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: { [key: string]: Array<AccessMetadataValue>; };  }> {
        const localVarPath = this.basePath + '/api/customentities/{entityType}/{identifierType}/{identifierValue}/metadata'
            .replace('{' + 'entityType' + '}', encodeURIComponent(String(entityType)))
            .replace('{' + 'identifierType' + '}', encodeURIComponent(String(identifierType)))
            .replace('{' + 'identifierValue' + '}', encodeURIComponent(String(identifierValue)));
        let localVarQueryParameters: any = {};
     ...
     * @summary GetCustomEntity: Get a Custom Entity instance.
     ...
     */
    public async getCustomEntity (entityType: string, identifierType: string, identifierValue: string, identifierScope: string, asAt?: Date, effectiveAt?: string, relatedEntityPropertyKeys?: Array<string>, relationshipDefinitionIds?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CustomEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/customentities/{entityType}/{identifierType}/{identifierValue}'
            .replace('{' + 'entityType' + '}', encodeURIComponent(String(entityType)))
            .replace('{' + 'identifierType' + '}', encodeURIComponent(String(identifierType)))
            .replace('{' + 'identifierValue' + '}', encodeURIComponent(String(identifierValue)));
     ...
     * @param asAt The asAt datetime at which to retrieve the Access Metadata. Defaults to returning the latest version of the metadata if not specified.
     */
    public async getCustomEntityAccessMetadataByKey (entityType: string, identifierType: string, identifierValue: string, metadataKey: string, identifierScope: string, effectiveAt?: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<AccessMetadataValue>;  }> {
        const localVarPath = this.basePath + '/api/customentities/{entityType}/{identifierType}/{identifierValue}/metadata/{metadataKey}'
            .replace('{' + 'entityType' + '}', encodeURIComponent(String(entityType)))
            .replace('{' + 'identifierType' + '}', encodeURIComponent(String(identifierType)))
            .replace('{' + 'identifierValue' + '}', encodeURIComponent(String(identifierValue)))
     ...
     */
    public async getCustomEntityRelationships (entityType: string, identifierScope: string, identifierType: string, identifierValue: string, effectiveAt?: string, asAt?: Date, filter?: string, identifierTypes?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfRelationship;  }> {
        const localVarPath = this.basePath + '/api/customentities/{entityType}/{identifierType}/{identifierValue}/relationships'
            .replace('{' + 'entityType' + '}', encodeURIComponent(String(entityType)))
            .replace('{' + 'identifierType' + '}', encodeURIComponent(String(identifierType)))
            .replace('{' + 'identifierValue' + '}', encodeURIComponent(String(identifierValue)));
        let localVarQueryParameters: any = {};
     ...
     * @summary ListCustomEntities: List Custom Entities of the specified entityType.
     ...
     */
    public async listCustomEntities (entityType: string, effectiveAt?: string, asAt?: Date, limit?: number, filter?: string, sortBy?: Array<string>, page?: string, relatedEntityPropertyKeys?: Array<string>, relationshipDefinitionIds?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfCustomEntityResponse;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfCustomEntityResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfCustomEntityResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     */
    public async upsertCustomEntities (entityType: string, successMode: string, requestBody: { [key: string]: CustomEntityRequest; }, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UpsertCustomEntitiesResponse;  }> {
        const localVarPath = this.basePath + '/api/customentities/{entityType}/$batchUpsert'
            .replace('{' + 'entityType' + '}', encodeURIComponent(String(entityType)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(requestBody, "{ [key: string]: CustomEntityRequest; }")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: UpsertCustomEntitiesResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "UpsertCustomEntitiesResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary UpsertCustomEntity: Upsert a Custom Entity instance
     * @param entityType The type of the Custom Entity to be created. An entityType can be created using the \&quot;CreateCustomEntityDefinition\&quot; endpoint for CustomEntityDefinitions.
     ...
     * @param effectiveUntil The effective datetime until which the Access Metadata is valid. If not supplied this will be valid indefinitely, or until the next \&#39;effectiveAt\&#39; datetime of the Access Metadata
     */
    public async upsertCustomEntityAccessMetadata (entityType: string, identifierType: string, identifierValue: string, metadataKey: string, identifierScope: string, upsertCustomEntityAccessMetadataRequest: UpsertCustomEntityAccessMetadataRequest, effectiveAt?: string, effectiveUntil?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<AccessMetadataValue>;  }> {
        const localVarPath = this.basePath + '/api/customentities/{entityType}/{identifierType}/{identifierValue}/metadata/{metadataKey}'
            .replace('{' + 'entityType' + '}', encodeURIComponent(String(entityType)))
            .replace('{' + 'identifierType' + '}', encodeURIComponent(String(identifierType)))
            .replace('{' + 'identifierValue' + '}', encodeURIComponent(String(identifierValue)))
        ...
        // verify required parameter 'upsertCustomEntityAccessMetadataRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(upsertCustomEntityAccessMetadataRequest, "UpsertCustomEntityAccessMetadataRequest")
        };
