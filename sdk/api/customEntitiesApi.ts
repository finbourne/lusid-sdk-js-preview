...
export class CustomEntitiesApi {
     ...
     */
    public async getCustomEntity (entityType: string, identifierType: string, identifierValue: string, identifierScope: string, asAt?: Date, effectiveAt?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CustomEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/customentities/{entityType}/{identifierType}/{identifierValue}'
            .replace('{' + 'entityType' + '}', encodeURIComponent(String(entityType)))
            .replace('{' + 'identifierType' + '}', encodeURIComponent(String(identifierType)))
            .replace('{' + 'identifierValue' + '}', encodeURIComponent(String(identifierValue)));
     ...
     */
    public async listCustomEntities (entityType: string, effectiveAt?: string, asAt?: Date, limit?: number, filter?: string, page?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfCustomEntityResponse;  }> {
