...
export class CustomEntitiesApi {
     ...
     * @summary [EXPERIMENTAL] DeleteCustomEntity: Delete a Custom Entity instance.
     ...
     * @summary [EXPERIMENTAL] GetCustomEntity: Get a Custom Entity instance.
     ...
     * @summary [EXPERIMENTAL] GetCustomEntityRelationships: Get Relationships for Custom Entity
     ...
     * @summary [EXPERIMENTAL] ListCustomEntities: List Custom Entities of the specified entityType.
     ...
     * @summary [EXPERIMENTAL] UpsertCustomEntities: Batch upsert instances of Custom Entities
     ...
     * @summary [EXPERIMENTAL] UpsertCustomEntity: Upsert a Custom Entity instance
     * @param entityType The type of the Custom Entity to be created. An entityType can be created using the \&quot;CreateCustomEntityDefinition\&quot; endpoint for CustomEntityDefinitions.
