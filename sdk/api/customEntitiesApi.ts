...
export class CustomEntitiesApi {
     ...
     */
    public async listCustomEntities (entityType: string, effectiveAt?: string, asAt?: Date, limit?: number, filter?: string, page?: string, relatedEntityPropertyKeys?: Array<string>, relationshipDefinitionIds?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfCustomEntityResponse;  }> {
