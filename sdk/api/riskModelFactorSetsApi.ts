...
import { CreateRiskModelFactorSetRequest } from '../model/createRiskModelFactorSetRequest';
...
import { PagedResourceListOfRiskModelFactorSet } from '../model/pagedResourceListOfRiskModelFactorSet';
import { RiskModelFactorSet } from '../model/riskModelFactorSet';
import { UpdateRiskModelFactorSetRequest } from '../model/updateRiskModelFactorSetRequest';
...
export enum RiskModelFactorSetsApiApiKeys {
}

export class RiskModelFactorSetsApi {
    ...
    public setApiKey(key: RiskModelFactorSetsApiApiKeys, value: string) {
        (this.authentications as any)[RiskModelFactorSetsApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EXPERIMENTAL] CreateRiskModelFactorSet: Create a Factor Set
     * @param createRiskModelFactorSetRequest The request containing the details of the factor set
     */
    public async createRiskModelFactorSet (createRiskModelFactorSetRequest?: CreateRiskModelFactorSetRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: RiskModelFactorSet;  }> {
        const localVarPath = this.basePath + '/api/riskmodels/factorsets';
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(createRiskModelFactorSetRequest, "CreateRiskModelFactorSetRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: RiskModelFactorSet;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "RiskModelFactorSet");
     ...
     * @summary [EXPERIMENTAL] DeleteRiskModelFactorSet: Deletes a particular Factor Set
     * @param scope The scope of the specified factor set.
     * @param code The code of the specified factor set. Together with the domain and scope this uniquely              identifies the factor set.
     */
    public async deleteRiskModelFactorSet (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/riskmodels/factorsets/{scope}/{code}'
        ...
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling deleteRiskModelFactorSet.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling deleteRiskModelFactorSet.');
        }
     ...
     * @summary [EXPERIMENTAL] GetRiskModelFactorSet: Get a single Factor Set by scope and code.
     * @param scope The scope of the specified factor set.
     * @param code The code of the specified factor set. Together with the domain and scope this uniquely              identifies the factor set.
     * @param asAt The asAt datetime at which to retrieve the factor set definition. Defaults to return              the latest version of the definition if not specified.
     */
    public async getRiskModelFactorSet (scope: string, code: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: RiskModelFactorSet;  }> {
        const localVarPath = this.basePath + '/api/riskmodels/factorsets/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling getRiskModelFactorSet.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling getRiskModelFactorSet.');
        }
     ...
     * @summary [EXPERIMENTAL] ListRiskModelFactorSets: Get a set of Factor Sets
     * @param asAt The asAt datetime at which to retrieve the factor sets. Defaults to return the latest              version of the factor sets if not specified.
     ...
     */
    public async listRiskModelFactorSets (asAt?: Date, page?: string, sortBy?: Array<string>, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfRiskModelFactorSet;  }> {
        const localVarPath = this.basePath + '/api/riskmodels/factorsets';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfRiskModelFactorSet;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfRiskModelFactorSet");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] UpdateRiskModelFactorSetName: Update Factor Set Display Name
     * @param scope The scope of the specified factor set.
     * @param code The code of the specified factor set. Together with the domain and scope this uniquely              identifies the factor set.
     * @param updateRiskModelFactorSetRequest The request containing the updated name of the factor set.
     */
    public async updateRiskModelFactorSetName (scope: string, code: string, updateRiskModelFactorSetRequest?: UpdateRiskModelFactorSetRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: RiskModelFactorSet;  }> {
        const localVarPath = this.basePath + '/api/riskmodels/factorsets/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling updateRiskModelFactorSetName.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling updateRiskModelFactorSetName.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(updateRiskModelFactorSetRequest, "UpdateRiskModelFactorSetRequest")
        };
