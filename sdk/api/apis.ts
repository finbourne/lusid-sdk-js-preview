...
export * from './checkDefinitionsApi';
import { CheckDefinitionsApi } from './checkDefinitionsApi';
...
export * from './currencyGroupsApi';
import { CurrencyGroupsApi } from './currencyGroupsApi';
...
export * from './entityResolversApi';
import { EntityResolversApi } from './entityResolversApi';
...
export * from './fundStructuresApi';
import { FundStructuresApi } from './fundStructuresApi';
...
export * from './marketDataFieldConfigurationApi';
import { MarketDataFieldConfigurationApi } from './marketDataFieldConfigurationApi';
...
export * from './paymentInstructionsApi';
import { PaymentInstructionsApi } from './paymentInstructionsApi';
...
export * from './relationalDatasetsApi';
import { RelationalDatasetsApi } from './relationalDatasetsApi';
...
export * from './resourceRecordApi';
import { ResourceRecordApi } from './resourceRecordApi';
...
export const APIS = [AborApi, AborConfigurationApi, AddressKeyAliasApi, AddressKeyDefinitionApi, AggregatedReturnsApi, AggregationApi, AllocationsApi, AmortisationRuleSetsApi, ApplicationMetadataApi, BlocksApi, CalendarsApi, ChartOfAccountsApi, CheckDefinitionsApi, ComplexMarketDataApi, ComplianceApi, ConfigurationRecipeApi, ConventionsApi, CorporateActionSourcesApi, CounterpartiesApi, CurrencyGroupsApi, CustomDataModelsApi, CustomEntitiesApi, CustomEntityDefinitionsApi, CustomEntityTypesApi, CutLabelDefinitionsApi, DataTypesApi, DerivedTransactionPortfoliosApi, EntitiesApi, EntityResolversApi, ExecutionsApi, FeeTypesApi, FundConfigurationApi, FundStructuresApi, FundsApi, GroupReconciliationsApi, IdentifierDefinitionsApi, InstrumentEventTypesApi, InstrumentEventsApi, InstrumentsApi, InvestmentAccountsApi, InvestorRecordsApi, LegacyComplianceApi, LegalEntitiesApi, MarketDataFieldConfigurationApi, OrderGraphApi, OrderInstructionsApi, OrderManagementApi, OrdersApi, PackagesApi, ParticipationsApi, PaymentInstructionsApi, PersonsApi, PlacementsApi, PortfolioGroupsApi, PortfoliosApi, PropertyDefinitionsApi, QueryableKeysApi, QuotesApi, ReconciliationsApi, RecsApi, ReferenceListsApi, ReferencePortfolioApi, RelationDefinitionsApi, RelationalDatasetDefinitionApi, RelationalDatasetsApi, RelationsApi, RelationshipDefinitionsApi, RelationshipsApi, ResourceRecordApi, ScenariosApi, SchemasApi, ScopesApi, ScriptedTranslationApi, SearchApi, SequencesApi, SettlementActivityApi, SimplePositionPortfoliosApi, StagedModificationsApi, StagingRuleSetApi, StructuredResultDataApi, SubscriptionsApi, SystemConfigurationApi, TaxRuleSetsApi, TimelinesApi, TransactionConfigurationApi, TransactionFeeTypesApi, TransactionFeesApi, TransactionPortfoliosApi, TransferAgencyApi, TransfersApi, TranslationApi, WithholdingTaxApi, WorkspaceApi];
