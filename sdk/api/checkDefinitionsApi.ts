...
import { CheckDefinition } from '../model/checkDefinition';
import { CreateCheckDefinitionRequest } from '../model/createCheckDefinitionRequest';
import { DeleteDataQualityRule } from '../model/deleteDataQualityRule';
...
import { PagedResourceListOfCheckDefinition } from '../model/pagedResourceListOfCheckDefinition';
import { RunCheckRequest } from '../model/runCheckRequest';
import { RunCheckResponse } from '../model/runCheckResponse';
import { UpdateCheckDefinitionRequest } from '../model/updateCheckDefinitionRequest';
import { UpsertDataQualityRule } from '../model/upsertDataQualityRule';
...
export enum CheckDefinitionsApiApiKeys {
}

export class CheckDefinitionsApi {
    ...
    public setApiKey(key: CheckDefinitionsApiApiKeys, value: string) {
        (this.authentications as any)[CheckDefinitionsApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EXPERIMENTAL] CreateCheckDefinition: Create a Check Definition
     * @param createCheckDefinitionRequest The request containing the details of the Check Definition
     */
    public async createCheckDefinition (createCheckDefinitionRequest?: CreateCheckDefinitionRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CheckDefinition;  }> {
        const localVarPath = this.basePath + '/api/dataquality/checkdefinitions';
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(createCheckDefinitionRequest, "CreateCheckDefinitionRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: CheckDefinition;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "CheckDefinition");
     ...
     * @summary [EXPERIMENTAL] DeleteCheckDefinition: Deletes a particular Check Definition
     * @param scope The scope of the specified Check Definition.
     * @param code The code of the specified Check Definition. Together with the domain and scope this uniquely              identifies the Check Definition.
     */
    public async deleteCheckDefinition (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/dataquality/checkdefinitions/{scope}/{code}'
        ...
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling deleteCheckDefinition.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling deleteCheckDefinition.');
        }
     ...
     * @summary [EXPERIMENTAL] DeleteRules: Delete rules on a particular Check Definition
     * @param scope The scope of the specified Check Definition.
     * @param code The code of the specified Check Definition. Together with the domain and scope this uniquely              identifies the Check Definition.
     * @param deleteDataQualityRule The request containing the rules to be deleted
     */
    public async deleteRules (scope: string, code: string, deleteDataQualityRule?: Array<DeleteDataQualityRule>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CheckDefinition;  }> {
        const localVarPath = this.basePath + '/api/dataquality/checkdefinitions/{scope}/{code}/$deleteRules'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling deleteRules.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling deleteRules.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(deleteDataQualityRule, "Array<DeleteDataQualityRule>")
        };
     ...
     * @summary [EXPERIMENTAL] GetCheckDefinition: Get a single Check Definition by scope and code.
     * @param scope The scope of the specified Check Definition.
     * @param code The code of the specified Check Definition. Together with the scope this uniquely              identifies the Check Definition.
     * @param asAt The asAt datetime at which to retrieve the Check Definition definition. Defaults to return              the latest version of the definition if not specified.
     * @param effectiveAt The effective datetime or cut label at which to retrieve the check definition properties.              Defaults to the current LUSID system datetime if not specified.
     * @param propertyKeys A list of property keys from the \&#39;CheckDefinition\&#39; domain to decorate onto              the Check Definition.              These must have the format {domain}/{scope}/{code}, for example \&#39;CheckDefinition/system/Name\&#39;.
     */
    public async getCheckDefinition (scope: string, code: string, asAt?: Date, effectiveAt?: string, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CheckDefinition;  }> {
        const localVarPath = this.basePath + '/api/dataquality/checkdefinitions/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling getCheckDefinition.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling getCheckDefinition.');
        }
     ...
     * @summary [EXPERIMENTAL] ListCheckDefinitions: List Check Definitions
     * @param asAt The asAt datetime at which to list the Check Definitions. Defaults to returning the latest version of each Check Definition if not specified.
     * @param effectiveAt The effective datetime or cut label at which to list the Check Definitions.              Note that Check Definitions are monotemporal, the effectiveAt is for Timevariant Properties on the Check Definition only.              Defaults to the current LUSID system datetime if not specified.
     ...
     * @param propertyKeys A list of property keys from the \&#39;CheckDefinition\&#39; domain to decorate onto each Check Definition.              These must take the format {domain}/{scope}/{code}, for example \&#39;CheckDefinition/Account/id\&#39;.
     */
    public async listCheckDefinitions (asAt?: Date, effectiveAt?: string, page?: string, limit?: number, filter?: string, sortBy?: Array<string>, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfCheckDefinition;  }> {
        const localVarPath = this.basePath + '/api/dataquality/checkdefinitions';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfCheckDefinition;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfCheckDefinition");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] RunCheckDefinition: Runs a Check Definition against given dataset.
     * @param scope Scope of the CheckDefinition to run.
     * @param code Code of the CheckDefinition to run.
     * @param runCheckRequest Run request defining what dataset to run against.
     */
    public async runCheckDefinition (scope: string, code: string, runCheckRequest?: RunCheckRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: RunCheckResponse;  }> {
        const localVarPath = this.basePath + '/api/dataquality/checkdefinitions/{scope}/{code}/$run'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling runCheckDefinition.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling runCheckDefinition.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(runCheckRequest, "RunCheckRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: RunCheckResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "RunCheckResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] UpdateCheckDefinition: Update Check Definition defined by scope and code
     * @param scope The scope of the specified Check Definition.
     * @param code The code of the specified Check Definition. Together with the domain and scope this uniquely identifies the Check Definition.
     * @param updateCheckDefinitionRequest The request containing the updated details of the Check Definition
     */
    public async updateCheckDefinition (scope: string, code: string, updateCheckDefinitionRequest?: UpdateCheckDefinitionRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CheckDefinition;  }> {
        const localVarPath = this.basePath + '/api/dataquality/checkdefinitions/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling updateCheckDefinition.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling updateCheckDefinition.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(updateCheckDefinitionRequest, "UpdateCheckDefinitionRequest")
        };
     ...
     * @summary [EXPERIMENTAL] UpsertRules: Upsert rules to a particular Check Definition
     * @param scope The scope of the specified Check Definition.
     * @param code The code of the specified Check Definition. Together with the domain and scope this uniquely              identifies the Check Definition.
     * @param upsertDataQualityRule The request containing the rules to be upserted
     */
    public async upsertRules (scope: string, code: string, upsertDataQualityRule?: Array<UpsertDataQualityRule>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CheckDefinition;  }> {
        const localVarPath = this.basePath + '/api/dataquality/checkdefinitions/{scope}/{code}/$upsertRules'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling upsertRules.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling upsertRules.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(upsertDataQualityRule, "Array<UpsertDataQualityRule>")
        };
