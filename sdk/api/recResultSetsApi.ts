...
import { PagedResourceListOfRecResultSet } from '../model/pagedResourceListOfRecResultSet';
import { RecResultSet } from '../model/recResultSet';
import { RecResultSetApprovalDecisionRequest } from '../model/recResultSetApprovalDecisionRequest';
import { SubmitRecResultSetReviewRequest } from '../model/submitRecResultSetReviewRequest';
...
export enum RecResultSetsApiApiKeys {
}

export class RecResultSetsApi {
    ...
    public setApiKey(key: RecResultSetsApiApiKeys, value: string) {
        (this.authentications as any)[RecResultSetsApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EXPERIMENTAL] AddRecResultSetApprovalDecision: AddRecResultSetApprovalDecision
     * @param entityUniqueId The entity unique id of the rec result set (its version.entityUniqueId).
     * @param recResultSetApprovalDecisionRequest The approval decision request.
     */
    public async addRecResultSetApprovalDecision (entityUniqueId: string, recResultSetApprovalDecisionRequest: RecResultSetApprovalDecisionRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: RecResultSet;  }> {
        const localVarPath = this.basePath + '/api/recs/resultsets/{entityUniqueId}/$decide'
        ...
        if (entityUniqueId === null || entityUniqueId === undefined) {
            throw new Error('Required parameter entityUniqueId was null or undefined when calling addRecResultSetApprovalDecision.');
        }

        // verify required parameter 'recResultSetApprovalDecisionRequest' is not null or undefined
        if (recResultSetApprovalDecisionRequest === null || recResultSetApprovalDecisionRequest === undefined) {
            throw new Error('Required parameter recResultSetApprovalDecisionRequest was null or undefined when calling addRecResultSetApprovalDecision.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(recResultSetApprovalDecisionRequest, "RecResultSetApprovalDecisionRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: RecResultSet;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "RecResultSet");
     ...
     * @summary [EXPERIMENTAL] GetRecResultSet: GetRecResultSet
     * @param entityUniqueId The entity unique id of the rec result set (its version.entityUniqueId).
     * @param asAt The asAt datetime at which to retrieve the result set. Defaults to latest if not specified.
     * @param includePreviousRuns When true, the previousRuns array is populated with prior run snapshots. Defaults to false.
     */
    public async getRecResultSet (entityUniqueId: string, asAt?: Date, includePreviousRuns?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: RecResultSet;  }> {
        const localVarPath = this.basePath + '/api/recs/resultsets/{entityUniqueId}'
            .replace('{' + 'entityUniqueId' + '}', encodeURIComponent(String(entityUniqueId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        // verify required parameter 'entityUniqueId' is not null or undefined
        if (entityUniqueId === null || entityUniqueId === undefined) {
            throw new Error('Required parameter entityUniqueId was null or undefined when calling getRecResultSet.');
        }
        ...
        if (includePreviousRuns !== undefined) {
            localVarQueryParameters['includePreviousRuns'] = ObjectSerializer.serialize(includePreviousRuns, "boolean");
        }
     ...
     * @summary [EXPERIMENTAL] ListRecResultSets: ListRecResultSets
     * @param asAt The asAt datetime at which to list result sets. Defaults to latest if not specified.
     * @param includePreviousRuns When true, each item\&#39;s previousRuns array is populated with prior run snapshots. Defaults to false.
     ...
     */
    public async listRecResultSets (asAt?: Date, includePreviousRuns?: boolean, page?: string, limit?: number, filter?: string, sortBy?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfRecResultSet;  }> {
        const localVarPath = this.basePath + '/api/recs/resultsets';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfRecResultSet;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfRecResultSet");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] SubmitRecResultSetReview: Submit a rec result set review for approval, or resubmit after addressing requested revisions.
     * @param entityUniqueId The entity unique id of the rec result set (its version.entityUniqueId).
     * @param submitRecResultSetReviewRequest The submission request.
     */
    public async submitRecResultSetReview (entityUniqueId: string, submitRecResultSetReviewRequest: SubmitRecResultSetReviewRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: RecResultSet;  }> {
        const localVarPath = this.basePath + '/api/recs/resultsets/{entityUniqueId}/$submit'
            .replace('{' + 'entityUniqueId' + '}', encodeURIComponent(String(entityUniqueId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        // verify required parameter 'entityUniqueId' is not null or undefined
        if (entityUniqueId === null || entityUniqueId === undefined) {
            throw new Error('Required parameter entityUniqueId was null or undefined when calling submitRecResultSetReview.');
        }

        // verify required parameter 'submitRecResultSetReviewRequest' is not null or undefined
        if (submitRecResultSetReviewRequest === null || submitRecResultSetReviewRequest === undefined) {
            throw new Error('Required parameter submitRecResultSetReviewRequest was null or undefined when calling submitRecResultSetReview.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(submitRecResultSetReviewRequest, "SubmitRecResultSetReviewRequest")
        };
