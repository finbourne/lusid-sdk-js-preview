...
import { TransactionTemplateResponse } from '../model/transactionTemplateResponse';
...
export class InstrumentEventTypesApi {
     ...
     */
    public async createTransactionTemplate (instrumentEventType: string, instrumentType: string, scope: string, transactionTemplateRequest: TransactionTemplateRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TransactionTemplateResponse;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: TransactionTemplateResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "TransactionTemplateResponse");
