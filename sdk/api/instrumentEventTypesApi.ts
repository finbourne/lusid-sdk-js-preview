...
export class InstrumentEventTypesApi {
     ...
     * @summary [EARLY ACCESS] GetTransactionTemplateSpecification: Get Transaction Template Specification.
     ...
     * @summary [EARLY ACCESS] ListTransactionTemplateSpecifications: List Transaction Template Specifications.
