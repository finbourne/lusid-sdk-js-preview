...
export enum InstrumentEventTypesApiApiKeys {
}

export class InstrumentEventTypesApi {
    ...
    public setApiKey(key: InstrumentEventTypesApiApiKeys, value: string) {
        (this.authentications as any)[InstrumentEventTypesApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EXPERIMENTAL] CreateTransactionTemplate: Create Transaction Template
     ...
     */
    public async createTransactionTemplate (instrumentEventType: string, instrumentType: string, scope: string, transactionTemplateRequest: TransactionTemplateRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TransactionTemplate;  }> {
        const localVarPath = this.basePath + '/api/instrumenteventtypes/{instrumentEventType}/transactiontemplates/{instrumentType}/{scope}'
            .replace('{' + 'instrumentEventType' + '}', encodeURIComponent(String(instrumentEventType)))
        ...
        // verify required parameter 'instrumentEventType' is not null or undefined
        ...
        // verify required parameter 'transactionTemplateRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(transactionTemplateRequest, "TransactionTemplateRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: TransactionTemplate;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "TransactionTemplate");
     ...
     * @summary [EXPERIMENTAL] DeleteTransactionTemplate: Delete Transaction Template
     * @param instrumentEventType The type of instrument events that the template is applied to.
     * @param instrumentType The instrument type of the transaction template. The combination of the instrument              event type, instrument type and scope uniquely identifies a transaction template
     * @param scope The scope of the template.
     */
    public async deleteTransactionTemplate (instrumentEventType: string, instrumentType: string, scope: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Date;  }> {
        const localVarPath = this.basePath + '/api/instrumenteventtypes/{instrumentEventType}/transactiontemplates/{instrumentType}/{scope}'
            .replace('{' + 'instrumentEventType' + '}', encodeURIComponent(String(instrumentEventType)))
            .replace('{' + 'instrumentType' + '}', encodeURIComponent(String(instrumentType)))
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)));
     ...
     * @summary [EXPERIMENTAL] GetTransactionTemplate: Get Transaction Template
     ...
     */
    public async getTransactionTemplate (instrumentEventType: string, instrumentType: string, scope: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TransactionTemplate;  }> {
        const localVarPath = this.basePath + '/api/instrumenteventtypes/{instrumentEventType}/transactiontemplates/{instrumentType}/{scope}'
            .replace('{' + 'instrumentEventType' + '}', encodeURIComponent(String(instrumentEventType)))
            .replace('{' + 'instrumentType' + '}', encodeURIComponent(String(instrumentType)))
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)));
     ...
     * @summary [EXPERIMENTAL] GetTransactionTemplateSpecification: Get Transaction Template Specification.
     * @param instrumentEventType The requested instrument event type.
     */
    public async getTransactionTemplateSpecification (instrumentEventType: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TransactionTemplateSpecification;  }> {
        const localVarPath = this.basePath + '/api/instrumenteventtypes/{instrumentEventType}/transactiontemplatespecification'
            .replace('{' + 'instrumentEventType' + '}', encodeURIComponent(String(instrumentEventType)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: TransactionTemplateSpecification;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "TransactionTemplateSpecification");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] ListTransactionTemplateSpecifications: List Transaction Template Specifications.
     ...
     */
    public async listTransactionTemplateSpecifications (asAt?: Date, page?: string, limit?: number, filter?: string, sortBy?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfTransactionTemplateSpecification;  }> {
        const localVarPath = this.basePath + '/api/instrumenteventtypes/transactiontemplatespecifications';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfTransactionTemplateSpecification;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfTransactionTemplateSpecification");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] ListTransactionTemplates: List Transaction Templates
     ...
     * @param sortBy A list of field names to sort by, each suffixed by \&quot; ASC\&quot; or \&quot; DESC\&quot;
     */
    public async listTransactionTemplates (asAt?: Date, page?: string, limit?: number, filter?: string, sortBy?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfTransactionTemplate;  }> {
        const localVarPath = this.basePath + '/api/instrumenteventtypes/transactiontemplates';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfTransactionTemplate;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfTransactionTemplate");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] UpdateTransactionTemplate: Update Transaction Template
     * @param instrumentEventType The type of instrument events that the template is applied to.
     * @param instrumentType The instrument type of the transaction template. The combination of the instrument              event type, instrument type and scope uniquely identifies a transaction template
     * @param scope The scope in which the template lies.
     * @param transactionTemplateRequest A request defining the updated values for the transaction template.
     */
    public async updateTransactionTemplate (instrumentEventType: string, instrumentType: string, scope: string, transactionTemplateRequest: TransactionTemplateRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TransactionTemplate;  }> {
        const localVarPath = this.basePath + '/api/instrumenteventtypes/{instrumentEventType}/transactiontemplates/{instrumentType}/{scope}'
            .replace('{' + 'instrumentEventType' + '}', encodeURIComponent(String(instrumentEventType)))
            .replace('{' + 'instrumentType' + '}', encodeURIComponent(String(instrumentType)))
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)));
