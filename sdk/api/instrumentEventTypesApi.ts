...
export class InstrumentEventTypesApi {
     ...
     * @param instrumentType The requested instrument type.
     * @param instrumentEventType The requested instrument event type.
     */
    public async getTransactionTemplateSpecification (instrumentType: string, instrumentEventType: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TransactionTemplateSpecification;  }> {
        const localVarPath = this.basePath + '/api/instrumenteventtypes/{instrumentEventType}/transactiontemplatespecification/{instrumentType}'
            .replace('{' + 'instrumentType' + '}', encodeURIComponent(String(instrumentType)))
            .replace('{' + 'instrumentEventType' + '}', encodeURIComponent(String(instrumentEventType)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'instrumentType' is not null or undefined
        if (instrumentType === null || instrumentType === undefined) {
            throw new Error('Required parameter instrumentType was null or undefined when calling getTransactionTemplateSpecification.');
        }
