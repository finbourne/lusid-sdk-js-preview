...
export class TransactionFeesApi {
     ...
     */
    public async deleteTransactionFeeRule (code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
