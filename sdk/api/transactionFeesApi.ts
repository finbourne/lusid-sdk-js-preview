...
export enum TransactionFeesApiApiKeys {
}

export class TransactionFeesApi {
    ...
    public setApiKey(key: TransactionFeesApiApiKeys, value: string) {
        (this.authentications as any)[TransactionFeesApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EXPERIMENTAL] DeleteFeeRule: Deletes a fee rule.
     * @param code The fee rule code.
     */
    public async deleteFeeRule (code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/transactions/fees/rules/{code}'
        ...
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling deleteFeeRule.');
        }
     ...
     * @summary [EXPERIMENTAL] GetApplicableTransactionFees: Get the Fees and Commissions that may be applicable to a transaction.
     ...
     */
    public async getApplicableTransactionFees (effectiveAt?: string, asAt?: Date, instrumentIdentifierType?: string, instrumentIdentifier?: string, portfolioScope?: string, portfolioCode?: string, requestBody?: { [key: string]: string; }, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfFeeRule;  }> {
        const localVarPath = this.basePath + '/api/transactions/fees/$GetApplicableFees';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
     ...
     * @summary [EXPERIMENTAL] GetTransactionFeeRule: Retrieve the definition of single fee rule.
     * @param code The fee rule code.
     ...
     */
    public async getTransactionFeeRule (code: string, effectiveAt?: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FeeRule;  }> {
        const localVarPath = this.basePath + '/api/transactions/fees/rules/{code}'
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @summary [EXPERIMENTAL] ListTransactionFeeRules: List fee rules, with optional filtering.
     ...
     */
    public async listTransactionFeeRules (effectiveAt?: string, asAt?: Date, limit?: number, filter?: string, page?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfFeeRule;  }> {
        const localVarPath = this.basePath + '/api/transactions/fees/rules';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
     ...
     */
    public async upsertTransactionFeeRules (requestBody: { [key: string]: FeeRuleUpsertRequest; }, effectiveAt?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FeeRuleUpsertResponse;  }> {
        const localVarPath = this.basePath + '/api/transactions/fees/rules';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
