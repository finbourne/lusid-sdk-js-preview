...
export class CutLabelDefinitionsApi {
     ...
     */
    public async listCutLabelDefinitions (asAt?: Date, sortBy?: Array<string>, limit?: number, filter?: string, page?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfCutLabelDefinition;  }> {
        const localVarPath = this.basePath + '/api/systemconfiguration/cutlabels';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
