...
export class LegalEntitiesApi {
     ...
     * @summary DeleteLegalEntity: Delete Legal Entity
     ...
     * @summary DeleteLegalEntityAccessMetadata: Delete a Legal Entity Access Metadata entry
     ...
     */
    public async deleteLegalEntityAccessMetadata (idTypeScope: string, idTypeCode: string, code: string, metadataKey: string, effectiveAt?: string, effectiveUntil?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
     ...
     */
    public async deleteLegalEntityIdentifiers (idTypeScope: string, idTypeCode: string, code: string, propertyKeys: Array<string>, effectiveAt?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/legalentities/{idTypeScope}/{idTypeCode}/{code}/identifiers'
            .replace('{' + 'idTypeScope' + '}', encodeURIComponent(String(idTypeScope)))
            .replace('{' + 'idTypeCode' + '}', encodeURIComponent(String(idTypeCode)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
     ...
     * @summary GetAllLegalEntityAccessMetadata: Get Access Metadata rules for a Legal Entity
     * @param idTypeScope Scope of the Legal Entity identifier.
     * @param idTypeCode Code of the Legal Entity identifier.
     * @param code Code of the Legal Entity under specified identifier type\&#39;s scope and code.
     ...
     * @summary GetLegalEntity: Get Legal Entity
     * @param idTypeScope Scope of the legal entity identifier type.
     * @param idTypeCode Code of the legal entity identifier type.
     * @param code Code of the legal entity under specified identifier type\&#39;s scope and code. This together with stated identifier type uniquely              identifies the legal entity.
     ...
     */
    public async getLegalEntity (idTypeScope: string, idTypeCode: string, code: string, propertyKeys?: Array<string>, effectiveAt?: string, asAt?: Date, relationshipDefinitionIds?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: LegalEntity;  }> {
        const localVarPath = this.basePath + '/api/legalentities/{idTypeScope}/{idTypeCode}/{code}'
            .replace('{' + 'idTypeScope' + '}', encodeURIComponent(String(idTypeScope)))
            .replace('{' + 'idTypeCode' + '}', encodeURIComponent(String(idTypeCode)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
     ...
     * @summary GetLegalEntityPropertyTimeSeries: Get Legal Entity Property Time Series
     * @param idTypeScope Scope of the legal entity identifier type.
     * @param idTypeCode Code of the legal entity identifier type.
     * @param code Code of the legal entity under specified identifier type\&#39;s scope and code. This together with stated identifier type uniquely identifies the legal entity.
     ...
     * @summary GetLegalEntityRelations: Get Relations for Legal Entity
     * @param idTypeScope Scope of the legal entity identifier type.
     * @param idTypeCode Code of the legal entity identifier type.
     * @param code Code of the legal entity under specified identifier type\&#39;s scope and code. This together with stated identifier type uniquely              identifies the legal entity.
     ...
     * @summary GetLegalEntityRelationships: Get Relationships for Legal Entity
     ...
     * @summary ListAllLegalEntities: List Legal Entities
     ...
     */
    public async listAllLegalEntities (effectiveAt?: string, asAt?: Date, page?: string, limit?: number, filter?: string, sortBy?: Array<string>, propertyKeys?: Array<string>, relationshipDefinitionIds?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfLegalEntity;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ResourceListOfLegalEntity;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ResourceListOfLegalEntity");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary ListLegalEntities: List Legal Entities
     * @param idTypeScope Scope of the legal entity identifier type.
     * @param idTypeCode Code of the legal entity identifier type.
     ...
     * @param relationshipDefinitionIds A list of relationship definitions that are used to decorate related entities              onto each portfolio in the response. These must take the form {relationshipDefinitionScope}/{relationshipDefinitionCode}.
     */
    public async listLegalEntities (idTypeScope: string, idTypeCode: string, effectiveAt?: string, asAt?: Date, page?: string, limit?: number, filter?: string, sortBy?: Array<string>, propertyKeys?: Array<string>, relationshipDefinitionIds?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfLegalEntity;  }> {
     ...
     */
    public async setLegalEntityIdentifiers (idTypeScope: string, idTypeCode: string, code: string, setLegalEntityIdentifiersRequest: SetLegalEntityIdentifiersRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: LegalEntity;  }> {
        const localVarPath = this.basePath + '/api/legalentities/{idTypeScope}/{idTypeCode}/{code}/identifiers'
            .replace('{' + 'idTypeScope' + '}', encodeURIComponent(String(idTypeScope)))
            .replace('{' + 'idTypeCode' + '}', encodeURIComponent(String(idTypeCode)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(setLegalEntityIdentifiersRequest, "SetLegalEntityIdentifiersRequest")
        };
     ...
     * @summary SetLegalEntityProperties: Set Legal Entity Properties
     * @param idTypeScope Scope of the legal entity identifier type.
     * @param idTypeCode Code of the legal entity identifier type.
     * @param code Code of the legal entity under specified identifier type\&#39;s scope and code. This together with stated identifier type uniquely              identifies the legal entity.
     ...
     */
    public async setLegalEntityProperties (idTypeScope: string, idTypeCode: string, code: string, setLegalEntityPropertiesRequest: SetLegalEntityPropertiesRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: LegalEntity;  }> {
        const localVarPath = this.basePath + '/api/legalentities/{idTypeScope}/{idTypeCode}/{code}/properties'
            .replace('{' + 'idTypeScope' + '}', encodeURIComponent(String(idTypeScope)))
            .replace('{' + 'idTypeCode' + '}', encodeURIComponent(String(idTypeCode)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(setLegalEntityPropertiesRequest, "SetLegalEntityPropertiesRequest")
        };
     ...
     * @summary [EARLY ACCESS] UpsertLegalEntities: Batch upsert Legal Entities
     ...
     */
    public async upsertLegalEntities (successMode: string, requestBody: { [key: string]: UpsertLegalEntityRequest; }, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UpsertLegalEntitiesResponse;  }> {
        const localVarPath = this.basePath + '/api/legalentities/$batchUpsert';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(requestBody, "{ [key: string]: UpsertLegalEntityRequest; }")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: UpsertLegalEntitiesResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "UpsertLegalEntitiesResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary UpsertLegalEntity: Upsert Legal Entity
     ...
     * @summary UpsertLegalEntityAccessMetadata: Upsert a Legal Entity Access Metadata entry associated with a specific metadataKey. This creates or updates the data in LUSID.
     * @param idTypeScope Scope of the Legal Entity identifier.
     * @param idTypeCode Code of the Legal Entity identifier.
     * @param code Code of the Legal Entity under specified identifier type\&#39;s scope and code.
     * @param metadataKey Key of the metadata entry to retrieve
     ...
     * @param effectiveUntil The effective datetime until which the Access Metadata is valid. If not supplied this will be valid indefinitely, or until the next \&#39;effectiveAt\&#39; datetime of the Access Metadata
     */
    public async upsertLegalEntityAccessMetadata (idTypeScope: string, idTypeCode: string, code: string, metadataKey: string, upsertLegalEntityAccessMetadataRequest: UpsertLegalEntityAccessMetadataRequest, effectiveAt?: string, effectiveUntil?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfAccessMetadataValueOf;  }> {
        const localVarPath = this.basePath + '/api/legalentities/{idTypeScope}/{idTypeCode}/{code}/metadata/{metadataKey}'
            .replace('{' + 'idTypeScope' + '}', encodeURIComponent(String(idTypeScope)))
            .replace('{' + 'idTypeCode' + '}', encodeURIComponent(String(idTypeCode)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
