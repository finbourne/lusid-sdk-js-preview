...
export class LegalEntitiesApi {
     ...
     * @summary [EXPERIMENTAL] DeleteLegalEntityAccessMetadata: Delete a Legal Entity Access Metadata entry
     ...
     * @summary [EXPERIMENTAL] GetAllLegalEntityAccessMetadata: Get Access Metadata rules for a Legal Entity
     * @param idTypeScope Scope of the Legal Entity identifier.
     * @param idTypeCode Code of the Legal Entity identifier.
     * @param code Code of the Legal Entity under specified identifier type\&#39;s scope and code.
     ...
     * @summary [EXPERIMENTAL] GetLegalEntityAccessMetadataByKey: Get an entry identified by a metadataKey in the Access Metadata of a Legal Entity
     * @param idTypeScope Scope of the Legal Entity identifier.
     * @param idTypeCode Code of the Legal Entity identifier.
     * @param code Code of the Legal Entity under specified identifier type\&#39;s scope and code.
     * @param metadataKey Key of the metadata entry to retrieve
     ...
     * @summary [EXPERIMENTAL] UpsertLegalEntityAccessMetadata: Upsert a Legal Entity Access Metadata entry associated with a specific metadataKey. This creates or updates the data in LUSID.
     * @param idTypeScope Scope of the Legal Entity identifier.
     * @param idTypeCode Code of the Legal Entity identifier.
     * @param code Code of the Legal Entity under specified identifier type\&#39;s scope and code.
     * @param metadataKey Key of the metadata entry to retrieve
