...
export class LegalEntitiesApi {
     ...
     * @summary [EXPERIMENTAL] GetLegalEntityRelationships: Get Relationships for Legal Entity
     ...
     * @summary [EXPERIMENTAL] ListAllLegalEntities: List Legal Entities
     ...
     */
    public async listAllLegalEntities (effectiveAt?: string, asAt?: Date, page?: string, limit?: number, filter?: string, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfLegalEntity;  }> {
     ...
     */
    public async patchLegalEntityAccessMetadata (idTypeScope: string, idTypeCode: string, code: string, operation: Array<Operation>, effectiveAt?: string, effectiveUntil?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: { [key: string]: Array<AccessMetadataValue>; };  }> {
        const localVarPath = this.basePath + '/api/legalentities/{idTypeScope}/{idTypeCode}/{code}/metadata'
            .replace('{' + 'idTypeScope' + '}', encodeURIComponent(String(idTypeScope)))
            .replace('{' + 'idTypeCode' + '}', encodeURIComponent(String(idTypeCode)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        ...
        if (operation === null || operation === undefined) {
            throw new Error('Required parameter operation was null or undefined when calling patchLegalEntityAccessMetadata.');
        }
