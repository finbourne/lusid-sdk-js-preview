...
import { WeightedAllocationServiceRunRequest } from '../model/weightedAllocationServiceRunRequest';
...
export enum OrderManagementApiApiKeys {
}
...
export class OrderManagementApi {
    ...
    public setApiKey(key: OrderManagementApiApiKeys, value: string) {
        (this.authentications as any)[OrderManagementApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary BookTransactions: Books transactions using specific allocations as a source.
     ...
     * @param markOrdersAndAllocationsAsBooked Whether to mark allocations and fully-booked orders with state Booked
     */
    public async bookTransactions (bookTransactionsRequest: BookTransactionsRequest, applyFeesAndCommission?: boolean, markOrdersAndAllocationsAsBooked?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BookTransactionsResponse;  }> {
        const localVarPath = this.basePath + '/api/ordermanagement/booktransactions';
        ...
        // verify required parameter 'bookTransactionsRequest' is not null or undefined
        ...
        if (applyFeesAndCommission !== undefined) {
            localVarQueryParameters['applyFeesAndCommission'] = ObjectSerializer.serialize(applyFeesAndCommission, "boolean");
        }

        if (markOrdersAndAllocationsAsBooked !== undefined) {
            localVarQueryParameters['markOrdersAndAllocationsAsBooked'] = ObjectSerializer.serialize(markOrdersAndAllocationsAsBooked, "boolean");
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(bookTransactionsRequest, "BookTransactionsRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: BookTransactionsResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "BookTransactionsResponse");
     ...
     * @summary [EARLY ACCESS] CancelOrders: Cancel existing orders
     * @param requestBody The request containing the ids of the orders to be cancelled.
     */
    public async cancelOrders (requestBody: { [key: string]: ResourceId; }, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CancelOrdersResponse;  }> {
        const localVarPath = this.basePath + '/api/ordermanagement/cancelorders';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(requestBody, "{ [key: string]: ResourceId; }")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: CancelOrdersResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "CancelOrdersResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] CancelOrdersAndMoveRemaining: Cancel existing orders and move any unplaced quantities to new orders in new blocks
     * @param requestBody The request containing the orders to be cancelled, and the destinations of remaining quantities.
     */
    public async cancelOrdersAndMoveRemaining (requestBody: { [key: string]: CancelOrdersAndMoveRemainingRequest; }, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CancelOrdersAndMoveRemainingResponse;  }> {
        const localVarPath = this.basePath + '/api/ordermanagement/cancelordersandmoveremaining';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(requestBody, "{ [key: string]: CancelOrdersAndMoveRemainingRequest; }")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: CancelOrdersAndMoveRemainingResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "CancelOrdersAndMoveRemainingResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] CancelPlacements: Cancel existing placements
     * @param requestBody The request containing the ids of the placements to be cancelled.
     */
    public async cancelPlacements (requestBody: { [key: string]: ResourceId; }, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CancelPlacementsResponse;  }> {
        const localVarPath = this.basePath + '/api/ordermanagement/$cancelplacements';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: CancelPlacementsResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "CancelPlacementsResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary CreateOrders: Upsert a Block and associated orders
     * @param blockAndOrdersCreateRequest The collection of block and orders requests.
     */
    public async createOrders (blockAndOrdersCreateRequest: BlockAndOrdersCreateRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfBlockAndOrders;  }> {
        const localVarPath = this.basePath + '/api/ordermanagement/createorders';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'blockAndOrdersCreateRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(blockAndOrdersCreateRequest, "BlockAndOrdersCreateRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ResourceListOfBlockAndOrders;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ResourceListOfBlockAndOrders");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary GetOrderHistory: Get the history of an order and related entity changes
     ...
     */
    public async getOrderHistory (scope: string, code: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfChangeIntervalWithOrderManagementDetail;  }> {
        const localVarPath = this.basePath + '/api/ordermanagement/order/{scope}/{code}/$history'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ResourceListOfChangeIntervalWithOrderManagementDetail;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ResourceListOfChangeIntervalWithOrderManagementDetail");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] MoveOrders: Move orders to new or existing block
     * @param moveOrdersToDifferentBlocksRequest The collection of order and destination block ids.
     */
    public async moveOrders (moveOrdersToDifferentBlocksRequest: MoveOrdersToDifferentBlocksRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfMovedOrderToDifferentBlockResponse;  }> {
        const localVarPath = this.basePath + '/api/ordermanagement/moveorders';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'moveOrdersToDifferentBlocksRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(moveOrdersToDifferentBlocksRequest, "MoveOrdersToDifferentBlocksRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ResourceListOfMovedOrderToDifferentBlockResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ResourceListOfMovedOrderToDifferentBlockResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] PlaceBlocks: Places blocks for a given list of placement requests.
     * @param placeBlocksRequest The request containing the blocks to the placed.
     */
    public async placeBlocks (placeBlocksRequest?: PlaceBlocksRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfPlacement;  }> {
        const localVarPath = this.basePath + '/api/ordermanagement/placeblocks';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(placeBlocksRequest, "PlaceBlocksRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ResourceListOfPlacement;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ResourceListOfPlacement");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary RunAllocationService: Runs the Allocation Service
     ...
     */
    public async runAllocationService (resourceId: Array<ResourceId>, allocationAlgorithm?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AllocationServiceRunResponse;  }> {
        const localVarPath = this.basePath + '/api/ordermanagement/allocate';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        if (allocationAlgorithm !== undefined) {
            localVarQueryParameters['allocationAlgorithm'] = ObjectSerializer.serialize(allocationAlgorithm, "string");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: AllocationServiceRunResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "AllocationServiceRunResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] RunAllocationServiceWithWeights: Runs the Allocation Service with portfolio weights
     * @param weightedAllocationServiceRunRequest The placement IDs to allocate against, and the portfolio weights to use for the allocation split.
     * @param allocationAlgorithm A string representation of the allocation algorithm you would like to use to allocate shares from executions e.g. \&quot;PR-LF\&quot;.  Allocating with weights means the base algorithm is always pro-rata, and the orphan allocation algorithm is either Largest First or Smallest First.  This defaults to \&quot;PR-LF\&quot;. Valid values are \&quot;PR-LF\&quot;, \&quot;PR-SF\&quot;, \&quot;LF\&quot;, \&quot;SF\&quot;.
     */
    public async runAllocationServiceWithWeights (weightedAllocationServiceRunRequest: WeightedAllocationServiceRunRequest, allocationAlgorithm?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AllocationServiceRunResponse;  }> {
        const localVarPath = this.basePath + '/api/ordermanagement/allocate/weighted';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'weightedAllocationServiceRunRequest' is not null or undefined
        if (weightedAllocationServiceRunRequest === null || weightedAllocationServiceRunRequest === undefined) {
            throw new Error('Required parameter weightedAllocationServiceRunRequest was null or undefined when calling runAllocationServiceWithWeights.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(weightedAllocationServiceRunRequest, "WeightedAllocationServiceRunRequest")
        };
     ...
     * @summary [EXPERIMENTAL] SweepBlocks: Sweeps specified blocks, for each block that meets the requirements. The request may be partially successful.
     * @param sweepBlocksRequest 
     */
    public async sweepBlocks (sweepBlocksRequest: SweepBlocksRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: SweepBlocksResponse;  }> {
        const localVarPath = this.basePath + '/api/ordermanagement/SweepBlocks';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'sweepBlocksRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(sweepBlocksRequest, "SweepBlocksRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: SweepBlocksResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "SweepBlocksResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] UpdateOrders: Update existing orders
     * @param requestBody The request containing the orders to be updated.
     */
    public async updateOrders (requestBody: { [key: string]: OrderUpdateRequest; }, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UpdateOrdersResponse;  }> {
        const localVarPath = this.basePath + '/api/ordermanagement/updateorders';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(requestBody, "{ [key: string]: OrderUpdateRequest; }")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: UpdateOrdersResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "UpdateOrdersResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] UpdatePlacements: Update existing placements
     * @param requestBody The request containing the placements to be updated.
     */
    public async updatePlacements (requestBody: { [key: string]: PlacementUpdateRequest; }, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UpdatePlacementsResponse;  }> {
        const localVarPath = this.basePath + '/api/ordermanagement/$updateplacements';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(requestBody, "{ [key: string]: PlacementUpdateRequest; }")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: UpdatePlacementsResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "UpdatePlacementsResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
