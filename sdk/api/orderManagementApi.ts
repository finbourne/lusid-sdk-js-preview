 ...
 *
 * The version of the OpenAPI document: 2.0.1143
...
export class OrderManagementApi {
     ...
     * @summary [EXPERIMENTAL] BookTransactions: Books transactions using specific allocations as a source.
     ...
     * @param usePreviewTransactionsForPricing Whether to use calculators for the transaction type to work out pricing fields on the booked transactions
     */
    public async bookTransactions (bookTransactionsRequest: BookTransactionsRequest, applyFeesAndCommission?: boolean, markOrdersAndAllocationsAsBooked?: boolean, usePreviewTransactionsForPricing?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BookTransactionsResponse;  }> {
        ...
        if (usePreviewTransactionsForPricing !== undefined) {
            localVarQueryParameters['usePreviewTransactionsForPricing'] = ObjectSerializer.serialize(usePreviewTransactionsForPricing, "boolean");
        }
     ...
     * @summary [EARLY ACCESS] CreateOrders: Upsert a Block and associated orders
     ...
     * @summary [EXPERIMENTAL] GetOrderHistory: Get the history of an order and related entity changes
     ...
     * @summary [EXPERIMENTAL] RunAllocationService: Runs the Allocation Service
