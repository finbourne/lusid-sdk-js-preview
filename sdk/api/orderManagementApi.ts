...
export class OrderManagementApi {
     ...
     */
    public async bookTransactions (resourceId: Array<ResourceId>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BookTransactionsResponse;  }> {
