...
export class OrderManagementApi {
     ...
     */
    public async bookTransactions (bookTransactionsRequest: BookTransactionsRequest, applyFeesAndCommission?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BookTransactionsResponse;  }> {
