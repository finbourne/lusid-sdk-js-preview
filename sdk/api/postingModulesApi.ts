...
export enum PostingModulesApiApiKeys {
}

export class PostingModulesApi {
    ...
    public setApiKey(key: PostingModulesApiApiKeys, value: string) {
        (this.authentications as any)[PostingModulesApiApiKeys[key]].apiKey = value;
    }
     ...
     * @param scope The scope of the Posting Module.
     * @param postingModuleRequest The definition of the Posting Module.
     */
    public async createPostingModule (scope: string, postingModuleRequest: PostingModuleRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PostingModuleCreateResponse;  }> {
        const localVarPath = this.basePath + '/api/postingmodule/{scope}'
     ...
     * @summary [EXPERIMENTAL] DeletePostingModule: Delete a PostingModule.
     * @param scope The scope of the PostingModule to be deleted.
     * @param code The code of the PostingModule to be deleted. Together with the scope this uniquely identifies the PostingModule.
     */
    public async deletePostingModule (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/postingmodule/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
     ...
     * @param scope The scope of the posting module.
     * @param code The code of the posting module. Together with the scope this uniquely identifies              the Posting Module.
     ...
     */
    public async listPostingModuleRules (scope: string, code: string, asAt?: Date, page?: string, start?: number, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfPostingModuleRule;  }> {
        const localVarPath = this.basePath + '/api/postingmodule/{scope}/{code}/postingrules'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @param start When paginating, skip this number of results.
     * @param limit When paginating, limit the results to this number. Defaults to 100 if not specified.
     * @param filter Expression to filter the results.              For example, to filter on the PostingModule type, specify \&quot;id.Code eq \&#39;001\&#39;\&quot;. For more information about filtering              results, see https://support.lusid.com/knowledgebase/article/KA-01914.
     */
    public async listPostingModules (asAt?: Date, page?: string, start?: number, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfPostingModuleResponse;  }> {
        const localVarPath = this.basePath + '/api/postingmodule';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
     ...
     * @summary [EXPERIMENTAL] UpdatePostingModuleDetails: Update a Posting Module details
     * @param scope The scope of the Posting Module to be updated.
     * @param code The code of the Posting Module to be updated. Together with the scope this uniquely identifies the Posting Module.
     * @param postingModuleDetails The details to be updated for the posting module.
     */
    public async updatePostingModuleDetails (scope: string, code: string, postingModuleDetails: PostingModuleDetails, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PostingModuleResponse;  }> {
        const localVarPath = this.basePath + '/api/postingmodule/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling updatePostingModuleDetails.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling updatePostingModuleDetails.');
        }
        ...
        if (postingModuleDetails === null || postingModuleDetails === undefined) {
            throw new Error('Required parameter postingModuleDetails was null or undefined when calling updatePostingModuleDetails.');
        }
     ...
     * @summary [EXPERIMENTAL] UpdatePostingModuleRules: Update a Posting Modules rules
     * @param scope The scope of the Posting Module to be updated.
     * @param code The code of the Posting Module to be updated. Together with the scope this uniquely identifies the Posting Module.
     * @param postingModuleRule The new rule set to be updated for the posting module.
     */
    public async updatePostingModuleRules (scope: string, code: string, postingModuleRule: Array<PostingModuleRule>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PostingModuleRulesUpdatedResponse;  }> {
        const localVarPath = this.basePath + '/api/postingmodule/{scope}/{code}/postingrules'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling updatePostingModuleRules.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling updatePostingModuleRules.');
        }
        ...
        if (postingModuleRule === null || postingModuleRule === undefined) {
            throw new Error('Required parameter postingModuleRule was null or undefined when calling updatePostingModuleRules.');
        }
