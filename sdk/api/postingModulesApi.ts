...
export class PostingModulesApi {
     ...
     * @param scope The scope of the Posting Module to be deleted.
     * @param code The code of the Posting Module to be deleted. Together with the scope this uniquely identifies the Posting Module.
     */
