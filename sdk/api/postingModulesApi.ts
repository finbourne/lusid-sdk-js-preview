...
export class PostingModulesApi {
     ...
     */
    public async setPostingModuleDetails (scope: string, code: string, postingModuleDetails: PostingModuleDetails, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PostingModuleResponse;  }> {
        const localVarPath = this.basePath + '/api/postingmodule/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
     ...
     */
    public async setPostingModuleRules (scope: string, code: string, postingModuleRule: Array<PostingModuleRule>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PostingModuleRulesUpdatedResponse;  }> {
        const localVarPath = this.basePath + '/api/postingmodule/{scope}/{code}/postingrules'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
