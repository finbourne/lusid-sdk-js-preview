...
export class SchemasApi {
     ...
     */
    public async getValueTypes (sortBy?: Array<string>, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfValueType;  }> {
