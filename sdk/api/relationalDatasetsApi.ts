...
export class RelationalDatasetsApi {
     ...
     */
    public async queryRelationalData (relationalDatasetDefinitionScope: string, relationalDatasetDefinitionCode: string, queryRelationalDatasetRequest: QueryRelationalDatasetRequest, asAt?: Date, effectiveAt?: string, page?: string, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfRelationalDataPointResponse;  }> {
        ...
        // verify required parameter 'queryRelationalDatasetRequest' is not null or undefined
        if (queryRelationalDatasetRequest === null || queryRelationalDatasetRequest === undefined) {
            throw new Error('Required parameter queryRelationalDatasetRequest was null or undefined when calling queryRelationalData.');
        }
