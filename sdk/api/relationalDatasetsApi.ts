...
import { BatchDeleteRelationalDataResponse } from '../model/batchDeleteRelationalDataResponse';
import { BatchUpsertRelationalDatasetsResponse } from '../model/batchUpsertRelationalDatasetsResponse';
import { DeleteRelationalDataPointRequest } from '../model/deleteRelationalDataPointRequest';
...
import { PagedResourceListOfRelationalDataPointResponse } from '../model/pagedResourceListOfRelationalDataPointResponse';
import { QueryRelationalDatasetRequest } from '../model/queryRelationalDatasetRequest';
import { UpsertRelationalDataPointRequest } from '../model/upsertRelationalDataPointRequest';
...
export enum RelationalDatasetsApiApiKeys {
}

export class RelationalDatasetsApi {
    ...
    public setApiKey(key: RelationalDatasetsApiApiKeys, value: string) {
        (this.authentications as any)[RelationalDatasetsApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EXPERIMENTAL] BatchDeleteRelationalData: Batch Delete Relational Data Points for a given Relational Dataset Definition.
     * @param relationalDatasetDefinitionScope The Scope of the relational dataset definition.
     * @param relationalDatasetDefinitionCode The Code of the relational dataset definition.
     * @param requestBody The Delete Request.
     * @param successMode Whether the batch request should fail Atomically or in a Partial fashion - Allowed Values: Atomic, Partial.              Note: If using partial failure modes, then it is important to check the response body for failures as any failures will still return a 200 status code.
     */
    public async batchDeleteRelationalData (relationalDatasetDefinitionScope: string, relationalDatasetDefinitionCode: string, requestBody: { [key: string]: DeleteRelationalDataPointRequest; }, successMode?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BatchDeleteRelationalDataResponse;  }> {
        const localVarPath = this.basePath + '/api/relationaldatasets/{relationalDatasetDefinitionScope}/{relationalDatasetDefinitionCode}/$batchDelete'
            .replace('{' + 'relationalDatasetDefinitionScope' + '}', encodeURIComponent(String(relationalDatasetDefinitionScope)))
            .replace('{' + 'relationalDatasetDefinitionCode' + '}', encodeURIComponent(String(relationalDatasetDefinitionCode)));
        ...
        // verify required parameter 'relationalDatasetDefinitionScope' is not null or undefined
        if (relationalDatasetDefinitionScope === null || relationalDatasetDefinitionScope === undefined) {
            throw new Error('Required parameter relationalDatasetDefinitionScope was null or undefined when calling batchDeleteRelationalData.');
        }

        // verify required parameter 'relationalDatasetDefinitionCode' is not null or undefined
        if (relationalDatasetDefinitionCode === null || relationalDatasetDefinitionCode === undefined) {
            throw new Error('Required parameter relationalDatasetDefinitionCode was null or undefined when calling batchDeleteRelationalData.');
        }

        // verify required parameter 'requestBody' is not null or undefined
        if (requestBody === null || requestBody === undefined) {
            throw new Error('Required parameter requestBody was null or undefined when calling batchDeleteRelationalData.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(requestBody, "{ [key: string]: DeleteRelationalDataPointRequest; }")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: BatchDeleteRelationalDataResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "BatchDeleteRelationalDataResponse");
     ...
     * @summary [EXPERIMENTAL] BatchUpsertRelationalData: Batch Upsert Relational Data Points for a given Relational Dataset Definition.
     * @param relationalDatasetDefinitionScope The Scope of the relational dataset definition.
     * @param relationalDatasetDefinitionCode The Code of the relational dataset definition.
     * @param requestBody The DataPoints to upsert.
     * @param successMode Whether the batch request should fail Atomically or in a Partial fashion - Allowed Values: Atomic, Partial.              Note: If using partial failure modes, then it is important to check the response body for failures as any failures will still return a 200 status code.
     */
    public async batchUpsertRelationalData (relationalDatasetDefinitionScope: string, relationalDatasetDefinitionCode: string, requestBody: { [key: string]: UpsertRelationalDataPointRequest; }, successMode?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BatchUpsertRelationalDatasetsResponse;  }> {
        const localVarPath = this.basePath + '/api/relationaldatasets/{relationalDatasetDefinitionScope}/{relationalDatasetDefinitionCode}/$batchUpsert'
            .replace('{' + 'relationalDatasetDefinitionScope' + '}', encodeURIComponent(String(relationalDatasetDefinitionScope)))
            .replace('{' + 'relationalDatasetDefinitionCode' + '}', encodeURIComponent(String(relationalDatasetDefinitionCode)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'relationalDatasetDefinitionScope' is not null or undefined
        if (relationalDatasetDefinitionScope === null || relationalDatasetDefinitionScope === undefined) {
            throw new Error('Required parameter relationalDatasetDefinitionScope was null or undefined when calling batchUpsertRelationalData.');
        }

        // verify required parameter 'relationalDatasetDefinitionCode' is not null or undefined
        if (relationalDatasetDefinitionCode === null || relationalDatasetDefinitionCode === undefined) {
            throw new Error('Required parameter relationalDatasetDefinitionCode was null or undefined when calling batchUpsertRelationalData.');
        }

        // verify required parameter 'requestBody' is not null or undefined
        if (requestBody === null || requestBody === undefined) {
            throw new Error('Required parameter requestBody was null or undefined when calling batchUpsertRelationalData.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(requestBody, "{ [key: string]: UpsertRelationalDataPointRequest; }")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: BatchUpsertRelationalDatasetsResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "BatchUpsertRelationalDatasetsResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] QueryRelationalData: Query Relational Data Points for a given Relational Dataset Definition.
     * @param relationalDatasetDefinitionScope The Scope of the relational dataset definition.
     * @param relationalDatasetDefinitionCode The Code of the relational dataset definition.
     * @param asAt The asAt datetime at which to retrieve the dataset(s). Defaults to returning the latest version of each dataset if not specified.
     * @param effectiveAt The effective datetime or cut label at which to query the datasets.              Defaults to the current LUSID system datetime if not specified.
     ...
     * @param queryRelationalDatasetRequest The query request.
     */
    public async queryRelationalData (relationalDatasetDefinitionScope: string, relationalDatasetDefinitionCode: string, asAt?: Date, effectiveAt?: string, page?: string, limit?: number, queryRelationalDatasetRequest?: QueryRelationalDatasetRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfRelationalDataPointResponse;  }> {
        const localVarPath = this.basePath + '/api/relationaldatasets/{relationalDatasetDefinitionScope}/{relationalDatasetDefinitionCode}/$query'
            .replace('{' + 'relationalDatasetDefinitionScope' + '}', encodeURIComponent(String(relationalDatasetDefinitionScope)))
            .replace('{' + 'relationalDatasetDefinitionCode' + '}', encodeURIComponent(String(relationalDatasetDefinitionCode)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'relationalDatasetDefinitionScope' is not null or undefined
        if (relationalDatasetDefinitionScope === null || relationalDatasetDefinitionScope === undefined) {
            throw new Error('Required parameter relationalDatasetDefinitionScope was null or undefined when calling queryRelationalData.');
        }

        // verify required parameter 'relationalDatasetDefinitionCode' is not null or undefined
        if (relationalDatasetDefinitionCode === null || relationalDatasetDefinitionCode === undefined) {
            throw new Error('Required parameter relationalDatasetDefinitionCode was null or undefined when calling queryRelationalData.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(queryRelationalDatasetRequest, "QueryRelationalDatasetRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfRelationalDataPointResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfRelationalDataPointResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
