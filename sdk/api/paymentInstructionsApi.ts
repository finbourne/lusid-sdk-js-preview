...
import { GetPaymentInstructionsResponse } from '../model/getPaymentInstructionsResponse';
...
import { PagedResourceListOfPaymentInstruction } from '../model/pagedResourceListOfPaymentInstruction';
import { PaymentInstruction } from '../model/paymentInstruction';
import { PaymentInstructionRequest } from '../model/paymentInstructionRequest';
import { PaymentInstructionsResponse } from '../model/paymentInstructionsResponse';
...
export enum PaymentInstructionsApiApiKeys {
}
...
export class PaymentInstructionsApi {
    ...
    public setApiKey(key: PaymentInstructionsApiApiKeys, value: string) {
        (this.authentications as any)[PaymentInstructionsApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EXPERIMENTAL] DeletePaymentInstruction: Delete Payment Instruction
     * @param scope The scope of the payment instruction.
     * @param code The code of the payment instruction.
     */
    public async deletePaymentInstruction (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/paymentinstructions/{scope}/{code}'
        ...
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling deletePaymentInstruction.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling deletePaymentInstruction.');
        }
     ...
     * @summary [EXPERIMENTAL] GetPaymentInstruction: Get Payment Instruction
     * @param scope The scope of the payment instruction.
     * @param code The code of the payment instruction.
     * @param propertyKeys A list of property keys from the \&quot;PaymentInstruction\&quot; domain to decorate onto the              payment instruction. These take the format {domain}/{scope}/{code} e.g. \&quot;PaymentInstruction/myScope/myProperty\&quot;.
     * @param effectiveAt The effective datetime or cut label at which to retrieve the payment instruction.              Defaults to the current LUSID system datetime if not specified.
     * @param asAt The asAt datetime at which to retrieve the payment instruction. Defaults to return the latest              version of the payment instruction if not specified.
     */
    public async getPaymentInstruction (scope: string, code: string, propertyKeys?: Array<string>, effectiveAt?: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PaymentInstruction;  }> {
        const localVarPath = this.basePath + '/api/paymentinstructions/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling getPaymentInstruction.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling getPaymentInstruction.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PaymentInstruction;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PaymentInstruction");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] GetPaymentInstructionsByPaymentRecordIds: Get Payment Instructions by Payment Record Ids
     * @param requestBody A collection of payment record ids to retrieve payment instructions for.              Duplicate ids are ignored.
     * @param propertyKeys A list of property keys from the \&quot;PaymentInstruction\&quot; domain to decorate onto each              payment instruction. These take the format {domain}/{scope}/{code} e.g. \&quot;PaymentInstruction/myScope/myProperty\&quot;.
     * @param effectiveAt The effective datetime or cut label at which to retrieve the payment instructions.              Defaults to the current LUSID system datetime if not specified.
     * @param asAt The asAt datetime at which to retrieve the payment instructions. Defaults to return the latest              version of each payment instruction if not specified.
     */
    public async getPaymentInstructionsByPaymentRecordIds (requestBody: Array<string>, propertyKeys?: Array<string>, effectiveAt?: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GetPaymentInstructionsResponse;  }> {
        const localVarPath = this.basePath + '/api/paymentinstructions/$getByPaymentRecordIds';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        if (requestBody === null || requestBody === undefined) {
            throw new Error('Required parameter requestBody was null or undefined when calling getPaymentInstructionsByPaymentRecordIds.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: GetPaymentInstructionsResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GetPaymentInstructionsResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] ListPaymentInstructions: List Payment Instructions
     * @param asAt The asAt datetime at which to list the payment instructions. Defaults to return the latest              version of each payment instruction if not specified.
     * @param effectiveAt The effective datetime or cut label at which to list the payment instructions.              Defaults to the current LUSID system datetime if not specified.
     * @param page The pagination token to use to continue listing payment instructions from a previous call to              list payment instructions. This value is returned from the previous call. If a pagination token is provided,              the filter, limit and asAt fields must not have changed since the original request.
     * @param limit When paginating, limit the number of returned results to this many.
     * @param filter Expression to filter the results. For example, to filter on the currency, specify              \&quot;currency eq \&#39;GBP\&#39;\&quot;. For more information about filtering results, see              https://support.lusid.com/knowledgebase/article/KA-01914.
     * @param sortBy A list of field names or properties to sort by, each suffixed by \&quot; ASC\&quot; or \&quot; DESC\&quot;.
     * @param propertyKeys A list of property keys from the \&quot;PaymentInstruction\&quot; domain to decorate onto each              payment instruction. These take the format {domain}/{scope}/{code} e.g. \&quot;PaymentInstruction/myScope/myProperty\&quot;.
     */
    public async listPaymentInstructions (asAt?: Date, effectiveAt?: string, page?: string, limit?: number, filter?: string, sortBy?: Array<string>, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfPaymentInstruction;  }> {
        const localVarPath = this.basePath + '/api/paymentinstructions';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfPaymentInstruction;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfPaymentInstruction");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] UpsertPaymentInstructions: Upsert Payment Instructions
     * @param requestBody A collection of requests to create or update Payment Instructions.
     */
    public async upsertPaymentInstructions (requestBody: { [key: string]: PaymentInstructionRequest; }, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PaymentInstructionsResponse;  }> {
        const localVarPath = this.basePath + '/api/paymentinstructions';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        // verify required parameter 'requestBody' is not null or undefined
        if (requestBody === null || requestBody === undefined) {
            throw new Error('Required parameter requestBody was null or undefined when calling upsertPaymentInstructions.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(requestBody, "{ [key: string]: PaymentInstructionRequest; }")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PaymentInstructionsResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PaymentInstructionsResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
