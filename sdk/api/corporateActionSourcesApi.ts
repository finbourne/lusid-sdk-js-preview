...
export class CorporateActionSourcesApi {
     ...
     * @summary [BETA] DeleteCorporateActionSource: Delete corporate actions (instrument transition events) from the corporate action source.
     ...
     * @summary [EXPERIMENTAL] DeleteCorporateActions: Delete corporate actions
    ...
    /**
     * Delete one or more corporate actions from a particular corporate action source.
     * @summary [EXPERIMENTAL] DeleteInstrumentEvents: Delete corporate actions (instrument transition events) from the corporate action source.
     * @param scope The scope of the corporate action source
     * @param code The code of the corporate action source
     * @param instrumentEventIds The IDs of the instrument events to delete
     */
    public async deleteInstrumentEvents (scope: string, code: string, instrumentEventIds: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/corporateactionsources/{scope}/{code}/instrumentevents'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'instrumentEventIds' is not null or undefined
        ...
        if (instrumentEventIds !== undefined) {
            localVarQueryParameters['instrumentEventIds'] = ObjectSerializer.serialize(instrumentEventIds, "Array<string>");
        }
     ...
     * @summary [EXPERIMENTAL] GetInstrumentEvents: Get extrinsic instrument events out of a given corporate actions source.
     ...
     */
    public async getInstrumentEvents (scope: string, code: string, asAt?: Date, limit?: number, page?: string, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfInstrumentEventHolder;  }> {
        const localVarPath = this.basePath + '/api/corporateactionsources/{scope}/{code}/instrumentevents'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfInstrumentEventHolder;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfInstrumentEventHolder");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] UpsertInstrumentEvents: Upsert instrument events to the provided corporate actions source.
     * @param scope The scope of the corporate action source.
     * @param code The code of the corporate action source.
     * @param upsertInstrumentEventRequest The instrument event definitions.
     */
    public async upsertInstrumentEvents (scope: string, code: string, upsertInstrumentEventRequest?: Array<UpsertInstrumentEventRequest>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UpsertInstrumentEventsResponse;  }> {
        const localVarPath = this.basePath + '/api/corporateactionsources/{scope}/{code}/instrumentevents'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(upsertInstrumentEventRequest, "Array<UpsertInstrumentEventRequest>")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: UpsertInstrumentEventsResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "UpsertInstrumentEventsResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
