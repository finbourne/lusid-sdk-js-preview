...
export enum FundConfigurationApiApiKeys {
}

export class FundConfigurationApi {
    ...
    public setApiKey(key: FundConfigurationApiApiKeys, value: string) {
        (this.authentications as any)[FundConfigurationApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EXPERIMENTAL] CreateFundConfiguration: Create a FundConfiguration.
     * @param scope The scope of the FundConfiguration.
     * @param fundConfigurationRequest The definition of the FundConfiguration.
     */
    public async createFundConfiguration (scope: string, fundConfigurationRequest: FundConfigurationRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FundConfiguration;  }> {
        const localVarPath = this.basePath + '/api/fundconfigurations/{scope}'
        ...
        // verify required parameter 'fundConfigurationRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(fundConfigurationRequest, "FundConfigurationRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: FundConfiguration;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "FundConfiguration");
     ...
     * @summary [EXPERIMENTAL] DeleteFundConfiguration: Delete a FundConfiguration.
     ...
     */
    public async deleteFundConfiguration (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/fundconfigurations/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
     ...
     * @summary [EXPERIMENTAL] GetFundConfiguration: Get FundConfiguration.
     * @param scope The scope of the FundConfiguration.
     ...
     */
    public async getFundConfiguration (scope: string, code: string, effectiveAt?: string, asAt?: Date, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FundConfiguration;  }> {
        const localVarPath = this.basePath + '/api/fundconfigurations/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
     ...
     * @summary [EXPERIMENTAL] ListFundConfigurations: List FundConfiguration.
     ...
     */
    public async listFundConfigurations (effectiveAt?: string, asAt?: Date, page?: string, limit?: number, filter?: string, sortBy?: Array<string>, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfFundConfiguration;  }> {
        const localVarPath = this.basePath + '/api/fundconfigurations';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfFundConfiguration;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfFundConfiguration");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] PatchFundConfiguration: Patch Fund Configuration.
     * @param scope The scope of the FundConfiguration.
     * @param code The code of the FundConfiguration. Together with the               scope this uniquely identifies the FundConfiguration.
     * @param operation The json patch document. For more information see: https://datatracker.ietf.org/doc/html/rfc6902.
     */
    public async patchFundConfiguration (scope: string, code: string, operation: Array<Operation>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FundConfiguration;  }> {
        const localVarPath = this.basePath + '/api/fundconfigurations/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
     ...
     * @summary [EXPERIMENTAL] UpsertFundConfigurationProperties: Upsert FundConfiguration properties
     ...
     */
    public async upsertFundConfigurationProperties (scope: string, code: string, requestBody?: { [key: string]: Property; }, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: FundConfigurationProperties;  }> {
        const localVarPath = this.basePath + '/api/fundconfigurations/{scope}/{code}/properties/$upsert'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: FundConfigurationProperties;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "FundConfigurationProperties");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
