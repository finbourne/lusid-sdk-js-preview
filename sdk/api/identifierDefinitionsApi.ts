...
export enum IdentifierDefinitionsApiApiKeys {
}

export class IdentifierDefinitionsApi {
    ...
    public setApiKey(key: IdentifierDefinitionsApiApiKeys, value: string) {
        (this.authentications as any)[IdentifierDefinitionsApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EXPERIMENTAL] CreateIdentifierDefinition: Create an Identifier Definition
     * @param createIdentifierDefinitionRequest The request defining the new definition
     */
    public async createIdentifierDefinition (createIdentifierDefinitionRequest?: CreateIdentifierDefinitionRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: IdentifierDefinition;  }> {
        const localVarPath = this.basePath + '/api/identifierdefinitions';
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(createIdentifierDefinitionRequest, "CreateIdentifierDefinitionRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: IdentifierDefinition;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "IdentifierDefinition");
     ...
     * @summary [EXPERIMENTAL] DeleteIdentifierDefinition: Delete a particular Identifier Definition
     * @param domain The type of entity to which the identifier relates
     * @param identifierScope The scope that the identifier exists in
     * @param identifierType What the identifier represents. Together with \&quot;domain\&quot; and \&quot;identifierScope\&quot; this uniquely identifies the identifier definition
     */
    public async deleteIdentifierDefinition (domain: 'NotDefined' | 'Transaction' | 'Portfolio' | 'Holding' | 'ReferenceHolding' | 'TransactionConfiguration' | 'Instrument' | 'CutLabelDefinition' | 'Analytic' | 'PortfolioGroup' | 'Person' | 'AccessMetadata' | 'Order' | 'UnitResult' | 'MarketData' | 'ConfigurationRecipe' | 'Allocation' | 'Calendar' | 'LegalEntity' | 'InvestorRecord' | 'InvestmentAccount' | 'Placement' | 'Execution' | 'Block' | 'Participation' | 'Package' | 'OrderInstruction' | 'NextBestAction' | 'CustomEntity' | 'InstrumentEvent' | 'Account' | 'ChartOfAccounts' | 'CustodianAccount' | 'CheckDefinition' | 'Abor' | 'AborConfiguration' | 'Fund' | 'FundConfiguration' | 'Fee' | 'Reconciliation' | 'PropertyDefinition' | 'Compliance' | 'DiaryEntry' | 'Leg' | 'DerivedValuation' | 'Timeline' | 'ClosedPeriod' | 'AddressKeyDefinition' | 'AmortisationRuleSet' | 'AnalyticsSetInventory' | 'AtomUnitResult' | 'CleardownModule' | 'ComplexMarketData' | 'ComplianceRunSummary' | 'ComplianceRule' | 'ComplianceRunInfo' | 'CorporateActionSource' | 'CounterpartyAgreement' | 'CustomEntityDefinition' | 'DataType' | 'Dialect' | 'EventHandler' | 'GeneralLedgerProfile' | 'PostingModule' | 'Quote' | 'RecipeComposer' | 'ReconciliationRunBreak' | 'ReferenceList' | 'RelationDefinition' | 'ReturnBlockIndex' | 'SRSDocument' | 'SRSIndex' | 'TransactionTemplate' | 'TransactionTemplateScope' | 'TransactionType' | 'TransactionTypeConfig' | 'TranslationScript' | 'TaskDefinition' | 'TaskInstance' | 'Worker' | 'StagingRuleSet' | 'IdentifierDefinition' | 'SettlementInstruction' | 'TransactionFee', identifierScope: string, identifierType: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/identifierdefinitions/{domain}/{identifierScope}/{identifierType}'
            .replace('{' + 'domain' + '}', encodeURIComponent(String(domain)))
            .replace('{' + 'identifierScope' + '}', encodeURIComponent(String(identifierScope)))
     ...
     * @summary [EXPERIMENTAL] GetIdentifierDefinition: Get a single Identifier Definition
     * @param domain The type of entity to which the identifier relates.
     * @param identifierScope The scope that the identifier exists in
     * @param identifierType What the identifier represents. Together with \&quot;domain\&quot; and \&quot;identifierScope\&quot; this uniquely identifies the identifier definition
     * @param asAt The asAt datetime at which to retrieve the Identifier Definition. Defaults to return              the latest version of the definition if not specified.
     ...
     * @param propertyKeys A list of property keys from the \&#39;IdentifierDefinition\&#39; domain to decorate onto the Identifier Definition.              These must take the format {domain}/{scope}/{code}. If no properties are specified, then no properties will be returned.
     */
    public async getIdentifierDefinition (domain: 'NotDefined' | 'Transaction' | 'Portfolio' | 'Holding' | 'ReferenceHolding' | 'TransactionConfiguration' | 'Instrument' | 'CutLabelDefinition' | 'Analytic' | 'PortfolioGroup' | 'Person' | 'AccessMetadata' | 'Order' | 'UnitResult' | 'MarketData' | 'ConfigurationRecipe' | 'Allocation' | 'Calendar' | 'LegalEntity' | 'InvestorRecord' | 'InvestmentAccount' | 'Placement' | 'Execution' | 'Block' | 'Participation' | 'Package' | 'OrderInstruction' | 'NextBestAction' | 'CustomEntity' | 'InstrumentEvent' | 'Account' | 'ChartOfAccounts' | 'CustodianAccount' | 'CheckDefinition' | 'Abor' | 'AborConfiguration' | 'Fund' | 'FundConfiguration' | 'Fee' | 'Reconciliation' | 'PropertyDefinition' | 'Compliance' | 'DiaryEntry' | 'Leg' | 'DerivedValuation' | 'Timeline' | 'ClosedPeriod' | 'AddressKeyDefinition' | 'AmortisationRuleSet' | 'AnalyticsSetInventory' | 'AtomUnitResult' | 'CleardownModule' | 'ComplexMarketData' | 'ComplianceRunSummary' | 'ComplianceRule' | 'ComplianceRunInfo' | 'CorporateActionSource' | 'CounterpartyAgreement' | 'CustomEntityDefinition' | 'DataType' | 'Dialect' | 'EventHandler' | 'GeneralLedgerProfile' | 'PostingModule' | 'Quote' | 'RecipeComposer' | 'ReconciliationRunBreak' | 'ReferenceList' | 'RelationDefinition' | 'ReturnBlockIndex' | 'SRSDocument' | 'SRSIndex' | 'TransactionTemplate' | 'TransactionTemplateScope' | 'TransactionType' | 'TransactionTypeConfig' | 'TranslationScript' | 'TaskDefinition' | 'TaskInstance' | 'Worker' | 'StagingRuleSet' | 'IdentifierDefinition' | 'SettlementInstruction' | 'TransactionFee', identifierScope: string, identifierType: string, asAt?: Date, effectiveAt?: string, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: IdentifierDefinition;  }> {
        const localVarPath = this.basePath + '/api/identifierdefinitions/{domain}/{identifierScope}/{identifierType}'
            .replace('{' + 'domain' + '}', encodeURIComponent(String(domain)))
            .replace('{' + 'identifierScope' + '}', encodeURIComponent(String(identifierScope)))
            .replace('{' + 'identifierType' + '}', encodeURIComponent(String(identifierType)));
     ...
     * @summary [EXPERIMENTAL] ListIdentifierDefinitions: List Identifier Definitions
     * @param effectiveAt The effectiveAt datetime at which to retrieve the Identifier Definitions.              Since Identifier Definitions exist for all effective time, this will only apply to properties (if requested)              on the Identifier Definition.
     * @param asAt The asAt datetime at which to retrieve the Identifier Definitions. Defaults to return the latest              version of the Identifier Definitions if not specified.
     ...
     * @param propertyKeys A list of property keys from the \&#39;IdentifierDefinition\&#39; domain to decorate onto the Identifier Definition.              These must take the format {domain}/{scope}/{code}.
     */
    public async listIdentifierDefinitions (effectiveAt?: string, asAt?: Date, page?: string, limit?: number, filter?: string, sortBy?: Array<string>, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfIdentifierDefinition;  }> {
        const localVarPath = this.basePath + '/api/identifierdefinitions';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfIdentifierDefinition;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfIdentifierDefinition");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] UpdateIdentifierDefinition: Update Identifier Definition defined by domain, identifierScope, and identifierType
     * @param domain The type of entity to which the identifier relates
     * @param identifierScope The scope that the identifier exists in
     * @param identifierType What the identifier represents. Together with \&quot;domain\&quot; and \&quot;identifierScope\&quot; this uniquely identifies the Identifier Definition
     * @param updateIdentifierDefinitionRequest The request containing the updated details of the Identifier Definition.
     */
    public async updateIdentifierDefinition (domain: 'NotDefined' | 'Transaction' | 'Portfolio' | 'Holding' | 'ReferenceHolding' | 'TransactionConfiguration' | 'Instrument' | 'CutLabelDefinition' | 'Analytic' | 'PortfolioGroup' | 'Person' | 'AccessMetadata' | 'Order' | 'UnitResult' | 'MarketData' | 'ConfigurationRecipe' | 'Allocation' | 'Calendar' | 'LegalEntity' | 'InvestorRecord' | 'InvestmentAccount' | 'Placement' | 'Execution' | 'Block' | 'Participation' | 'Package' | 'OrderInstruction' | 'NextBestAction' | 'CustomEntity' | 'InstrumentEvent' | 'Account' | 'ChartOfAccounts' | 'CustodianAccount' | 'CheckDefinition' | 'Abor' | 'AborConfiguration' | 'Fund' | 'FundConfiguration' | 'Fee' | 'Reconciliation' | 'PropertyDefinition' | 'Compliance' | 'DiaryEntry' | 'Leg' | 'DerivedValuation' | 'Timeline' | 'ClosedPeriod' | 'AddressKeyDefinition' | 'AmortisationRuleSet' | 'AnalyticsSetInventory' | 'AtomUnitResult' | 'CleardownModule' | 'ComplexMarketData' | 'ComplianceRunSummary' | 'ComplianceRule' | 'ComplianceRunInfo' | 'CorporateActionSource' | 'CounterpartyAgreement' | 'CustomEntityDefinition' | 'DataType' | 'Dialect' | 'EventHandler' | 'GeneralLedgerProfile' | 'PostingModule' | 'Quote' | 'RecipeComposer' | 'ReconciliationRunBreak' | 'ReferenceList' | 'RelationDefinition' | 'ReturnBlockIndex' | 'SRSDocument' | 'SRSIndex' | 'TransactionTemplate' | 'TransactionTemplateScope' | 'TransactionType' | 'TransactionTypeConfig' | 'TranslationScript' | 'TaskDefinition' | 'TaskInstance' | 'Worker' | 'StagingRuleSet' | 'IdentifierDefinition' | 'SettlementInstruction' | 'TransactionFee', identifierScope: string, identifierType: string, updateIdentifierDefinitionRequest?: UpdateIdentifierDefinitionRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: IdentifierDefinition;  }> {
        const localVarPath = this.basePath + '/api/identifierdefinitions/{domain}/{identifierScope}/{identifierType}'
            .replace('{' + 'domain' + '}', encodeURIComponent(String(domain)))
            .replace('{' + 'identifierScope' + '}', encodeURIComponent(String(identifierScope)))
            .replace('{' + 'identifierType' + '}', encodeURIComponent(String(identifierType)));
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(updateIdentifierDefinitionRequest, "UpdateIdentifierDefinitionRequest")
        };
