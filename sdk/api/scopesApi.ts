...
export class ScopesApi {
     ...
     * @summary ListEntityScopes: List Entity Scopes
     ...
     */
    public async listEntityScopes (entityType: string, asAt?: Date, page?: string, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfScopeDefinition;  }> {
        const localVarPath = this.basePath + '/api/scopes/{entityType}'
