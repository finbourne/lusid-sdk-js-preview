...
export class ScopesApi {
     ...
     */
    public async listEntityScopes (entityType: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfScopeDefinition;  }> {
