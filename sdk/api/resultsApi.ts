...
export class ResultsApi {
     ...
     * @param createResults The details of what to upsert
     */
    public async upsertResults (createResults?: CreateResults, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Results;  }> {
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(createResults, "CreateResults")
        };
