...
export class TransactionTransactionFeesApi {
     ...
     * @param effectiveAt The date and time at which the TransactionFee should be effective.
     */
    public async createTransactionFee (scope: string, code: string, createTransactionFeeRequest: CreateTransactionFeeRequest, effectiveAt?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TransactionFee;  }> {
     ...
     * @param scope The scope of the TransactionFee.
     * @param code The code of the TransactionFee.              Together with the scope this uniquely identifies the TransactionFee.
     * @param effectiveAt The date and time at which the query is effective.
     ...
     * @param scope The scope of the TransactionFee.
     * @param code The code of the specified TransactionFee.              Together with the scope this uniquely identifies the TransactionFee.
     * @param updateTransactionFeeRequest The contents of the TransactionFee.
     * @param effectiveAt The date and time at which the update should take effect.             The updated contents of the TransactionFee.
     */
    public async updateTransactionFee (scope: string, code: string, updateTransactionFeeRequest: UpdateTransactionFeeRequest, effectiveAt?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TransactionFee;  }> {
        const localVarPath = this.basePath + '/api/transactions/transactionfees/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
