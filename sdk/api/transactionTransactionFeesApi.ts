...
import { CreateTransactionFeeRequest } from '../model/createTransactionFeeRequest';
...
import { ResourceListOfTransactionFee } from '../model/resourceListOfTransactionFee';
import { TransactionFee } from '../model/transactionFee';
import { UpdateTransactionFeeRequest } from '../model/updateTransactionFeeRequest';
...
export enum TransactionTransactionFeesApiApiKeys {
}

export class TransactionTransactionFeesApi {
    ...
    public setApiKey(key: TransactionTransactionFeesApiApiKeys, value: string) {
        (this.authentications as any)[TransactionTransactionFeesApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EXPERIMENTAL] CreateTransactionFee: Create a TransactionFee
     * @param scope The scope of the TransactionFee.
     * @param code The code of the TransactionFee.              Together with the scope this uniquely identifies the TransactionFee.
     * @param createTransactionFeeRequest The contents of the TransactionFee.
     */
    public async createTransactionFee (scope: string, code: string, createTransactionFeeRequest: CreateTransactionFeeRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TransactionFee;  }> {
        const localVarPath = this.basePath + '/api/transactions/transactionfees/{scope}/{code}'
        ...
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling createTransactionFee.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling createTransactionFee.');
        }

        // verify required parameter 'createTransactionFeeRequest' is not null or undefined
        if (createTransactionFeeRequest === null || createTransactionFeeRequest === undefined) {
            throw new Error('Required parameter createTransactionFeeRequest was null or undefined when calling createTransactionFee.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(createTransactionFeeRequest, "CreateTransactionFeeRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: TransactionFee;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "TransactionFee");
     ...
     * @summary [EXPERIMENTAL] DeleteTransactionFee: Delete a TransactionFee
     * @param scope The scope of the TransactionFee.
     * @param code The code of the specified TransactionFee.              Together with the scope this uniquely identifies the TransactionFee.
     */
    public async deleteTransactionFee (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/transactions/transactionfees/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling deleteTransactionFee.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling deleteTransactionFee.');
        }
     ...
     * @summary [EXPERIMENTAL] GetTransactionFee: Get a TransactionFee
     * @param scope The scope of the TransactionFee.
     * @param code The code of the TransactionFee.              Together with the scope this uniquely identifies the TransactionFee.
     * @param effectiveAt The effective datetime at which to retrieve the TransactionFee properties.              Defaults to the current LUSID system datetime if not specified.
     * @param asAt The asAt datetime at which to retrieve the TransactionFees.              Defaults to latest if not specified.
     * @param propertyKeys The collection of &#x60;PropertyKey&#x60;s that we want to decorate on identifies the TransactionFee.
     */
    public async getTransactionFee (scope: string, code: string, effectiveAt?: string, asAt?: Date, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TransactionFee;  }> {
        const localVarPath = this.basePath + '/api/transactions/transactionfees/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling getTransactionFee.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling getTransactionFee.');
        }
     ...
     * @summary [EXPERIMENTAL] ListTransactionFees: List TransactionFees
     * @param effectiveAt The effective datetime at which to retrieve TransactionFee properties.              Defaults to the current LUSID system datetime if not specified.
     * @param asAt The asAt datetime at which to retrieve the TransactionFees.              Defaults to latest if not specified.
     ...
     * @param propertyKeys The collection of &#x60;PropertyKey&#x60;s to filter on
     */
    public async listTransactionFees (effectiveAt?: string, asAt?: Date, page?: string, limit?: number, filter?: string, sortBy?: Array<string>, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfTransactionFee;  }> {
        const localVarPath = this.basePath + '/api/transactions/transactionfees';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ResourceListOfTransactionFee;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ResourceListOfTransactionFee");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] UpdateTransactionFee: Update a TransactionFee
     * @param scope The scope of the TransactionFee.
     * @param code The code of the specified TransactionFee.              Together with the scope this uniquely identifies the TransactionFee.
     * @param updateTransactionFeeRequest The updated contents of the TransactionFee.
     */
    public async updateTransactionFee (scope: string, code: string, updateTransactionFeeRequest: UpdateTransactionFeeRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TransactionFee;  }> {
        const localVarPath = this.basePath + '/api/transactions/transactionfees/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling updateTransactionFee.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling updateTransactionFee.');
        }

        // verify required parameter 'updateTransactionFeeRequest' is not null or undefined
        if (updateTransactionFeeRequest === null || updateTransactionFeeRequest === undefined) {
            throw new Error('Required parameter updateTransactionFeeRequest was null or undefined when calling updateTransactionFee.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(updateTransactionFeeRequest, "UpdateTransactionFeeRequest")
        };
