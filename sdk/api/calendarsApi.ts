 ...
 *
 * The version of the OpenAPI document: 0.11.1683
...
import { ResourceListOfDate } from '../model/resourceListOfDate';
import { UpdateCalendarRequest } from '../model/updateCalendarRequest';

import { ObjectSerializer, Authentication, VoidAuth } from '../model/models';
import { OAuth } from '../model/models';

let defaultBasePath = 'http://localhost:52783';
...
export class CalendarsApi {
     ...
     */
    public async addDateToCalendar (scope: string, code: string, createDateRequest: CreateDateRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ModelDate;  }> {
        const localVarPath = this.basePath + '/api/calendar/generic/{scope}/{code}/dates'
        ...
        return new Promise<{ response: http.IncomingMessage; body: ModelDate;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
                    body = ObjectSerializer.deserialize(body, "ModelDate");
    ...
    public async createCalendar (createCalendarRequest: CreateCalendarRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Calendar;  }> {
        const localVarPath = this.basePath + '/api/calendar/generic';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
    ...
    public async deleteCalendar (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Calendar;  }> {
        const localVarPath = this.basePath + '/api/calendar/generic/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
     ...
     */
    public async deleteDateFromCalendar (scope: string, code: string, dateId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ModelDate;  }> {
        const localVarPath = this.basePath + '/api/calendar/generic/{scope}/{code}/dates/{dateId}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
     ...
     */
    public async getDates (scope: string, code: string, fromEffectiveAt?: string, toEffectiveAt?: string, asAt?: Date, idFilter?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfDate;  }> {
        const localVarPath = this.basePath + '/api/calendar/generic/{scope}/{code}/dates'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        return new Promise<{ response: http.IncomingMessage; body: ResourceListOfDate;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
                    body = ObjectSerializer.deserialize(body, "ResourceListOfDate");
                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                        resolve({ response: response, body: body });
                    } else {
                        reject({ response: response, body: body });
    ...
    public async updateCalendar (scope: string, code: string, updateCalendarRequest: UpdateCalendarRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Calendar;  }> {
        const localVarPath = this.basePath + '/api/calendar/generic/{scope}/{code}/mask'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
