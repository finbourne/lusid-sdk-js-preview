...
export class CalendarsApi {
     ...
     * @summary [EXPERIMENTAL] AddBusinessDaysToDate: Adds the requested number of Business Days to the provided date.
     ...
     * @summary [BETA] AddDateToCalendar: Add a date to a calendar
     ...
     * @summary [BETA] CreateCalendar: Create a calendar in its generic form
     ...
     * @summary [BETA] DeleteCalendar: Delete a calendar
     * @param scope Scope of the calendar
     * @param code Code of the calendar
     */
     ...
     * @summary [BETA] DeleteDateFromCalendar: Remove a date from a calendar
     * @param scope Scope of the calendar
     * @param code Code of the calendar
     ...
     * @summary [EXPERIMENTAL] GenerateSchedule: Generate an ordered schedule of dates.
     ...
     * @summary [BETA] GetCalendar: Get a calendar in its generic form
     ...
     * @summary [BETA] GetDates: Get dates for a specific calendar
     * @param scope Scope of the calendar
     * @param code Code of the calendar
     ...
     * @summary [BETA] IsBusinessDateTime: Check whether a DateTime is a \"Business DateTime\"
     ...
     * @summary [BETA] ListCalendars: List Calendars
    ...
    /**
     * List calendars at a point in AsAt time.
     * @summary [BETA] ListCalendarsInScope: List all calenders in a specified scope
     ...
     * @summary [BETA] UpdateCalendar: Update a calendar
