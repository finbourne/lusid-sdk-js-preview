...
import { GetTransferRequest } from '../model/getTransferRequest';
...
export class TransfersApi {
     ...
     * @summary [EXPERIMENTAL] CreateTransfer: Create a transfer.
     * @param createTransferRequest The transfer to create.
     */
    public async createTransfer (createTransferRequest: CreateTransferRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CreateTransferResponse;  }> {
        const localVarPath = this.basePath + '/api/transfers';
        ...
        if (createTransferRequest === null || createTransferRequest === undefined) {
            throw new Error('Required parameter createTransferRequest was null or undefined when calling createTransfer.');
        }
     ...
     * @summary [EXPERIMENTAL] GetTransfer: Get a transfer
     * @param getTransferRequest The transfer to retrieve.
     * @param asAt The asAt datetime at which to retrieve the transfer. Defaults to latest              version if not specified.
     */
    public async getTransfer (getTransferRequest: GetTransferRequest, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GetTransferResponse;  }> {
        const localVarPath = this.basePath + '/api/transfers/$get';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'getTransferRequest' is not null or undefined
        if (getTransferRequest === null || getTransferRequest === undefined) {
            throw new Error('Required parameter getTransferRequest was null or undefined when calling getTransfer.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(getTransferRequest, "GetTransferRequest")
        };
