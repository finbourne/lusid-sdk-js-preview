...
export class DataTypesApi {
     ...
     */
    public async getDataType (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DataType;  }> {
     ...
     */
    public async getUnitsFromDataType (scope: string, code: string, units?: Array<string>, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfIUnitDefinitionDto;  }> {
     ...
     * @param filter Optional. Expression to filter the result set
     */
    public async listDataTypes (scope: string, includeSystem?: boolean, sortBy?: Array<string>, start?: number, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfDataType;  }> {
