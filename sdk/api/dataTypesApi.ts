...
export class DataTypesApi {
     ...
     * @summary [BETA] CreateDataType: Create data type definition
     ...
     * @summary [EARLY ACCESS] GetDataType: Get data type definition
     ...
     * @summary [EXPERIMENTAL] ListDataTypeSummaries: List all data type summaries, without the reference data
     ...
     * @param sortBy Sort the results by these fields. Use use the \&#39;-\&#39; sign to denote descending allocation e.g. -MyFieldName.
     */
    public async listDataTypeSummaries (asAt?: Date, page?: string, start?: number, limit?: number, filter?: string, sortBy?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfDataTypeSummary;  }> {
        const localVarPath = this.basePath + '/api/datatypes';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
     ...
     * @summary [EARLY ACCESS] ListDataTypes: List data types
     ...
     * @summary [EXPERIMENTAL] UpdateDataType: Update data type definition
     * @param scope The scope of the data type
     * @param code The code of the data type
     ...
     * @summary [EXPERIMENTAL] UpdateReferenceValues: Update reference data on a data type
     * @param scope The scope of the data type
     * @param code The code of the data type
