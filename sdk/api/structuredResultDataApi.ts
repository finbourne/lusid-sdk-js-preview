...
export class StructuredResultDataApi {
     ...
     * @summary [EXPERIMENTAL] CreateDataMap: Create data map
     ...
     * @summary [EXPERIMENTAL] DeleteStructuredResultData: Delete structured result data
     ...
     * @summary [EARLY ACCESS] GetAddressKeyDefinitionsForDocument: Get AddressKeyDefinitions for a virtual document.
     ...
     */
    public async getAddressKeyDefinitionsForDocument (scope: string, code: string, source: string, resultType: string, effectiveAt?: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfAddressKeyDefinition;  }> {
        const localVarPath = this.basePath + '/api/unitresults/virtualdocument/{scope}/{code}/{source}/{resultType}/addresskeydefinitions'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'source' + '}', encodeURIComponent(String(source)))
            .replace('{' + 'resultType' + '}', encodeURIComponent(String(resultType)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ResourceListOfAddressKeyDefinition;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ResourceListOfAddressKeyDefinition");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] GetStructuredResultData: Get structured result data
     ...
     * @param asAt The asAt datetime at which to retrieve the structured result data. Defaults to returning the latest version if not specified.
     */
    public async getVirtualDocument (scope: string, requestBody: { [key: string]: StructuredResultDataId; }, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GetVirtualDocumentResponse;  }> {
        const localVarPath = this.basePath + '/api/unitresults/virtualdocument/{scope}/$get'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: GetVirtualDocumentResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "GetVirtualDocumentResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     */
    public async getVirtualDocumentRows (scope: string, code: string, source: string, resultType: string, effectiveAt: string, asAt?: Date, page?: string, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfVirtualRow;  }> {
        const localVarPath = this.basePath + '/api/unitresults/virtualdocument/{scope}/{code}/{source}/{resultType}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'source' + '}', encodeURIComponent(String(source)))
            .replace('{' + 'resultType' + '}', encodeURIComponent(String(resultType)));
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfVirtualRow;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfVirtualRow");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param requestBody The time invariant set of structured data identifiers to retrieve, keyed by a unique, ephemeral correlation ID.
     */
    public async upsertResultValue (scope: string, requestBody: { [key: string]: UpsertResultValuesDataRequest; }, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UpsertStructuredDataResponse;  }> {
        const localVarPath = this.basePath + '/api/unitresults/resultvalue/{scope}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(requestBody, "{ [key: string]: UpsertResultValuesDataRequest; }")
        };
     ...
     * @summary [BETA] UpsertStructuredResultData: Upsert structured result data
