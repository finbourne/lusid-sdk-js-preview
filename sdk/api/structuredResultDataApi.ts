...
export class StructuredResultDataApi {
     ...
     * @param scope Scope in which to upsert the result address definition maps
     * @param requestBody Individual result address definition map creation requests
     */
     ...
     * @param requestBody The structured result data Ids to delete, each keyed by a unique correlation id.
     */
     ...
     * @param scope The scope of the result address definition map keys
     * @param requestBody The result address definition map keys to lookup
     */
     ...
     * @param requestBody The set of structured result data items to update or insert keyed by a unique correlation id.
     */
