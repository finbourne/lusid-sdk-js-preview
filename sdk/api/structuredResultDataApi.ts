...
export class StructuredResultDataApi {
     ...
     */
    public async getStructuredResultData (scope: string, requestBody: { [key: string]: StructuredResultDataId; }, effectiveAt?: string, asAt?: Date, maxAge?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GetStructuredResultDataResponse;  }> {
