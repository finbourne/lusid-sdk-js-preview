...
export class CounterpartiesApi {
     ...
     * @summary [EXPERIMENTAL] DeleteCounterpartyAgreement: Delete the Counterparty Agreement of given scope and code
     ...
     * @summary [EXPERIMENTAL] DeleteCreditSupportAnnex: Delete the Credit Support Annex of given scope and code
     ...
     * @summary [EXPERIMENTAL] GetCounterpartyAgreement: Get Counterparty Agreement
     ...
     * @summary [EXPERIMENTAL] GetCreditSupportAnnex: Get Credit Support Annex
     ...
     * @summary [EXPERIMENTAL] ListCounterpartyAgreements: List the set of Counterparty Agreements
     ...
     * @summary [EXPERIMENTAL] ListCreditSupportAnnexes: List the set of Credit Support Annexes
     ...
     * @summary [EXPERIMENTAL] UpsertCounterpartyAgreement: Upsert Counterparty Agreement
     ...
     * @summary [EXPERIMENTAL] UpsertCreditSupportAnnex: Upsert Credit Support Annex
