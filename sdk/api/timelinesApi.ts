...
export class TimelinesApi {
     ...
     * @summary [EXPERIMENTAL] UnconfirmClosedPeriod: Unconfirm the last confirmed Closed Period against a Timeline Entity
     * @param scope The scope of the specified Timeline.
     * @param code The code of the specified Timeline. Together with the scope this uniquely identifies the Timeline.
     * @param closedPeriodId The id of the Closed Period. Together with the scope and code of the Timeline,              this uniquely identifies the ClosedPeriod. The closed period must be the last closed period on the Timeline.
     * @param body Not in use at the moment
     */
    public async unconfirmClosedPeriod (scope: string, code: string, closedPeriodId: string, body?: object, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ClosedPeriod;  }> {
