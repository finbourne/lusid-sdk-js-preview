...
import { BatchCreateClosedPeriodsRequest } from '../model/batchCreateClosedPeriodsRequest';
...
import { ResourceListOfClosedPeriod } from '../model/resourceListOfClosedPeriod';
import { Timeline } from '../model/timeline';
import { UnconfirmClosedPeriodRequest } from '../model/unconfirmClosedPeriodRequest';
...
export enum TimelinesApiApiKeys {
}
...
export class TimelinesApi {
    ...
    public setApiKey(key: TimelinesApiApiKeys, value: string) {
        (this.authentications as any)[TimelinesApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EXPERIMENTAL] BatchCreateClosedPeriodCandidates: Atomically create an ordered series of confirmed closed period candidates against a timeline entity
     * @param scope The scope of the specified Timeline.
     * @param code The code of the specified Timeline. Together with the scope this uniquely identifies the Timeline.
     * @param batchCreateClosedPeriodsRequest The ordered set of Closed Periods to create
     */
    public async batchCreateClosedPeriodCandidates (scope: string, code: string, batchCreateClosedPeriodsRequest?: BatchCreateClosedPeriodsRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfClosedPeriod;  }> {
        const localVarPath = this.basePath + '/api/timelines/{scope}/{code}/closedperiods/candidate/$batchCreate'
        ...
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling batchCreateClosedPeriodCandidates.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling batchCreateClosedPeriodCandidates.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(batchCreateClosedPeriodsRequest, "BatchCreateClosedPeriodsRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ResourceListOfClosedPeriod;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ResourceListOfClosedPeriod");
     ...
     * @summary [EXPERIMENTAL] BatchCreateClosedPeriods: Atomically create an ordered series of confirmed closed periods against a timeline entity
     * @param scope The scope of the specified Timeline.
     * @param code The code of the specified Timeline. Together with the domain and scope this uniquely identifies the Timeline.
     * @param batchCreateClosedPeriodsRequest The ordered set of Closed Periods to create
     */
    public async batchCreateClosedPeriods (scope: string, code: string, batchCreateClosedPeriodsRequest?: BatchCreateClosedPeriodsRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfClosedPeriod;  }> {
        const localVarPath = this.basePath + '/api/timelines/{scope}/{code}/closedperiods/$batchCreate'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling batchCreateClosedPeriods.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling batchCreateClosedPeriods.');
        }
     ...
     * @summary [EXPERIMENTAL] ConfirmClosedPeriod: Confirm a Closed Period against a Timeline Entity
     * @param scope The scope of the specified Timeline.
     * @param code The code of the specified Timeline. Together with the scope this uniquely identifies the Timeline.
     ...
     */
    public async confirmClosedPeriod (scope: string, code: string, closedPeriodId: string, body?: object, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ClosedPeriod;  }> {
        const localVarPath = this.basePath + '/api/timelines/{scope}/{code}/closedperiods/{closedPeriodId}/$confirm'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'closedPeriodId' + '}', encodeURIComponent(String(closedPeriodId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling confirmClosedPeriod.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling confirmClosedPeriod.');
        }

        // verify required parameter 'closedPeriodId' is not null or undefined
        if (closedPeriodId === null || closedPeriodId === undefined) {
            throw new Error('Required parameter closedPeriodId was null or undefined when calling confirmClosedPeriod.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ClosedPeriod;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ClosedPeriod");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] CreateClosedPeriod: Create a new closed period against a timeline entity
     * @param scope The scope of the specified Timeline.
     * @param code The code of the specified Timeline. Together with the domain and scope this uniquely identifies the Timeline.
     * @param createClosedPeriodRequest The request containing the details of the Closed Period
     */
    public async createClosedPeriod (scope: string, code: string, createClosedPeriodRequest?: CreateClosedPeriodRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ClosedPeriod;  }> {
        const localVarPath = this.basePath + '/api/timelines/{scope}/{code}/closedperiods'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(createClosedPeriodRequest, "CreateClosedPeriodRequest")
        };
     ...
     * @summary [EXPERIMENTAL] CreateClosedPeriodCandidate: Create a new closed period candidate against a timeline entity
     * @param scope The scope of the specified Timeline.
     * @param code The code of the specified Timeline. Together with the scope this uniquely identifies the Timeline.
     * @param createClosedPeriodRequest The request containing the details of the Closed Period
     */
    public async createClosedPeriodCandidate (scope: string, code: string, createClosedPeriodRequest?: CreateClosedPeriodRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ClosedPeriod;  }> {
        const localVarPath = this.basePath + '/api/timelines/{scope}/{code}/closedperiods/candidate'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling createClosedPeriodCandidate.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling createClosedPeriodCandidate.');
        }
     ...
     * @summary [EXPERIMENTAL] CreateTimeline: Create a Timeline
     * @param createTimelineRequest The request containing the details of the Timeline
     */
    public async createTimeline (createTimelineRequest?: CreateTimelineRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Timeline;  }> {
        const localVarPath = this.basePath + '/api/timelines';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(createTimelineRequest, "CreateTimelineRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: Timeline;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
     ...
     * @summary [EXPERIMENTAL] DeleteTimeline: Deletes a particular Timeline
     * @param scope The scope of the specified Timeline.
     * @param code The code of the specified Timeline. Together with the domain and scope this uniquely              identifies the Timeline.
     */
    public async deleteTimeline (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/timelines/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @summary [EXPERIMENTAL] GetClosedPeriod: Gets a Closed Period entity.
     * @param scope The scope of the Timeline.
     * @param code The code of the Timeline. Together with the scope this uniquely              identifies the Timeline.
     * @param closedPeriodId The id of the Closed Period. Together with the scope and code of the Timeline,              this uniquely identifies the ClosedPeriod
     * @param asAt The asAt datetime at which to retrieve the ClosedPeriod definition. Defaults to return              the latest version of the definition if not specified.
     * @param propertyKeys A list of property keys from the \&#39;ClosedPeriod\&#39; domain to decorate onto              the ClosedPeriod.              These must have the format {domain}/{scope}/{code}, for example \&#39;ClosedPeriod/system/Name\&#39;.
     */
    public async getClosedPeriod (scope: string, code: string, closedPeriodId: string, asAt?: Date, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ClosedPeriod;  }> {
        const localVarPath = this.basePath + '/api/timelines/{scope}/{code}/closedperiods/{closedPeriodId}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'closedPeriodId' + '}', encodeURIComponent(String(closedPeriodId)));
        let localVarQueryParameters: any = {};
     ...
     * @summary [EXPERIMENTAL] GetTimeline: Get a single Timeline by scope and code.
     * @param scope The scope of the specified Timeline.
     * @param code The code of the specified Timeline. Together with the scope this uniquely              identifies the Timeline.
     * @param asAt The asAt datetime at which to retrieve the Timeline definition. Defaults to return              the latest version of the definition if not specified.
     * @param effectiveAt The effective datetime or cut label at which to retrieve the timeline properties.              Defaults to the current LUSID system datetime if not specified.
     * @param propertyKeys A list of property keys from the \&#39;Timeline\&#39; domain to decorate onto              the Timeline.              These must have the format {domain}/{scope}/{code}, for example \&#39;Timeline/system/Name\&#39;.
     */
    public async getTimeline (scope: string, code: string, asAt?: Date, effectiveAt?: string, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Timeline;  }> {
        const localVarPath = this.basePath + '/api/timelines/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
     ...
     * @summary [EXPERIMENTAL] ListClosedPeriods: List ClosedPeriods for a specified Timeline.
     * @param scope The scope of the Timeline.
     * @param code The code of the Timeline.
     * @param asAt The asAt datetime at which to list the ClosedPeriods. Defaults to returning the latest version of each ClosedPeriod if not specified.
     ...
     * @param propertyKeys A list of property keys from the \&#39;ClosedPeriod\&#39; domain to decorate onto each ClosedPeriod.              These must take the format {domain}/{scope}/{code}, for example \&#39;ClosedPeriod/Account/id\&#39;.
     */
    public async listClosedPeriods (scope: string, code: string, asAt?: Date, page?: string, limit?: number, filter?: string, sortBy?: Array<string>, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfClosedPeriod;  }> {
        const localVarPath = this.basePath + '/api/timelines/{scope}/{code}/closedperiods'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfClosedPeriod;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfClosedPeriod");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] ListTimelines: List Timelines
     * @param asAt The asAt datetime at which to list the Timelines. Defaults to returning the latest version of each Timeline if not specified.
     * @param effectiveAt The effective datetime or cut label at which to list the Timelines.              Note that Timelines are monotemporal, the effectiveAt is for Timevariant Properties on the Timeline only.              Defaults to the current LUSID system datetime if not specified.
     ...
     * @param sortBy A list of field names or properties to sort by, each suffixed by \&quot; ASC\&quot; or \&quot; DESC\&quot;
     * @param propertyKeys A list of property keys from the \&#39;Timeline\&#39; domain to decorate onto each Timeline.              These must take the format {domain}/{scope}/{code}, for example \&#39;Timeline/Account/id\&#39;.
     */
    public async listTimelines (asAt?: Date, effectiveAt?: string, page?: string, limit?: number, filter?: string, sortBy?: Array<string>, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfTimeline;  }> {
        const localVarPath = this.basePath + '/api/timelines';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfTimeline;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfTimeline");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] SetPostCloseActivity: Sets post-close activities to a Closed Period.
     * @param scope The scope of the Timeline.
     * @param code The code of the Timeline.
     * @param closedPeriodId The ID of the Closed Period.               This ID together with the scope and code of the Timeline uniquely defines the Closed Period.
     * @param postCloseActivitiesRequest This specifies a collection of post-close activities.
     */
    public async setPostCloseActivity (scope: string, code: string, closedPeriodId: string, postCloseActivitiesRequest?: PostCloseActivitiesRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ClosedPeriod;  }> {
        const localVarPath = this.basePath + '/api/timelines/{scope}/{code}/closedperiods/{closedPeriodId}/postcloseactivity'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'closedPeriodId' + '}', encodeURIComponent(String(closedPeriodId)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling setPostCloseActivity.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling setPostCloseActivity.');
        }

        // verify required parameter 'closedPeriodId' is not null or undefined
        if (closedPeriodId === null || closedPeriodId === undefined) {
            throw new Error('Required parameter closedPeriodId was null or undefined when calling setPostCloseActivity.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(postCloseActivitiesRequest, "PostCloseActivitiesRequest")
        };
     ...
     * @summary [EXPERIMENTAL] UnconfirmClosedPeriod: Unconfirm a confirmed Closed Period against a Timeline Entity
     * @param scope The scope of the specified Timeline.
     * @param code The code of the specified Timeline. Together with the scope this uniquely identifies the Timeline.
     * @param closedPeriodId The id of the Closed Period. Together with the scope and code of the Timeline,              this uniquely identifies the ClosedPeriod. Must be the latest confirmed Closed Period unless              deleteSubsequentPeriods is set on the request body.
     * @param unconfirmClosedPeriodRequest Controls whether a non-latest confirmed Closed Period may be unconfirmed.
     */
    public async unconfirmClosedPeriod (scope: string, code: string, closedPeriodId: string, unconfirmClosedPeriodRequest?: UnconfirmClosedPeriodRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ClosedPeriod;  }> {
        const localVarPath = this.basePath + '/api/timelines/{scope}/{code}/closedperiods/{closedPeriodId}/$unconfirm'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'closedPeriodId' + '}', encodeURIComponent(String(closedPeriodId)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling unconfirmClosedPeriod.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling unconfirmClosedPeriod.');
        }

        // verify required parameter 'closedPeriodId' is not null or undefined
        if (closedPeriodId === null || closedPeriodId === undefined) {
            throw new Error('Required parameter closedPeriodId was null or undefined when calling unconfirmClosedPeriod.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(unconfirmClosedPeriodRequest, "UnconfirmClosedPeriodRequest")
        };
     ...
     * @summary [EXPERIMENTAL] UpdateTimeline: Update Timeline defined by scope and code
     * @param scope The scope of the specified Timeline.
     * @param code The code of the specified Timeline. Together with the domain and scope this uniquely identifies the Timeline.
     * @param updateTimelineRequest The request containing the updated details of the Timeline
     */
    public async updateTimeline (scope: string, code: string, updateTimelineRequest?: UpdateTimelineRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Timeline;  }> {
        const localVarPath = this.basePath + '/api/timelines/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(updateTimelineRequest, "UpdateTimelineRequest")
        };
