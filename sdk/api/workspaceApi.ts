...
export class WorkspaceApi {
     ...
     * @summary [EXPERIMENTAL] CreateItem: Create a new item in a workspace.
     * @param visibility The visibility for the containing workspace; case is important. Available values: shared, personal.
     * @param workspaceName The item\&#39;s workspace name.
     * @param workspaceItemCreationRequest The item to be created.
     */
    public async createItem (visibility: 'shared' | 'personal', workspaceName: string, workspaceItemCreationRequest?: WorkspaceItemCreationRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WorkspaceItem;  }> {
        const localVarPath = this.basePath + '/api/workspaces/{visibility}/{workspaceName}/items'
     ...
     * @summary [EXPERIMENTAL] CreateWorkspace: Create a new workspace.
     * @param visibility The visibility for the workspace being created; case is important. Available values: shared, personal.
     * @param workspaceCreationRequest The workspace to be created.
     * @param includeItemAccess If true, includes the workspace item actions the user is permitted to perform in the response. Defaults to false.
     */
    public async createWorkspace (visibility: 'shared' | 'personal', workspaceCreationRequest: WorkspaceCreationRequest, includeItemAccess?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Workspace;  }> {
        const localVarPath = this.basePath + '/api/workspaces/{visibility}'
            .replace('{' + 'visibility' + '}', encodeURIComponent(String(visibility)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        if (workspaceCreationRequest === null || workspaceCreationRequest === undefined) {
            throw new Error('Required parameter workspaceCreationRequest was null or undefined when calling createWorkspace.');
        }

        if (includeItemAccess !== undefined) {
            localVarQueryParameters['includeItemAccess'] = ObjectSerializer.serialize(includeItemAccess, "boolean");
        }
     ...
     * @summary [EXPERIMENTAL] DeleteItem: Delete an item from a workspace.
     * @param visibility The visibility for the containing workspace; case is important. Available values: shared, personal.
     * @param workspaceName The name of the workspace.
     * @param groupName The group containing the item.
     * @param itemName The name of the item.
     */
    public async deleteItem (visibility: 'shared' | 'personal', workspaceName: string, groupName: string, itemName: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/workspaces/{visibility}/{workspaceName}/items/{groupName}/{itemName}'
            .replace('{' + 'visibility' + '}', encodeURIComponent(String(visibility)))
            .replace('{' + 'workspaceName' + '}', encodeURIComponent(String(workspaceName)))
    ...
    /**
     * Delete a workspace.
     * @summary [EXPERIMENTAL] DeleteWorkspace: Delete a workspace.
     * @param visibility The visibility for the workspace; case is important. Available values: shared, personal.
     * @param workspaceName The name of the workspace.
     * @param recurse If true, recursively delete items in the workspace.
     */
    public async deleteWorkspace (visibility: 'shared' | 'personal', workspaceName: string, recurse?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/workspaces/{visibility}/{workspaceName}'
            .replace('{' + 'visibility' + '}', encodeURIComponent(String(visibility)))
            .replace('{' + 'workspaceName' + '}', encodeURIComponent(String(workspaceName)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @summary [EXPERIMENTAL] GetItem: Get a single workspace item.
     * @param visibility The visibility for the containing workspace; case is important. Available values: shared, personal.
     * @param workspaceName The name of the workspace.
     * @param groupName The group containing the item.
     * @param itemName The name of the item.
     ...
     */
    public async getItem (visibility: 'shared' | 'personal', workspaceName: string, groupName: string, itemName: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WorkspaceItem;  }> {
        const localVarPath = this.basePath + '/api/workspaces/{visibility}/{workspaceName}/items/{groupName}/{itemName}'
            .replace('{' + 'visibility' + '}', encodeURIComponent(String(visibility)))
            .replace('{' + 'workspaceName' + '}', encodeURIComponent(String(workspaceName)))
            .replace('{' + 'groupName' + '}', encodeURIComponent(String(groupName)))
    ...
    /**
     * Get a workspace.
     * @summary [EXPERIMENTAL] GetWorkspace: Get a workspace.
     * @param visibility The visibility for the workspace; case is important. Available values: shared, personal.
     * @param workspaceName The workspace name.
     * @param asAt The asAt datetime at which to retrieve workspaces. Defaults to \&#39;latest\&#39; if not specified.
     * @param includeItemAccess If true, includes the workspace item actions the user is permitted to perform in the response. Defaults to false.
     */
    public async getWorkspace (visibility: 'shared' | 'personal', workspaceName: string, asAt?: Date, includeItemAccess?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Workspace;  }> {
        const localVarPath = this.basePath + '/api/workspaces/{visibility}/{workspaceName}'
            .replace('{' + 'visibility' + '}', encodeURIComponent(String(visibility)))
            .replace('{' + 'workspaceName' + '}', encodeURIComponent(String(workspaceName)));
        let localVarQueryParameters: any = {};
     ...
     * @summary [EXPERIMENTAL] ListItems: List the items in a workspace.
     * @param visibility The visibility for the containing workspace; case is important. Available values: shared, personal.
     * @param workspaceName The item\&#39;s workspace name.
     ...
     */
    public async listItems (visibility: 'shared' | 'personal', workspaceName: string, asAt?: Date, page?: string, sortBy?: Array<string>, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfWorkspaceItem;  }> {
        const localVarPath = this.basePath + '/api/workspaces/{visibility}/{workspaceName}/items'
            .replace('{' + 'visibility' + '}', encodeURIComponent(String(visibility)))
            .replace('{' + 'workspaceName' + '}', encodeURIComponent(String(workspaceName)));
        let localVarQueryParameters: any = {};
    ...
    /**
     * List workspaces.
     * @summary [EXPERIMENTAL] ListWorkspaces: List workspaces.
     * @param visibility The visibility for the workspaces; case is important. Available values: shared, personal.
     * @param asAt The asAt datetime at which to retrieve workspaces. Defaults to \&#39;latest\&#39; if not specified.
     ...
     * @param includeItemAccess If true, includes the workspace item actions the user is permitted to perform in the response. Defaults to false.
     */
    public async listWorkspaces (visibility: 'shared' | 'personal', asAt?: Date, page?: string, sortBy?: Array<string>, limit?: number, filter?: string, includeItemAccess?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfWorkspace;  }> {
        const localVarPath = this.basePath + '/api/workspaces/{visibility}'
            .replace('{' + 'visibility' + '}', encodeURIComponent(String(visibility)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @summary [EXPERIMENTAL] SearchItems: List items across all workspaces.
     * @param visibility The visibility for the containing workspace; case is important. Available values: shared, personal.
     * @param asAt The asAt datetime at which to retrieve workspace items. Defaults to \&#39;latest\&#39; if not specified.
     * @param page The pagination token to use to continue listing workspaces items from a previous call to list workspaces items.              This value is returned from the previous call. If a pagination token is provided the sortBy, filter, effectiveAt, and asAt fields              must not have changed since the original request.
     * @param sortBy A list of field names to sort by, each suffixed by \&quot; ASC\&quot; or \&quot; DESC\&quot;.
     ...
     * @param filter Expression to filter the result set. Read more about filtering results from LUSID here:              https://support.lusid.com/filtering-results-from-lusid.
     */
    public async searchItems (visibility: 'shared' | 'personal', asAt?: Date, page?: string, sortBy?: Array<string>, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfItemAndWorkspace;  }> {
        const localVarPath = this.basePath + '/api/workspaces/{visibility}/items'
            .replace('{' + 'visibility' + '}', encodeURIComponent(String(visibility)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfItemAndWorkspace;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfItemAndWorkspace");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] UpdateItem: Update an item in a workspace.
     * @param visibility The visibility for the containing workspace; case is important. Available values: shared, personal.
     * @param workspaceName The workspace name.
     * @param groupName The group containing the item.
     ...
     */
    public async updateItem (visibility: 'shared' | 'personal', workspaceName: string, groupName: string, itemName: string, workspaceItemUpdateRequest?: WorkspaceItemUpdateRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WorkspaceItem;  }> {
        const localVarPath = this.basePath + '/api/workspaces/{visibility}/{workspaceName}/items/{groupName}/{itemName}'
            .replace('{' + 'visibility' + '}', encodeURIComponent(String(visibility)))
            .replace('{' + 'workspaceName' + '}', encodeURIComponent(String(workspaceName)))
            .replace('{' + 'groupName' + '}', encodeURIComponent(String(groupName)))
    ...
    /**
     * Update a workspace.
     * @summary [EXPERIMENTAL] UpdateWorkspace: Update a workspace.
     * @param visibility The visibility for the workspace; case is important. Available values: shared, personal.
     * @param workspaceName The workspace name.
     * @param workspaceUpdateRequest The new workspace details.
     * @param includeItemAccess If true, includes the workspace item actions the user is permitted to perform in the response. Defaults to false.
     */
    public async updateWorkspace (visibility: 'shared' | 'personal', workspaceName: string, workspaceUpdateRequest: WorkspaceUpdateRequest, includeItemAccess?: boolean, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Workspace;  }> {
        const localVarPath = this.basePath + '/api/workspaces/{visibility}/{workspaceName}'
            .replace('{' + 'visibility' + '}', encodeURIComponent(String(visibility)))
            .replace('{' + 'workspaceName' + '}', encodeURIComponent(String(workspaceName)));
        let localVarQueryParameters: any = {};
        ...
        if (workspaceUpdateRequest === null || workspaceUpdateRequest === undefined) {
            throw new Error('Required parameter workspaceUpdateRequest was null or undefined when calling updateWorkspace.');
        }
