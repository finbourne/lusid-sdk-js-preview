...
export class WorkspaceApi {
     ...
     */
    public async createWorkspace (visibility: 'shared' | 'personal', workspaceCreationRequest?: WorkspaceCreationRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Workspace;  }> {
     ...
     */
    public async getWorkspace (visibility: 'shared' | 'personal', workspaceName: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Workspace;  }> {
        const localVarPath = this.basePath + '/api/workspaces/{visibility}/{workspaceName}'
            .replace('{' + 'visibility' + '}', encodeURIComponent(String(visibility)))
            .replace('{' + 'workspaceName' + '}', encodeURIComponent(String(workspaceName)));
        let localVarQueryParameters: any = {};
     ...
     * @param filter Expression to filter the result set. Read more about filtering results from LUSID here:              https://support.lusid.com/filtering-results-from-lusid.
     */
    public async listWorkspaces (visibility: 'shared' | 'personal', asAt?: Date, page?: string, sortBy?: Array<string>, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfWorkspace;  }> {
        const localVarPath = this.basePath + '/api/workspaces/{visibility}'
            .replace('{' + 'visibility' + '}', encodeURIComponent(String(visibility)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     */
    public async updateWorkspace (visibility: 'shared' | 'personal', workspaceName: string, workspaceUpdateRequest?: WorkspaceUpdateRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Workspace;  }> {
        const localVarPath = this.basePath + '/api/workspaces/{visibility}/{workspaceName}'
            .replace('{' + 'visibility' + '}', encodeURIComponent(String(visibility)))
            .replace('{' + 'workspaceName' + '}', encodeURIComponent(String(workspaceName)));
        let localVarQueryParameters: any = {};
