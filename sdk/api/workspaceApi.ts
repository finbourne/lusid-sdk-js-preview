...
export class WorkspaceApi {
     ...
     * @summary [EARLY ACCESS] CreatePersonalItem: Create a new item in a personal workspace.
     ...
     * @summary [EARLY ACCESS] CreatePersonalWorkspace: Create a new personal workspace.
     ...
     * @summary [EARLY ACCESS] CreateSharedItem: Create a new item in a shared workspace.
     * @param workspaceName The item\&#39;s workspace name.
     * @param workspaceItemCreationRequest The item to be created.
     */
     ...
     * @summary [EARLY ACCESS] CreateSharedWorkspace: Create a new shared workspace.
     * @param workspaceCreationRequest The workspace to be created.
     */
     ...
     * @summary [EARLY ACCESS] DeletePersonalItem: Delete an item from a personal workspace.
     * @param workspaceName The name of the personal workspace.
     * @param itemName The name of the item.
     */
    public async deletePersonalItem (workspaceName: string, itemName: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/workspaces/personal/{workspaceName}/items/{itemName}'
            .replace('{' + 'workspaceName' + '}', encodeURIComponent(String(workspaceName)))
     ...
     * @summary [EARLY ACCESS] DeletePersonalWorkspace: Delete a personal workspace.
     * @param workspaceName The name of the personal workspace.
     */
     ...
     * @summary [EARLY ACCESS] DeleteSharedItem: Delete an item from a shared workspace.
     * @param workspaceName The name of the shared workspace.
     * @param itemName The name of the item.
     */
    public async deleteSharedItem (workspaceName: string, itemName: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/workspaces/shared/{workspaceName}/items/{itemName}'
            .replace('{' + 'workspaceName' + '}', encodeURIComponent(String(workspaceName)))
            .replace('{' + 'itemName' + '}', encodeURIComponent(String(itemName)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @summary [EARLY ACCESS] DeleteSharedWorkspace: Delete a shared workspace.
     * @param workspaceName The name of the shared workspace.
     */
     ...
     * @summary [EARLY ACCESS] GetPersonalItem: Get a single personal workspace item.
     * @param workspaceName The name of the personal workspace.
     * @param itemName The name of the item.
     * @param asAt The datetime at which to request the workspace item. If not provided, defaults to \&#39;latest\&#39;.
     */
    public async getPersonalItem (workspaceName: string, itemName: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WorkspaceItem;  }> {
        const localVarPath = this.basePath + '/api/workspaces/personal/{workspaceName}/items/{itemName}'
            .replace('{' + 'workspaceName' + '}', encodeURIComponent(String(workspaceName)))
            .replace('{' + 'itemName' + '}', encodeURIComponent(String(itemName)));
        let localVarQueryParameters: any = {};
     ...
     * @summary [EARLY ACCESS] GetPersonalWorkspace: Get a personal workspace.
     ...
     * @summary [EARLY ACCESS] GetSharedItem: Get a single shared workspace item.
     * @param workspaceName The name of the shared workspace.
     * @param itemName The name of the item.
     * @param asAt The datetime at which to request the workspace item. If not provided, defaults to \&#39;latest\&#39;.
     */
    public async getSharedItem (workspaceName: string, itemName: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WorkspaceItem;  }> {
        const localVarPath = this.basePath + '/api/workspaces/shared/{workspaceName}/items/{itemName}'
            .replace('{' + 'workspaceName' + '}', encodeURIComponent(String(workspaceName)))
            .replace('{' + 'itemName' + '}', encodeURIComponent(String(itemName)));
        let localVarQueryParameters: any = {};
     ...
     * @summary [EARLY ACCESS] GetSharedWorkspace: Get a shared workspace.
     ...
     * @summary [EARLY ACCESS] ListPersonalItems: List the items in a personal workspace.
     * @param workspaceName The item\&#39;s workspace name.
     ...
     * @summary [EARLY ACCESS] ListPersonalWorkspaces: List personal workspaces.
     * @param asAt The asAt datetime at which to retrieve workspaces. Defaults to \&#39;latest\&#39; if not specified.
     ...
     * @summary [EARLY ACCESS] ListSharedItems: List the items in a shared workspace.
     * @param workspaceName The item\&#39;s workspace name.
     * @param asAt The asAt datetime at which to retrieve workspace items. Defaults to \&#39;latest\&#39; if not specified.
     * @param page The pagination token to use to continue listing workspaces items from a previous call to list workspaces items.              This value is returned from the previous call. If a pagination token is provided the sortBy, filter, effectiveAt, and asAt fields              must not have changed since the original request.
     * @param sortBy A list of field names to sort by, each suffixed by \&quot; ASC\&quot; or \&quot; DESC\&quot;.
     ...
     * @summary [EARLY ACCESS] ListSharedWorkspaces: List shared workspaces.
     * @param asAt The asAt datetime at which to retrieve workspaces. Defaults to \&#39;latest\&#39; if not specified.
     * @param page The pagination token to use to continue listing workspaces from a previous call to list workspaces.              This value is returned from the previous call. If a pagination token is provided the sortBy, filter, effectiveAt, and asAt fields              must not have changed since the original request.
     * @param sortBy A list of field names to sort by, each suffixed by \&quot; ASC\&quot; or \&quot; DESC\&quot;.
     * @param limit When paginating, limit the number of returned results to this many.
     ...
     * @summary [EARLY ACCESS] UpdatePersonalItem: Update an item in a personal workspace.
     * @param workspaceName The personal workspace name.
     * @param itemName The item name.
     * @param workspaceItemUpdateRequest The new item details.
     */
    public async updatePersonalItem (workspaceName: string, itemName: string, workspaceItemUpdateRequest?: WorkspaceItemUpdateRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WorkspaceItem;  }> {
        const localVarPath = this.basePath + '/api/workspaces/personal/{workspaceName}/items/{itemName}'
            .replace('{' + 'workspaceName' + '}', encodeURIComponent(String(workspaceName)))
            .replace('{' + 'itemName' + '}', encodeURIComponent(String(itemName)));
        let localVarQueryParameters: any = {};
     ...
     * @summary [EARLY ACCESS] UpdatePersonalWorkspace: Update a personal workspace.
     * @param workspaceName The personal workspace name.
     ...
     * @summary [EARLY ACCESS] UpdateSharedItem: Update an item in a shared workspace.
     * @param workspaceName The shared workspace name.
     * @param itemName The item name.
     * @param workspaceItemUpdateRequest The new item details.
     */
    public async updateSharedItem (workspaceName: string, itemName: string, workspaceItemUpdateRequest?: WorkspaceItemUpdateRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WorkspaceItem;  }> {
        const localVarPath = this.basePath + '/api/workspaces/shared/{workspaceName}/items/{itemName}'
            .replace('{' + 'workspaceName' + '}', encodeURIComponent(String(workspaceName)))
            .replace('{' + 'itemName' + '}', encodeURIComponent(String(itemName)));
        let localVarQueryParameters: any = {};
     ...
     * @summary [EARLY ACCESS] UpdateSharedWorkspace: Update a shared workspace.
     * @param workspaceName The shared workspace name.
     * @param workspaceUpdateRequest The new workspace details.
     */
