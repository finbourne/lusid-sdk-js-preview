...
export enum WorkspaceApiApiKeys {
}
...
export class WorkspaceApi {
    ...
    public setApiKey(key: WorkspaceApiApiKeys, value: string) {
        (this.authentications as any)[WorkspaceApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EXPERIMENTAL] CreatePersonalItem: Create a new item in a personal workspace.
     * @param workspaceName The item\&#39;s workspace name.
     * @param workspaceItemCreationRequest The item to be created.
     */
    public async createPersonalItem (workspaceName: string, workspaceItemCreationRequest?: WorkspaceItemCreationRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WorkspaceItem;  }> {
        const localVarPath = this.basePath + '/api/workspaces/personal/{workspaceName}/items'
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(workspaceItemCreationRequest, "WorkspaceItemCreationRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: WorkspaceItem;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "WorkspaceItem");
     ...
     * @summary [EXPERIMENTAL] CreatePersonalWorkspace: Create a new personal workspace.
     * @param workspaceCreationRequest The workspace to be created.
     */
    public async createPersonalWorkspace (workspaceCreationRequest?: WorkspaceCreationRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Workspace;  }> {
        const localVarPath = this.basePath + '/api/workspaces/personal';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(workspaceCreationRequest, "WorkspaceCreationRequest")
        };
     ...
     * @summary [EXPERIMENTAL] CreateSharedItem: Create a new item in a shared workspace.
     * @param workspaceName The item\&#39;s workspace name.
     * @param workspaceItemCreationRequest The item to be created.
     */
    public async createSharedItem (workspaceName: string, workspaceItemCreationRequest?: WorkspaceItemCreationRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WorkspaceItem;  }> {
        const localVarPath = this.basePath + '/api/workspaces/shared/{workspaceName}/items'
            .replace('{' + 'workspaceName' + '}', encodeURIComponent(String(workspaceName)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
     ...
     * @summary [EXPERIMENTAL] CreateSharedWorkspace: Create a new shared workspace.
     * @param workspaceCreationRequest The workspace to be created.
     */
    public async createSharedWorkspace (workspaceCreationRequest?: WorkspaceCreationRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Workspace;  }> {
        const localVarPath = this.basePath + '/api/workspaces/shared';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
     ...
     * @summary [EXPERIMENTAL] DeletePersonalItem: Delete an item from a personal workspace.
     * @param workspaceName The name of the personal workspace.
     * @param groupName The group containing the item.
     * @param itemName The name of the item.
     */
    public async deletePersonalItem (workspaceName: string, groupName: string, itemName: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/workspaces/personal/{workspaceName}/items/{groupName}/{itemName}'
            .replace('{' + 'workspaceName' + '}', encodeURIComponent(String(workspaceName)))
        ...
        if (groupName === null || groupName === undefined) {
            throw new Error('Required parameter groupName was null or undefined when calling deletePersonalItem.');
        }
     ...
     * @summary [EXPERIMENTAL] DeletePersonalWorkspace: Delete a personal workspace.
     * @param workspaceName The name of the personal workspace.
     */
    public async deletePersonalWorkspace (workspaceName: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/workspaces/personal/{workspaceName}'
            .replace('{' + 'workspaceName' + '}', encodeURIComponent(String(workspaceName)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
     ...
     * @summary [EXPERIMENTAL] DeleteSharedItem: Delete an item from a shared workspace.
     * @param workspaceName The name of the shared workspace.
     * @param groupName The group containing the item.
     * @param itemName The name of the item.
     */
    public async deleteSharedItem (workspaceName: string, groupName: string, itemName: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/workspaces/shared/{workspaceName}/items/{groupName}/{itemName}'
            .replace('{' + 'workspaceName' + '}', encodeURIComponent(String(workspaceName)))
            .replace('{' + 'groupName' + '}', encodeURIComponent(String(groupName)))
            .replace('{' + 'itemName' + '}', encodeURIComponent(String(itemName)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'groupName' is not null or undefined
        if (groupName === null || groupName === undefined) {
            throw new Error('Required parameter groupName was null or undefined when calling deleteSharedItem.');
        }
     ...
     * @summary [EXPERIMENTAL] DeleteSharedWorkspace: Delete a shared workspace.
     * @param workspaceName The name of the shared workspace.
     */
    public async deleteSharedWorkspace (workspaceName: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/workspaces/shared/{workspaceName}'
            .replace('{' + 'workspaceName' + '}', encodeURIComponent(String(workspaceName)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
     ...
     * @summary [EXPERIMENTAL] GetPersonalItem: Get a single personal workspace item.
     * @param workspaceName The name of the personal workspace.
     * @param groupName The group containing the item.
     * @param itemName The name of the item.
     * @param asAt The datetime at which to request the workspace item. If not provided, defaults to \&#39;latest\&#39;.
     */
    public async getPersonalItem (workspaceName: string, groupName: string, itemName: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WorkspaceItem;  }> {
        const localVarPath = this.basePath + '/api/workspaces/personal/{workspaceName}/items/{groupName}/{itemName}'
            .replace('{' + 'workspaceName' + '}', encodeURIComponent(String(workspaceName)))
            .replace('{' + 'groupName' + '}', encodeURIComponent(String(groupName)))
            .replace('{' + 'itemName' + '}', encodeURIComponent(String(itemName)));
        ...
        // verify required parameter 'groupName' is not null or undefined
        if (groupName === null || groupName === undefined) {
            throw new Error('Required parameter groupName was null or undefined when calling getPersonalItem.');
        }
     ...
     * @summary [EXPERIMENTAL] GetPersonalWorkspace: Get a personal workspace.
     ...
     */
    public async getPersonalWorkspace (workspaceName: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Workspace;  }> {
        const localVarPath = this.basePath + '/api/workspaces/personal/{workspaceName}'
            .replace('{' + 'workspaceName' + '}', encodeURIComponent(String(workspaceName)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @summary [EXPERIMENTAL] GetSharedItem: Get a single shared workspace item.
     * @param workspaceName The name of the shared workspace.
     * @param groupName The group containing the item.
     * @param itemName The name of the item.
     * @param asAt The datetime at which to request the workspace item. If not provided, defaults to \&#39;latest\&#39;.
     */
    public async getSharedItem (workspaceName: string, groupName: string, itemName: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WorkspaceItem;  }> {
        const localVarPath = this.basePath + '/api/workspaces/shared/{workspaceName}/items/{groupName}/{itemName}'
            .replace('{' + 'workspaceName' + '}', encodeURIComponent(String(workspaceName)))
            .replace('{' + 'groupName' + '}', encodeURIComponent(String(groupName)))
            .replace('{' + 'itemName' + '}', encodeURIComponent(String(itemName)));
        ...
        // verify required parameter 'groupName' is not null or undefined
        if (groupName === null || groupName === undefined) {
            throw new Error('Required parameter groupName was null or undefined when calling getSharedItem.');
        }
     ...
     * @summary [EXPERIMENTAL] GetSharedWorkspace: Get a shared workspace.
     * @param workspaceName The shared workspace name.
     * @param asAt The asAt datetime at which to retrieve workspaces. Defaults to \&#39;latest\&#39; if not specified.
     */
    public async getSharedWorkspace (workspaceName: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Workspace;  }> {
        const localVarPath = this.basePath + '/api/workspaces/shared/{workspaceName}'
            .replace('{' + 'workspaceName' + '}', encodeURIComponent(String(workspaceName)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @summary [EXPERIMENTAL] ListPersonalItems: List the items in a personal workspace.
     * @param workspaceName The item\&#39;s workspace name.
     ...
     */
    public async listPersonalItems (workspaceName: string, asAt?: Date, page?: string, sortBy?: Array<string>, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfWorkspaceItem;  }> {
        const localVarPath = this.basePath + '/api/workspaces/personal/{workspaceName}/items'
            .replace('{' + 'workspaceName' + '}', encodeURIComponent(String(workspaceName)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfWorkspaceItem;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfWorkspaceItem");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] ListPersonalWorkspaces: List personal workspaces.
     * @param asAt The asAt datetime at which to retrieve workspaces. Defaults to \&#39;latest\&#39; if not specified.
     ...
     * @param filter Expression to filter the result set. Read more about filtering results from LUSID here:              https://support.lusid.com/filtering-results-from-lusid.
     */
    public async listPersonalWorkspaces (asAt?: Date, page?: string, sortBy?: Array<string>, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfWorkspace;  }> {
        const localVarPath = this.basePath + '/api/workspaces/personal';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfWorkspace;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfWorkspace");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] ListSharedItems: List the items in a shared workspace.
     * @param workspaceName The item\&#39;s workspace name.
     * @param asAt The asAt datetime at which to retrieve workspace items. Defaults to \&#39;latest\&#39; if not specified.
     * @param page The pagination token to use to continue listing workspaces items from a previous call to list workspaces items.              This value is returned from the previous call. If a pagination token is provided the sortBy, filter, effectiveAt, and asAt fields              must not have changed since the original request.
     * @param sortBy A list of field names to sort by, each suffixed by \&quot; ASC\&quot; or \&quot; DESC\&quot;.
     ...
     * @param filter Expression to filter the result set. Read more about filtering results from LUSID here:              https://support.lusid.com/filtering-results-from-lusid.
     */
    public async listSharedItems (workspaceName: string, asAt?: Date, page?: string, sortBy?: Array<string>, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfWorkspaceItem;  }> {
        const localVarPath = this.basePath + '/api/workspaces/shared/{workspaceName}/items'
            .replace('{' + 'workspaceName' + '}', encodeURIComponent(String(workspaceName)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @summary [EXPERIMENTAL] ListSharedWorkspaces: List shared workspaces.
     * @param asAt The asAt datetime at which to retrieve workspaces. Defaults to \&#39;latest\&#39; if not specified.
     * @param page The pagination token to use to continue listing workspaces from a previous call to list workspaces.              This value is returned from the previous call. If a pagination token is provided the sortBy, filter, effectiveAt, and asAt fields              must not have changed since the original request.
     * @param sortBy A list of field names to sort by, each suffixed by \&quot; ASC\&quot; or \&quot; DESC\&quot;.
     * @param limit When paginating, limit the number of returned results to this many.
     * @param filter Expression to filter the result set. Read more about filtering results from LUSID here:              https://support.lusid.com/filtering-results-from-lusid.
     */
    public async listSharedWorkspaces (asAt?: Date, page?: string, sortBy?: Array<string>, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfWorkspace;  }> {
        const localVarPath = this.basePath + '/api/workspaces/shared';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
     ...
     * @summary [EXPERIMENTAL] UpdatePersonalItem: Update an item in a personal workspace.
     * @param workspaceName The personal workspace name.
     * @param groupName The group containing the item.
     * @param itemName The item name.
     * @param workspaceItemUpdateRequest The new item details.
     */
    public async updatePersonalItem (workspaceName: string, groupName: string, itemName: string, workspaceItemUpdateRequest?: WorkspaceItemUpdateRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WorkspaceItem;  }> {
        const localVarPath = this.basePath + '/api/workspaces/personal/{workspaceName}/items/{groupName}/{itemName}'
            .replace('{' + 'workspaceName' + '}', encodeURIComponent(String(workspaceName)))
            .replace('{' + 'groupName' + '}', encodeURIComponent(String(groupName)))
            .replace('{' + 'itemName' + '}', encodeURIComponent(String(itemName)));
        ...
        // verify required parameter 'groupName' is not null or undefined
        if (groupName === null || groupName === undefined) {
            throw new Error('Required parameter groupName was null or undefined when calling updatePersonalItem.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(workspaceItemUpdateRequest, "WorkspaceItemUpdateRequest")
        };
     ...
     * @summary [EXPERIMENTAL] UpdatePersonalWorkspace: Update a personal workspace.
     * @param workspaceName The personal workspace name.
     * @param workspaceUpdateRequest The new workspace details.
     */
    public async updatePersonalWorkspace (workspaceName: string, workspaceUpdateRequest?: WorkspaceUpdateRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Workspace;  }> {
        const localVarPath = this.basePath + '/api/workspaces/personal/{workspaceName}'
            .replace('{' + 'workspaceName' + '}', encodeURIComponent(String(workspaceName)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @summary [EXPERIMENTAL] UpdateSharedItem: Update an item in a shared workspace.
     * @param workspaceName The shared workspace name.
     * @param groupName The group containing the item.
     * @param itemName The item name.
     * @param workspaceItemUpdateRequest The new item details.
     */
    public async updateSharedItem (workspaceName: string, groupName: string, itemName: string, workspaceItemUpdateRequest?: WorkspaceItemUpdateRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: WorkspaceItem;  }> {
        const localVarPath = this.basePath + '/api/workspaces/shared/{workspaceName}/items/{groupName}/{itemName}'
            .replace('{' + 'workspaceName' + '}', encodeURIComponent(String(workspaceName)))
            .replace('{' + 'groupName' + '}', encodeURIComponent(String(groupName)))
            .replace('{' + 'itemName' + '}', encodeURIComponent(String(itemName)));
        ...
        // verify required parameter 'groupName' is not null or undefined
        if (groupName === null || groupName === undefined) {
            throw new Error('Required parameter groupName was null or undefined when calling updateSharedItem.');
        }
     ...
     * @summary [EXPERIMENTAL] UpdateSharedWorkspace: Update a shared workspace.
     * @param workspaceName The shared workspace name.
     * @param workspaceUpdateRequest The new workspace details.
     */
    public async updateSharedWorkspace (workspaceName: string, workspaceUpdateRequest?: WorkspaceUpdateRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Workspace;  }> {
        const localVarPath = this.basePath + '/api/workspaces/shared/{workspaceName}'
            .replace('{' + 'workspaceName' + '}', encodeURIComponent(String(workspaceName)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
