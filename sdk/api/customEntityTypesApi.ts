...
export enum CustomEntityTypesApiApiKeys {
}

export class CustomEntityTypesApi {
    ...
    public setApiKey(key: CustomEntityTypesApiApiKeys, value: string) {
        (this.authentications as any)[CustomEntityTypesApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EARLY ACCESS] CreateCustomEntityType: Define a new Custom Entity Type.
     * @param createCustomEntityTypeRequest The payload containing the description of the Custom Entity Type.
     */
    public async createCustomEntityType (createCustomEntityTypeRequest: CreateCustomEntityTypeRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CustomEntityType;  }> {
        const localVarPath = this.basePath + '/api/customentitytypes';
        ...
        // verify required parameter 'createCustomEntityTypeRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(createCustomEntityTypeRequest, "CreateCustomEntityTypeRequest")
        };
            ...
            return new Promise<{ response: http.IncomingMessage; body: CustomEntityType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        ...
                        body = ObjectSerializer.deserialize(body, "CustomEntityType");
     ...
     * @summary [EARLY ACCESS] GetCustomEntityType: Get a Custom Entity Type.
     ...
     */
    public async getCustomEntityType (entityType: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CustomEntityType;  }> {
        const localVarPath = this.basePath + '/api/customentitytypes/{entityType}'
     ...
     * @summary [EARLY ACCESS] ListCustomEntityTypes: List Custom Entity Types.
     ...
     */
    public async listCustomEntityTypes (asAt?: Date, limit?: number, filter?: string, sortBy?: Array<string>, page?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfCustomEntityType;  }> {
        const localVarPath = this.basePath + '/api/customentitytypes';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfCustomEntityType;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfCustomEntityType");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] UpdateCustomEntityType: Modify an existing Custom Entity Type.
     * @param entityType The identifier for the Custom Entity Type, derived from the \&quot;entityTypeName\&quot; provided on creation.
     * @param updateCustomEntityTypeRequest The payload containing the description of the Custom Entity Type.
     */
    public async updateCustomEntityType (entityType: string, updateCustomEntityTypeRequest: UpdateCustomEntityTypeRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CustomEntityType;  }> {
        const localVarPath = this.basePath + '/api/customentitytypes/{entityType}'
            .replace('{' + 'entityType' + '}', encodeURIComponent(String(entityType)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'updateCustomEntityTypeRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(updateCustomEntityTypeRequest, "UpdateCustomEntityTypeRequest")
        };
