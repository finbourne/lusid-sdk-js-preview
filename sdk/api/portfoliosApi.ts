...
export class PortfoliosApi {
     ...
     * @summary [EXPERIMENTAL] DeleteKeyFromPortfolioAccessMetadata: Delete a Portfolio Access Metadata Rule
     ...
     * @summary [EXPERIMENTAL] DeletePortfolioReturns: Delete Returns
     * @param scope The scope of the Portfolio.
     ...
     * @summary [EXPERIMENTAL] GetPortfolioAggregateReturns: Aggregate Returns (This is a deprecated endpoint).
     * @param scope The scope of the Portfolio.
     * @param code The code of the  Portfolio.
     * @param returnScope The scope of the Returns.
     * @param returnCode The code of the Returns.
    ...
    /**
     * Aggregate Returns which are on the specified portfolio.
     * @summary [EXPERIMENTAL] GetPortfolioAggregatedReturns: Aggregated Returns
     * @param scope The scope of the Portfolio.
     * @param code The code of the  Portfolio.
     * @param returnScope The scope of the Returns.
     * @param returnCode The code of the Returns.
    ...
    public async getPortfolioAggregatedReturns (scope: string, code: string, returnScope: string, returnCode: string, aggregatedReturnsRequest: AggregatedReturnsRequest, fromEffectiveAt?: string, toEffectiveAt?: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfAggregatedReturn;  }> {
        ...
        // verify required parameter 'returnScope' is not null or undefined
        if (returnScope === null || returnScope === undefined) {
            throw new Error('Required parameter returnScope was null or undefined when calling getPortfolioAggregatedReturns.');
        }

        // verify required parameter 'returnCode' is not null or undefined
        if (returnCode === null || returnCode === undefined) {
            throw new Error('Required parameter returnCode was null or undefined when calling getPortfolioAggregatedReturns.');
        }
     ...
     * @summary [EARLY ACCESS] GetPortfolioCommands: Get portfolio commands
     * @param scope The scope of the portfolio.
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio.
     ...
     * @summary [EXPERIMENTAL] GetPortfolioMetadata: Get access metadata rules for a portfolio
     ...
     * @summary [EXPERIMENTAL] GetPortfolioPropertyTimeSeries: Get portfolio property time series
     * @param scope The scope of the portfolio.
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio.
     ...
     * @summary [EXPERIMENTAL] GetPortfolioRelationships: Get portfolio relationships
     * @param scope The scope of the portfolio.
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio.
     ...
     * @summary [EXPERIMENTAL] GetPortfoliosAccessMetadataByKey: Get an entry identified by a metadataKey in the access metadata object
     * @param scope The scope of the Portfolio Access Metadata Rule to retrieve.
     * @param code The code of the portfolio
    ...
    /**
     * List all the properties of a particular portfolio.
     * @summary [EXPERIMENTAL] ListPortfolioProperties: Get portfolio properties
     * @param scope The scope of the portfolio.
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio.
     * @param effectiveAt The effective datetime or cut label at which to list the portfolio\&#39;s properties. Defaults to the current LUSID system datetime if not specified.
     * @param asAt The asAt datetime at which to list the portfolio\&#39;s properties. Defaults to returning the latest version of each property if not specified.
     ...
     * @summary [EXPERIMENTAL] UpsertPortfolioAccessMetadata: Upsert a Portfolio Access Metadata Rule associated with specific metadataKey. This creates or updates the data in LUSID.
