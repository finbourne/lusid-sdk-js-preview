...
export class PortfoliosApi {
     ...
     * @param key The key identifying the access metadata entry to delete
     * @param effectiveAt The effective date to delete at, if this is not supplied, it will delete all data found
     */
    public async deleteKeyFromPortfolioAccessMetadata (scope: string, code: string, key: string, effectiveAt?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/portfolios/{scope}/{code}/metadata/{key}'
        ...
        if (key === null || key === undefined) {
            throw new Error('Required parameter key was null or undefined when calling deleteKeyFromPortfolioAccessMetadata.');
        }
     ...
     * @summary [EXPERIMENTAL] Get an entry identified by a key in the access metadata object
     * @param scope The scope of the Portfolio Access Metadata Rule to retrieve.
     * @param code The code of the portfolio
     ...
     * @param asAt The asAt datetime at which to retrieve the portfolio access metadata.
     */
    public async getPortfoliosAccessMetadataByKey (scope: string, code: string, key: string, effectiveAt?: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Array<AccessMetadataValue>;  }> {
        const localVarPath = this.basePath + '/api/portfolios/{scope}/{code}/metadata/{key}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'key' + '}', encodeURIComponent(String(key)));
        ...
        // verify required parameter 'key' is not null or undefined
        if (key === null || key === undefined) {
            throw new Error('Required parameter key was null or undefined when calling getPortfoliosAccessMetadataByKey.');
        }
     ...
     * @summary [EXPERIMENTAL] Upsert a Portfolio Access Metadata Rule associated with specific key. This creates or updates the data in LUSID.
     * @param scope The scope to use when updating or inserting the Portfolio Access Metadata Rule.
     * @param code Portfolio code
     * @param key Key of the access metadata to upsert
     * @param request The Portfolio Access Metadata Rule to update or insert
     * @param effectiveAt The date this rule will effective from
     */
    public async upsertPortfolioAccessMetadata (scope: string, code: string, key: string, request: UpsertPortfolioAccessMetadataRequest, effectiveAt?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfAccessMetadataValueOf;  }> {
        const localVarPath = this.basePath + '/api/portfolios/{scope}/{code}/metadata/{key}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'key' + '}', encodeURIComponent(String(key)));
        ...
        // verify required parameter 'key' is not null or undefined
        if (key === null || key === undefined) {
            throw new Error('Required parameter key was null or undefined when calling upsertPortfolioAccessMetadata.');
        }

        // verify required parameter 'request' is not null or undefined
        if (request === null || request === undefined) {
            throw new Error('Required parameter request was null or undefined when calling upsertPortfolioAccessMetadata.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(request, "UpsertPortfolioAccessMetadataRequest")
        };
