...
import { ResourceListOfPropertyIntervalTimeSeries } from '../model/resourceListOfPropertyIntervalTimeSeries';
...
export class PortfoliosApi {
     ...
     * @param timelineScope The scope of the Timeline, used to override the AsAt, and fetch post close activity data.              If this is provided, timelineCode must also be provided.
     * @param timelineCode The code of the Timeline, used to override the AsAt, and fetch post close activity data.              If this is provided, timelineScope must also be provided.
     * @param closedPeriodId The code of the ClosedPeriod attached to the timeline, used to override the AsAt, and fetch post close activity data.              If this field is left empty and the timelineScope and timelineCode fields are filled out, the portfolioEffectiveAt will be used to resolve the relevant closed period.
     */
    public async getInstrumentEventInstruction (scope: string, code: string, instrumentEventInstructionId: string, portfolioEffectiveAt?: string, asAt?: Date, timelineScope?: string, timelineCode?: string, closedPeriodId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InstrumentEventInstruction;  }> {
        const localVarPath = this.basePath + '/api/portfolios/{scope}/{code}/instrumenteventinstructions/{instrumentEventInstructionId}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)))
            .replace('{' + 'instrumentEventInstructionId' + '}', encodeURIComponent(String(instrumentEventInstructionId)));
     ...
     * @param fromEffectiveAt The start date from which to calculate the Returns.
     * @param toEffectiveAt The end date for which to calculate the Returns.
     * @param compositeMethod The method used to calculate the Portfolio performance. Available values: Equal, Asset.
     * @param period The type of the returns used to calculate the aggregation result. Available values: Daily, Monthly.
     * @param outputFrequency The type of calculated output. Available values: Daily, Weekly, Monthly, Quarterly, HalfYearly, Yearly.
     ...
     * @summary [BETA] GetPortfolioPropertiesTimeSeries: Get portfolio properties time series
     * @param scope The scope of the portfolio.
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio.
     * @param propertyKeys The property keys of the properties whose history to show. These must be from the \&#39;Portfolio\&#39; domain and in the format {domain}/{scope}/{code}, for example \&#39;Portfolio/Manager/Id\&#39;.
     ...
     * @param limit When paginating, limit the number of property keys returned per page to this number.
     */
    public async getPortfolioPropertiesTimeSeries (scope: string, code: string, propertyKeys: Array<string>, portfolioEffectiveAt?: string, asAt?: Date, filter?: string, page?: string, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfPropertyIntervalTimeSeries;  }> {
        const localVarPath = this.basePath + '/api/portfolios/{scope}/{code}/properties/time-series/batch'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling getPortfolioPropertiesTimeSeries.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling getPortfolioPropertiesTimeSeries.');
        }

        // verify required parameter 'propertyKeys' is not null or undefined
        if (propertyKeys === null || propertyKeys === undefined) {
            throw new Error('Required parameter propertyKeys was null or undefined when calling getPortfolioPropertiesTimeSeries.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ResourceListOfPropertyIntervalTimeSeries;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ResourceListOfPropertyIntervalTimeSeries");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] GetPortfolioRelations: Get portfolio relations
     * @param scope The scope of the portfolio.
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio.
     ...
     * @param closedPeriodId The code of the ClosedPeriod attached to the timeline, used to override the AsAt, and fetch post close activity data.              If this field is left empty and the timelineScope and timelineCode fields are filled out, the portfolioEffectiveAt will be used to resolve the relevant closed period.
     */
    public async listInstrumentEventInstructions (scope: string, code: string, portfolioEffectiveAt?: string, asAt?: Date, page?: string, limit?: number, filter?: string, sortBy?: Array<string>, timelineScope?: string, timelineCode?: string, closedPeriodId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfInstrumentEventInstruction;  }> {
