...
export class PortfoliosApi {
     ...
     * @summary [EXPERIMENTAL] BatchUpsertPortfolioAccessMetadata: Upsert multiple portfolio access metadata with different keys to multiple portfolios
     * @param batchUpsertPortfolioAccessMetadataRequest The Portfolio Access Metadata Rule to update or insert
     ...
     */
    public async batchUpsertPortfolioAccessMetadata (batchUpsertPortfolioAccessMetadataRequest: BatchUpsertPortfolioAccessMetadataRequest, effectiveAt?: string, effectiveUntil?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BatchUpsertPortfolioAccessMetadataResponse;  }> {
        ...
        // verify required parameter 'batchUpsertPortfolioAccessMetadataRequest' is not null or undefined
        if (batchUpsertPortfolioAccessMetadataRequest === null || batchUpsertPortfolioAccessMetadataRequest === undefined) {
            throw new Error('Required parameter batchUpsertPortfolioAccessMetadataRequest was null or undefined when calling batchUpsertPortfolioAccessMetadata.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(batchUpsertPortfolioAccessMetadataRequest, "BatchUpsertPortfolioAccessMetadataRequest")
        };
