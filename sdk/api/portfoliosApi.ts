...
export class PortfoliosApi {
     ...
     * @param outputFrequency The type of calculated output: Daily/Monthly/Yearly.
     * @param metrics The period time to calculate the aggregate return.
     * @param asAt The asAt datetime at which to retrieve the Returns. Defaults to the latest.
     */
    public async getPortfolioAggregateReturns (scope: string, code: string, returnScope: string, returnCode: string, fromEffectiveAt?: string, toEffectiveAt?: string, compositeMethod?: string, period?: string, outputFrequency?: string, metrics?: Array<string>, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfAggregatedReturn;  }> {
     ...
     * @param scope The scope of the portfolio.
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio.
     * @param fromAsAt The lower bound as-at datetime (inclusive) from which to retrieve commands. There is no lower bound if this is not specified.
     * @param toAsAt The upper bound as-at datetime (inclusive) from which to retrieve commands. There is no upper bound if this is not specified.
     ...
     * @param page The pagination token to use to continue listing commands from a previous call to GetPortfolioCommands.
     ...
     * @param asAt The as-at datetime at which to list the portfolio\&#39;s properties. Defaults to return the latest version of each property if not specified.
     */
     ...
     * @param scope The scope of the portfolio.
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio.
     * @param propertyKey The property key of the property that will have its history shown.              These must be from the \&#39;Portfolio\&#39; domain and in the format {domain}/{scope}/{code}, for example \&#39;Portfolio/Manager/Id\&#39;.
     ...
     * @param asAt The as-at datetime at which to list the portfolio\&#39;s property history. Defaults to return the current datetime if not supplied.
     ...
     * @param asAt The as-at datetime at which to retrieve relations. Defaults to return the latest LUSID AsAt time if not specified.
     ...
     * @param identifierTypes Identifiers types (as property keys) used for referencing Persons or Legal Entities.              These must be from the \&#39;Person\&#39; or \&#39;LegalEntity\&#39; domains and take the format {domain}/{scope}/{code}, for example              \&#39;Person/CompanyDetails/Role\&#39;. Only identifier types stated will be used to look up relevant entities in relations. If not applicable, provide an empty array.
     */
     ...
     * @param asAt The as-at datetime at which to retrieve relationships. Defaults to return the latest LUSID AsAt time if not specified.
     * @param filter Expression to filter the relationships. Users should provide null or empty string for this field until further notice.
     ...
     * @param asAt The as-at datetime at which to list the portfolios. Defaults to return the latest version              of each portfolio if not specified.
     ...
     * @param scope The scope of the portfolio.
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio.
     * @param requestBody The properties to be updated or inserted onto the portfolio. Each property in               the request must be keyed by its unique property key. This has the format {domain}/{scope}/{code}, for example               \&#39;Portfolio/Manager/Id\&#39;.
     */
