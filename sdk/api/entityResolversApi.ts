...
import { CreateEntityResolverRequest } from '../model/createEntityResolverRequest';
import { DeletedEntityResponse } from '../model/deletedEntityResponse';
import { EntityResolver } from '../model/entityResolver';
...
import { UpsertEntityResolverRequest } from '../model/upsertEntityResolverRequest';
...
export enum EntityResolversApiApiKeys {
}

export class EntityResolversApi {
    ...
    public setApiKey(key: EntityResolversApiApiKeys, value: string) {
        (this.authentications as any)[EntityResolversApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EXPERIMENTAL] CreateEntityResolver: Create an Entity Resolver
     * @param createEntityResolverRequest The request defining the new Entity Resolver
     */
    public async createEntityResolver (createEntityResolverRequest?: CreateEntityResolverRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: EntityResolver;  }> {
        const localVarPath = this.basePath + '/api/entityresolvers';
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(createEntityResolverRequest, "CreateEntityResolverRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: EntityResolver;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "EntityResolver");
     ...
     * @summary [EXPERIMENTAL] DeleteEntityResolver: Delete an Entity Resolver
     * @param scope The scope of the Entity Resolver
     * @param code The code of the Entity Resolver. Together with the scope this uniquely identifies the Entity Resolver
     */
    public async deleteEntityResolver (scope: string, code: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeletedEntityResponse;  }> {
        const localVarPath = this.basePath + '/api/entityresolvers/{scope}/{code}'
        ...
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling deleteEntityResolver.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling deleteEntityResolver.');
        }
     ...
     * @summary [EXPERIMENTAL] GetEntityResolver: Get a single Entity Resolver
     * @param scope The scope of the Entity Resolver
     * @param code The code of the Entity Resolver. Together with the scope this uniquely identifies the Entity Resolver
     * @param asAt The asAt datetime at which to retrieve the Entity Resolver. Defaults to return              the latest version if not specified.
     */
    public async getEntityResolver (scope: string, code: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: EntityResolver;  }> {
        const localVarPath = this.basePath + '/api/entityresolvers/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling getEntityResolver.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling getEntityResolver.');
        }
     ...
     * @summary [EXPERIMENTAL] UpdateEntityResolver: Update an Entity Resolver
     * @param scope The scope of the Entity Resolver
     * @param code The code of the Entity Resolver. Together with the scope this uniquely identifies the Entity Resolver
     * @param upsertEntityResolverRequest The request containing the updated details of the Entity Resolver
     */
    public async updateEntityResolver (scope: string, code: string, upsertEntityResolverRequest?: UpsertEntityResolverRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: EntityResolver;  }> {
        const localVarPath = this.basePath + '/api/entityresolvers/{scope}/{code}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        let localVarQueryParameters: any = {};
        ...
        // verify required parameter 'scope' is not null or undefined
        if (scope === null || scope === undefined) {
            throw new Error('Required parameter scope was null or undefined when calling updateEntityResolver.');
        }

        // verify required parameter 'code' is not null or undefined
        if (code === null || code === undefined) {
            throw new Error('Required parameter code was null or undefined when calling updateEntityResolver.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(upsertEntityResolverRequest, "UpsertEntityResolverRequest")
        };
