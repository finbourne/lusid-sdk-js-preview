...
export class ScriptedTranslationApi {
     ...
     */
    public async upsertTranslationDialect (upsertDialectRequest: UpsertDialectRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Dialect;  }> {
        ...
        // verify required parameter 'upsertDialectRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(upsertDialectRequest, "UpsertDialectRequest")
        };
     ...
     */
    public async upsertTranslationScript (upsertTranslationScriptRequest: UpsertTranslationScriptRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TranslationScript;  }> {
        ...
        // verify required parameter 'upsertTranslationScriptRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(upsertTranslationScriptRequest, "UpsertTranslationScriptRequest")
        };
