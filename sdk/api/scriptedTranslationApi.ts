...
export enum ScriptedTranslationApiApiKeys {
}

export class ScriptedTranslationApi {
    ...
    public setApiKey(key: ScriptedTranslationApiApiKeys, value: string) {
        (this.authentications as any)[ScriptedTranslationApiApiKeys[key]].apiKey = value;
    }
     ...
     * @summary [EARLY ACCESS] GetTranslationDialect: Get a dialect.
     ...
     */
    public async getTranslationDialect (scope: string, vendor: string, sourceSystem: string, entityType: string, serialisationFormat: string, version: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Dialect;  }> {
        const localVarPath = this.basePath + '/api/scriptedtranslation/dialects/{scope}/{vendor}/{sourceSystem}/{entityType}/{serialisationFormat}/{version}'
            ...
            .replace('{' + 'serialisationFormat' + '}', encodeURIComponent(String(serialisationFormat)))
        ...
        // verify required parameter 'serialisationFormat' is not null or undefined
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: Dialect;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "Dialect");
     ...
     * @summary [EARLY ACCESS] GetTranslationScript: Retrieve a translation script by its identifier.
     ...
     */
    public async getTranslationScript (scope: string, code: string, version: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TranslationScript;  }> {
        const localVarPath = this.basePath + '/api/scriptedtranslation/scripts/{scope}/{code}/{version}'
            .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: TranslationScript;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "TranslationScript");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] ListDialectIds: List dialect identifiers matching an optional filter.
     ...
     */
    public async listDialectIds (asAt?: Date, page?: string, limit?: number, filter?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfDialectId;  }> {
        const localVarPath = this.basePath + '/api/scriptedtranslation/dialects/ids';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfDialectId;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfDialectId");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] ListTranslationScriptIds: List translation script identifiers.
     ...
     */
    public async listTranslationScriptIds (asAt?: Date, limit?: number, filter?: string, page?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfTranslationScriptId;  }> {
        const localVarPath = this.basePath + '/api/scriptedtranslation/scripts/ids';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: PagedResourceListOfTranslationScriptId;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "PagedResourceListOfTranslationScriptId");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] TranslateEntities: Translate a collection of entities with a specified translation script.
     ...
     */
    public async translateEntities (translateEntitiesRequest: TranslateEntitiesRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TranslateEntitiesResponse;  }> {
        const localVarPath = this.basePath + '/api/scriptedtranslation/translateentities';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'translateEntitiesRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(translateEntitiesRequest, "TranslateEntitiesRequest")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: TranslateEntitiesResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "TranslateEntitiesResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EARLY ACCESS] TranslateEntitiesInlined: Translate a collection of entities, inlining the body of the translation script.
     ...
     */
    public async translateEntitiesInlined (translateEntitiesInlinedRequest: TranslateEntitiesInlinedRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TranslateEntitiesResponse;  }> {
        const localVarPath = this.basePath + '/api/scriptedtranslation/translateentitiesinlined';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'translateEntitiesInlinedRequest' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(translateEntitiesInlinedRequest, "TranslateEntitiesInlinedRequest")
        };
     ...
     * @summary [EARLY ACCESS] UpsertTranslationDialect: Upsert a Dialect.
     * @param dialect The dialect to upsert.
     */
    public async upsertTranslationDialect (dialect: Dialect, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Dialect;  }> {
        const localVarPath = this.basePath + '/api/scriptedtranslation/dialects';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'dialect' is not null or undefined
        if (dialect === null || dialect === undefined) {
            throw new Error('Required parameter dialect was null or undefined when calling upsertTranslationDialect.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(dialect, "Dialect")
        };
     ...
     * @summary [EARLY ACCESS] UpsertTranslationScript: Upsert a translation script.
     * @param translationScript The translation script to be upserted.
     */
    public async upsertTranslationScript (translationScript: TranslationScript, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: TranslationScript;  }> {
        const localVarPath = this.basePath + '/api/scriptedtranslation/scripts';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'translationScript' is not null or undefined
        if (translationScript === null || translationScript === undefined) {
            throw new Error('Required parameter translationScript was null or undefined when calling upsertTranslationScript.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(translationScript, "TranslationScript")
        };
