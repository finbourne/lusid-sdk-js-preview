...
export class InstrumentsApi {
     ...
     * @summary [EXPERIMENTAL] DeleteInstruments: Soft or hard delete multiple instruments
     ...
     * @summary [EXPERIMENTAL] GetInstrumentCapabilities: Given an lusid instrument id provides instrument capabilities, outlining features, and, given the model, the capabilities also include supported addresses as well as economic dependencies.
     ...
     */
    public async getInstrumentCapabilities (identifier: string, model?: string, effectiveAt?: string, asAt?: Date, instrumentScope?: string, recipeScope?: string, recipeCode?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InstrumentCapabilities;  }> {
        ...
        // verify required parameter 'identifier' is not null or undefined
        if (identifier === null || identifier === undefined) {
            throw new Error('Required parameter identifier was null or undefined when calling getInstrumentCapabilities.');
        }
    ...
    /**
     * Returns instrument capabilities containing useful information about the instrument and the model. This includes  - features corresponding to the instrument e.g. Optionality:American, Other:InflationLinked  - supported addresses (if model provided) e.g. Valuation/Pv, Valuation/DirtyPriceKey, Valuation/Accrued  - economic dependencies (if model provided) e.g. Cash:USD, Fx:GBP.USD, Rates:GBP.GBPOIS
     * @summary [EXPERIMENTAL] PostInstrumentCapabilities: Given an example instrument provides instrument capabilities, outlining features, and, given the model, the capabilities also include supported addresses as well as economic dependencies.
     ...
     * @param recipeCode A unique identifier for an entity, used to obtain configuration recipe details. Default configuration recipe is used if not provided.
     */
    public async postInstrumentCapabilities (lusidInstrument: LusidInstrument, model?: string, effectiveAt?: string, recipeScope?: string, recipeCode?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InstrumentCapabilities;  }> {
        ...
        if (lusidInstrument === null || lusidInstrument === undefined) {
            throw new Error('Required parameter lusidInstrument was null or undefined when calling postInstrumentCapabilities.');
        }
