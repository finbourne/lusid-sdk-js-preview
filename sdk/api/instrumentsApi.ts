...
export class InstrumentsApi {
     ...
     */
    public async batchUpsertInstrumentProperties (requestBody: { [key: string]: UpsertInstrumentPropertyRequest; }, scope?: string, identifierEffectiveAt?: string, successMode?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BatchUpsertInstrumentPropertiesResponse;  }> {
     ...
     * @param scope The scope in which the instrument lies. When not supplied the scope is \&#39;default\&#39;.
     */
    public async deleteInstrumentProperties (identifierType: string, identifier: string, requestBody: Array<string>, effectiveAt?: string, scope?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeleteInstrumentPropertiesResponse;  }> {
     ...
     * @param scope The scope in which the instrument lies. When not supplied the scope is \&#39;default\&#39;.
     */
    public async updateInstrumentIdentifier (identifierType: string, identifier: string, updateInstrumentIdentifierRequest: UpdateInstrumentIdentifierRequest, scope?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Instrument;  }> {
        const localVarPath = this.basePath + '/api/instruments/{identifierType}/{identifier}'
            .replace('{' + 'identifierType' + '}', encodeURIComponent(String(identifierType)))
            .replace('{' + 'identifier' + '}', encodeURIComponent(String(identifier)));
        let localVarQueryParameters: any = {};
     ...
     * @param scope The scope in which the instrument lies. When not supplied the scope is \&#39;default\&#39;.
     */
    public async upsertInstrumentsProperties (upsertInstrumentPropertyRequest: Array<UpsertInstrumentPropertyRequest>, scope?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UpsertInstrumentPropertiesResponse;  }> {
