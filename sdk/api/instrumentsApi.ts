...
export class InstrumentsApi {
     ...
     * @param propertyKeys The property keys of the properties to be deleted from the instrument. Only properties in the  Finbourne.WebApi.Interface.Dto.PropertyDomain.Instrument domain can be supplied.
     ...
     * @param instruments The definitions of the instruments to update or insert.
     */
    public async upsertLusidInstruments (instruments: { [key: string]: LusidInstrumentDefinition; }, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UpsertInstrumentsResponse;  }> {
        ...
        // verify required parameter 'instruments' is not null or undefined
        if (instruments === null || instruments === undefined) {
            throw new Error('Required parameter instruments was null or undefined when calling upsertLusidInstruments.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(instruments, "{ [key: string]: LusidInstrumentDefinition; }")
        };
