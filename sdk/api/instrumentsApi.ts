...
export class InstrumentsApi {
     ...
     * @summary [EXPERIMENTAL] DeleteInstruments: Deletes multiple instruments from a set of specified LusidInstrumentId strings
     * @param requestBody The list of lusidInstrumentId\&#39;s to delete.
     * @param deleteMode The delete mode to use, currently only \&#39;soft\&#39; is supported, if left unspecified, this argument is optional.
     * @param scope The scope in which the instrument lies. When not supplied the scope is \&#39;default\&#39;.
     */
     ...
     * @param scope The scope in which the instrument lies. When not supplied the scope is \&#39;default\&#39;.
     */
    public async getInstrument (identifierType: string, identifier: string, effectiveAt?: string, asAt?: Date, propertyKeys?: Array<string>, scope?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Instrument;  }> {
        const localVarPath = this.basePath + '/api/instruments/{identifierType}/{identifier}'
            .replace('{' + 'identifierType' + '}', encodeURIComponent(String(identifierType)))
            .replace('{' + 'identifier' + '}', encodeURIComponent(String(identifier)));
        let localVarQueryParameters: any = {};
     ...
     * @summary [EXPERIMENTAL] GetInstrumentRelationships: Get Instrument relationships
     ...
     * @param scope The scope in which the instrument lies. When not supplied the scope is \&#39;default\&#39;.
     */
    public async getInstruments (identifierType: string, requestBody: Array<string>, effectiveAt?: string, asAt?: Date, propertyKeys?: Array<string>, scope?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GetInstrumentsResponse;  }> {
     ...
     * @param scope The scope in which the instrument lies. When not supplied the scope is \&#39;default\&#39;.
     */
    public async listInstruments (asAt?: Date, effectiveAt?: string, page?: string, sortBy?: Array<string>, start?: number, limit?: number, filter?: string, instrumentPropertyKeys?: Array<string>, scope?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfInstrument;  }> {
