...
export class InstrumentsApi {
     ...
     * @param identifierType The identifier type of the instrument, e.g., \&quot;Figi\&quot;
     * @param identifier The value of the identifier for the requested instrument.
     * @param propertyKey The property key of the property that will have its history shown. These must be in the format {domain}/{scope}/{code} e.g. \&quot;Instrument/system/Name\&quot;.              Each property must be from the \&quot;Instrument\&quot; domain.
     * @param identifierEffectiveAt The effective datetime used to resolve the instrument from the provided identifier. Defaults to the current LUSID system datetime if not specified.
