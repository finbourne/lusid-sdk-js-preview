...
export class InstrumentsApi {
     ...
     * @param effectiveAt The effective datetime or cut label at which to retrieve the instrument.              Defaults to the current LUSID system datetime if not specified.
     */
    public async postInstrumentCapabilities (lusidInstrument: LusidInstrument, model?: string, effectiveAt?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InstrumentCapabilities;  }> {
