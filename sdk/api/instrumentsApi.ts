...
export class InstrumentsApi {
     ...
     * @summary BatchUpsertInstrumentProperties: Batch upsert instruments properties
     ...
     * @param dataModelScope The optional scope of a Hierarchical Data Model to use
     * @param dataModelCode The optional code of a Hierarchical Data Model to use
     */
    public async batchUpsertInstrumentProperties (requestBody: { [key: string]: UpsertInstrumentPropertyRequest; }, scope?: string, identifierEffectiveAt?: string, successMode?: string, dataModelScope?: string, dataModelCode?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: BatchUpsertInstrumentPropertiesResponse;  }> {
        const localVarPath = this.basePath + '/api/instruments/$batchupsertproperties';
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(requestBody, "{ [key: string]: UpsertInstrumentPropertyRequest; }")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: BatchUpsertInstrumentPropertiesResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "BatchUpsertInstrumentPropertiesResponse");
     ...
     */
    public async calculateSettlementDate (identifierType: string, identifier: string, transactionDate?: string, scope?: string, asAt?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: AddBusinessDaysToDateResponse;  }> {
        const localVarPath = this.basePath + '/api/instruments/{identifierType}/{identifier}/settlementdate'
        ...
        if (transactionDate !== undefined) {
            localVarQueryParameters['transactionDate'] = ObjectSerializer.serialize(transactionDate, "string");
        }
     ...
     * @summary DeleteInstrument: Soft delete a single instrument
     ...
     * @param scope The scope in which the instrument lies. When not supplied the scope is \&#39;default\&#39;.
     */
    public async deleteInstrument (identifierType: string, identifier: string, scope?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeleteInstrumentResponse;  }> {
     ...
     * @param dataModelCode The optional code of a Hierarchical Data Model to use
     */
    public async deleteInstrumentProperties (identifierType: string, identifier: string, requestBody: Array<string>, effectiveAt?: string, scope?: string, dataModelScope?: string, dataModelCode?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeleteInstrumentPropertiesResponse;  }> {
     ...
     * @summary DeleteInstruments: Soft or hard delete multiple instruments
     ...
     */
    public async deleteInstruments (requestBody: Array<string>, deleteMode?: 'Soft' | 'Hard', scope?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: DeleteInstrumentsResponse;  }> {
        const localVarPath = this.basePath + '/api/instruments/$delete';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: DeleteInstrumentsResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "DeleteInstrumentsResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary [EXPERIMENTAL] GetAllPossibleFeatures: Provides list of all possible features for instrument type.
     * @param instrumentType A lusid instrument type e.g. Bond, FxOption.
     */
    public async getAllPossibleFeatures (instrumentType: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: { [key: string]: Array<string>; };  }> {
        const localVarPath = this.basePath + '/api/instruments/{instrumentType}/allfeatures'
            .replace('{' + 'instrumentType' + '}', encodeURIComponent(String(instrumentType)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: { [key: string]: Array<string>; };  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
     ...
     */
    public async getExistingInstrumentCapabilities (identifier: string, model?: string, effectiveAt?: string, asAt?: Date, instrumentScope?: string, recipeScope?: string, recipeCode?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InstrumentCapabilities;  }> {
        const localVarPath = this.basePath + '/api/instruments/{identifier}/capabilities'
            .replace('{' + 'identifier' + '}', encodeURIComponent(String(identifier)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        if (instrumentScope !== undefined) {
            localVarQueryParameters['instrumentScope'] = ObjectSerializer.serialize(instrumentScope, "string");
        }

        if (recipeScope !== undefined) {
            localVarQueryParameters['recipeScope'] = ObjectSerializer.serialize(recipeScope, "string");
        }

        if (recipeCode !== undefined) {
            localVarQueryParameters['recipeCode'] = ObjectSerializer.serialize(recipeCode, "string");
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: InstrumentCapabilities;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "InstrumentCapabilities");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param recipeCode A unique identifier for an entity, used to obtain configuration recipe details. Default configuration recipe is used if not provided.
     */
    public async getExistingInstrumentModels (identifier: string, effectiveAt?: string, asAt?: Date, instrumentScope?: string, recipeScope?: string, recipeCode?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InstrumentModels;  }> {
        const localVarPath = this.basePath + '/api/instruments/{identifier}/models'
            .replace('{' + 'identifier' + '}', encodeURIComponent(String(identifier)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: InstrumentModels;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "InstrumentModels");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     */
    public async getInstrument (identifierType: string, identifier: string, effectiveAt?: string, asAt?: Date, propertyKeys?: Array<string>, scope?: string, relationshipDefinitionIds?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Instrument;  }> {
        const localVarPath = this.basePath + '/api/instruments/{identifierType}/{identifier}'
            .replace('{' + 'identifierType' + '}', encodeURIComponent(String(identifierType)))
            .replace('{' + 'identifier' + '}', encodeURIComponent(String(identifier)));
        let localVarQueryParameters: any = {};
     ...
     * @param scope The scope in which the instrument lies. When not supplied the scope is \&#39;default\&#39;.
     */
    public async getInstrumentPaymentDiary (identifierType: string, identifier: string, recipeScope: string, recipeCode: string, effectiveAt?: string, asAt?: Date, scope?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InstrumentPaymentDiary;  }> {
        const localVarPath = this.basePath + '/api/instruments/{identifierType}/{identifier}/paymentdiary'
            .replace('{' + 'identifierType' + '}', encodeURIComponent(String(identifierType)))
            .replace('{' + 'identifier' + '}', encodeURIComponent(String(identifier)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'recipeScope' is not null or undefined
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: InstrumentPaymentDiary;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "InstrumentPaymentDiary");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @summary GetInstrumentProperties: Get instrument properties
     * @param identifierType The unique identifier type to search, for example \&#39;Figi\&#39;.
     * @param identifier An &lt;i&gt;identifierType&lt;/i&gt; value to use to identify the instrument, for example \&#39;BBG000BLNNV0\&#39;.
     * @param effectiveAt The effective datetime or cut label at which to list the instrument\&#39;s properties.              Defaults to the current LUSID system datetime if not specified.
     ...
     * @param scope The scope in which the instrument lies. When not supplied the scope is \&#39;default\&#39;.
     */
    public async getInstrumentProperties (identifierType: string, identifier: string, effectiveAt?: string, asAt?: Date, scope?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InstrumentProperties;  }> {
     ...
     * @summary GetInstrumentPropertyTimeSeries: Get instrument property time series
     * @param identifierType The unique identifier type to search, for example \&#39;Figi\&#39;.
     * @param identifier An &lt;i&gt;identifierType&lt;/i&gt; value to use to identify the instrument, for example \&#39;BBG000BLNNV0\&#39;.
     ...
     * @param scope The scope in which the instrument lies. When not supplied the scope is \&#39;default\&#39;.
     */
    public async getInstrumentPropertyTimeSeries (identifierType: string, identifier: string, propertyKey: string, identifierEffectiveAt?: string, asAt?: Date, filter?: string, page?: string, limit?: number, scope?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfPropertyInterval;  }> {
     ...
     */
    public async getInstrumentRelationships (identifierType: string, identifier: string, effectiveAt?: string, asAt?: Date, filter?: string, identifierTypes?: Array<string>, scope?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfRelationship;  }> {
        const localVarPath = this.basePath + '/api/instruments/{identifierType}/{identifier}/relationships'
            .replace('{' + 'identifierType' + '}', encodeURIComponent(String(identifierType)))
            .replace('{' + 'identifier' + '}', encodeURIComponent(String(identifier)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     */
    public async getInstruments (identifierType: string, requestBody: Array<string>, effectiveAt?: string, asAt?: Date, propertyKeys?: Array<string>, scope?: string, relationshipDefinitionIds?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GetInstrumentsResponse;  }> {
     ...
     * @param scope The scope in which the instrument lies. When not supplied the scope is \&#39;default\&#39;.
     */
    public async listInstrumentProperties (identifierType: string, identifier: string, effectiveAt?: string, asAt?: Date, page?: string, limit?: number, scope?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfProperty;  }> {
     ...
     * @param dataModelCode The optional code of a Hierarchical Data Model to use.
     */
    public async listInstruments (asAt?: Date, effectiveAt?: string, page?: string, sortBy?: Array<string>, limit?: number, filter?: string, instrumentPropertyKeys?: Array<string>, scope?: string, relationshipDefinitionIds?: Array<string>, dataModelScope?: string, dataModelCode?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: PagedResourceListOfInstrument;  }> {
    ...
    /**
     * Returns instrument capabilities containing useful information about the instrument and the model. This includes  - features corresponding to the instrument e.g. Optionality:American, Other:InflationLinked  - supported addresses (if model provided) e.g. Valuation/Pv, Valuation/DirtyPriceKey, Valuation/Accrued  - economic dependencies (if model provided) e.g. Cash:USD, Fx:GBP.USD, Rates:GBP.GBPOIS
     * @summary [EXPERIMENTAL] QueryInstrumentCapabilities: Query capabilities of a particular instrument in advance of creating it. These include instrument features, and if model is provided it also includes supported address keys and economic dependencies.
     * @param lusidInstrument The definition of the instrument.
     * @param model A pricing model for the instrument. Defaults to Unknown if not specified. If not specified the SupportedAddresses and EconomicDependencies are not provided.
     */
    public async queryInstrumentCapabilities (lusidInstrument: LusidInstrument, model?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InstrumentCapabilities;  }> {
        const localVarPath = this.basePath + '/api/instruments/capabilities';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
        // give precedence to 'application/json'
        ...
        // verify required parameter 'lusidInstrument' is not null or undefined
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(lusidInstrument, "LusidInstrument")
        };
     ...
     * @param dataModelCode The optional code of a Hierarchical Data Model to use
     */
    public async updateInstrumentIdentifier (identifierType: string, identifier: string, updateInstrumentIdentifierRequest: UpdateInstrumentIdentifierRequest, scope?: string, dataModelScope?: string, dataModelCode?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Instrument;  }> {
        const localVarPath = this.basePath + '/api/instruments/{identifierType}/{identifier}'
            .replace('{' + 'identifierType' + '}', encodeURIComponent(String(identifierType)))
            .replace('{' + 'identifier' + '}', encodeURIComponent(String(identifier)));
        let localVarQueryParameters: any = {};
     ...
     * @param dataModelCode The optional code of a Hierarchical Data Model to use
     */
    public async upsertInstruments (requestBody: { [key: string]: InstrumentDefinition; }, scope?: string, dataModelScope?: string, dataModelCode?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UpsertInstrumentsResponse;  }> {
        const localVarPath = this.basePath + '/api/instruments';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['text/plain', 'application/json', 'text/json'];
     ...
     * @param dataModelCode The optional code of a Hierarchical Data Model to use
     */
    public async upsertInstrumentsProperties (upsertInstrumentPropertyRequest: Array<UpsertInstrumentPropertyRequest>, scope?: string, dataModelScope?: string, dataModelCode?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UpsertInstrumentPropertiesResponse;  }> {
