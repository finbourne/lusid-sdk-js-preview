...
export class InstrumentsApi {
     ...
     * @param recipeCode A unique identifier for an entity, used to obtain configuration recipe details. Default configuration recipe is used if not provided.
     */
    public async queryInstrumentCapabilities (lusidInstrument: LusidInstrument, model?: string, effectiveAt?: string, recipeScope?: string, recipeCode?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InstrumentCapabilities;  }> {
