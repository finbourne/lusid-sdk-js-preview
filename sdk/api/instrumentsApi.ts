...
export class InstrumentsApi {
    ...
    /**
     * List the complete time series of an instrument property, ordered by effective datetime.
     * @summary [EXPERIMENTAL] Get the time series of an instrument property
     * @param identifierType The identifier type of the instrument, e.g., \&quot;Figi\&quot;
     * @param identifier The identifier of the instrument to delete properties from.
     * @param propertyKey The property key of the property that will have its history shown.
     * @param identifierEffectiveAt The effective datetime at which to list the property history. Defaults to the current LUSID system datetime if not specified.
     * @param asAt The asAt datetime at which to list the instrument\&#39;s property history. Defaults to return the current datetime if not supplied.
     * @param filter Expression to filter the result set. Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid.
     * @param page The pagination token to use to continue listing properties from a previous call to get property timeseries.              This value is returned from the previous call. If a pagination token is provided the filter, effectiveAt, and asAt fields              must not have changed since the original request.
