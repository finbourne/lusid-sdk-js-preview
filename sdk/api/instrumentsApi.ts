...
import { GetExpandedInstrumentsResponse } from '../model/getExpandedInstrumentsResponse';
...
import { LusidInstrumentDefinition } from '../model/lusidInstrumentDefinition';
...
export class InstrumentsApi {
     ...
     * @param requestBody The property keys of the properties to be deleted from the instrument. Only properties in the  Finbourne.WebApi.Interface.Dto.PropertyDomain.Instrument domain can be supplied.
     * @param effectiveAt The effective date to delete the properties from. Note that this is only valid to set if the properties being deleted  are defined to be Finbourne.WebApi.Interface.Dto.PropertyLifeTime.TimeVariant, otherwise this value must not be set.
     */
     ...
     * @param identifierType The identifier being supplied e.g. \&quot;Figi\&quot;.
     * @param requestBody The values of the identifier for the requested instruments.
     ...
     * @summary [EXPERIMENTAL] Get instruments
     * @param identifierType The identifier being supplied e.g. \&quot;Figi\&quot;.
     * @param requestBody The values of the identifier for the requested instruments.
     * @param effectiveAt The effective datetime or cut label at which to retrieve the instrument definitions.              Defaults to the current LUSID system datetime if not specified.
     * @param asAt The asAt datetime at which to retrieve the instrument definitions.              Defaults to return the latest version of each instrument definition if not specified.
     * @param propertyKeys A list of property keys from the \&quot;Instrument\&quot; domain to decorate onto the instrument.              These take the format {domain}/{scope}/{code} e.g. \&quot;Instrument/system/Name\&quot;.
     */
    public async getLusidInstruments (identifierType: string, requestBody: Array<string>, effectiveAt?: string, asAt?: Date, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: GetExpandedInstrumentsResponse;  }> {
        const localVarPath = this.basePath + '/api/instruments/otc/$get';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
        ...
        // verify required parameter 'identifierType' is not null or undefined
        if (identifierType === null || identifierType === undefined) {
            throw new Error('Required parameter identifierType was null or undefined when calling getLusidInstruments.');
        }

        // verify required parameter 'requestBody' is not null or undefined
        if (requestBody === null || requestBody === undefined) {
            throw new Error('Required parameter requestBody was null or undefined when calling getLusidInstruments.');
        }
        ...
        return new Promise<{ response: http.IncomingMessage; body: GetExpandedInstrumentsResponse;  }>((resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    reject(error);
                } else {
                    body = ObjectSerializer.deserialize(body, "GetExpandedInstrumentsResponse");
                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                        resolve({ response: response, body: body });
                    } else {
                        reject({ response: response, body: body });
     ...
     * @param updateInstrumentIdentifierRequest The identifier to update or remove. This may or may not be the same identifier used              to resolve the instrument.
     */
     ...
     * @param requestBody The definitions of the instruments to update or insert.
     */
     ...
     * @param upsertInstrumentPropertyRequest A collection of instruments and associated instrument properties to update or insert.
     */
     ...
     * @summary [EXPERIMENTAL] Upsert instruments
     * @param requestBody The definitions of the instruments to update or insert.
     */
    public async upsertLusidInstruments (requestBody: { [key: string]: LusidInstrumentDefinition; }, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UpsertInstrumentsResponse;  }> {
        const localVarPath = this.basePath + '/api/instruments/otc';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this.defaultHeaders);
        let localVarFormParams: any = {};
        ...
        // verify required parameter 'requestBody' is not null or undefined
        if (requestBody === null || requestBody === undefined) {
            throw new Error('Required parameter requestBody was null or undefined when calling upsertLusidInstruments.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(requestBody, "{ [key: string]: LusidInstrumentDefinition; }")
        };
