...
export class InstrumentsApi {
     ...
     * @param scope The scope in which the instrument lies. When not supplied the scope is \&#39;default\&#39;.
     */
    public async getInstrumentCapabilities (identifier: string, model?: string, effectiveAt?: string, asAt?: Date, scope?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InstrumentCapabilities;  }> {
     ...
     * @param scope The scope in which the instrument lies. When not supplied the scope is \&#39;default\&#39;.
     */
    public async postInstrumentCapabilities (lusidInstrument: LusidInstrument, model?: string, effectiveAt?: string, asAt?: Date, scope?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: InstrumentCapabilities;  }> {
