...
export class InstrumentsApi {
     ...
     * @param effectiveAt The effective date to delete time-variant properties from. Do not specify this parameter              if any of the properties to delete are perpetual.
     */
