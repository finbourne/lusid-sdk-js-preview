...
export class PersonsApi {
     ...
     * @param idTypeCode Code of the person identifier type.
     * @param code Code of the person under specified identifier type\&#39;s scope and code. This together with stated identifier type uniquely              identifies the person.
     * @param identifiers Request containing identifiers to set for the person. Identifiers not specified in request will not be changed.
     */
    public async setPersonIdentifiers (idTypeScope: string, idTypeCode: string, code: string, identifiers: SetPersonIdentifiersRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Person;  }> {
        const localVarPath = this.basePath + '/api/persons/{idTypeScope}/{idTypeCode}/{code}/identifiers'
            .replace('{' + 'idTypeScope' + '}', encodeURIComponent(String(idTypeScope)))
            .replace('{' + 'idTypeCode' + '}', encodeURIComponent(String(idTypeCode)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        ...
        if (identifiers === null || identifiers === undefined) {
            throw new Error('Required parameter identifiers was null or undefined when calling setPersonIdentifiers.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(identifiers, "SetPersonIdentifiersRequest")
        };
     ...
     * @param idTypeCode Code of the person identifier type.
     * @param code Code of the person under specified identifier type\&#39;s scope and code. This together with stated identifier type uniquely              identifies the person.
     * @param properties Request containing properties to set for the person. Properties not specified in request will not be changed.
     */
    public async setPersonProperties (idTypeScope: string, idTypeCode: string, code: string, properties: SetPersonPropertiesRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Person;  }> {
        const localVarPath = this.basePath + '/api/persons/{idTypeScope}/{idTypeCode}/{code}/properties'
            .replace('{' + 'idTypeScope' + '}', encodeURIComponent(String(idTypeScope)))
            .replace('{' + 'idTypeCode' + '}', encodeURIComponent(String(idTypeCode)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        ...
        if (properties === null || properties === undefined) {
            throw new Error('Required parameter properties was null or undefined when calling setPersonProperties.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(properties, "SetPersonPropertiesRequest")
        };
    ...
    public async upsertPerson (request: UpsertPersonRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Person;  }> {
        ...
        if (request === null || request === undefined) {
            throw new Error('Required parameter request was null or undefined when calling upsertPerson.');
        }
