...
export class PersonsApi {
     ...
     * @summary [EXPERIMENTAL] DeletePerson: Delete person
     ...
     * @summary [EXPERIMENTAL] DeletePersonIdentifiers: Delete Person Identifiers
     ...
     * @summary [EXPERIMENTAL] DeletePersonProperties: Delete Person Properties
     * @param idTypeScope Scope of the person identifier type.
     * @param idTypeCode Code of the person identifier type.
     * @param code Code of the person under specified identifier type\&#39;s scope and code. This together with stated identifier type uniquely              identifies the person.
     ...
     * @summary [EXPERIMENTAL] GetPerson: Get Person
     * @param idTypeScope Scope of the person identifier type.
     * @param idTypeCode Code of the person identifier type.
     ...
     * @summary [EXPERIMENTAL] GetPersonPropertyTimeSeries: Get Person Property Time Series
     * @param idTypeScope Scope of the person identifier type.
     * @param idTypeCode Code of the person identifier type.
     * @param code Code of the person under specified identifier type\&#39;s scope and code. This together with stated identifier type uniquely identifies the person.
     ...
     * @summary [EXPERIMENTAL] GetPersonRelations: Get Relations for Person
     * @param idTypeScope Scope of the person identifier type.
     * @param idTypeCode Code of the person identifier type.
     * @param code Code of the person under specified identifier type\&#39;s scope and code. This together with stated identifier type uniquely              identifies the person.
     ...
     * @summary [EXPERIMENTAL] GetPersonRelationships: Get Relationships for Person
     ...
     * @summary [EXPERIMENTAL] ListAllPersons: List All Persons
     ...
     */
    public async listAllPersons (effectiveAt?: string, asAt?: Date, page?: string, limit?: number, filter?: string, propertyKeys?: Array<string>, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ResourceListOfPerson;  }> {
     ...
     * @summary [EXPERIMENTAL] ListPersons: List Persons
     * @param idTypeScope Scope of the person identifier type.
     * @param idTypeCode Code of the person identifier type.
     * @param effectiveAt The effective datetime or cut label at which to list the people. Defaults to the current LUSID              system datetime if not specified.
     * @param asAt The asAt datetime at which to list the people. Defaults to return the latest version              of each people if not specified.
     ...
     * @summary [EXPERIMENTAL] PatchPersonAccessMetadata: Patch Access Metadata rules for a Person.
     * @param idTypeScope Scope of the person identifier.
     * @param idTypeCode Code of the person identifier.
     * @param code Code of the person under specified identifier type\&#39;s scope and code.
     ...
     */
    public async patchPersonAccessMetadata (idTypeScope: string, idTypeCode: string, code: string, operation: Array<Operation>, effectiveAt?: string, effectiveUntil?: Date, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: { [key: string]: Array<AccessMetadataValue>; };  }> {
        const localVarPath = this.basePath + '/api/persons/{idTypeScope}/{idTypeCode}/{code}/metadata'
            .replace('{' + 'idTypeScope' + '}', encodeURIComponent(String(idTypeScope)))
            .replace('{' + 'idTypeCode' + '}', encodeURIComponent(String(idTypeCode)))
            .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
        ...
        if (operation === null || operation === undefined) {
            throw new Error('Required parameter operation was null or undefined when calling patchPersonAccessMetadata.');
        }
     ...
     * @summary [EXPERIMENTAL] SetPersonIdentifiers: Set Person Identifiers
     * @param idTypeScope Scope of the person identifier type.
     * @param idTypeCode Code of the person identifier type.
     * @param code Code of the person under specified identifier type\&#39;s scope and code. This together with stated identifier type uniquely              identifies the person.
     ...
     * @summary [EXPERIMENTAL] SetPersonProperties: Set Person Properties
     * @param idTypeScope Scope of the person identifier type.
     * @param idTypeCode Code of the person identifier type.
     * @param code Code of the person under specified identifier type\&#39;s scope and code. This together with stated identifier type uniquely              identifies the person.
     ...
     * @summary [EXPERIMENTAL] UpsertPerson: Upsert Person
