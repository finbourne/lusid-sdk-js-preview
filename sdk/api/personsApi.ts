...
export class PersonsApi {
     ...
     * @summary [EXPERIMENTAL] DeletePersonAccessMetadata: Delete a Person Access Metadata entry
     ...
     * @summary [EXPERIMENTAL] GetAllPersonAccessMetadata: Get Access Metadata rules for a Person
     * @param idTypeScope Scope of the person identifier.
     * @param idTypeCode Code of the person identifier.
     * @param code Code of the person under specified identifier type\&#39;s scope and code.
     ...
     * @summary [EXPERIMENTAL] GetPersonAccessMetadataByKey: Get an entry identified by a metadataKey in the Access Metadata of a Person
     * @param idTypeScope Scope of the person identifier.
     * @param idTypeCode Code of the person identifier.
     * @param code Code of the person under specified identifier type\&#39;s scope and code.
     * @param metadataKey Key of the metadata entry to retrieve
     ...
     * @summary [EXPERIMENTAL] UpsertPersonAccessMetadata: Upsert a Person Access Metadata entry associated with a specific metadataKey. This creates or updates the data in LUSID.
     * @param idTypeScope Scope of the person identifier.
     * @param idTypeCode Code of the person identifier.
     * @param code Code of the person under specified identifier type\&#39;s scope and code.
     * @param metadataKey Key of the metadata entry to retrieve
