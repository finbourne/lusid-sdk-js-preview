...
// ===============================================
var StructuredMarketDataApiApiKeys;
(function (StructuredMarketDataApiApiKeys) {
})(StructuredMarketDataApiApiKeys = exports.StructuredMarketDataApiApiKeys || (exports.StructuredMarketDataApiApiKeys = {}));
var StructuredMarketDataApi = /** @class */ (function () {
    function StructuredMarketDataApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(StructuredMarketDataApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(StructuredMarketDataApi.prototype, "basePath", {
        get: function () {
    ...
    StructuredMarketDataApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    StructuredMarketDataApi.prototype.setApiKey = function (key, value) {
        this.authentications[StructuredMarketDataApiApiKeys[key]].apiKey = value;
    };
    Object.defineProperty(StructuredMarketDataApi.prototype, "accessToken", {
        set: function (token) {
     ...
     */
    StructuredMarketDataApi.prototype.deleteStructuredMarketData = function (scope, structuredDataIds, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/structured/{scope}/$delete'
                ...
                localVarRequestOptions = {
                    ...
                    json: true,
                    body: models_1.ObjectSerializer.serialize(structuredDataIds, "{ [key: string]: StructuredMarketDataId; }")
                };
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "AnnulStructuredDataResponse");
     ...
     */
    StructuredMarketDataApi.prototype.getStructuredMarketData = function (scope, structuredDataIds, effectiveAt, asAt, maxAge, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/structured/{scope}/$get'
                    .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this.defaultHeaders);
                localVarFormParams = {};
                ...
                if (maxAge !== undefined) {
                    localVarQueryParameters['maxAge'] = models_1.ObjectSerializer.serialize(maxAge, "string");
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "GetStructuredMarketDataResponse");
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    resolve({ response: response, body: body });
                                }
                                else {
     ...
     */
    StructuredMarketDataApi.prototype.upsertStructuredMarketData = function (scope, structuredData, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/structured/{scope}'
                    .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this.defaultHeaders);
                localVarFormParams = {};
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(structuredData, "{ [key: string]: UpsertStructuredMarketDataRequest; }")
                };
                this.authentications.oauth2.applyToRequest(localVarRequestOptions);
                this.authentications.default.applyToRequest(localVarRequestOptions);
                if (Object.keys(localVarFormParams).length) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "UpsertStructuredDataResponse");
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    resolve({ response: response, body: body });
                                }
                                else {
    ...
    return StructuredMarketDataApi;
}());
exports.StructuredMarketDataApi = StructuredMarketDataApi;
