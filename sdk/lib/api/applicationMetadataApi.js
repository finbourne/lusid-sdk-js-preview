...
// ===============================================
var ApplicationMetadataApiApiKeys;
(function (ApplicationMetadataApiApiKeys) {
})(ApplicationMetadataApiApiKeys = exports.ApplicationMetadataApiApiKeys || (exports.ApplicationMetadataApiApiKeys = {}));
var ApplicationMetadataApi = /** @class */ (function () {
    function ApplicationMetadataApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(ApplicationMetadataApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(ApplicationMetadataApi.prototype, "basePath", {
        get: function () {
    ...
    ApplicationMetadataApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    ApplicationMetadataApi.prototype.setApiKey = function (key, value) {
        this.authentications[ApplicationMetadataApiApiKeys[key]].apiKey = value;
    };
    Object.defineProperty(ApplicationMetadataApi.prototype, "accessToken", {
        set: function (token) {
     ...
     */
    ApplicationMetadataApi.prototype.getExcelAddin = function (version, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/metadata/downloads/exceladdin';
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "FileResponse");
     ...
     */
    ApplicationMetadataApi.prototype.getLusidVersions = function (options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/metadata/versions';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this.defaultHeaders);
                localVarFormParams = {};
                Object.assign(localVarHeaderParams, options.headers);
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "VersionSummaryDto");
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    resolve({ response: response, body: body });
                                }
                                else {
     ...
     */
    ApplicationMetadataApi.prototype.listAccessControlledResources = function (filter, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/metadata/access/resources';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this.defaultHeaders);
                localVarFormParams = {};
                if (filter !== undefined) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "ResourceListOfAccessControlledResource");
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    resolve({ response: response, body: body });
                                }
                                else {
    ...
    return ApplicationMetadataApi;
}());
exports.ApplicationMetadataApi = ApplicationMetadataApi;
