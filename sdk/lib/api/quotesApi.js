...
// ===============================================
var QuotesApiApiKeys;
(function (QuotesApiApiKeys) {
})(QuotesApiApiKeys = exports.QuotesApiApiKeys || (exports.QuotesApiApiKeys = {}));
var QuotesApi = /** @class */ (function () {
    function QuotesApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(QuotesApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(QuotesApi.prototype, "basePath", {
        get: function () {
    ...
    QuotesApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    QuotesApi.prototype.setApiKey = function (key, value) {
        this.authentications[QuotesApiApiKeys[key]].apiKey = value;
    };
    Object.defineProperty(QuotesApi.prototype, "accessToken", {
        set: function (token) {
     ...
     */
    QuotesApi.prototype.deleteQuotes = function (scope, quotes, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/quotes/{scope}/$delete'
                ...
                localVarRequestOptions = {
                    ...
                    json: true,
                    body: models_1.ObjectSerializer.serialize(quotes, "{ [key: string]: QuoteId; }")
                };
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "AnnulQuotesResponse");
     ...
     */
    QuotesApi.prototype.getQuotes = function (scope, effectiveAt, asAt, maxAge, quoteIds, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/quotes/{scope}/$get'
                    .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this.defaultHeaders);
                localVarFormParams = {};
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(quoteIds, "{ [key: string]: QuoteSeriesId; }")
                };
                this.authentications.oauth2.applyToRequest(localVarRequestOptions);
                this.authentications.default.applyToRequest(localVarRequestOptions);
                if (Object.keys(localVarFormParams).length) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "GetQuotesResponse");
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    resolve({ response: response, body: body });
                                }
                                else {
     ...
     */
    QuotesApi.prototype.listQuotes = function (scope, asAt, page, start, limit, filter, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/quotes/{scope}'
                    .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this.defaultHeaders);
                localVarFormParams = {};
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "ResourceListOfQuote");
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    resolve({ response: response, body: body });
                                }
                                else {
     ...
     */
    QuotesApi.prototype.upsertQuotes = function (scope, quotes, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(quotes, "{ [key: string]: UpsertQuoteRequest; }")
                };
                this.authentications.oauth2.applyToRequest(localVarRequestOptions);
                this.authentications.default.applyToRequest(localVarRequestOptions);
                if (Object.keys(localVarFormParams).length) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "UpsertQuotesResponse");
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    resolve({ response: response, body: body });
                                }
                                else {
