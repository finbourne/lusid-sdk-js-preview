...
// ===============================================
var DataTypesApiApiKeys;
(function (DataTypesApiApiKeys) {
})(DataTypesApiApiKeys = exports.DataTypesApiApiKeys || (exports.DataTypesApiApiKeys = {}));
var DataTypesApi = /** @class */ (function () {
    function DataTypesApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(DataTypesApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(DataTypesApi.prototype, "basePath", {
        get: function () {
    ...
    DataTypesApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    DataTypesApi.prototype.setApiKey = function (key, value) {
        this.authentications[DataTypesApiApiKeys[key]].apiKey = value;
    };
    Object.defineProperty(DataTypesApi.prototype, "accessToken", {
        set: function (token) {
     ...
     */
    DataTypesApi.prototype.createDataType = function (request, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/datatypes';
                ...
                localVarRequestOptions = {
                    ...
                    json: true,
                    body: models_1.ObjectSerializer.serialize(request, "CreateDataTypeRequest")
                };
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "DataType");
     ...
     */
    DataTypesApi.prototype.getDataType = function (scope, code, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/datatypes/{scope}/{code}'
     ...
     */
    DataTypesApi.prototype.getUnitsFromDataType = function (scope, code, units, filter, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/datatypes/{scope}/{code}/units'
                    .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
                    .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this.defaultHeaders);
                ...
                if (units !== undefined) {
                    localVarQueryParameters['units'] = models_1.ObjectSerializer.serialize(units, "Array<string>");
                }
                if (filter !== undefined) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "ResourceListOfIUnitDefinitionDto");
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    resolve({ response: response, body: body });
                                }
                                else {
     ...
     * @param filter Optional. Expression to filter the result set
     */
    DataTypesApi.prototype.listDataTypes = function (scope, includeSystem, sortBy, start, limit, filter, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/datatypes/{scope}'
                    .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this.defaultHeaders);
                localVarFormParams = {};
                ...
                if (includeSystem !== undefined) {
                    localVarQueryParameters['includeSystem'] = models_1.ObjectSerializer.serialize(includeSystem, "boolean");
                }
                if (sortBy !== undefined) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "ResourceListOfDataType");
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    resolve({ response: response, body: body });
                                }
                                else {
     ...
     */
    DataTypesApi.prototype.updateDataType = function (scope, code, request, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(request, "UpdateDataTypeRequest")
                };
                this.authentications.oauth2.applyToRequest(localVarRequestOptions);
                this.authentications.default.applyToRequest(localVarRequestOptions);
                if (Object.keys(localVarFormParams).length) {
...
exports.DataTypesApi = DataTypesApi;
