...
// ===============================================
var SchemasApiApiKeys;
(function (SchemasApiApiKeys) {
})(SchemasApiApiKeys = exports.SchemasApiApiKeys || (exports.SchemasApiApiKeys = {}));
var SchemasApi = /** @class */ (function () {
    function SchemasApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(SchemasApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(SchemasApi.prototype, "basePath", {
        get: function () {
    ...
    SchemasApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    SchemasApi.prototype.setApiKey = function (key, value) {
        this.authentications[SchemasApiApiKeys[key]].apiKey = value;
    };
    Object.defineProperty(SchemasApi.prototype, "accessToken", {
        set: function (token) {
     ...
     */
    SchemasApi.prototype.getEntitySchema = function (entity, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/schemas/entities/{entity}'
     ...
     */
    SchemasApi.prototype.getPropertySchema = function (propertyKeys, asAt, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/schemas/properties';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this.defaultHeaders);
                localVarFormParams = {};
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "PropertySchema");
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    resolve({ response: response, body: body });
                                }
                                else {
     ...
     */
    SchemasApi.prototype.getValueTypes = function (sortBy, start, limit, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/schemas/types';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this.defaultHeaders);
                localVarFormParams = {};
                if (sortBy !== undefined) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "ResourceListOfValueType");
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    resolve({ response: response, body: body });
                                }
                                else {
     ...
     */
    SchemasApi.prototype.listEntities = function (options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/schemas/entities';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this.defaultHeaders);
                localVarFormParams = {};
                Object.assign(localVarHeaderParams, options.headers);
