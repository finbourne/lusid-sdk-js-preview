...
// ===============================================
var InstrumentsApiApiKeys;
(function (InstrumentsApiApiKeys) {
})(InstrumentsApiApiKeys = exports.InstrumentsApiApiKeys || (exports.InstrumentsApiApiKeys = {}));
var InstrumentsApi = /** @class */ (function () {
    function InstrumentsApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(InstrumentsApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(InstrumentsApi.prototype, "basePath", {
        get: function () {
    ...
    InstrumentsApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    InstrumentsApi.prototype.setApiKey = function (key, value) {
        this.authentications[InstrumentsApiApiKeys[key]].apiKey = value;
    };
    Object.defineProperty(InstrumentsApi.prototype, "accessToken", {
        set: function (token) {
    ...
    InstrumentsApi.prototype.deleteInstrument = function (identifierType, identifier, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/instruments/{identifierType}/{identifier}'
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "DeleteInstrumentResponse");
     ...
     */
    InstrumentsApi.prototype.deleteInstrumentProperties = function (identifierType, identifier, propertyKeys, effectiveAt, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/instruments/{identifierType}/{identifier}/properties/$delete'
                    .replace('{' + 'identifierType' + '}', encodeURIComponent(String(identifierType)))
                    .replace('{' + 'identifier' + '}', encodeURIComponent(String(identifier)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this.defaultHeaders);
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(propertyKeys, "Array<string>")
                };
                this.authentications.oauth2.applyToRequest(localVarRequestOptions);
                this.authentications.default.applyToRequest(localVarRequestOptions);
                if (Object.keys(localVarFormParams).length) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "DeleteInstrumentPropertiesResponse");
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    resolve({ response: response, body: body });
                                }
                                else {
     ...
     * @param instrumentPropertyKeys A list of property keys from the \&quot;Instrument\&quot; domain to decorate onto the instrument.              These take the format {domain}/{scope}/{code} e.g. \&quot;Instrument/system/Name\&quot;.
     */
    InstrumentsApi.prototype.getInstrument = function (identifierType, identifier, effectiveAt, asAt, instrumentPropertyKeys, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "Instrument");
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    resolve({ response: response, body: body });
                                }
                                else {
     ...
     */
    InstrumentsApi.prototype.getInstrumentIdentifierTypes = function (options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/instruments/identifierTypes';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this.defaultHeaders);
                localVarFormParams = {};
                Object.assign(localVarHeaderParams, options.headers);
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "ResourceListOfInstrumentIdTypeDescriptor");
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    resolve({ response: response, body: body });
                                }
                                else {
     ...
     * @param instrumentPropertyKeys A list of property keys from the \&quot;Instrument\&quot; domain to decorate onto the instrument.              These take the format {domain}/{scope}/{code} e.g. \&quot;Instrument/system/Name\&quot;.
     */
    InstrumentsApi.prototype.getInstruments = function (identifierType, identifiers, effectiveAt, asAt, instrumentPropertyKeys, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/instruments/$get';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this.defaultHeaders);
                localVarFormParams = {};
                // verify required parameter 'identifierType' is not null or undefined
                ...
                if (identifierType !== undefined) {
                    localVarQueryParameters['identifierType'] = models_1.ObjectSerializer.serialize(identifierType, "string");
                }
                if (effectiveAt !== undefined) {
                    localVarQueryParameters['effectiveAt'] = models_1.ObjectSerializer.serialize(effectiveAt, "string");
                }
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(identifiers, "Array<string>")
                };
                this.authentications.oauth2.applyToRequest(localVarRequestOptions);
                this.authentications.default.applyToRequest(localVarRequestOptions);
                if (Object.keys(localVarFormParams).length) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "GetInstrumentsResponse");
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    resolve({ response: response, body: body });
                                }
                                else {
    ...
    InstrumentsApi.prototype.listInstruments = function (asAt, effectiveAt, page, sortBy, start, limit, filter, instrumentPropertyKeys, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/instruments';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this.defaultHeaders);
                localVarFormParams = {};
                if (asAt !== undefined) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "ResourceListOfInstrument");
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    resolve({ response: response, body: body });
                                }
                                else {
     ...
     */
    InstrumentsApi.prototype.updateInstrumentIdentifier = function (identifierType, identifier, request, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(request, "UpdateInstrumentIdentifierRequest")
                };
                this.authentications.oauth2.applyToRequest(localVarRequestOptions);
                this.authentications.default.applyToRequest(localVarRequestOptions);
                if (Object.keys(localVarFormParams).length) {
     ...
     * @param requests The definitions of the instruments to update or insert.
     */
    InstrumentsApi.prototype.upsertInstruments = function (requests, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(requests, "{ [key: string]: InstrumentDefinition; }")
                };
                this.authentications.oauth2.applyToRequest(localVarRequestOptions);
                this.authentications.default.applyToRequest(localVarRequestOptions);
                if (Object.keys(localVarFormParams).length) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "UpsertInstrumentsResponse");
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    resolve({ response: response, body: body });
                                }
                                else {
     ...
     */
    InstrumentsApi.prototype.upsertInstrumentsProperties = function (instrumentProperties, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/instruments/$upsertproperties';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this.defaultHeaders);
                localVarFormParams = {};
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(instrumentProperties, "Array<UpsertInstrumentPropertyRequest>")
                };
                this.authentications.oauth2.applyToRequest(localVarRequestOptions);
                this.authentications.default.applyToRequest(localVarRequestOptions);
                if (Object.keys(localVarFormParams).length) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "UpsertInstrumentPropertiesResponse");
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    resolve({ response: response, body: body });
                                }
                                else {
