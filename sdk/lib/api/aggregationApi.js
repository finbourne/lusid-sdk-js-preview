...
// ===============================================
var AggregationApiApiKeys;
(function (AggregationApiApiKeys) {
})(AggregationApiApiKeys = exports.AggregationApiApiKeys || (exports.AggregationApiApiKeys = {}));
var AggregationApi = /** @class */ (function () {
    function AggregationApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(AggregationApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(AggregationApi.prototype, "basePath", {
        get: function () {
    ...
    AggregationApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    AggregationApi.prototype.setApiKey = function (key, value) {
        this.authentications[AggregationApiApiKeys[key]].apiKey = value;
    };
    Object.defineProperty(AggregationApi.prototype, "accessToken", {
        set: function (token) {
     ...
     */
    AggregationApi.prototype.getAggregationByGroup = function (scope, code, sortBy, start, limit, request, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/portfoliogroups/{scope}/{code}/$aggregate'
                ...
                localVarRequestOptions = {
                    ...
                    json: true,
                    body: models_1.ObjectSerializer.serialize(request, "AggregationRequest")
                };
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "ListAggregationResponse");
     ...
     * @param request The request specifying the parameters of the aggregation
     */
    AggregationApi.prototype.getAggregationByPortfolio = function (scope, code, sortBy, start, limit, request, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/portfolios/{scope}/{code}/$aggregate'
                    .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
                    .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this.defaultHeaders);
     ...
     * @param request The request specifying the parameters of the aggregation
     */
    AggregationApi.prototype.getAggregationByResultSet = function (scope, resultsKey, sortBy, start, limit, request, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/results/{scope}/{resultsKey}/$aggregate'
                    .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
     ...
     * @param request The request specifying the parameters of the aggregation
     */
    AggregationApi.prototype.getNestedAggregationByGroup = function (scope, code, request, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/portfoliogroups/{scope}/{code}/$aggregatenested'
                    .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
                    .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this.defaultHeaders);
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "NestedAggregationResponse");
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    resolve({ response: response, body: body });
                                }
                                else {
...
exports.AggregationApi = AggregationApi;
