...
// ===============================================
var EntitiesApiApiKeys;
(function (EntitiesApiApiKeys) {
})(EntitiesApiApiKeys = exports.EntitiesApiApiKeys || (exports.EntitiesApiApiKeys = {}));
var EntitiesApi = /** @class */ (function () {
    function EntitiesApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(EntitiesApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(EntitiesApi.prototype, "basePath", {
        get: function () {
    ...
    EntitiesApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    EntitiesApi.prototype.setApiKey = function (key, value) {
        this.authentications[EntitiesApiApiKeys[key]].apiKey = value;
    };
    Object.defineProperty(EntitiesApi.prototype, "accessToken", {
        set: function (token) {
     ...
     */
    EntitiesApi.prototype.getPortfolioChanges = function (scope, effectiveAt, asAt, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/entities/changes/portfolios';
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "ResourceListOfChange");
