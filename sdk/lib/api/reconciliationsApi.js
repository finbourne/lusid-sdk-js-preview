...
// ===============================================
var ReconciliationsApiApiKeys;
(function (ReconciliationsApiApiKeys) {
})(ReconciliationsApiApiKeys = exports.ReconciliationsApiApiKeys || (exports.ReconciliationsApiApiKeys = {}));
var ReconciliationsApi = /** @class */ (function () {
    function ReconciliationsApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(ReconciliationsApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(ReconciliationsApi.prototype, "basePath", {
        get: function () {
    ...
    ReconciliationsApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    ReconciliationsApi.prototype.setApiKey = function (key, value) {
        this.authentications[ReconciliationsApiApiKeys[key]].apiKey = value;
    };
    Object.defineProperty(ReconciliationsApi.prototype, "accessToken", {
        set: function (token) {
     ...
     */
    ReconciliationsApi.prototype.reconcileHoldings = function (sortBy, start, limit, filter, request, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/portfolios/$reconcileholdings';
                ...
                localVarRequestOptions = {
                    ...
                    json: true,
                    body: models_1.ObjectSerializer.serialize(request, "PortfoliosReconciliationRequest")
                };
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "ResourceListOfReconciliationBreak");
     ...
     * @param request The specifications of the inputs to the reconciliation
     */
    ReconciliationsApi.prototype.reconcileValuation = function (sortBy, start, limit, filter, request, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/portfolios/$reconcileValuation';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this.defaultHeaders);
                localVarFormParams = {};
                if (sortBy !== undefined) {
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(request, "ValuationsReconciliationRequest")
                };
                this.authentications.oauth2.applyToRequest(localVarRequestOptions);
                this.authentications.default.applyToRequest(localVarRequestOptions);
                if (Object.keys(localVarFormParams).length) {
    ...
    return ReconciliationsApi;
}());
exports.ReconciliationsApi = ReconciliationsApi;
