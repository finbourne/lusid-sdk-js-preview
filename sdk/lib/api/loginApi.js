...
var LoginApi = /** @class */ (function () {
    function LoginApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(LoginApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(LoginApi.prototype, "basePath", {
        get: function () {
    ...
    LoginApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    LoginApi.prototype.setApiKey = function (key, value) {
        this.authentications[LoginApiApiKeys[key]].apiKey = value;
    };
    Object.defineProperty(LoginApi.prototype, "accessToken", {
        set: function (token) {
     ...
     */
    LoginApi.prototype.getSamlIdentityProviderId = function (domain, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/login/saml/{domain}'
