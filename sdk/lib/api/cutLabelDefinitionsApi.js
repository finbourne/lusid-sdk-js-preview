...
// ===============================================
var CutLabelDefinitionsApiApiKeys;
(function (CutLabelDefinitionsApiApiKeys) {
})(CutLabelDefinitionsApiApiKeys = exports.CutLabelDefinitionsApiApiKeys || (exports.CutLabelDefinitionsApiApiKeys = {}));
var CutLabelDefinitionsApi = /** @class */ (function () {
    function CutLabelDefinitionsApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(CutLabelDefinitionsApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(CutLabelDefinitionsApi.prototype, "basePath", {
        get: function () {
    ...
    CutLabelDefinitionsApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    CutLabelDefinitionsApi.prototype.setApiKey = function (key, value) {
        this.authentications[CutLabelDefinitionsApiApiKeys[key]].apiKey = value;
    };
    Object.defineProperty(CutLabelDefinitionsApi.prototype, "accessToken", {
        set: function (token) {
     ...
     */
    CutLabelDefinitionsApi.prototype.createCutLabelDefinition = function (createRequest, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/systemconfiguration/cutlabels';
                ...
                localVarRequestOptions = {
                    ...
                    json: true,
                    body: models_1.ObjectSerializer.serialize(createRequest, "CreateCutLabelDefinitionRequest")
                };
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "CutLabelDefinition");
     ...
     */
    CutLabelDefinitionsApi.prototype.deleteCutLabelDefinition = function (code, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/systemconfiguration/cutlabels/{code}'
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "Date");
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    resolve({ response: response, body: body });
                                }
                                else {
     ...
     */
    CutLabelDefinitionsApi.prototype.getCutLabelDefinition = function (code, asAt, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
     ...
     */
    CutLabelDefinitionsApi.prototype.listCutLabelDefinitions = function (asAt, sortBy, start, limit, filter, query, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "ResourceListOfCutLabelDefinition");
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    resolve({ response: response, body: body });
                                }
                                else {
     ...
     */
    CutLabelDefinitionsApi.prototype.updateCutLabelDefinition = function (code, updateRequest, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(updateRequest, "UpdateCutLabelDefinitionRequest")
                };
                this.authentications.oauth2.applyToRequest(localVarRequestOptions);
                this.authentications.default.applyToRequest(localVarRequestOptions);
                if (Object.keys(localVarFormParams).length) {
    ...
    return CutLabelDefinitionsApi;
}());
exports.CutLabelDefinitionsApi = CutLabelDefinitionsApi;
