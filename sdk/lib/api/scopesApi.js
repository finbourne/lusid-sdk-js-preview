...
// ===============================================
var ScopesApiApiKeys;
(function (ScopesApiApiKeys) {
})(ScopesApiApiKeys = exports.ScopesApiApiKeys || (exports.ScopesApiApiKeys = {}));
var ScopesApi = /** @class */ (function () {
    function ScopesApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(ScopesApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(ScopesApi.prototype, "basePath", {
        get: function () {
    ...
    ScopesApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    ScopesApi.prototype.setApiKey = function (key, value) {
        this.authentications[ScopesApiApiKeys[key]].apiKey = value;
    };
    Object.defineProperty(ScopesApi.prototype, "accessToken", {
        set: function (token) {
     ...
     */
    ScopesApi.prototype.listScopes = function (filter, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/scopes';
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "ResourceListOfScopeDefinition");
