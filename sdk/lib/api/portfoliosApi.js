...
// ===============================================
var PortfoliosApiApiKeys;
(function (PortfoliosApiApiKeys) {
})(PortfoliosApiApiKeys = exports.PortfoliosApiApiKeys || (exports.PortfoliosApiApiKeys = {}));
var PortfoliosApi = /** @class */ (function () {
    function PortfoliosApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(PortfoliosApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(PortfoliosApi.prototype, "basePath", {
        get: function () {
    ...
    PortfoliosApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    PortfoliosApi.prototype.setApiKey = function (key, value) {
        this.authentications[PortfoliosApiApiKeys[key]].apiKey = value;
    };
    Object.defineProperty(PortfoliosApi.prototype, "accessToken", {
        set: function (token) {
     ...
     */
    PortfoliosApi.prototype.deletePortfolioProperties = function (scope, code, portfolioPropertyKeys, effectiveAt, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                ...
                // verify required parameter 'portfolioPropertyKeys' is not null or undefined
                if (portfolioPropertyKeys === null || portfolioPropertyKeys === undefined) {
                    throw new Error('Required parameter portfolioPropertyKeys was null or undefined when calling deletePortfolioProperties.');
                }
                if (effectiveAt !== undefined) {
                    localVarQueryParameters['effectiveAt'] = models_1.ObjectSerializer.serialize(effectiveAt, "string");
                }
                if (portfolioPropertyKeys !== undefined) {
                    localVarQueryParameters['portfolioPropertyKeys'] = models_1.ObjectSerializer.serialize(portfolioPropertyKeys, "Array<string>");
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
     ...
     */
    PortfoliosApi.prototype.getPortfolio = function (scope, code, effectiveAt, asAt, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
     ...
     */
    PortfoliosApi.prototype.getPortfolioCommands = function (scope, code, fromAsAt, toAsAt, filter, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "PortfolioProperties");
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    resolve({ response: response, body: body });
                                }
                                else {
     ...
     */
    PortfoliosApi.prototype.listPortfolios = function (effectiveAt, asAt, page, start, limit, filter, query, portfolioPropertyKeys, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "ResourceListOfPortfolio");
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    resolve({ response: response, body: body });
                                }
                                else {
     ...
     * @param portfolioPropertyKeys A list of property keys from the \&quot;Portfolio\&quot; domain to decorate onto each portfolio.              These take the format {domain}/{scope}/{code} e.g. \&quot;Portfolio/Manager/Id\&quot;.
     */
    PortfoliosApi.prototype.listPortfoliosForScope = function (scope, effectiveAt, asAt, filter, portfolioPropertyKeys, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
     ...
     */
    PortfoliosApi.prototype.updatePortfolio = function (scope, code, effectiveAt, request, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(request, "UpdatePortfolioRequest")
                };
                this.authentications.oauth2.applyToRequest(localVarRequestOptions);
                this.authentications.default.applyToRequest(localVarRequestOptions);
                if (Object.keys(localVarFormParams).length) {
     ...
     */
    PortfoliosApi.prototype.upsertPortfolioProperties = function (scope, code, portfolioProperties, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(portfolioProperties, "{ [key: string]: Property; }")
                };
                this.authentications.oauth2.applyToRequest(localVarRequestOptions);
                this.authentications.default.applyToRequest(localVarRequestOptions);
                if (Object.keys(localVarFormParams).length) {
