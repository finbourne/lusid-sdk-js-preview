...
// ===============================================
var PropertyDefinitionsApiApiKeys;
(function (PropertyDefinitionsApiApiKeys) {
})(PropertyDefinitionsApiApiKeys = exports.PropertyDefinitionsApiApiKeys || (exports.PropertyDefinitionsApiApiKeys = {}));
var PropertyDefinitionsApi = /** @class */ (function () {
    function PropertyDefinitionsApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(PropertyDefinitionsApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(PropertyDefinitionsApi.prototype, "basePath", {
        get: function () {
    ...
    PropertyDefinitionsApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    PropertyDefinitionsApi.prototype.setApiKey = function (key, value) {
        this.authentications[PropertyDefinitionsApiApiKeys[key]].apiKey = value;
    };
    Object.defineProperty(PropertyDefinitionsApi.prototype, "accessToken", {
        set: function (token) {
     ...
     */
    PropertyDefinitionsApi.prototype.createPropertyDefinition = function (definition, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/propertydefinitions';
                ...
                localVarRequestOptions = {
                    ...
                    json: true,
                    body: models_1.ObjectSerializer.serialize(definition, "CreatePropertyDefinitionRequest")
                };
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "PropertyDefinition");
     ...
     */
    PropertyDefinitionsApi.prototype.deletePropertyDefinition = function (domain, scope, code, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/propertydefinitions/{domain}/{scope}/{code}'
     ...
     */
    PropertyDefinitionsApi.prototype.getMultiplePropertyDefinitions = function (propertyKeys, asAt, filter, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
     ...
     */
    PropertyDefinitionsApi.prototype.getPropertyDefinition = function (domain, scope, code, asAt, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
     ...
     */
    PropertyDefinitionsApi.prototype.updatePropertyDefinition = function (domain, scope, code, definition, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(definition, "UpdatePropertyDefinitionRequest")
                };
                this.authentications.oauth2.applyToRequest(localVarRequestOptions);
                this.authentications.default.applyToRequest(localVarRequestOptions);
                if (Object.keys(localVarFormParams).length) {
    ...
    return PropertyDefinitionsApi;
}());
exports.PropertyDefinitionsApi = PropertyDefinitionsApi;
