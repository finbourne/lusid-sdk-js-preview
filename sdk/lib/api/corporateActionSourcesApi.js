...
// ===============================================
var CorporateActionSourcesApiApiKeys;
(function (CorporateActionSourcesApiApiKeys) {
})(CorporateActionSourcesApiApiKeys = exports.CorporateActionSourcesApiApiKeys || (exports.CorporateActionSourcesApiApiKeys = {}));
var CorporateActionSourcesApi = /** @class */ (function () {
    function CorporateActionSourcesApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(CorporateActionSourcesApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(CorporateActionSourcesApi.prototype, "basePath", {
        get: function () {
    ...
    CorporateActionSourcesApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    CorporateActionSourcesApi.prototype.setApiKey = function (key, value) {
        this.authentications[CorporateActionSourcesApiApiKeys[key]].apiKey = value;
    };
    Object.defineProperty(CorporateActionSourcesApi.prototype, "accessToken", {
        set: function (token) {
     ...
     */
    CorporateActionSourcesApi.prototype.batchUpsertCorporateActions = function (scope, code, actions, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/corporateactionsources/{scope}/{code}/corporateactions'
                ...
                localVarRequestOptions = {
                    ...
                    json: true,
                    body: models_1.ObjectSerializer.serialize(actions, "Array<UpsertCorporateActionRequest>")
                };
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "UpsertCorporateActionsResponse");
     ...
     */
    CorporateActionSourcesApi.prototype.createCorporateActionSource = function (request, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/corporateactionsources';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this.defaultHeaders);
                localVarFormParams = {};
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(request, "CreateCorporateActionSourceRequest")
                };
                this.authentications.oauth2.applyToRequest(localVarRequestOptions);
                this.authentications.default.applyToRequest(localVarRequestOptions);
                if (Object.keys(localVarFormParams).length) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "CorporateActionSource");
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    resolve({ response: response, body: body });
                                }
                                else {
     ...
     */
    CorporateActionSourcesApi.prototype.deleteCorporateActionSource = function (scope, code, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/corporateactionsources/{scope}/{code}'
                    .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
                    .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this.defaultHeaders);
     ...
     */
    CorporateActionSourcesApi.prototype.getCorporateActions = function (scope, code, fromEffectiveAt, toEffectiveAt, asAt, sortBy, start, limit, filter, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                ...
                if (sortBy !== undefined) {
                    localVarQueryParameters['sortBy'] = models_1.ObjectSerializer.serialize(sortBy, "Array<string>");
                }
                if (start !== undefined) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "ResourceListOfCorporateAction");
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    resolve({ response: response, body: body });
                                }
                                else {
     ...
     * @param filter Optional. Expression to filter the result set
     */
    CorporateActionSourcesApi.prototype.listCorporateActionSources = function (asAt, sortBy, start, limit, filter, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "ResourceListOfCorporateActionSource");
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    resolve({ response: response, body: body });
                                }
                                else {
    ...
    return CorporateActionSourcesApi;
}());
exports.CorporateActionSourcesApi = CorporateActionSourcesApi;
