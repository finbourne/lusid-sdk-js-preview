...
// ===============================================
var SystemConfigurationApiApiKeys;
(function (SystemConfigurationApiApiKeys) {
})(SystemConfigurationApiApiKeys = exports.SystemConfigurationApiApiKeys || (exports.SystemConfigurationApiApiKeys = {}));
var SystemConfigurationApi = /** @class */ (function () {
    function SystemConfigurationApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(SystemConfigurationApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(SystemConfigurationApi.prototype, "basePath", {
        get: function () {
    ...
    SystemConfigurationApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    SystemConfigurationApi.prototype.setApiKey = function (key, value) {
        this.authentications[SystemConfigurationApiApiKeys[key]].apiKey = value;
    };
    Object.defineProperty(SystemConfigurationApi.prototype, "accessToken", {
        set: function (token) {
     ...
     */
    SystemConfigurationApi.prototype.createConfigurationTransactionType = function (type, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/systemconfiguration/transactiontypes';
                ...
                localVarRequestOptions = {
                    ...
                    json: true,
                    body: models_1.ObjectSerializer.serialize(type, "TransactionConfigurationDataRequest")
                };
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "ResourceListOfTransactionConfigurationData");
     ...
     */
    SystemConfigurationApi.prototype.listConfigurationTransactionTypes = function (options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
     ...
     */
    SystemConfigurationApi.prototype.setConfigurationTransactionTypes = function (types, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(types, "Array<TransactionConfigurationDataRequest>")
                };
                this.authentications.oauth2.applyToRequest(localVarRequestOptions);
                this.authentications.default.applyToRequest(localVarRequestOptions);
                if (Object.keys(localVarFormParams).length) {
...
exports.SystemConfigurationApi = SystemConfigurationApi;
