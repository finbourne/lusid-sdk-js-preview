...
// ===============================================
var AnalyticsStoresApiApiKeys;
(function (AnalyticsStoresApiApiKeys) {
})(AnalyticsStoresApiApiKeys = exports.AnalyticsStoresApiApiKeys || (exports.AnalyticsStoresApiApiKeys = {}));
var AnalyticsStoresApi = /** @class */ (function () {
    function AnalyticsStoresApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(AnalyticsStoresApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(AnalyticsStoresApi.prototype, "basePath", {
        get: function () {
    ...
    AnalyticsStoresApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    AnalyticsStoresApi.prototype.setApiKey = function (key, value) {
        this.authentications[AnalyticsStoresApiApiKeys[key]].apiKey = value;
    };
    Object.defineProperty(AnalyticsStoresApi.prototype, "accessToken", {
        set: function (token) {
     ...
     */
    AnalyticsStoresApi.prototype.createAnalyticStore = function (request, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/analytics';
                ...
                localVarRequestOptions = {
                    ...
                    json: true,
                    body: models_1.ObjectSerializer.serialize(request, "CreateAnalyticStoreRequest")
                };
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "AnalyticStore");
     ...
     */
    AnalyticsStoresApi.prototype.deleteAnalyticStore = function (scope, year, month, day, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/analytics/{scope}/{year}/{month}/{day}'
     ...
     */
    AnalyticsStoresApi.prototype.getAnalyticStore = function (scope, year, month, day, asAt, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
     ...
     */
    AnalyticsStoresApi.prototype.listAnalyticStores = function (asAt, sortBy, start, limit, filter, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "ResourceListOfAnalyticStoreKey");
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    resolve({ response: response, body: body });
                                }
                                else {
     ...
     */
    AnalyticsStoresApi.prototype.setAnalytics = function (scope, year, month, day, data, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/analytics/{scope}/{year}/{month}/{day}/prices'
                    .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
                    .replace('{' + 'year' + '}', encodeURIComponent(String(year)))
                    .replace('{' + 'month' + '}', encodeURIComponent(String(month)))
                    .replace('{' + 'day' + '}', encodeURIComponent(String(day)));
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(data, "Array<InstrumentAnalytic>")
                };
                this.authentications.oauth2.applyToRequest(localVarRequestOptions);
                this.authentications.default.applyToRequest(localVarRequestOptions);
                if (Object.keys(localVarFormParams).length) {
    ...
    return AnalyticsStoresApi;
}());
exports.AnalyticsStoresApi = AnalyticsStoresApi;
