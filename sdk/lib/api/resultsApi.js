...
// ===============================================
var ResultsApiApiKeys;
(function (ResultsApiApiKeys) {
})(ResultsApiApiKeys = exports.ResultsApiApiKeys || (exports.ResultsApiApiKeys = {}));
var ResultsApi = /** @class */ (function () {
    function ResultsApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(ResultsApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(ResultsApi.prototype, "basePath", {
        get: function () {
    ...
    ResultsApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    ResultsApi.prototype.setApiKey = function (key, value) {
        this.authentications[ResultsApiApiKeys[key]].apiKey = value;
    };
    Object.defineProperty(ResultsApi.prototype, "accessToken", {
        set: function (token) {
     ...
     */
    ResultsApi.prototype.getResults = function (entityScope, entityCode, calculationScope, calculationCode, effectiveAt, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/results/{entityScope}/{entityCode}/{calculationScope}/{calculationCode}/{effectiveAt}'
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "Results");
     ...
     */
    ResultsApi.prototype.upsertResults = function (request, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/results';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this.defaultHeaders);
                localVarFormParams = {};
                Object.assign(localVarHeaderParams, options.headers);
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(request, "CreateResults")
                };
                this.authentications.oauth2.applyToRequest(localVarRequestOptions);
                this.authentications.default.applyToRequest(localVarRequestOptions);
                if (Object.keys(localVarFormParams).length) {
