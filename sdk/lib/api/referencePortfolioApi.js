...
// ===============================================
var ReferencePortfolioApiApiKeys;
(function (ReferencePortfolioApiApiKeys) {
})(ReferencePortfolioApiApiKeys = exports.ReferencePortfolioApiApiKeys || (exports.ReferencePortfolioApiApiKeys = {}));
var ReferencePortfolioApi = /** @class */ (function () {
    function ReferencePortfolioApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(ReferencePortfolioApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(ReferencePortfolioApi.prototype, "basePath", {
        get: function () {
    ...
    ReferencePortfolioApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    ReferencePortfolioApi.prototype.setApiKey = function (key, value) {
        this.authentications[ReferencePortfolioApiApiKeys[key]].apiKey = value;
    };
    Object.defineProperty(ReferencePortfolioApi.prototype, "accessToken", {
        set: function (token) {
     ...
     */
    ReferencePortfolioApi.prototype.createReferencePortfolio = function (scope, referencePortfolio, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/referenceportfolios/{scope}'
                ...
                localVarRequestOptions = {
                    ...
                    json: true,
                    body: models_1.ObjectSerializer.serialize(referencePortfolio, "CreateReferencePortfolioRequest")
                };
     ...
     */
    ReferencePortfolioApi.prototype.getReferencePortfolioConstituents = function (scope, code, effectiveAt, asAt, propertyKeys, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/referenceportfolios/{scope}/{code}/constituents'
                    .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "GetReferencePortfolioConstituentsResponse");
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    resolve({ response: response, body: body });
                                }
                                else {
     ...
     */
    ReferencePortfolioApi.prototype.listConstituentsAdjustments = function (scope, code, fromEffectiveAt, toEffectiveAt, asAtTime, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/api/referenceportfolios/{scope}/{code}/constituentsadjustments'
                    .replace('{' + 'scope' + '}', encodeURIComponent(String(scope)))
                    .replace('{' + 'code' + '}', encodeURIComponent(String(code)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this.defaultHeaders);
                ...
                if (asAtTime !== undefined) {
                    localVarQueryParameters['asAtTime'] = models_1.ObjectSerializer.serialize(asAtTime, "Date");
                }
                Object.assign(localVarHeaderParams, options.headers);
                localVarUseFormData = false;
                localVarRequestOptions = {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "ResourceListOfConstituentsAdjustmentHeader");
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    resolve({ response: response, body: body });
                                }
                                else {
     ...
     */
    ReferencePortfolioApi.prototype.upsertReferencePortfolioConstituents = function (scope, code, constituents, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions;
            return __generator(this, function (_a) {
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(constituents, "UpsertReferencePortfolioConstituentsRequest")
                };
                this.authentications.oauth2.applyToRequest(localVarRequestOptions);
                this.authentications.default.applyToRequest(localVarRequestOptions);
                if (Object.keys(localVarFormParams).length) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        localVarRequest(localVarRequestOptions, function (error, response, body) {
                            if (error) {
                                ...
                                body = models_1.ObjectSerializer.deserialize(body, "UpsertReferencePortfolioConstituentsResponse");
                                if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                    resolve({ response: response, body: body });
                                }
                                else {
    ...
    return ReferencePortfolioApi;
}());
exports.ReferencePortfolioApi = ReferencePortfolioApi;
