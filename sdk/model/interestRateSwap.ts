...
*/
export class InterestRateSwap extends LusidInstrument {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "isNonDeliverable",
            "baseName": "isNonDeliverable",
            "type": "boolean"
        },
        {
            "name": "legs",
        ...
        },
        {
            ...
            "type": "InterestRateSwap.InstrumentTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(InterestRateSwap.attributeTypeMap);
    }
}
