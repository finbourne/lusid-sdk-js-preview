...
export class FinalisedValuationPointAllOf {
    /**
    ...
    */
    'finalisedFromVariant'?: string | null;
    /**
    ...
    */
    'entryType': FinalisedValuationPointAllOf.EntryTypeEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "finalisedFromVariant",
            "baseName": "finalisedFromVariant",
            "type": "string"
        },
        {
            "name": "displayName",
        ...
        },
        {
            "name": "entryType",
            "baseName": "entryType",
            "type": "FinalisedValuationPointAllOf.EntryTypeEnum"
        },
        {
            "name": "status",
            "baseName": "status",
        ...
        {
            "name": "dateOfLastPcaScan",
            "baseName": "dateOfLastPcaScan",
            "type": "Date"
        },
        {
            "name": "fundCalendarEntriesType",
            "baseName": "fundCalendarEntriesType",
            "type": "FinalisedValuationPointAllOf.FundCalendarEntriesTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return FinalisedValuationPointAllOf.attributeTypeMap;
    }
}

export namespace FinalisedValuationPointAllOf {
