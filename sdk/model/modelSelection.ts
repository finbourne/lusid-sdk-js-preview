...
export class ModelSelection {
    ...
    */
    ...
    /**
    * The available values are: SimpleStatic, Discounting, VendorDefault, BlackScholes, ConstantTimeValueOfMoney, Bachelier, ForwardWithPoints, ForwardWithPointsUndiscounted, ForwardSpecifiedRate, ForwardSpecifiedRateUndiscounted, IndexNav, IndexPrice, InlinedIndex, ForwardFromCurve, ForwardFromCurveUndiscounted
    */
...
export namespace ModelSelection {
    ...
    export enum ModelEnum {
        ...
        ForwardFromCurve = <any> 'ForwardFromCurve',
        ForwardFromCurveUndiscounted = <any> 'ForwardFromCurveUndiscounted'
    }
}
