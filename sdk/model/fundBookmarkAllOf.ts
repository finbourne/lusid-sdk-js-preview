...
export class FundBookmarkAllOf {
    /**
    ...
    */
    'entryType': FundBookmarkAllOf.EntryTypeEnum;
    /**
    ...
    */
    'fundCalendarEntriesType': FundBookmarkAllOf.FundCalendarEntriesTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "entryType",
            "baseName": "entryType",
            "type": "FundBookmarkAllOf.EntryTypeEnum"
        },
        {
            "name": "status",
            "baseName": "status",
        ...
        },
        {
            ...
            "type": "FundBookmarkAllOf.FundCalendarEntriesTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return FundBookmarkAllOf.attributeTypeMap;
    }
}

export namespace FundBookmarkAllOf {
