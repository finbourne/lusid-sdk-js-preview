...
*/
export class CreditSpreadCurveData extends ComplexMarketData {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "CreditSpreadCurveData.MarketDataTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(CreditSpreadCurveData.attributeTypeMap);
    }
}
