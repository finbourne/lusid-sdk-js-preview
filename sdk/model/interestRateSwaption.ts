...
*/
export class InterestRateSwaption extends LusidInstrument {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "InterestRateSwaption.PayOrReceiveFixedEnum"
        },
        {
            "name": "deliveryMethod",
            "baseName": "deliveryMethod",
            "type": "InterestRateSwaption.DeliveryMethodEnum"
        },
        {
            "name": "swap",
            "baseName": "swap",
        ...
        },
        {
            ...
            "type": "InterestRateSwaption.InstrumentTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(InterestRateSwaption.attributeTypeMap);
    }
}
