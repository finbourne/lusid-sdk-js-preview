...
export class IdentifierDefinition {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "domain",
            "baseName": "domain",
            "type": "IdentifierDefinition.DomainEnum"
        },
        {
        ...
        },
        {
            "name": "lifeTime",
            "baseName": "lifeTime",
            "type": "IdentifierDefinition.LifeTimeEnum"
        },
        {
            "name": "hierarchyUsage",
    ...
    static getAttributeTypeMap() {
        return IdentifierDefinition.attributeTypeMap;
    }
}
