...
export class CapFloorAllOf {
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "floorStrike",
            "baseName": "floorStrike",
            "type": "number"
        },
        {
            "name": "includeFirstCaplet",
            "baseName": "includeFirstCaplet",
            "type": "boolean"
        },
        {
            "name": "underlyingFloatingLeg",
            "baseName": "underlyingFloatingLeg",
            "type": "FloatingLeg"
        },
        {
            "name": "instrumentType",
            "baseName": "instrumentType",
            "type": "CapFloorAllOf.InstrumentTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return CapFloorAllOf.attributeTypeMap;
    }
}
