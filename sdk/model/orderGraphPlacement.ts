...
export class OrderGraphPlacement {
    'placement': Placement;
    'blockId': ResourceId;
    /**
    * Identifiers for all orders in the block - DEPRECATED: see Ordered.
    */
    'orderIds': Array<ResourceId>;
    /**
    * Identifiers for all allocations relating to this placement - DEPRECATED: see Allocated.
    */
    'allocationIds': Array<ResourceId>;
    /**
    * Identifiers of all executions against this placement - DEPRECATED: see Executed.
    */
    'executionIds': Array<ResourceId>;
    ...
    */
    'calculatedAveragePrice'?: number | null;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "ordered",
            "baseName": "ordered",
            "type": "OrderGraphPlacementOrderSynopsis"
        },
        {
            "name": "placed",
            "baseName": "placed",
            "type": "OrderGraphPlacementPlacementSynopsis"
        },
        {
            "name": "executed",
            "baseName": "executed",
            "type": "OrderGraphPlacementExecutionSynopsis"
        },
        {
            "name": "allocated",
            "baseName": "allocated",
            "type": "OrderGraphPlacementAllocationSynopsis"
        },
        {
            "name": "derivedState",
            "baseName": "derivedState",
            "type": "string"
        },
        {
            "name": "calculatedAveragePrice",
            "baseName": "calculatedAveragePrice",
            "type": "number"
        }    ];

    static getAttributeTypeMap() {
        return OrderGraphPlacement.attributeTypeMap;
    }
}
