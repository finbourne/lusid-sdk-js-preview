...
*/
export class InflationLinkedBond extends LusidInstrument {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "InflationLinkedBond.InstrumentTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(InflationLinkedBond.attributeTypeMap);
    }
}
