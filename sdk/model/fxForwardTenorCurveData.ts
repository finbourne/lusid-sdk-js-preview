...
*/
export class FxForwardTenorCurveData extends ComplexMarketData {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "FxForwardTenorCurveData.MarketDataTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(FxForwardTenorCurveData.attributeTypeMap);
    }
}
