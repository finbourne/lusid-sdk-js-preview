...
export class BondAllOf {
    ...
    */
    ...
    /**
    * The initial coupon date is in fact the previous coupon pay date in the bond schedule. This date specifies the start of the coupon period in which the ex-dividend date lies.
    */
