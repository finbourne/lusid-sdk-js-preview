...
export class BondAllOf {
    /**
    * The start date of the instrument. This is normally synonymous with the trade-date. If settle days = 0 then this is the initial accrual date of the bond.
    */
    'startDate': Date;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "initialCouponDate",
            "baseName": "initialCouponDate",
            "type": "Date"
        },
        {
            "name": "firstCouponPayDate",
            "baseName": "firstCouponPayDate",
            "type": "Date"
        },
        {
        ...
        },
        {
            ...
            "type": "BondAllOf.InstrumentTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return BondAllOf.attributeTypeMap;
    }
}
