...
*/
export class YieldCurveData extends ComplexMarketData {
    /**
    * Base date
    */
    'baseDate': Date;
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "YieldCurveData.MarketDataTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(YieldCurveData.attributeTypeMap);
    }
}
