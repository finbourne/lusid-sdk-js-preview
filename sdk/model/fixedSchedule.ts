    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "FixedSchedule.ScheduleTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(FixedSchedule.attributeTypeMap);
    }
}

export namespace FixedSchedule {
    export enum ScheduleTypeEnum {
        FixedSchedule = <any> 'FixedSchedule',
        FloatSchedule = <any> 'FloatSchedule',
        OptionalitySchedule = <any> 'OptionalitySchedule',
        StepSchedule = <any> 'StepSchedule',
        Exercise = <any> 'Exercise',
        FxRateSchedule = <any> 'FxRateSchedule',
        FxLinkedNotionalSchedule = <any> 'FxLinkedNotionalSchedule',
        Invalid = <any> 'Invalid'
    }
}
