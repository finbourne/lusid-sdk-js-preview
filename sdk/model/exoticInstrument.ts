...
*/
export class ExoticInstrument extends LusidInstrument {
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "ExoticInstrument.InstrumentTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(ExoticInstrument.attributeTypeMap);
    }
}
