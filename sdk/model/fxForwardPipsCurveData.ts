...
*/
export class FxForwardPipsCurveData extends ComplexMarketData {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "FxForwardPipsCurveData.MarketDataTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(FxForwardPipsCurveData.attributeTypeMap);
    }
}
