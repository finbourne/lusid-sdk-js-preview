...
*/
export class ComplexMarketData {
    /**
    ...
    */
    ...
    static discriminator: string | undefined = "marketDataType";

    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        {
            "name": "marketDataType",
            "baseName": "marketDataType",
            "type": "ComplexMarketData.MarketDataTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return ComplexMarketData.attributeTypeMap;
    }
}
