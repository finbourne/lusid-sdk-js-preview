...
export class FinalisedValuationPoint extends FundCalendarEntries {
    /**
    ...
    */
    'entryType': FinalisedValuationPoint.EntryTypeEnum;
    /**
    ...
    */
    'fundCalendarEntriesType': FinalisedValuationPoint.FundCalendarEntriesTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            "name": "entryType",
            "baseName": "entryType",
            "type": "FinalisedValuationPoint.EntryTypeEnum"
        },
        {
            "name": "status",
            "baseName": "status",
        ...
        },
        {
            ...
            "type": "FinalisedValuationPoint.FundCalendarEntriesTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(FinalisedValuationPoint.attributeTypeMap);
    }
}

export namespace FinalisedValuationPoint {
