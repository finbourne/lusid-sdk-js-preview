...
export class PropertyDefinition {
    ...
    */
    ...
    /**
    * The domain that the property exists in. The available values are: NotDefined, Transaction, Portfolio, Holding, ReferenceHolding, TransactionConfiguration, Instrument, CutLabelDefinition, Analytic, PortfolioGroup, Person, AccessMetadata, Order, UnitResult, MarketData, ConfigurationRecipe, Allocation, Calendar
    */
...
export namespace PropertyDefinition {
    export enum ValueTypeEnum {
        ...
        Tenor = <any> 'Tenor',
        CdsProtectionDetailSpecification = <any> 'CdsProtectionDetailSpecification',
        FlowConventions = <any> 'FlowConventions',
        CdsFlowConventions = <any> 'CdsFlowConventions',
        Conventions = <any> 'Conventions',
        LegDefinition = <any> 'LegDefinition',
        IndexConvention = <any> 'IndexConvention',
        FuturesContractDetails = <any> 'FuturesContractDetails',
        OrderId = <any> 'OrderId',
        Order = <any> 'Order',
        Quote = <any> 'Quote',
        WeekendMask = <any> 'WeekendMask',
        DateAttributes = <any> 'DateAttributes',
        CashFlowLeg = <any> 'CashFlowLeg',
        InstrumentDefinitionFormat = <any> 'InstrumentDefinitionFormat'
    }
