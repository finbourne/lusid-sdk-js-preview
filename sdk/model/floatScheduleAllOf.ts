...
export class FloatScheduleAllOf {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "indexConventions",
            "baseName": "indexConventions",
        ...
        {
            "name": "useAnnualisedDirectRates",
            "baseName": "useAnnualisedDirectRates",
            "type": "boolean"
        },
        {
            "name": "capRate",
        ...
        },
        {
            ...
            "type": "FloatScheduleAllOf.ScheduleTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return FloatScheduleAllOf.attributeTypeMap;
    }
}
...
export namespace FloatScheduleAllOf {
    export enum ScheduleTypeEnum {
        ...
        BondConversionSchedule = <any> 'BondConversionSchedule',
        PikSchedule = <any> 'PikSchedule',
        CommodityCalendarSchedule = <any> 'CommodityCalendarSchedule',
        Invalid = <any> 'Invalid',
        CancelSchedule = <any> 'CancelSchedule'
    }
}
