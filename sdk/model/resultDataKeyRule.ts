...
export class ResultDataKeyRule extends ResultKeyRule {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "ResultDataKeyRule.ResultKeyRuleTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(ResultDataKeyRule.attributeTypeMap);
    }
}
