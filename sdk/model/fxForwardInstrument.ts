...
*/
export class FxForwardInstrument extends LusidInstrument {
    /**
    ...
    */
    'instrumentType': FxForwardInstrument.InstrumentTypeEnum;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "FxForwardInstrument.InstrumentTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(FxForwardInstrument.attributeTypeMap);
    }
}

export namespace FxForwardInstrument {
