...
export class FlowConventions {
    ...
    */
    'accrualDateAdjustment'?: string | null;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "leapDaysIncluded",
            "baseName": "leapDaysIncluded",
            "type": "boolean"
        },
        {
            "name": "accrualDateAdjustment",
            "baseName": "accrualDateAdjustment",
            "type": "string"
        },
        {
            "name": "scope",
