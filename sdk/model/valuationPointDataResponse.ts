...
*/
export class ValuationPointDataResponse {
    /**
    ...
    */
    'shareClassData': { [key: string]: ShareClassData; };
    /**
    * The code of the valuation point.
    */
    'valuationPointCode'?: string | null;
    /**
    * The code of the previous valuation point.
    */
    'previousValuationPointCode'?: string | null;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "previousNav",
            "baseName": "previousNav",
            "type": "number"
        },
        {
            "name": "fundDetails",
            "baseName": "fundDetails",
            "type": "FundDetails"
        },
        {
            "name": "fundValuationPointData",
            "baseName": "fundValuationPointData",
            "type": "FundValuationPointData"
        },
        {
            "name": "shareClassData",
            "baseName": "shareClassData",
            "type": "{ [key: string]: ShareClassData; }"
        },
        {
            "name": "valuationPointCode",
            "baseName": "valuationPointCode",
            "type": "string"
        },
        {
            "name": "previousValuationPointCode",
            "baseName": "previousValuationPointCode",
            "type": "string"
        },
        {
            "name": "links",
    ...
    static getAttributeTypeMap() {
        return ValuationPointDataResponse.attributeTypeMap;
    }
}
