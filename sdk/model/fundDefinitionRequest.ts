...
*/
export class FundDefinitionRequest {
    /**
    ...
    */
    'shareClasses'?: Array<ShareClassDefinition> | null;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "shareClassInstrumentScopes",
            "baseName": "shareClassInstrumentScopes",
            "type": "Array<string>"
        },
        {
        ...
        },
        {
            ...
            "type": "Array<ShareClassDefinition>"
        }    ];

    static getAttributeTypeMap() {
        return FundDefinitionRequest.attributeTypeMap;
    }
}
