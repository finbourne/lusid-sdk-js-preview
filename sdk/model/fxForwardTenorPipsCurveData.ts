...
*/
export class FxForwardTenorPipsCurveData extends ComplexMarketData {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        },
        {
            ...
            "type": "FxForwardTenorPipsCurveData.MarketDataTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return super.getAttributeTypeMap().concat(FxForwardTenorPipsCurveData.attributeTypeMap);
    }
}
