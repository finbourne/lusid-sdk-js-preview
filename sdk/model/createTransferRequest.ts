...
export class CreateTransferRequest {
    ...
    'portfolioIdOut': ResourceId;
    'portfolioIdIn': ResourceId;
    ...
    */
    ...
    'tradeDateOut': Date;
    'tradeDateIn': Date;
    'settlementDateOut': Date;
    'settlementDateIn'?: Date | null;
    'exchangeRateOut'?: number | null;
    'exchangeRateIn'?: number | null;
    'transactionPriceOut'?: number | null;
    'transactionPriceIn'?: number | null;
    'counterpartyIdOut'?: string | null;
    'counterpartyIdIn'?: string | null;
    'custodianAccountIdOut'?: ResourceId;
    'custodianAccountIdIn'?: ResourceId;
    'source': string;
    /**
    * Available values: AverageCost, FirstInFirstOut, LastInFirstOut, HighestCostFirst, LowestCostFirst, ProRateByUnits, ProRateByCost, ProRateByCostPortfolioCurrency, IntraDayThenFirstInFirstOut, LongTermHighestCostFirst, LongTermHighestCostFirstPortfolioCurrency, HighestCostFirstPortfolioCurrency, LowestCostFirstPortfolioCurrency, MaximumLossMinimumGain, MaximumLossMinimumGainPortfolioCurrency.
    */
    'accountingMethod'?: string | null;
    'propertiesOut'?: { [key: string]: PerpetualProperty; } | null;
    'propertiesIn'?: { [key: string]: PerpetualProperty; } | null;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "portfolioIdOut",
            "baseName": "portfolioIdOut",
            "type": "ResourceId"
        },
        {
            "name": "portfolioIdIn",
            "baseName": "portfolioIdIn",
            "type": "ResourceId"
        },
        {
            "name": "instrumentIdentifierOut",
            "baseName": "instrumentIdentifierOut",
            "type": "string"
        },
        {
            "name": "instrumentIdentifierIn",
            "baseName": "instrumentIdentifierIn",
            "type": "string"
        },
        {
            "name": "pricingMethod",
            "baseName": "pricingMethod",
            "type": "string"
        },
        {
            "name": "taxLotStructure",
            "baseName": "taxLotStructure",
            "type": "string"
        },
        {
            "name": "unitsOut",
        ...
        {
            "name": "tradeDateOut",
            "baseName": "tradeDateOut",
            "type": "Date"
        },
        {
            "name": "tradeDateIn",
            "baseName": "tradeDateIn",
            "type": "Date"
        },
        {
            "name": "settlementDateOut",
            "baseName": "settlementDateOut",
            "type": "Date"
        },
        {
            "name": "settlementDateIn",
            "baseName": "settlementDateIn",
            "type": "Date"
        },
        {
            "name": "exchangeRateOut",
            "baseName": "exchangeRateOut",
            "type": "number"
        },
        {
            "name": "exchangeRateIn",
            "baseName": "exchangeRateIn",
            "type": "number"
        },
        {
            "name": "transactionPriceOut",
            "baseName": "transactionPriceOut",
            "type": "number"
        },
        {
            "name": "transactionPriceIn",
            "baseName": "transactionPriceIn",
            "type": "number"
        },
        {
            "name": "counterpartyIdOut",
            "baseName": "counterpartyIdOut",
            "type": "string"
        },
        {
            "name": "counterpartyIdIn",
            "baseName": "counterpartyIdIn",
            "type": "string"
        },
        {
            "name": "custodianAccountIdOut",
            "baseName": "custodianAccountIdOut",
            "type": "ResourceId"
        },
        {
            "name": "custodianAccountIdIn",
            "baseName": "custodianAccountIdIn",
            "type": "ResourceId"
        },
        {
            "name": "source",
        ...
        {
            "name": "propertiesOut",
            "baseName": "propertiesOut",
            "type": "{ [key: string]: PerpetualProperty; }"
        },
        {
            "name": "propertiesIn",
            "baseName": "propertiesIn",
            "type": "{ [key: string]: PerpetualProperty; }"
        },
        {
            "name": "properties",
