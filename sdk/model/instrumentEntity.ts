...
export class InstrumentEntity {
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "entityUniqueId",
            "baseName": "entityUniqueId",
            "type": "string"
        },
        {
            "name": "asAtVersionNumber",
            "baseName": "asAtVersionNumber",
            "type": "number"
        },
        {
            "name": "status",
        ...
        {
            "name": "asAtDeleted",
            "baseName": "asAtDeleted",
            "type": "Date"
        },
        {
            "name": "userIdDeleted",
            "baseName": "userIdDeleted",
            "type": "string"
        },
        {
            "name": "requestIdDeleted",
            "baseName": "requestIdDeleted",
            "type": "string"
        },
        {
            "name": "effectiveAtCreated",
            "baseName": "effectiveAtCreated",
            "type": "Date"
        },
        {
            "name": "prevailingInstrument",
            "baseName": "prevailingInstrument",
            "type": "Instrument"
        },
        {
            "name": "deletedInstrument",
            "baseName": "deletedInstrument",
            "type": "Instrument"
        },
        {
            "name": "previewedStatus",
            "baseName": "previewedStatus",
            "type": "string"
        },
        {
            "name": "previewedInstrument",
            "baseName": "previewedInstrument",
            "type": "Instrument"
        },
        {
            "name": "links",
    ...
    static getAttributeTypeMap() {
        return InstrumentEntity.attributeTypeMap;
    }
}
