...
export class PricingContext {
    ...
    */
    'modelChoice'?: { [key: string]: ModelSelection; } | null;
    ...
    */
    'resultDataRules'?: Array<ResultDataKeyRule> | null;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "modelChoice",
            "baseName": "modelChoice",
            "type": "{ [key: string]: ModelSelection; }"
        },
        {
            "name": "options",
            "baseName": "options",
        ...
        {
            "name": "resultDataRules",
            "baseName": "resultDataRules",
            "type": "Array<ResultDataKeyRule>"
        }    ];

    static getAttributeTypeMap() {
        return PricingContext.attributeTypeMap;
    }
}
