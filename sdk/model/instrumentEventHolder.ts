...
*/
export class InstrumentEventHolder {
    /**
    ...
    */
    ...
    /**
    * The date the event is determined to have occured.
    */
    'anchorDate'?: Date;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "instrumentEventId",
            "baseName": "instrumentEventId",
            "type": "string"
        },
        {
            "name": "description",
    ...
    static getAttributeTypeMap() {
        return InstrumentEventHolder.attributeTypeMap;
    }
}
