...
export class FxOption extends LusidInstrument {
    ...
    */
    ...
    /**
    * Type of optionality that is present; European, Bermudan, American.    Supported string (enumeration) values are: [European, Bermudan, American].
    */
    ...
    */
    ...
    /**
    * True if the option is settled in cash, false if delivery.
    */
    ...
    */
    ...
    /**
    * PayoutStyle for touch options.  For options without touch optionality (IsTouch==false),  PayoutStyle should not be set (ot it can be set to None)  For options with touch optionality (IsTouch==true),  PayoutStyle cannot be None.    Supported string (enumeration) values are: [Deferred, Immediate].
    */
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "isPayoffDigital",
            "baseName": "isPayoffDigital",
            "type": "boolean"
        },
        {
