...
export class ResultDataKeyRuleAllOf {
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "documentResultType",
            "baseName": "documentResultType",
            "type": "string"
        },
        {
            "name": "resultKeyRuleType",
            "baseName": "resultKeyRuleType",
            "type": "ResultDataKeyRuleAllOf.ResultKeyRuleTypeEnum"
        }    ];

    static getAttributeTypeMap() {
        return ResultDataKeyRuleAllOf.attributeTypeMap;
    }
}
