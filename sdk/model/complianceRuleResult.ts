...
export class ComplianceRuleResult {
    ...
    */
    'ruleInformationMatch': string;
    /**
    * The property key matched by the rule
    */
    'ruleInformationKey': string;
    /**
    * The lower limit of the rule
    */
    'ruleLowerLimit': number;
    /**
    * The upper limit of the rule
    */
    'ruleUpperLimit': number;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "resultValue",
            "baseName": "resultValue",
            "type": "number"
        },
        {
            "name": "ruleInformationMatch",
            "baseName": "ruleInformationMatch",
            "type": "string"
        },
        {
            "name": "ruleInformationKey",
            "baseName": "ruleInformationKey",
            "type": "string"
        },
        {
            "name": "ruleLowerLimit",
            "baseName": "ruleLowerLimit",
            "type": "number"
        },
        {
            "name": "ruleUpperLimit",
            "baseName": "ruleUpperLimit",
            "type": "number"
        }    ];

    static getAttributeTypeMap() {
        return ComplianceRuleResult.attributeTypeMap;
    }
}
