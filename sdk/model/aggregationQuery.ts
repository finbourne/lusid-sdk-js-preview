...
export class AggregationQuery {
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "flattenedType",
            "baseName": "flattenedType",
            "type": "AggregationQuery.FlattenedTypeEnum"
        },
        {
        ...
        },
        {
            ...
            "baseName": "applicableOptions",
            "type": "{ [key: string]: AddressKeyOptionDefinition; }"
        }    ];
