...
export class ExchangeTradedOptionContractDetails {
    ...
    */
    'description': string;
    /**
    * Exchange code for contract  Supported string (enumeration) values are: [ASX, CBOT, CBF, CME, CMX, EOP, HKG, KFE, MFM, OSE, SGX, NYBOT, KCBT, MGE, MATIF, SFE, NYFE, NYM, LIFFE, EUREX, ICE, MSE, NASDAQ, EEX, LME].
    */
    'exchangeCode': string;
    /**
    * Exercise Date
