...
*/
export class ExchangeTradedOptionContractDetails {
    /**
    ...
    */
    'country': string;
    /**
    * The delivery type, cash or physical. An option on a future is physically settled if upon exerciseing the  holder receives a future.  Supported string (enumeration) values are: [Cash, Physical].
    */
    'deliveryType': string;
    /**
    ...
    */
    'description': string;
    /**
    * Exchange code for contract  Supported string (enumeration) values are: [ASX, CBOT, CBF, CME, CMX, EOP, HKG, KFE, MFM, OSE, SGX, NYBOT, KCBT, MGE, MATIF, SFE, NYFE, NYM, LIFFE, EUREX, ICE, MSE, NASDAQ, EEX].
    */
    'exchangeCode': string;
    /**
    * Exercise Date
    */
    'exerciseDate': Date;
    /**
    * The exercise type, European, American or Bermudan  Supported string (enumeration) values are: [None, European, Bermudan, American].
    */
    'exerciseType': string;
    /**
    ...
    */
    'optionCode': string;
    /**
    * The option type, Call or Put.  Supported string (enumeration) values are: [None, Call, Put].
    */
    'optionType': string;
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "underlyingCode",
            "baseName": "underlyingCode",
            "type": "string"
        }    ];

    static getAttributeTypeMap() {
        return ExchangeTradedOptionContractDetails.attributeTypeMap;
    }
}
