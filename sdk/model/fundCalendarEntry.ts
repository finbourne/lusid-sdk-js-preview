...
export class FundCalendarEntry {
    /**
    ...
    */
    'navTypeCode': string;
    'timelineId'?: ResourceId;
    'previousEntry'?: PreviousFundCalendarEntry;
    /**
    ...
    */
    'entryType': FundCalendarEntry.EntryTypeEnum;
    /**
    ...
    */
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "previousEntry",
            "baseName": "previousEntry",
            "type": "PreviousFundCalendarEntry"
        },
        {
            "name": "effectiveAt",
        ...
        },
        {
            "name": "entryType",
            "baseName": "entryType",
            "type": "FundCalendarEntry.EntryTypeEnum"
        },
        {
            "name": "status",
            "baseName": "status",
        ...
        {
            "name": "applyClearDown",
            "baseName": "applyClearDown",
            "type": "boolean"
        },
        {
            "name": "holdingsAsAtOverride",
            "baseName": "holdingsAsAtOverride",
            "type": "Date"
        },
        {
            "name": "valuationsAsAtOverride",
            "baseName": "valuationsAsAtOverride",
            "type": "Date"
        },
        {
            "name": "properties",
        ...
        {
            "name": "leaderNavTypeCode",
            "baseName": "leaderNavTypeCode",
            "type": "string"
        }    ];

    static getAttributeTypeMap() {
        return FundCalendarEntry.attributeTypeMap;
    }
}

export namespace FundCalendarEntry {
    export enum EntryTypeEnum {
        ValuationPointFundCalendarEntry = <any> 'ValuationPointFundCalendarEntry',
        BookmarkFundCalendarEntry = <any> 'BookmarkFundCalendarEntry'
    }
}
